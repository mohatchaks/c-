...
{
	public class RouteDetailsForm : Form, IForm
	{
		private RouteData currentData;

		private const string TABLENAME_CONST = "Route";

		private const string IDFIELD_CONST = "RouteID";
		...
		private bool GetData()
		{
			try
			{
				...
				{
					currentData = new RouteData();
				}
				DataRow dataRow = (!isNewRecord) ? currentData.RouteTable.Rows[0] : currentData.RouteTable.NewRow();
				dataRow.BeginEdit();
				dataRow["RouteID"] = textBoxCode.Text.Trim();
				dataRow["RouteName"] = textBoxName.Text.Trim();
				...
				if (isNewRecord)
				{
					currentData.RouteTable.Rows.Add(dataRow);
				}
				return true;
			}
			catch (Exception e)
		...
		public void LoadData(string id)
		{
			try
			{
				...
				{
					currentData = Factory.RouteSystem.GetRouteByID(id.Trim());
		...
		private void FillData()
		{
			if (currentData != null && currentData.Tables.Count != 0 && currentData.Tables[0].Rows.Count != 0)
			{
				...
				textBoxCode.Text = dataRow["RouteID"].ToString();
				textBoxName.Text = dataRow["RouteName"].ToString();
		...
		private bool SaveData()
		{
			...
			try
			{
				...
				if (isNewRecord)
				{
					flag = Factory.RouteSystem.CreateRoute(currentData);
					if (flag)
					{
						ComboDataHelper.SetRefreshStatus(DataComboType.Route, needRefresh: true);
					}
				}
				else
				{
					flag = Factory.RouteSystem.UpdateRoute(currentData);
				}
				if (!flag)
				{
		...
		private bool ValidateData()
		{
			...
			if (!IsNewRecord && !Global.IsUserAdmin && !AllowEditCard && Global.CurrentUser != Factory.SystemDocumentSystem.GetCardUserID("Route", "RouteID", textBoxCode.Text))
			{
			...
			if (isNewRecord && Factory.DatabaseSystem.ExistFieldValue("Route", "RouteID", textBoxCode.Text.Trim()))
			{
		...
		private bool Delete()
		{
			try
			{
				...
				return Factory.RouteSystem.DeleteRoute(textBoxCode.Text);
			}
			catch (Exception e)
			{
				ErrorHelper.ProcessError(e);
		...
		{
			LoadData(DatabaseHelper.GetNextID("Route", "RouteID", textBoxCode.Text));
		}

		private void toolStripButtonPrevious_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetPreviousID("Route", "RouteID", textBoxCode.Text));
		}

		private void toolStripButtonLast_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetLastID("Route", "RouteID"));
		}

		private void toolStripButtonFirst_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetFirstID("Route", "RouteID"));
		}
		...
		private void toolStripButtonFind_Click(object sender, EventArgs e)
		{
			try
			{
				...
				else if (Factory.DatabaseSystem.ExistFieldValue("Route", "RouteID", toolStripTextBoxFind.Text.Trim()))
				{
		...
		{
			new FormHelper().ShowList(DataComboType.Route);
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Inventory.RouteDetailsForm));
			...
			checkBoxInactive.Location = new System.Drawing.Point(283, 38);
			...
			textBoxNote.Location = new System.Drawing.Point(105, 107);
			textBoxNote.MaxLength = 255;
			textBoxNote.Multiline = true;
			textBoxNote.Name = "textBoxNote";
			textBoxNote.Size = new System.Drawing.Size(327, 34);
			...
			mmLabel4.Location = new System.Drawing.Point(12, 114);
			...
			textBoxName.Location = new System.Drawing.Point(105, 60);
			textBoxName.MaxLength = 64;
			textBoxName.Name = "textBoxName";
			textBoxName.Size = new System.Drawing.Size(327, 20);
			...
			textBoxCode.Location = new System.Drawing.Point(105, 36);
			textBoxCode.MaxLength = 30;
			textBoxCode.Name = "textBoxCode";
			textBoxCode.Size = new System.Drawing.Size(169, 20);
			...
			linkLabelCountry.Location = new System.Drawing.Point(12, 88);
			...
			comboBoxLocation.DisplayLayout.Appearance = appearance2;
			...
			comboBoxLocation.DisplayLayout.GroupByBox.Appearance = appearance3;
			appearance4.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxLocation.DisplayLayout.GroupByBox.BandLabelAppearance = appearance4;
			...
			comboBoxLocation.DisplayLayout.GroupByBox.PromptAppearance = appearance5;
			...
			comboBoxLocation.DisplayLayout.Override.ActiveCellAppearance = appearance6;
			appearance7.BackColor = System.Drawing.SystemColors.Highlight;
			appearance7.ForeColor = System.Drawing.SystemColors.HighlightText;
			comboBoxLocation.DisplayLayout.Override.ActiveRowAppearance = appearance7;
			...
			comboBoxLocation.DisplayLayout.Override.CardAreaAppearance = appearance8;
			appearance9.BorderColor = System.Drawing.Color.Silver;
			appearance9.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxLocation.DisplayLayout.Override.CellAppearance = appearance9;
			...
			comboBoxLocation.DisplayLayout.Override.GroupByRowAppearance = appearance10;
			appearance11.TextHAlignAsString = "Left";
			comboBoxLocation.DisplayLayout.Override.HeaderAppearance = appearance11;
			...
			comboBoxLocation.DisplayLayout.Override.RowAppearance = appearance12;
			comboBoxLocation.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance13.BackColor = System.Drawing.SystemColors.ControlLight;
			comboBoxLocation.DisplayLayout.Override.TemplateAddRowAppearance = appearance13;
			...
			comboBoxLocation.Location = new System.Drawing.Point(105, 84);
			...
			comboBoxLocation.Size = new System.Drawing.Size(168, 20);
			comboBoxLocation.TabIndex = 83;
