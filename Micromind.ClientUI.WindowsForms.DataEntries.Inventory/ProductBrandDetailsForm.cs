...
{
	public class ProductBrandDetailsForm : Form, IForm
	{
		private ProductBrandData currentData;

		private const string TABLENAME_CONST = "Product_Brand";

		private const string IDFIELD_CONST = "BrandID";
		...
		public ProductBrandDetailsForm()
		{
			InitializeComponent();
			AddEvents();
		}
		...
		{
			base.Load += ProductBrandDetailsForm_Load;
		}
		...
		private bool GetData()
		{
			try
			{
				...
				{
					currentData = new ProductBrandData();
				}
				DataRow dataRow = (!isNewRecord) ? currentData.ProductBrandTable.Rows[0] : currentData.ProductBrandTable.NewRow();
				dataRow.BeginEdit();
				dataRow["BrandID"] = textBoxCode.Text.Trim();
				dataRow["BrandName"] = textBoxName.Text.Trim();
				...
				if (isNewRecord)
				{
					currentData.ProductBrandTable.Rows.Add(dataRow);
				}
				return true;
			}
			catch (Exception e)
		...
		public void LoadData(string id)
		{
			try
			{
				...
				{
					currentData = Factory.ProductBrandSystem.GetProductBrandByID(id.Trim());
		...
		private void FillData()
		{
			try
			{
				if (currentData != null && currentData.Tables.Count != 0 && currentData.Tables[0].Rows.Count != 0)
				{
					...
					textBoxCode.Text = dataRow["BrandID"].ToString();
					textBoxName.Text = dataRow["BrandName"].ToString();
		...
		private bool SaveData()
		{
			...
			try
			{
				...
				if (isNewRecord)
				{
					flag = Factory.ProductBrandSystem.CreateProductBrand(currentData);
					if (flag)
					{
						ComboDataHelper.SetRefreshStatus(DataComboType.ProductBrand, needRefresh: true);
					}
				}
				else
				{
					flag = Factory.ProductBrandSystem.UpdateProductBrand(currentData);
				}
				if (!flag)
				{
		...
		private bool ValidateData()
		{
			...
			if (!IsNewRecord && !Global.IsUserAdmin && !AllowEditCard && Global.CurrentUser != Factory.SystemDocumentSystem.GetCardUserID("Product_Brand", "BrandID", textBoxCode.Text))
			{
			...
			if (isNewRecord && Factory.DatabaseSystem.ExistFieldValue("Product_Brand", "BrandID", textBoxCode.Text.Trim()))
			{
		...
		{
			textBoxCode.Text = PublicFunctions.GetNextCardNumber("Product_Brand", "BrandID");
			textBoxName.Clear();
			textBoxNote.Clear();
			formManager.ResetDirty();
			textBoxCode.Focus();
		...
		private void ProductBrandGroupDetailsForm_Validating(object sender, CancelEventArgs e)
		{
		}

		private void ProductBrandGroupDetailsForm_Validated(object sender, EventArgs e)
		{
		}
		...
		private bool Delete()
		{
			try
			{
				...
				bool num = Factory.ProductBrandSystem.DeleteProductBrand(textBoxCode.Text);
				if (num)
				{
					ComboDataHelper.SetRefreshStatus(DataComboType.ProductBrand, needRefresh: true);
				}
		...
		{
			LoadData(DatabaseHelper.GetNextID("Product_Brand", "BrandID", textBoxCode.Text));
		}

		private void toolStripButtonPrevious_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetPreviousID("Product_Brand", "BrandID", textBoxCode.Text));
		}

		private void toolStripButtonLast_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetLastID("Product_Brand", "BrandID"));
		}

		private void toolStripButtonFirst_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetFirstID("Product_Brand", "BrandID"));
		}
		...
		private void toolStripButtonFind_Click(object sender, EventArgs e)
		{
			try
			{
				...
				else if (Factory.DatabaseSystem.ExistFieldValue("Product_Brand", "BrandID", toolStripTextBoxFind.Text.Trim()))
				{
		...
		private void ProductBrandDetailsForm_Load(object sender, EventArgs e)
		{
			try
			{
				SetSecurity();
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Inventory.ProductBrandDetailsForm));
			...
			ultraFormattedLinkLabel7.VisitedLinkAppearance = appearance;
			...
			comboBoxPrefVendor.DisplayLayout.Appearance = appearance2;
			...
			comboBoxPrefVendor.DisplayLayout.GroupByBox.Appearance = appearance3;
			appearance4.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxPrefVendor.DisplayLayout.GroupByBox.BandLabelAppearance = appearance4;
			...
			comboBoxPrefVendor.DisplayLayout.GroupByBox.PromptAppearance = appearance5;
			...
			comboBoxPrefVendor.DisplayLayout.Override.ActiveCellAppearance = appearance6;
			appearance7.BackColor = System.Drawing.SystemColors.Highlight;
			appearance7.ForeColor = System.Drawing.SystemColors.HighlightText;
			comboBoxPrefVendor.DisplayLayout.Override.ActiveRowAppearance = appearance7;
			...
			comboBoxPrefVendor.DisplayLayout.Override.CardAreaAppearance = appearance8;
			appearance9.BorderColor = System.Drawing.Color.Silver;
			appearance9.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxPrefVendor.DisplayLayout.Override.CellAppearance = appearance9;
			...
			comboBoxPrefVendor.DisplayLayout.Override.GroupByRowAppearance = appearance10;
			appearance11.TextHAlignAsString = "Left";
			comboBoxPrefVendor.DisplayLayout.Override.HeaderAppearance = appearance11;
			...
			comboBoxPrefVendor.DisplayLayout.Override.RowAppearance = appearance12;
			comboBoxPrefVendor.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance13.BackColor = System.Drawing.SystemColors.ControlLight;
			comboBoxPrefVendor.DisplayLayout.Override.TemplateAddRowAppearance = appearance13;
			...
			comboBoxPrefVendor.Location = new System.Drawing.Point(114, 102);
			...
			comboBoxPrefVendor.Size = new System.Drawing.Size(173, 20);
			comboBoxPrefVendor.TabIndex = 6;
			...
			base.ClientSize = new System.Drawing.Size(470, 178);
			base.Controls.Add(ultraFormattedLinkLabel7);
			base.Controls.Add(comboBoxPrefVendor);
			...
			base.Name = "ProductBrandDetailsForm";
			Text = "Product Brand Detail";
