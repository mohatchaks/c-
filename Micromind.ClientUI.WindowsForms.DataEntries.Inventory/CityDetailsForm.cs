...
{
	public class CityDetailsForm : Form, IForm
	{
		private CityData currentData;

		private const string TABLENAME_CONST = "City";

		private const string IDFIELD_CONST = "CityID";
		...
		{
			base.Load += CityDetailsForm_Load;
		}
		...
		private bool GetData()
		{
			try
			{
				...
				{
					currentData = new CityData();
				}
				DataRow dataRow = (!isNewRecord) ? currentData.CityTable.Rows[0] : currentData.CityTable.NewRow();
				dataRow.BeginEdit();
				dataRow["CityID"] = textBoxCode.Text.Trim();
				dataRow["CityName"] = textBoxName.Text.Trim();
				if (comboBoxCountry.SelectedID != null)
				{
				...
				if (isNewRecord)
				{
					currentData.CityTable.Rows.Add(dataRow);
				}
				return true;
			}
			catch (Exception e)
		...
		public void LoadData(string id)
		{
			try
			{
				...
				{
					currentData = Factory.CitySystem.GetCityByID(id.Trim());
		...
		private void FillData()
		{
			if (currentData != null && currentData.Tables.Count != 0 && currentData.Tables[0].Rows.Count != 0)
			{
				...
				textBoxCode.Text = dataRow["CityID"].ToString();
				textBoxName.Text = dataRow["CityName"].ToString();
		...
		private bool SaveData()
		{
			...
			try
			{
				...
				if (isNewRecord)
				{
					flag = Factory.CitySystem.CreateCity(currentData);
					if (flag)
					{
						ComboDataHelper.SetRefreshStatus(DataComboType.City, needRefresh: true);
					}
				}
				else
				{
					flag = Factory.CitySystem.UpdateCity(currentData);
				}
				if (!flag)
				{
		...
		private bool ValidateData()
		{
			...
			if (!IsNewRecord && !Global.IsUserAdmin && !AllowEditCard && Global.CurrentUser != Factory.SystemDocumentSystem.GetCardUserID("City", "CityID", textBoxCode.Text))
			{
			...
			if (isNewRecord && Factory.DatabaseSystem.ExistFieldValue("City", "CityID", textBoxCode.Text.Trim()))
			{
		...
		{
			textBoxCode.Text = PublicFunctions.GetNextCardNumber("City", "CityID");
			textBoxName.Clear();
			comboBoxCountry.Clear();
			checkBoxInactive.Checked = false;
			formManager.ResetDirty();
		...
		private void CityGroupDetailsForm_Validating(object sender, CancelEventArgs e)
		{
		}

		private void CityGroupDetailsForm_Validated(object sender, EventArgs e)
		{
		}
		...
		private bool Delete()
		{
			try
			{
				...
				return Factory.CitySystem.DeleteCity(textBoxCode.Text);
			}
			catch (Exception e)
			{
				ErrorHelper.ProcessError(e);
		...
		{
			LoadData(DatabaseHelper.GetNextID("City", "CityID", textBoxCode.Text));
		}

		private void toolStripButtonPrevious_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetPreviousID("City", "CityID", textBoxCode.Text));
		}

		private void toolStripButtonLast_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetLastID("City", "CityID"));
		}

		private void toolStripButtonFirst_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetFirstID("City", "CityID"));
		}
		...
		private void toolStripButtonFind_Click(object sender, EventArgs e)
		{
			try
			{
				...
				else if (Factory.DatabaseSystem.ExistFieldValue("City", "CityID", toolStripTextBoxFind.Text.Trim()))
				{
		...
		{
			new FormHelper().ShowList(DataComboType.City);
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Inventory.CityDetailsForm));
			...
			toolStrip1.Size = new System.Drawing.Size(450, 31);
			...
			panelButtons.Location = new System.Drawing.Point(0, 124);
			...
			mmLabel4.Location = new System.Drawing.Point(12, 83);
			mmLabel4.Name = "mmLabel4";
			mmLabel4.PenWidth = 1f;
			mmLabel4.ShowBorder = false;
			mmLabel4.Size = new System.Drawing.Size(46, 13);
			mmLabel4.TabIndex = 18;
			mmLabel4.Text = "Country:";
			...
			comboBoxCountry.DisplayLayout.Appearance = appearance;
			...
			comboBoxCountry.DisplayLayout.GroupByBox.Appearance = appearance2;
			appearance3.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxCountry.DisplayLayout.GroupByBox.BandLabelAppearance = appearance3;
			...
			comboBoxCountry.DisplayLayout.GroupByBox.PromptAppearance = appearance4;
			...
			comboBoxCountry.DisplayLayout.Override.ActiveCellAppearance = appearance5;
			appearance6.BackColor = System.Drawing.SystemColors.Highlight;
			appearance6.ForeColor = System.Drawing.SystemColors.HighlightText;
			comboBoxCountry.DisplayLayout.Override.ActiveRowAppearance = appearance6;
			...
			comboBoxCountry.DisplayLayout.Override.CardAreaAppearance = appearance7;
			appearance8.BorderColor = System.Drawing.Color.Silver;
			appearance8.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxCountry.DisplayLayout.Override.CellAppearance = appearance8;
			...
			comboBoxCountry.DisplayLayout.Override.GroupByRowAppearance = appearance9;
			appearance10.TextHAlignAsString = "Left";
			comboBoxCountry.DisplayLayout.Override.HeaderAppearance = appearance10;
			...
			comboBoxCountry.DisplayLayout.Override.RowAppearance = appearance11;
			comboBoxCountry.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance12.BackColor = System.Drawing.SystemColors.ControlLight;
			comboBoxCountry.DisplayLayout.Override.TemplateAddRowAppearance = appearance12;
			...
			textBoxCountryName.Location = new System.Drawing.Point(212, 80);
			textBoxCountryName.MaxLength = 64;
			textBoxCountryName.Name = "textBoxCountryName";
			textBoxCountryName.ReadOnly = true;
			textBoxCountryName.Size = new System.Drawing.Size(225, 20);
			textBoxCountryName.TabIndex = 20;
			textBoxCountryName.TabStop = false;
			base.AutoScaleDimensions = new System.Drawing.SizeF(6f, 13f);
			base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			BackColor = System.Drawing.Color.WhiteSmoke;
			base.ClientSize = new System.Drawing.Size(450, 164);
