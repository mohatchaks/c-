...
{
	public class CompanyAddressDetailsForm : Form, IForm
	{
		private CompanyAddressData currentData;

		private const string TABLENAME_CONST = "Company_Address";

		private const string IDFIELD_CONST = "AddressID";

		private bool isNewRecord = true;

		private bool isLoadingNewCompany;
		...
		public event EventHandler CompanyAddressChanged;

		public CompanyAddressDetailsForm()
		{
			InitializeComponent();
		...
		{
			base.Load += CompanyAddressDetailsForm_Load;
		}
		...
		private bool GetData()
		{
			try
			{
				...
				{
					currentData = new CompanyAddressData();
				}
				DataRow dataRow = (!isNewRecord) ? currentData.CompanyAddressTable.Rows[0] : currentData.CompanyAddressTable.NewRow();
				dataRow.BeginEdit();
		...
		public void LoadData(string addressID)
		{
			try
			{
				if (!(addressID == "") && CanClose())
				{
					currentData = Factory.CompanyAddressSystem.GetCompanyAddressByID(addressID);
					if (currentData != null)
					{
						FillData();
						IsNewRecord = false;
		...
		private bool SaveData()
		{
			...
			try
			{
				...
				if (isNewRecord)
				{
					flag = Factory.CompanyAddressSystem.CreateCompanyAddress(currentData);
				}
				else
				{
					flag = Factory.CompanyAddressSystem.UpdateCompanyAddress(currentData);
					if (this.CompanyAddressChanged != null)
					{
						this.CompanyAddressChanged(currentData, null);
					}
				}
				if (!flag)
				{
		...
		private bool ValidateData()
		{
			...
			if (isNewRecord && Factory.DatabaseSystem.ExistFieldValue("Company_Address", "AddressID", textBoxCode.Text.Trim()))
			{
		...
		private void CompanyAddressGroupDetailsForm_Validating(object sender, CancelEventArgs e)
		{
		}

		private void CompanyAddressGroupDetailsForm_Validated(object sender, EventArgs e)
		{
		}
		...
		private bool Delete()
		{
			try
			{
				...
				if (Factory.CompanyAddressSystem.IsPrimaryAddress(textBoxCode.Text))
				{
					ErrorHelper.InformationMessage("You cannot delete this address because it is assigned as the primary address.");
					return false;
				}
				return Factory.CompanyAddressSystem.DeleteCompanyAddress(textBoxCode.Text);
			}
			catch (Exception e)
			{
				ErrorHelper.ProcessError(e);
		...
		{
			LoadData(DatabaseHelper.GetNextID("Company_Address", "AddressID", textBoxCode.Text));
		}

		private void toolStripButtonPrevious_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetPreviousID("Company_Address", "AddressID", textBoxCode.Text));
		}

		private void toolStripButtonLast_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetLastID("Company_Address", "AddressID"));
		}

		private void toolStripButtonFirst_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetFirstID("Company_Address", "AddressID"));
		}
		...
		private void toolStripButtonFind_Click(object sender, EventArgs e)
		{
			try
			{
				...
				else if (Factory.DatabaseSystem.ExistFieldValue("Company_Address", "AddressID", toolStripTextBoxFind.Text.Trim()))
				{
		...
		private void CompanyAddressDetailsForm_Load(object sender, EventArgs e)
		{
			try
			{
				SetSecurity();
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Others.CompanyAddressDetailsForm));
			...
			mmLabel23.Location = new System.Drawing.Point(374, 193);
			...
			textBoxComment.Location = new System.Drawing.Point(445, 190);
			...
			mmLabel22.Location = new System.Drawing.Point(374, 39);
			...
			textBoxDepartment.Location = new System.Drawing.Point(445, 36);
			...
			mmLabel19.Location = new System.Drawing.Point(374, 171);
			...
			mmLabel8.Location = new System.Drawing.Point(12, 37);
			...
			textBoxWebsite.Location = new System.Drawing.Point(445, 168);
			...
			textBoxCode.Location = new System.Drawing.Point(135, 36);
			...
			textBoxContactName.Location = new System.Drawing.Point(135, 58);
			...
			mmLabel21.Location = new System.Drawing.Point(12, 235);
			...
			mmLabel9.Location = new System.Drawing.Point(12, 60);
			...
			textBoxAddressPrintFormat.Location = new System.Drawing.Point(135, 234);
			...
			textBoxAddress1.Location = new System.Drawing.Point(135, 80);
			...
			mmLabel20.Location = new System.Drawing.Point(12, 215);
			...
			mmLabel10.Location = new System.Drawing.Point(12, 82);
			...
			textBoxPostalCode.Location = new System.Drawing.Point(135, 212);
			...
			textBoxAddress2.Location = new System.Drawing.Point(135, 102);
			...
			mmLabel18.Location = new System.Drawing.Point(374, 149);
			...
			textBoxAddress3.Location = new System.Drawing.Point(135, 124);
			...
			textBoxEmail.Location = new System.Drawing.Point(445, 146);
			...
			textBoxCity.Location = new System.Drawing.Point(135, 146);
			...
			mmLabel17.Location = new System.Drawing.Point(374, 127);
			...
			mmLabel13.Location = new System.Drawing.Point(12, 148);
			...
			textBoxMobile.Location = new System.Drawing.Point(445, 124);
			...
			textBoxState.Location = new System.Drawing.Point(135, 168);
			...
			mmLabel16.Location = new System.Drawing.Point(374, 104);
			...
			mmLabel11.Location = new System.Drawing.Point(12, 171);
			...
			textBoxFax.Location = new System.Drawing.Point(445, 102);
			...
			textBoxCountry.Location = new System.Drawing.Point(135, 190);
			...
			mmLabel15.Location = new System.Drawing.Point(374, 83);
			...
			mmLabel12.Location = new System.Drawing.Point(12, 193);
			...
			textBoxPhone2.Location = new System.Drawing.Point(445, 80);
			...
			textBoxPhone1.Location = new System.Drawing.Point(445, 58);
			...
			mmLabel14.Location = new System.Drawing.Point(374, 61);
			...
			base.Name = "CompanyAddressDetailsForm";
			Text = "Company Address Detail";
