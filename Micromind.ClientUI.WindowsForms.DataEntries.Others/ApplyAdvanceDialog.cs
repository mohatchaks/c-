...
{
	public class ApplyAdvanceDialog : Form
	{
		...
		private TextBox textBoxAdvanceApplied;
		...
		public ApplyAdvanceDialog()
		{
			InitializeComponent();
			base.Load += ApplyAdvanceDialog_Load;
			base.Activated += ApplyAdvanceDialog_Activated;
			base.FormClosing += ApplyAdvanceDialog_FormClosing;
			base.StartPosition = FormStartPosition.CenterParent;
			comboBoxAdvance.ReadOnly = true;
			textBoxAdvanceName.ReadOnly = true;
		}

		private void ApplyAdvanceDialog_FormClosing(object sender, FormClosingEventArgs e)
		{
			try
			{
		...
		private void ApplyAdvanceDialog_Activated(object sender, EventArgs e)
		{
		}

		private void ApplyAdvanceDialog_Load(object sender, EventArgs e)
		{
			try
			{
		...
		public void LoadData()
		{
			...
			{
				d = decimal.Parse(jobByID.Tables[0].Rows[0]["AdvanceBilled"].ToString());
			}
			if (jobByID.Tables[0].Rows[0]["AdvanceApplied"] != DBNull.Value)
			{
				d2 = decimal.Parse(jobByID.Tables[0].Rows[0]["AdvanceApplied"].ToString());
			}
			textBoxAdvanceApplied.Text = d2.ToString(Format.TotalAmountFormat);
			textBoxBilled.Text = d.ToString(Format.TotalAmountFormat);
			textBoxBalance.Text = (d - d2).ToString(Format.TotalAmountFormat);
			comboBoxAdvance.SelectedID = jobByID.Tables[0].Rows[0]["AdvanceItemID"].ToString();
			textBoxAdvanceName.Text = jobByID.Tables[0].Rows[0]["AdvanceDescription"].ToString();
		...
		private void buttonOK_Click(object sender, EventArgs e)
		{
			...
			decimal d = decimal.Parse(textBoxAmount.Text);
			num = decimal.Parse(textBoxBalance.Text);
			if (d > num)
			{
				ErrorHelper.WarningMessage("You cannot apply an advance amount greater than the balance. Please enter an amount equal or less than the balance.");
				base.DialogResult = DialogResult.None;
			}
			else
			{
		...
		private void InitializeComponent()
		{
			...
			textBoxAdvanceApplied = new System.Windows.Forms.TextBox();
			...
			panelButtons.Size = new System.Drawing.Size(601, 40);
			...
			buttonOK.Location = new System.Drawing.Point(389, 8);
			...
			buttonCancel.Location = new System.Drawing.Point(491, 8);
			...
			panelDetails.Controls.Add(textBoxAdvanceApplied);
			...
			textBoxBalance.AllowNegative = true;
			...
			textBoxBalance.Location = new System.Drawing.Point(469, 56);
			textBoxBalance.Name = "textBoxBalance";
			textBoxBalance.ReadOnly = true;
			textBoxBalance.Size = new System.Drawing.Size(118, 20);
			textBoxBalance.TabIndex = 153;
			...
			textBoxAdvanceApplied.BackColor = System.Drawing.Color.WhiteSmoke;
			textBoxAdvanceApplied.Location = new System.Drawing.Point(285, 56);
			textBoxAdvanceApplied.MaxLength = 64;
			textBoxAdvanceApplied.Name = "textBoxAdvanceApplied";
			textBoxAdvanceApplied.ReadOnly = true;
			textBoxAdvanceApplied.Size = new System.Drawing.Size(123, 20);
			textBoxAdvanceApplied.TabIndex = 4;
			textBoxAdvanceApplied.TabStop = false;
			textBoxAdvanceApplied.Text = "0.00";
			textBoxAdvanceApplied.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			label5.AutoSize = true;
			label5.Location = new System.Drawing.Point(234, 59);
			label5.Name = "label5";
			label5.Size = new System.Drawing.Size(45, 13);
			label5.TabIndex = 151;
			label5.Text = "Applied:";
			label6.AutoSize = true;
			label6.Location = new System.Drawing.Point(414, 59);
			label6.Name = "label6";
			label6.Size = new System.Drawing.Size(49, 13);
			label6.TabIndex = 149;
			label6.Text = "Balance:";
			textBoxBilled.BackColor = System.Drawing.Color.WhiteSmoke;
			textBoxBilled.Location = new System.Drawing.Point(111, 56);
			textBoxBilled.MaxLength = 64;
			textBoxBilled.Name = "textBoxBilled";
			textBoxBilled.ReadOnly = true;
			textBoxBilled.Size = new System.Drawing.Size(117, 20);
			...
			label1.Location = new System.Drawing.Point(14, 60);
			label1.Name = "label1";
			...
			comboBoxAdvance.CustomReportFieldName = "";
			comboBoxAdvance.CustomReportKey = "";
			comboBoxAdvance.CustomReportValueType = 1;
			...
			comboBoxAdvance.FilteredJobID = null;
			...
			comboBoxAdvance.IsDataLoaded = false;
			comboBoxAdvance.Location = new System.Drawing.Point(112, 129);
			...
			comboBoxAdvance.TabStop = false;
			comboBoxAdvance.UseFlatMode = Infragistics.Win.DefaultableBoolean.True;
			textBoxAdvanceName.Location = new System.Drawing.Point(247, 129);
			...
			ultraFormattedLinkLabel1.Location = new System.Drawing.Point(16, 131);
			ultraFormattedLinkLabel1.Name = "ultraFormattedLinkLabel1";
			ultraFormattedLinkLabel1.Size = new System.Drawing.Size(76, 15);
			...
			textBoxAmount.AllowNegative = true;
			...
			textBoxAmount.Location = new System.Drawing.Point(112, 151);
			...
			label3.Location = new System.Drawing.Point(14, 154);
			label3.Name = "label3";
			label3.Size = new System.Drawing.Size(46, 13);
			label3.TabIndex = 151;
			label3.Text = "Amount:";
			label7.AutoSize = true;
			label7.Location = new System.Drawing.Point(14, 103);
			label7.Name = "label7";
			label7.Size = new System.Drawing.Size(311, 13);
			label7.TabIndex = 152;
			label7.Text = "Enter the advance amount that you want to apply to this invoice:";
			base.AcceptButton = buttonOK;
			base.AutoScaleDimensions = new System.Drawing.SizeF(6f, 13f);
			base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			BackColor = System.Drawing.Color.WhiteSmoke;
			base.CancelButton = buttonCancel;
			base.ClientSize = new System.Drawing.Size(601, 251);
