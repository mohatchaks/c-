...
{
	public class GeneralDetailsForm : Form
	{
		...
		private bool SaveData()
		{
			...
			try
			{
				bool flag = (!isNewRecord) ? Factory.AccountGroupsSystem.UpdateAccountGroup(currentData) : Factory.AccountGroupsSystem.CreateAccountGroup(currentData);
				if (!flag)
				{
		...
		private bool ValidateData()
		{
			...
			if (isNewRecord && Factory.DatabaseSystem.ExistFieldValue(TABLENAME_CONST, IDFIELD_CONST, textBoxCode.Text.Trim()))
			{
		...
		{
			LoadData(DatabaseHelper.GetNextID(TABLENAME_CONST, IDFIELD_CONST, textBoxCode.Text));
		}

		private void toolStripButtonPrevious_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetPreviousID(TABLENAME_CONST, IDFIELD_CONST, textBoxCode.Text));
		}

		private void toolStripButtonLast_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetLastID(TABLENAME_CONST, IDFIELD_CONST));
		}

		private void toolStripButtonFirst_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetFirstID(TABLENAME_CONST, IDFIELD_CONST));
		}
		...
		private void toolStripButtonFind_Click(object sender, EventArgs e)
		{
			try
			{
				...
				else if (Factory.DatabaseSystem.ExistFieldValue(TABLENAME_CONST, IDFIELD_CONST, toolStripTextBoxFind.Text.Trim()))
				{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Others.GeneralDetailsForm));
			...
			toolStrip1.Size = new System.Drawing.Size(471, 25);
			...
			checkBoxInactive.Location = new System.Drawing.Point(240, 42);
			...
			textBoxNote.Size = new System.Drawing.Size(349, 20);
			...
			base.ClientSize = new System.Drawing.Size(471, 171);
