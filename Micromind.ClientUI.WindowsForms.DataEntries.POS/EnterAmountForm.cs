...
{
	public class EnterAmountForm : XtraForm
	{
		...
		private void XtraForm1_Load(object sender, EventArgs e)
		{
			...
			{
				Text = "Discount";
				label1.Text = "Please enter the discount:";
			}
			else if (IsPrice)
			{
				Text = "Total";
				label1.Text = "Please enter the total amount:";
			}
			else if (IsQuantity)
			{
				Text = "Quantity";
			...
			{
				Text = "Price";
				label1.Text = "Please enter the price:";
			}
		}
		...
		private void buttonSave_Click(object sender, EventArgs e)
		{
			try
			{
				...
				if (!decimal.TryParse(textBoxTotal.Text, out result))
				{
				...
				{
					ErrorHelper.InformationMessage("Please enter a numeric value between " + MinValue.ToString() + " and " + MaxValue.ToString());
					return;
				}
			}
			catch (Exception e2)
