...
{
	public class ProductStockPivotListReport : Form, IForm
	{
		...
		public ProductStockPivotListReport()
		{
			InitializeComponent();
			base.Load += Form_Load;
		}
		...
		private void buttonOK_Click(object sender, EventArgs e)
		{
			try
			{
				...
				text = "Item Stock List Location Wise";
				if (IsValuation)
				{
				...
				if (report == null)
				{
					ErrorHelper.ErrorMessage("Cannot find the report file", "'Item Stock List Item Wise.repx'", "Please make sure you have access to reports path and the files are not corrupted.");
				}
				else
				{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.Items.ProductStockPivotListReport));
			...
			buttonOK.Location = new System.Drawing.Point(289, 437);
			...
			productSelector.Size = new System.Drawing.Size(403, 191);
			productSelector.TabIndex = 2;
			checkBoxShowInactive.AutoSize = true;
			checkBoxShowInactive.Location = new System.Drawing.Point(18, 391);
			...
			buttonClose.Location = new System.Drawing.Point(393, 437);
			...
			checkBoxShowZero.Location = new System.Drawing.Point(18, 372);
			...
			radioButtonCurrent.Location = new System.Drawing.Point(18, 332);
			...
			radioButtonAsOf.Location = new System.Drawing.Point(114, 332);
			...
			line1.Location = new System.Drawing.Point(-8, 431);
			line1.Name = "line1";
			...
			dateTimePickerAsOfDate.Location = new System.Drawing.Point(172, 332);
			...
			ultraGroupBox2.Location = new System.Drawing.Point(12, 234);
			...
			base.ClientSize = new System.Drawing.Size(500, 469);
			...
			base.Name = "ProductStockPivotListReport";
			Text = "Item Stock List Report";
