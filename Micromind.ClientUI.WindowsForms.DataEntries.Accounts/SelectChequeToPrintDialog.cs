...
{
	public class SelectChequeToPrintDialog : Form, IForm
	{
		...
		public SelectChequeToPrintDialog()
		{
			InitializeComponent();
			base.Load += SelectChequeToPrintDialog_Load;
			textBoxSearch.KeyDown += textBoxSearch_KeyDown;
			base.Activated += SelectChequeToPrintDialog_Activated;
		}

		private void SelectChequeToPrintDialog_Activated(object sender, EventArgs e)
		{
			textBoxSearch.Focus();
		}
		...
		private void SelectChequeToPrintDialog_Load(object sender, EventArgs e)
		{
			try
			{
				LoadData();
				...
				dataGridItems.DisplayLayout.Bands[0].Columns["IsSecurityChq"].Hidden = true;
			}
			catch (Exception e2)
			{
		...
		{
			DataSet issuedChequeToPrint = Factory.IssuedChequeSystem.GetIssuedChequeToPrint(DateTime.Now, DateTime.Now, checkBoxShowAll.Checked);
			DataTable dataTable = issuedChequeToPrint.Tables[0];
			dataTable.Columns.Add("SearchColumn");
			string text = "";
			foreach (DataRow row in dataTable.Rows)
			{
				...
				foreach (DataColumn column in dataTable.Columns)
				{
					if (!(column.ColumnName == "SearchColumn") && !(column.ColumnName == "ChequeID") && !(column.ColumnName == "Amount"))
					{
						text = text + row[column].ToString() + " ";
					}
				}
			...
			dataGridItems.DataSource = issuedChequeToPrint;
			dataGridItems.DisplayLayout.Bands[0].Columns["SearchColumn"].Hidden = true;
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Accounts.SelectChequeToPrintDialog));
			...
			SuspendLayout();
			panelButtons.Controls.Add(checkBoxShowAll);
			...
			checkBoxShowAll.Location = new System.Drawing.Point(11, 11);
			checkBoxShowAll.Name = "checkBoxShowAll";
			checkBoxShowAll.Size = new System.Drawing.Size(110, 17);
			checkBoxShowAll.TabIndex = 0;
			checkBoxShowAll.Text = "Show all cheques";
			...
			dataGridItems.Size = new System.Drawing.Size(480, 215);
			...
			base.Name = "SelectChequeToPrintDialog";
