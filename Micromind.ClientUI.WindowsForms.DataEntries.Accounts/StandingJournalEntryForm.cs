...
{
	public class StandingJournalEntryForm : Form, IForm
	{
		private StandingJournalData currentData;

		private const string TABLENAME_CONST = "Standing_Journal";

		private const string IDFIELD_CONST = "StandingJournalID";
		...
		private MonthComboBox comboBoxEndMonth;

		private MonthComboBox comboBoxStartMonth;

		private YearComboBox comboBoxEndYear;
		...
		private TextBox textBoxPeriodCount;
		...
		public StandingJournalEntryForm()
		{
			InitializeComponent();
		...
		private void AddEvents()
		{
			...
			comboBoxStartYear.TextChanged += comboBoxPeriods_TextChanged;
			comboBoxStartMonth.TextChanged += comboBoxPeriods_TextChanged;
			comboBoxEndYear.TextChanged += comboBoxPeriods_TextChanged;
			comboBoxEndMonth.TextChanged += comboBoxPeriods_TextChanged;
		}

		private void comboBoxPeriods_TextChanged(object sender, EventArgs e)
		{
			CaldulateTotal();
		}
		...
		private void dataGridItems_AfterRowActivate(object sender, EventArgs e)
		{
			...
			{
				dataGridItems.DisplayLayout.Bands[0].Columns["Account Code"].ValueList = comboBoxGridCustomer;
			}
			else if (a == "V")
			{
				dataGridItems.DisplayLayout.Bands[0].Columns["Account Code"].ValueList = comboBoxGridVendor;
			}
			else if (a == "E")
			{
				dataGridItems.DisplayLayout.Bands[0].Columns["Account Code"].ValueList = comboBoxGridEmployee;
			}
			if (a == "A")
			{
			...
			{
				dataGridItems.ActiveRow.Cells["Analysis"].Activation = Activation.NoEdit;
			}
		}
		...
		private void dataGridItems_CellChange(object sender, CellEventArgs e)
		{
			...
			if (e.Cell.Column.Key == "Debit")
			{
				...
				{
					dataGridItems.ActiveRow.Cells["Credit"].Value = DBNull.Value;
				}
			}
			else if (e.Cell.Column.Key == "Credit")
			{
				if (dataGridItems.ActiveRow.Cells["Debit"].Value.ToString() != "")
				{
					dataGridItems.ActiveRow.Cells["Debit"].Value = DBNull.Value;
				}
			}
			else if (e.Cell.Column.Key == "T")
			{
				object obj3 = dataGridItems.ActiveRow.Cells["Account Code"].Value = (dataGridItems.ActiveRow.Cells["Account Name"].Value = "");
			}
		}

		private void dataGridItems_BeforeCellActivate(object sender, CancelableCellEventArgs e)
		{
			if (e.Cell.Column.Key == "Debit" && e.Cell.Value.ToString() == "")
			{
				if (dataGridItems.ActiveRow.Cells["Credit"].Value.ToString() == "")
				{
					...
					foreach (UltraGridRow row in dataGridItems.Rows)
					{
						...
						{
							d -= decimal.Parse(row.Cells["Debit"].Value.ToString());
						}
						if (row.Cells["Credit"].Value != null && row.Cells["Credit"].Value.ToString() != "")
						{
							d += decimal.Parse(row.Cells["Credit"].Value.ToString());
						}
					}
					if (d > 0m)
					{
						e.Cell.Value = d.ToString();
					}
				}
			}
			else if (e.Cell.Column.Key == "Credit" && e.Cell.Value.ToString() == "" && dataGridItems.ActiveRow.Cells["Debit"].Value.ToString() == "")
			{
				decimal num = default(decimal);
				foreach (UltraGridRow row2 in dataGridItems.Rows)
				{
					if (row2.Cells["Debit"].Value != null && row2.Cells["Debit"].Value.ToString() != "")
					{
						num -= decimal.Parse(row2.Cells["Debit"].Value.ToString());
					}
					if (row2.Cells["Credit"].Value != null && row2.Cells["Credit"].Value.ToString() != "")
					{
						num += decimal.Parse(row2.Cells["Credit"].Value.ToString());
					}
				}
				if (num < 0m)
				{
					e.Cell.Value = (-num).ToString();
				}
			}
		}
		...
		private void dataGrid_BeforeCellDeactivate(object sender, CancelEventArgs e)
		{
			...
			else if ((dataGridItems.ActiveCell.Column.Key == "Debit" || dataGridItems.ActiveCell.Column.Key == "Credit") && dataGridItems.ActiveCell.Text != "")
			{
		...
		private void dataGrid_BeforeRowDeactivate(object sender, CancelEventArgs e)
		{
			...
			if (activeRow.Cells["Debit"].Value.ToString() == "" && activeRow.Cells["Credit"].Value.ToString() == "")
			{
				object obj3 = activeRow.Cells["Debit"].Value = (activeRow.Cells["Credit"].Value = 0);
			}
			labelBalance.Text = GetTransactionBalance().ToString(Format.TotalAmountFormat);
		}
		...
		{
			if (e.Cell.Column.Key == "Debit" || e.Cell.Column.Key == "Credit")
			{
				labelBalance.Text = GetTransactionBalance().ToString(Format.TotalAmountFormat);
			}
			else if (e.Cell.Column.Key == "T")
		...
		private void dataGrid_CellDataError(object sender, CellDataErrorEventArgs e)
		{
			...
			else if (dataGridItems.ActiveCell.Column.Key.ToString() == "Debit" || dataGridItems.ActiveCell.Column.Key.ToString() == "Credit")
			{
				e.RaiseErrorEvent = false;
		...
		private void CaldulateTotal()
		{
			int value = 0;
			if (comboBoxStartYear.SelectedID < 0 || comboBoxStartMonth.SelectedID < 0 || comboBoxEndYear.SelectedID < 0 || comboBoxEndMonth.SelectedID < 0)
			{
				textBoxPeriodCount.Text = "0";
			}
			else
			{
				DateTime dateTime = new DateTime(comboBoxStartYear.SelectedID, comboBoxStartMonth.SelectedID, 1);
				DateTime dateTime2 = new DateTime(comboBoxEndYear.SelectedID, comboBoxEndMonth.SelectedID, 1);
				value = checked(dateTime2.Month - dateTime.Month + 12 * (dateTime2.Year - dateTime.Year) + 1);
				textBoxPeriodCount.Text = value.ToString();
			}
			decimal d = default(decimal);
			foreach (UltraGridRow row in dataGridItems.Rows)
			{
			...
			textBoxTotal.Text = ((decimal)value * d).ToString();
		}
		...
		private bool GetData()
		{
			try
			{
				...
				{
					currentData = new StandingJournalData();
				}
				DataRow dataRow = (!isNewRecord) ? currentData.StandingJournalTable.Rows[0] : currentData.StandingJournalTable.NewRow();
				dataRow["StandingJournalID"] = textBoxVoucherNumber.Text;
				dataRow["Reference"] = textBoxRef1.Text;
				dataRow["Narration"] = textBoxNarration.Text;
				dataRow["StartMonth"] = comboBoxStartMonth.SelectedID;
				dataRow["StartYear"] = comboBoxStartYear.SelectedID;
				dataRow["EndMonth"] = comboBoxEndMonth.SelectedID;
				dataRow["EndYear"] = comboBoxEndYear.SelectedID;
				dataRow["Status"] = checked(comboBoxStatus.SelectedIndex + 1);
				dataRow["TransactionSysDocID"] = comboBoxSysDoc.SelectedID;
				...
				if (IsNewRecord)
				{
					currentData.StandingJournalTable.Rows.Add(dataRow);
				}
				currentData.StandingJournalDetailsTable.Rows.Clear();
				foreach (UltraGridRow row in dataGridItems.Rows)
				{
					DataRow dataRow2 = currentData.StandingJournalDetailsTable.NewRow();
					dataRow2.BeginEdit();
					dataRow2["StandingJournalID"] = textBoxVoucherNumber.Text;
					...
					{
						dataRow2["PayeeID"] = row.Cells["Account Code"].Value.ToString();
					}
					dataRow2["AccountID"] = row.Cells["Account Code"].Value.ToString();
					if (row.Cells["Debit"].Value.ToString() != "")
					{
						dataRow2["Debit"] = row.Cells["Debit"].Value.ToString();
					}
					else
					{
						dataRow2["Debit"] = DBNull.Value;
					}
					if (row.Cells["Credit"].Value.ToString() != "")
					{
						dataRow2["Credit"] = row.Cells["Credit"].Value.ToString();
					}
					else
					{
						dataRow2["Credit"] = DBNull.Value;
					}
					...
					dataRow2.EndEdit();
					currentData.StandingJournalDetailsTable.Rows.Add(dataRow2);
				}
				return true;
			}
			catch (Exception e)
		...
		private void SetupGrid()
		{
			try
			{
				...
				dataGridItems.DisplayLayout.Bands[0].Columns["T"].ValueList = payeeTypeComboBox1;
				...
				dataGridItems.DisplayLayout.Bands[0].Columns["Account Code"].Width = checked(7 * dataGridItems.Width) / 100;
				...
				dataGridItems.DisplayLayout.Bands[0].Columns["Debit"].Width = checked(7 * dataGridItems.Width) / 100;
				dataGridItems.DisplayLayout.Bands[0].Columns["Credit"].Width = checked(7 * dataGridItems.Width) / 100;
		...
		public void LoadData(string journalID)
		{
			try
			{
				...
				{
					currentData = Factory.StandingJournalSystem.GetStandingJournalVoucherByID(journalID);
					if (currentData != null)
					{
						FillData();
						IsNewRecord = false;
		...
		private void FillData()
		{
			try
			{
				...
				{
					DataRow dataRow = currentData.Tables["Standing_Journal"].Rows[0];
					textBoxVoucherNumber.Text = dataRow["StandingJournalID"].ToString();
					textBoxRef1.Text = dataRow["Reference"].ToString();
					textBoxNarration.Text = dataRow["Narration"].ToString();
					comboBoxSysDoc.SelectedID = dataRow["TransactionSysDocID"].ToString();
					comboBoxStartMonth.SelectedID = Convert.ToInt16(dataRow["StartMonth"]);
					comboBoxStartYear.SelectedID = Convert.ToInt16(dataRow["StartYear"]);
					comboBoxEndMonth.SelectedID = Convert.ToInt16(dataRow["EndMonth"]);
					comboBoxEndYear.SelectedID = Convert.ToInt16(dataRow["EndYear"]);
					comboBoxStatus.SelectedIndex = checked(Convert.ToInt16(dataRow["Status"]) - 1);
					...
					if (currentData.Tables.Contains("Standing_Journal_Detail") && currentData.StandingJournalDetailsTable.Rows.Count != 0)
					{
						foreach (DataRow row in currentData.Tables["Standing_Journal_Detail"].Rows)
						{
							DataRow dataRow3 = dataTable.NewRow();
							string text = row["PayeeType"].ToString();
							...
							case "V":
							case "E":
								dataRow3["Account Code"] = row["PayeeID"];
								break;
							default:
		...
		private bool SaveData(bool clearAfter)
		{
			...
			try
			{
				bool flag2 = (!isNewRecord) ? Factory.StandingJournalSystem.UpdateStandingJournal(currentData) : Factory.StandingJournalSystem.CreateStandingJournal(currentData);
				if (flag2)
				{
					flag = true;
				}
		...
		private bool ValidateData()
		{
			...
			if (comboBoxEndMonth.SelectedID < 0 || comboBoxStartMonth.SelectedID < 0 || comboBoxStartYear.SelectedID < 0 || comboBoxEndYear.SelectedID < 0)
			{
			...
			if (isNewRecord && !Security.IsAllowedSecurityRole(GeneralSecurityRoles.EnterBackDatedTransaction))
			{
				ErrorHelper.WarningMessage("You are not allowed to enter back-dated transactions.");
				return false;
			}
			if (isNewRecord && !Security.IsAllowedSecurityRole(GeneralSecurityRoles.FutureDatedTransaction))
			{
			...
			if (GetTransactionBalance() != 0m)
			{
				ErrorHelper.InformationMessage(UIMessages.TransactionNotBalance);
				return false;
			}
			if (formManager.IsFieldDirty(textBoxVoucherNumber) && Factory.DatabaseSystem.ExistFieldValue("Standing_Journal", "StandingJournalID", textBoxVoucherNumber.Text))
			{
				ErrorHelper.WarningMessage(UIMessages.DocumentNumberInUse);
		...
		private decimal GetTransactionBalance()
		{
			...
			foreach (UltraGridRow row in dataGridItems.Rows)
			{
				if (row.Cells["Debit"].Value != null && row.Cells["Debit"].Value.ToString() != "")
				{
					result += decimal.Parse(row.Cells["Debit"].Value.ToString());
				}
				if (row.Cells["Credit"].Value != null && row.Cells["Credit"].Value.ToString() != "")
				{
					result -= decimal.Parse(row.Cells["Credit"].Value.ToString());
				}
			}
			CaldulateTotal();
			return result;
		...
		private void ClearForm()
		{
			try
			{
				textBoxNote.Clear();
				textBoxRef1.Clear();
				textBoxNarration.Clear();
				comboBoxStatus.SelectedIndex = 0;
				DateTime dateTime = DateTime.Today.AddMonths(1);
				comboBoxStartYear.SelectedID = dateTime.Year;
				comboBoxStartMonth.SelectedID = dateTime.Month;
				dateTime = dateTime.AddMonths(11);
				comboBoxEndYear.SelectedID = dateTime.Year;
				comboBoxEndMonth.SelectedID = dateTime.Month;
		...
		private bool Delete()
		{
			try
			{
				...
				return Factory.StandingJournalSystem.DeleteStandingJournal(textBoxVoucherNumber.Text);
			}
			catch (Exception e)
			{
				ErrorHelper.ProcessError(e);
		...
		{
			string nextID = DatabaseHelper.GetNextID("Standing_Journal", "StandingJournalID", textBoxVoucherNumber.Text);
			if (!(nextID == ""))
			{
				LoadData(nextID);
			}
		...
		{
			string previousID = DatabaseHelper.GetPreviousID("Standing_Journal", "StandingJournalID", textBoxVoucherNumber.Text);
			if (!(previousID == ""))
			{
				LoadData(previousID);
			}
		...
		{
			string lastID = DatabaseHelper.GetLastID("Standing_Journal", "StandingJournalID");
			if (!(lastID == ""))
			{
				LoadData(lastID);
			}
		...
		{
			string firstID = DatabaseHelper.GetFirstID("Standing_Journal", "StandingJournalID");
			if (!(firstID == ""))
			{
				LoadData(firstID);
			}
		...
		private void toolStripButtonFind_Click(object sender, EventArgs e)
		{
			try
			{
				...
				else if (Factory.DatabaseSystem.ExistFieldValue("Standing_Journal", "StandingJournalID", toolStripTextBoxFind.Text.Trim()))
				{
		...
		private void JournalLeavesForm_Load(object sender, EventArgs e)
		{
			try
			{
				...
				comboBoxEndYear.LoadData();
				comboBoxEndMonth.LoadData();
				comboBoxStatus.SelectedIndex = 0;
		...
		private void Print(bool isPrint, bool showPrintDialog, bool saveChanges)
		{
			try
			{
				if (!(IsDirty && saveChanges) || (ErrorHelper.QuestionMessage(MessageBoxButtons.YesNo, "You must save the document before printing.", "Do you want to save?") == DialogResult.Yes && SaveData(clearAfter: false)))
				{
					...
					DataSet standingJournalToPrint = Factory.StandingJournalSystem.GetStandingJournalToPrint(text);
					if (standingJournalToPrint == null || standingJournalToPrint.Tables.Count == 0)
					{
						ErrorHelper.ErrorMessage("Cannot print the document.", "Document not found.");
					}
					else
					{
						PrintHelper.PrintDocument(standingJournalToPrint, comboBoxSysDoc.SelectedID, "Standing Journal", SysDocTypes.GJournal, isPrint, showPrintDialog);
					}
				}
			}
			catch (Exception e)
		...
		{
			FormActivator.BringFormToFront(FormActivator.StandingJournalListFormObj);
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Accounts.StandingJournalEntryForm));
			...
			comboBoxEndYear = new Micromind.DataControls.YearComboBox();
			comboBoxStartYear = new Micromind.DataControls.YearComboBox();
			comboBoxEndMonth = new Micromind.DataControls.MonthComboBox();
			...
			textBoxNarration = new System.Windows.Forms.TextBox();
			label6 = new System.Windows.Forms.Label();
			label5 = new System.Windows.Forms.Label();
			textBoxPeriodCount = new System.Windows.Forms.TextBox();
			...
			ultraGroupBox1.Location = new System.Drawing.Point(9, 460);
			ultraGroupBox1.Name = "ultraGroupBox1";
			ultraGroupBox1.Size = new System.Drawing.Size(706, 21);
			...
			labelBalance.Location = new System.Drawing.Point(563, 3);
			...
			ultraLabel1.Size = new System.Drawing.Size(561, 16);
			...
			toolStrip1.Size = new System.Drawing.Size(727, 31);
			...
			panelButtons.Location = new System.Drawing.Point(0, 487);
			panelButtons.Name = "panelButtons";
			panelButtons.Size = new System.Drawing.Size(727, 40);
			...
			linePanelDown.Size = new System.Drawing.Size(727, 1);
			...
			xpButton1.Location = new System.Drawing.Point(617, 8);
			...
			textBoxVoucherNumber.Location = new System.Drawing.Point(122, 3);
			textBoxVoucherNumber.MaxLength = 15;
			textBoxVoucherNumber.Name = "textBoxVoucherNumber";
			textBoxVoucherNumber.Size = new System.Drawing.Size(139, 20);
			textBoxVoucherNumber.TabIndex = 0;
			label1.AutoSize = true;
			label1.Location = new System.Drawing.Point(269, 80);
			label1.Name = "label1";
			label1.Size = new System.Drawing.Size(60, 13);
			label1.TabIndex = 20;
			label1.Text = "Reference:";
			textBoxRef1.Location = new System.Drawing.Point(342, 77);
			textBoxRef1.MaxLength = 20;
			textBoxRef1.Name = "textBoxRef1";
			textBoxRef1.Size = new System.Drawing.Size(150, 20);
			textBoxRef1.TabIndex = 7;
			textBoxNote.Location = new System.Drawing.Point(122, 124);
			textBoxNote.MaxLength = 255;
			textBoxNote.Name = "textBoxNote";
			textBoxNote.Size = new System.Drawing.Size(575, 20);
			textBoxNote.TabIndex = 10;
			label3.AutoSize = true;
			label3.Location = new System.Drawing.Point(17, 126);
			label3.Name = "label3";
			label3.Size = new System.Drawing.Size(33, 13);
			label3.TabIndex = 20;
			label3.Text = "Note:";
			appearance4.FontData.BoldAsString = "False";
			labelCurrency.Appearance = appearance4;
			labelCurrency.AutoSize = true;
			labelCurrency.Location = new System.Drawing.Point(498, 79);
			...
			labelCurrency.VisitedLinkAppearance = appearance5;
			...
			ultraFormattedLinkLabel2.Appearance = appearance6;
			ultraFormattedLinkLabel2.AutoSize = true;
			ultraFormattedLinkLabel2.Location = new System.Drawing.Point(17, 6);
			ultraFormattedLinkLabel2.Name = "ultraFormattedLinkLabel2";
			ultraFormattedLinkLabel2.Size = new System.Drawing.Size(80, 15);
			ultraFormattedLinkLabel2.TabIndex = 110;
			ultraFormattedLinkLabel2.TabStop = true;
			ultraFormattedLinkLabel2.TreatValueAs = Infragistics.Win.FormattedLinkLabel.TreatValueAs.URL;
			ultraFormattedLinkLabel2.UnderlineLinks = Infragistics.Win.FormattedLinkLabel.UnderlineLink.WhenHovered;
			ultraFormattedLinkLabel2.Value = "Journal Code:";
			appearance7.ForeColor = System.Drawing.Color.Blue;
			ultraFormattedLinkLabel2.VisitedLinkAppearance = appearance7;
			ultraFormattedLinkLabel2.LinkClicked += new Infragistics.Win.FormattedLinkLabel.LinkClickedEventHandler(ultraFormattedLinkLabel2_LinkClicked);
			panelDetails.Controls.Add(textBoxTotal);
			panelDetails.Controls.Add(label2);
			panelDetails.Controls.Add(comboBoxStatus);
			panelDetails.Controls.Add(comboBoxEndYear);
			panelDetails.Controls.Add(comboBoxStartYear);
			panelDetails.Controls.Add(comboBoxEndMonth);
			panelDetails.Controls.Add(comboBoxStartMonth);
			...
			textBoxTotal.Location = new System.Drawing.Point(342, 51);
			...
			textBoxTotal.Size = new System.Drawing.Size(149, 20);
			textBoxTotal.TabIndex = 123;
			...
			label2.Location = new System.Drawing.Point(269, 6);
			label2.Name = "label2";
			...
			comboBoxStatus.Location = new System.Drawing.Point(342, 3);
			comboBoxStatus.Name = "comboBoxStatus";
			comboBoxStatus.Size = new System.Drawing.Size(99, 21);
			comboBoxStatus.TabIndex = 1;
			comboBoxEndYear.FormattingEnabled = true;
			comboBoxEndYear.Location = new System.Drawing.Point(425, 28);
			comboBoxEndYear.Name = "comboBoxEndYear";
			comboBoxEndYear.Size = new System.Drawing.Size(66, 21);
			comboBoxEndYear.TabIndex = 5;
			comboBoxStartYear.FormattingEnabled = true;
			comboBoxStartYear.Location = new System.Drawing.Point(196, 28);
			comboBoxStartYear.Name = "comboBoxStartYear";
			comboBoxStartYear.Size = new System.Drawing.Size(66, 21);
			comboBoxStartYear.TabIndex = 3;
			comboBoxEndMonth.DropDownStyle = System.Windows.Forms.ComboBoxStyle.DropDownList;
			comboBoxEndMonth.FormattingEnabled = true;
			comboBoxEndMonth.IsMonthNumbers = false;
			comboBoxEndMonth.Location = new System.Drawing.Point(342, 28);
			comboBoxEndMonth.Name = "comboBoxEndMonth";
			comboBoxEndMonth.Size = new System.Drawing.Size(77, 21);
			comboBoxEndMonth.TabIndex = 4;
			...
			comboBoxStartMonth.Location = new System.Drawing.Point(123, 28);
			comboBoxStartMonth.Name = "comboBoxStartMonth";
			comboBoxStartMonth.Size = new System.Drawing.Size(67, 21);
			...
			ultraFormattedLinkLabel5.Location = new System.Drawing.Point(17, 78);
			ultraFormattedLinkLabel5.Name = "ultraFormattedLinkLabel5";
			ultraFormattedLinkLabel5.Size = new System.Drawing.Size(77, 15);
			ultraFormattedLinkLabel5.TabIndex = 118;
			ultraFormattedLinkLabel5.TabStop = true;
			ultraFormattedLinkLabel5.TreatValueAs = Infragistics.Win.FormattedLinkLabel.TreatValueAs.URL;
			ultraFormattedLinkLabel5.UnderlineLinks = Infragistics.Win.FormattedLinkLabel.UnderlineLink.WhenHovered;
			ultraFormattedLinkLabel5.Value = "Tran. Doc ID:";
			...
			comboBoxSysDoc.Location = new System.Drawing.Point(123, 77);
			...
			currencySelector.Location = new System.Drawing.Point(558, 77);
			...
			currencySelector.TabIndex = 8;
			mmLabel2.AutoSize = true;
			mmLabel2.BorderColor = System.Drawing.Color.FromArgb(78, 122, 171);
			mmLabel2.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25f, System.Drawing.FontStyle.Bold);
			mmLabel2.IsFieldHeader = false;
			mmLabel2.IsRequired = true;
			mmLabel2.Location = new System.Drawing.Point(268, 31);
			mmLabel2.Name = "mmLabel2";
			mmLabel2.PenWidth = 1f;
			mmLabel2.ShowBorder = false;
			mmLabel2.Size = new System.Drawing.Size(73, 13);
			mmLabel2.TabIndex = 2;
			mmLabel2.Text = "End Period:";
			mmLabel1.AutoSize = true;
			mmLabel1.BorderColor = System.Drawing.Color.FromArgb(78, 122, 171);
			mmLabel1.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25f, System.Drawing.FontStyle.Bold);
			mmLabel1.IsFieldHeader = false;
			mmLabel1.IsRequired = true;
			mmLabel1.Location = new System.Drawing.Point(17, 31);
			mmLabel1.Name = "mmLabel1";
			mmLabel1.PenWidth = 1f;
			mmLabel1.ShowBorder = false;
			mmLabel1.Size = new System.Drawing.Size(78, 13);
			mmLabel1.TabIndex = 2;
			mmLabel1.Text = "Start Period:";
			label4.AutoSize = true;
			label4.Location = new System.Drawing.Point(17, 104);
			label4.Name = "label4";
			label4.Size = new System.Drawing.Size(53, 13);
			label4.TabIndex = 20;
			label4.Text = "Narration:";
			textBoxNarration.Location = new System.Drawing.Point(122, 102);
			textBoxNarration.MaxLength = 255;
			textBoxNarration.Name = "textBoxNarration";
			textBoxNarration.Size = new System.Drawing.Size(575, 20);
			textBoxNarration.TabIndex = 9;
			label6.AutoSize = true;
			label6.Location = new System.Drawing.Point(268, 54);
			label6.Name = "label6";
			label6.Size = new System.Drawing.Size(34, 13);
			label6.TabIndex = 20;
			label6.Text = "Total:";
			label5.AutoSize = true;
			label5.Location = new System.Drawing.Point(17, 54);
			label5.Name = "label5";
			label5.Size = new System.Drawing.Size(71, 13);
			label5.TabIndex = 20;
			label5.Text = "Period Count:";
			textBoxPeriodCount.Location = new System.Drawing.Point(123, 52);
			textBoxPeriodCount.MaxLength = 20;
			textBoxPeriodCount.Name = "textBoxPeriodCount";
			textBoxPeriodCount.ReadOnly = true;
			textBoxPeriodCount.Size = new System.Drawing.Size(138, 20);
			textBoxPeriodCount.TabIndex = 7;
			...
			dataGridItems.Location = new System.Drawing.Point(12, 185);
			...
			dataGridItems.Size = new System.Drawing.Size(703, 277);
			...
			comboBoxGridEmployee.DisplayLayout.Appearance = appearance34;
			...
			comboBoxGridEmployee.DisplayLayout.GroupByBox.Appearance = appearance35;
			appearance36.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxGridEmployee.DisplayLayout.GroupByBox.BandLabelAppearance = appearance36;
			...
			comboBoxGridEmployee.DisplayLayout.GroupByBox.PromptAppearance = appearance37;
			...
			comboBoxGridEmployee.DisplayLayout.Override.ActiveCellAppearance = appearance38;
			...
			comboBoxGridEmployee.DisplayLayout.Override.ActiveRowAppearance = appearance39;
			...
			comboBoxGridEmployee.DisplayLayout.Override.CardAreaAppearance = appearance40;
			appearance41.BorderColor = System.Drawing.Color.Silver;
			appearance41.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxGridEmployee.DisplayLayout.Override.CellAppearance = appearance41;
			...
			comboBoxGridEmployee.DisplayLayout.Override.GroupByRowAppearance = appearance42;
			appearance43.TextHAlignAsString = "Left";
			comboBoxGridEmployee.DisplayLayout.Override.HeaderAppearance = appearance43;
			...
			comboBoxGridEmployee.DisplayLayout.Override.RowAppearance = appearance44;
			...
			comboBoxGridEmployee.DisplayLayout.Override.TemplateAddRowAppearance = appearance45;
			...
			comboBoxGridEmployee.Location = new System.Drawing.Point(631, 229);
			...
			comboBoxGridVendor.DisplayLayout.Appearance = appearance46;
			...
			comboBoxGridVendor.DisplayLayout.GroupByBox.Appearance = appearance47;
			appearance48.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxGridVendor.DisplayLayout.GroupByBox.BandLabelAppearance = appearance48;
			...
			comboBoxGridVendor.DisplayLayout.GroupByBox.PromptAppearance = appearance49;
			...
			comboBoxGridVendor.DisplayLayout.Override.ActiveCellAppearance = appearance50;
			...
			comboBoxGridVendor.DisplayLayout.Override.ActiveRowAppearance = appearance51;
			...
			comboBoxGridVendor.DisplayLayout.Override.CardAreaAppearance = appearance52;
			appearance53.BorderColor = System.Drawing.Color.Silver;
			appearance53.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxGridVendor.DisplayLayout.Override.CellAppearance = appearance53;
			...
			comboBoxGridVendor.DisplayLayout.Override.GroupByRowAppearance = appearance54;
			appearance55.TextHAlignAsString = "Left";
			comboBoxGridVendor.DisplayLayout.Override.HeaderAppearance = appearance55;
			...
			comboBoxGridVendor.DisplayLayout.Override.RowAppearance = appearance56;
			...
			comboBoxGridVendor.DisplayLayout.Override.TemplateAddRowAppearance = appearance57;
			...
			comboBoxGridVendor.Location = new System.Drawing.Point(626, 255);
			...
			comboBoxGridCustomer.DisplayLayout.Appearance = appearance58;
			...
			comboBoxGridCustomer.DisplayLayout.GroupByBox.Appearance = appearance59;
			appearance60.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxGridCustomer.DisplayLayout.GroupByBox.BandLabelAppearance = appearance60;
			...
			comboBoxGridCustomer.DisplayLayout.GroupByBox.PromptAppearance = appearance61;
			...
			comboBoxGridCustomer.DisplayLayout.Override.ActiveCellAppearance = appearance62;
			...
			comboBoxGridCustomer.DisplayLayout.Override.ActiveRowAppearance = appearance63;
			...
			comboBoxGridCustomer.DisplayLayout.Override.CardAreaAppearance = appearance64;
			...
			comboBoxGridCustomer.DisplayLayout.Override.CellAppearance = appearance65;
			...
			comboBoxGridCustomer.DisplayLayout.Override.GroupByRowAppearance = appearance66;
			appearance67.TextHAlignAsString = "Left";
			comboBoxGridCustomer.DisplayLayout.Override.HeaderAppearance = appearance67;
			...
			comboBoxGridCustomer.DisplayLayout.Override.RowAppearance = appearance68;
			...
			comboBoxGridCustomer.DisplayLayout.Override.TemplateAddRowAppearance = appearance69;
			...
			comboBoxGridCustomer.Location = new System.Drawing.Point(631, 281);
			...
			payeeTypeComboBox1.DisplayLayout.Appearance = appearance70;
			...
			payeeTypeComboBox1.DisplayLayout.GroupByBox.Appearance = appearance71;
			appearance72.ForeColor = System.Drawing.SystemColors.GrayText;
			payeeTypeComboBox1.DisplayLayout.GroupByBox.BandLabelAppearance = appearance72;
			...
			payeeTypeComboBox1.DisplayLayout.GroupByBox.PromptAppearance = appearance73;
			...
			payeeTypeComboBox1.DisplayLayout.Override.ActiveCellAppearance = appearance74;
			...
			payeeTypeComboBox1.DisplayLayout.Override.ActiveRowAppearance = appearance75;
			...
			payeeTypeComboBox1.DisplayLayout.Override.CardAreaAppearance = appearance76;
			...
			payeeTypeComboBox1.DisplayLayout.Override.CellAppearance = appearance77;
			...
			payeeTypeComboBox1.DisplayLayout.Override.GroupByRowAppearance = appearance78;
			appearance79.TextHAlignAsString = "Left";
			payeeTypeComboBox1.DisplayLayout.Override.HeaderAppearance = appearance79;
			...
			payeeTypeComboBox1.DisplayLayout.Override.RowAppearance = appearance80;
			...
			payeeTypeComboBox1.DisplayLayout.Override.TemplateAddRowAppearance = appearance81;
			...
			payeeTypeComboBox1.Location = new System.Drawing.Point(659, 173);
			...
			comboBoxCostCategory.DisplayLayout.Appearance = appearance82;
			...
			comboBoxCostCategory.DisplayLayout.GroupByBox.Appearance = appearance83;
			appearance84.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxCostCategory.DisplayLayout.GroupByBox.BandLabelAppearance = appearance84;
			...
			comboBoxCostCategory.DisplayLayout.GroupByBox.PromptAppearance = appearance85;
			...
			comboBoxCostCategory.DisplayLayout.Override.ActiveCellAppearance = appearance86;
			...
			comboBoxCostCategory.DisplayLayout.Override.ActiveRowAppearance = appearance87;
			...
			comboBoxCostCategory.DisplayLayout.Override.CardAreaAppearance = appearance88;
			...
			comboBoxCostCategory.DisplayLayout.Override.CellAppearance = appearance89;
			...
			comboBoxCostCategory.DisplayLayout.Override.GroupByRowAppearance = appearance90;
			appearance91.TextHAlignAsString = "Left";
			comboBoxCostCategory.DisplayLayout.Override.HeaderAppearance = appearance91;
			...
			comboBoxCostCategory.DisplayLayout.Override.RowAppearance = appearance92;
			...
			comboBoxCostCategory.DisplayLayout.Override.TemplateAddRowAppearance = appearance93;
			...
			comboBoxCostCategory.Location = new System.Drawing.Point(649, 255);
			...
			comboBoxJob.Location = new System.Drawing.Point(627, 290);
			...
			comboBoxGridAccount.DisplayLayout.Appearance = appearance94;
			...
			comboBoxGridAccount.DisplayLayout.GroupByBox.Appearance = appearance95;
			appearance96.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxGridAccount.DisplayLayout.GroupByBox.BandLabelAppearance = appearance96;
			...
			comboBoxGridAccount.DisplayLayout.GroupByBox.PromptAppearance = appearance97;
			...
			comboBoxGridAccount.DisplayLayout.Override.ActiveCellAppearance = appearance98;
			...
			comboBoxGridAccount.DisplayLayout.Override.ActiveRowAppearance = appearance99;
			...
			comboBoxGridAccount.DisplayLayout.Override.CardAreaAppearance = appearance100;
			...
			comboBoxGridAccount.DisplayLayout.Override.CellAppearance = appearance101;
			...
			comboBoxGridAccount.DisplayLayout.Override.GroupByRowAppearance = appearance102;
			appearance103.TextHAlignAsString = "Left";
			comboBoxGridAccount.DisplayLayout.Override.HeaderAppearance = appearance103;
			...
			comboBoxGridAccount.DisplayLayout.Override.RowAppearance = appearance104;
			...
			comboBoxGridAccount.DisplayLayout.Override.TemplateAddRowAppearance = appearance105;
			...
			comboBoxGridAccount.Location = new System.Drawing.Point(595, 342);
			...
			comboBoxGridanalysis.DisplayLayout.Appearance = appearance106;
			...
			comboBoxGridanalysis.DisplayLayout.GroupByBox.Appearance = appearance107;
			appearance108.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxGridanalysis.DisplayLayout.GroupByBox.BandLabelAppearance = appearance108;
			...
			comboBoxGridanalysis.DisplayLayout.GroupByBox.PromptAppearance = appearance109;
			...
			comboBoxGridanalysis.DisplayLayout.Override.ActiveCellAppearance = appearance110;
			...
			comboBoxGridanalysis.DisplayLayout.Override.ActiveRowAppearance = appearance111;
			...
			comboBoxGridanalysis.DisplayLayout.Override.CardAreaAppearance = appearance112;
			...
			comboBoxGridanalysis.DisplayLayout.Override.CellAppearance = appearance113;
			...
			comboBoxGridanalysis.DisplayLayout.Override.GroupByRowAppearance = appearance114;
			appearance115.TextHAlignAsString = "Left";
			comboBoxGridanalysis.DisplayLayout.Override.HeaderAppearance = appearance115;
			...
			comboBoxGridanalysis.DisplayLayout.Override.RowAppearance = appearance116;
			...
			comboBoxGridanalysis.DisplayLayout.Override.TemplateAddRowAppearance = appearance117;
			...
			comboBoxGridanalysis.Location = new System.Drawing.Point(582, 316);
			...
			comboBoxGridCostCenter.DisplayLayout.Appearance = appearance118;
			...
			comboBoxGridCostCenter.DisplayLayout.GroupByBox.Appearance = appearance119;
			appearance120.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxGridCostCenter.DisplayLayout.GroupByBox.BandLabelAppearance = appearance120;
			...
			comboBoxGridCostCenter.DisplayLayout.GroupByBox.PromptAppearance = appearance121;
			...
			comboBoxGridCostCenter.DisplayLayout.Override.ActiveCellAppearance = appearance122;
			...
			comboBoxGridCostCenter.DisplayLayout.Override.ActiveRowAppearance = appearance123;
			...
			comboBoxGridCostCenter.DisplayLayout.Override.CardAreaAppearance = appearance124;
			...
			comboBoxGridCostCenter.DisplayLayout.Override.CellAppearance = appearance125;
			...
			comboBoxGridCostCenter.DisplayLayout.Override.GroupByRowAppearance = appearance126;
			appearance127.TextHAlignAsString = "Left";
			comboBoxGridCostCenter.DisplayLayout.Override.HeaderAppearance = appearance127;
			...
			comboBoxGridCostCenter.DisplayLayout.Override.RowAppearance = appearance128;
			...
			comboBoxGridCostCenter.DisplayLayout.Override.TemplateAddRowAppearance = appearance129;
			...
			comboBoxGridCostCenter.Location = new System.Drawing.Point(660, 212);
			...
			base.ClientSize = new System.Drawing.Size(727, 527);
			...
			base.Name = "StandingJournalEntryForm";
			Text = "Standing Journal Entry";
