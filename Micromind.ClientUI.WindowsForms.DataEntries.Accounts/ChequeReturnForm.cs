...
{
	public class ChequeReturnForm : Form, IForm
	{
		...
		private bool SaveData()
		{
			...
			if (ErrorHelper.QuestionMessageYesNo("You are going to return one cheque.", "Are you sure you want to continue?") == DialogResult.No)
			{
				return false;
			}
			if (!GetData())
			...
			try
			{
				bool flag = (!isNewRecord) ? Factory.TransactionSystem.InsertUpdateReturnedCheque(currentData) : Factory.TransactionSystem.InsertUpdateReturnedCheque(currentData);
				if (!flag)
				{
		...
		private bool ValidateData()
		{
			...
			if (byte.Parse(currentChequeRow["Status"].ToString()) == 8)
			{
		...
		private void TransactionLeavesForm_Load(object sender, EventArgs e)
		{
			try
			{
				...
				if (!base.IsDisposed)
				{
					comboBoxSysDoc.FilterByType(SysDocTypes.ReturnedCheque);
					IsNewRecord = true;
					ClearForm();
				}
			}
		...
		private void buttonSelectCheque_Click(object sender, EventArgs e)
		{
			try
			{
				...
				selectChequeDialog.DataSource = Factory.ReceivedChequeSystem.GetReceivedChequeToReturnList();
				...
				if (selectChequeDialog.ShowDialog() == DialogResult.OK)
				{
					...
					if (!(text == ""))
					{
						...
						textBoxNote.Text = "Returned Chq No:" + dataRow["ChequeNumber"].ToString();
		...
		{
			new FormHelper().EditSysDoc(comboBoxSysDoc.SelectedID, SysDocTypes.ReturnedCheque);
		}
		...
		private void Print(bool isPrint, bool showPrintDialog, bool saveChanges)
		{
			try
			{
				if (!(IsDirty && saveChanges) || (ErrorHelper.QuestionMessage(MessageBoxButtons.YesNo, "You must save the document before printing.", "Do you want to save?") == DialogResult.Yes && SaveData()))
				{
					...
					{
						PrintHelper.PrintDocument(transactionToPrint, systemDocID, "Cheque Return", SysDocTypes.ReturnedCheque, isPrint, showPrintDialog);
					}
				}
			}
			catch (Exception e)
		...
		private void comboBoxReason_SelectedIndexChanged_1(object sender, EventArgs e)
		{
			textBoxReasonName.Text = comboBoxReason.SelectedName;
		}
		...
		{
			FormActivator.BringFormToFront(FormActivator.ReturnVoucherListFormObj);
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Accounts.ChequeReturnForm));
			...
			toolStrip1.Size = new System.Drawing.Size(587, 31);
			...
			ultraFormattedLinkLabel5.Location = new System.Drawing.Point(6, 9);
			ultraFormattedLinkLabel5.Name = "ultraFormattedLinkLabel5";
			ultraFormattedLinkLabel5.Size = new System.Drawing.Size(45, 15);
			ultraFormattedLinkLabel5.TabIndex = 120;
			...
			comboBoxSysDoc.Location = new System.Drawing.Point(87, 7);
			comboBoxSysDoc.MaxDropDownItems = 12;
			comboBoxSysDoc.Name = "comboBoxSysDoc";
			comboBoxSysDoc.ShowAll = false;
			comboBoxSysDoc.ShowInactiveItems = false;
			comboBoxSysDoc.ShowQuickAdd = true;
			comboBoxSysDoc.Size = new System.Drawing.Size(150, 20);
			...
			ultraGroupBox1.Location = new System.Drawing.Point(3, 109);
			...
			comboBoxReason.SelectedIndexChanged += new System.EventHandler(comboBoxReason_SelectedIndexChanged_1);
			dateTimePickerDate.Format = System.Windows.Forms.DateTimePickerFormat.Short;
			dateTimePickerDate.Location = new System.Drawing.Point(87, 29);
			dateTimePickerDate.Name = "dateTimePickerDate";
			dateTimePickerDate.Size = new System.Drawing.Size(150, 20);
			dateTimePickerDate.TabIndex = 2;
			dateTimePickerDate.Value = new System.DateTime(2008, 5, 15, 11, 59, 23, 978);
			...
			textBoxVoucherNumber.Location = new System.Drawing.Point(328, 7);
			textBoxVoucherNumber.MaxLength = 15;
			textBoxVoucherNumber.Name = "textBoxVoucherNumber";
			textBoxVoucherNumber.Size = new System.Drawing.Size(130, 20);
			textBoxVoucherNumber.TabIndex = 1;
			textBoxRef1.Location = new System.Drawing.Point(328, 29);
			...
			ultraFormattedLinkLabel2.Location = new System.Drawing.Point(246, 10);
			...
			mmLabel1.Location = new System.Drawing.Point(6, 32);
			...
			base.ClientSize = new System.Drawing.Size(587, 328);
			base.Controls.Add(panelDetails);
			base.Controls.Add(formManager);
			base.Controls.Add(panelButtons);
			base.Controls.Add(toolStrip1);
			base.Icon = (System.Drawing.Icon)resources.GetObject("$this.Icon");
			MinimumSize = new System.Drawing.Size(595, 355);
			base.Name = "ChequeReturnForm";
			Text = "Bounced Cheque Entry";
