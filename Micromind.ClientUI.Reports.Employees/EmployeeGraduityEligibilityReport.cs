...
{
	public class EmployeeGraduityEligibilityReport : Form, IForm
	{
		...
		public EmployeeGraduityEligibilityReport()
		{
			InitializeComponent();
			base.Load += Form_Load;
		}
		...
		{
			DataSet data = Factory.EmployeeSystem.GetEmployeeGraduityEligibilityReport(employeeSelector.FromEmployee, employeeSelector.ToEmployee, employeeSelector.FromDepartment, employeeSelector.ToDepartment, employeeSelector.FromLocation, employeeSelector.ToLocation, employeeSelector.FromType, employeeSelector.ToType, employeeSelector.FromDivision, employeeSelector.ToDivision, employeeSelector.FromSponsor, employeeSelector.ToSponsor, employeeSelector.FromGroup, employeeSelector.ToGroup, employeeSelector.FromGrade, employeeSelector.ToGrade, employeeSelector.FromPosition, employeeSelector.ToPosition, employeeSelector.FromBank, employeeSelector.ToBank, employeeSelector.FromAccount, employeeSelector.ToAccount, dateTimePickerAsOfDate.Value, employeeSelector.MultipleEmployees);
			ReportHelper reportHelper = new ReportHelper();
			string reportFilter = "As of Date: " + dateTimePickerAsOfDate.Value.ToShortDateString();
			reportHelper.AddGeneralReportData(ref data, reportFilter);
			reportHelper.AddFilterData(ref data, GetAllFormControls(this));
			XtraReport report = reportHelper.GetReport("Employee Graduity Eligibility");
			if (report == null)
			{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.Employees.EmployeeGraduityEligibilityReport));
			...
			SuspendLayout();
			buttonOK.Location = new System.Drawing.Point(247, 384);
			...
			buttonClose.Location = new System.Drawing.Point(351, 384);
			...
			label2.Location = new System.Drawing.Point(20, 329);
			label2.Name = "label2";
			...
			dateTimePickerAsOfDate.Location = new System.Drawing.Point(81, 326);
			...
			dateTimePickerAsOfDate.Value = new System.DateTime(2015, 11, 11, 0, 0, 0, 0);
			ultraGroupBox1.Controls.Add(employeeSelector);
			ultraGroupBox1.Location = new System.Drawing.Point(3, 13);
			ultraGroupBox1.Name = "ultraGroupBox1";
			ultraGroupBox1.Size = new System.Drawing.Size(457, 307);
			...
			employeeSelector.Size = new System.Drawing.Size(402, 280);
			...
			base.ClientSize = new System.Drawing.Size(463, 418);
			...
			base.Name = "EmployeeGraduityEligibilityReport";
			Text = "Employee Graduity Eligibility Report";
