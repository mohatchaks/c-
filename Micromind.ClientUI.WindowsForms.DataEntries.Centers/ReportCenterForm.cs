...
{
	public class ReportCenterForm : Form, IForm
	{
		private IContainer components;

		private Label label1;

		public ScreenAreas ScreenArea => ScreenAreas.Reports;

		public int ScreenID => 7001;

		public ScreenTypes ScreenType => ScreenTypes.Setup;

		public ReportCenterForm(Form parent)
		{
