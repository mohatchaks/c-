...
{
	public class InventoryCenterForm : Form, IForm
	{
		...
		public int ScreenID => 4017;

		public ScreenTypes ScreenType => ScreenTypes.Setup;

		public InventoryCenterForm(Form parent)
		{
