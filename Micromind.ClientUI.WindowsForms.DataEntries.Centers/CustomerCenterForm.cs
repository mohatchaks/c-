...
{
	public class CustomerCenterForm : Form, IForm
	{
		...
		public int ScreenID => 2016;

		public ScreenTypes ScreenType => ScreenTypes.Setup;

		public CustomerCenterForm(Form parent)
		{
