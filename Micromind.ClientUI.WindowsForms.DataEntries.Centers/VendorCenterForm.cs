...
{
	public class VendorCenterForm : Form, IForm
	{
		...
		public int ScreenID => 3017;

		public ScreenTypes ScreenType => ScreenTypes.Setup;

		public VendorCenterForm(Form parent)
		{
