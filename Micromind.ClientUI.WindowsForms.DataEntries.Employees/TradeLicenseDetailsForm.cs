...
{
	public class TradeLicenseDetailsForm : Form, IForm
	{
		private TradeLicenseData currentData;

		private const string TABLENAME_CONST = "Trade_License";

		private const string IDFIELD_CONST = "TradeLicenseID";
		...
		private MMTextBox textBoxSponsors;

		private MMLabel mmLabel3;

		private MMTextBox textBoxPartners;
		...
		private MMTextBox textBoxLegalType;
		...
		private MMSDateTimePicker dateTimePickerRenewDate;
		...
		public TradeLicenseDetailsForm()
		{
			InitializeComponent();
			AddEvents();
		}
		...
		{
			base.Load += TradeLicenseDetailsForm_Load;
		}
		...
		private bool GetData()
		{
			try
			{
				...
				{
					currentData = new TradeLicenseData();
				}
				DataRow dataRow = (!isNewRecord) ? currentData.TradeLicenseTable.Rows[0] : currentData.TradeLicenseTable.NewRow();
				dataRow.BeginEdit();
				dataRow["TradeLicenseID"] = textBoxCode.Text.Trim();
				dataRow["Description"] = textBoxName.Text;
				dataRow["Sponsors"] = textBoxSponsors.Text;
				...
				dataRow["Partners"] = textBoxPartners.Text;
				dataRow["RegisterNumber"] = textBoxRegisterNumber.Text;
				dataRow["LegalType"] = textBoxLegalType.Text;
				...
				if (dateTimePickerRenewDate.Checked)
				{
					dataRow["RenewDate"] = dateTimePickerRenewDate.Value;
				}
				else
				{
				...
				if (isNewRecord)
				{
					currentData.TradeLicenseTable.Rows.Add(dataRow);
				}
				return true;
			}
			catch (Exception e)
		...
		public void LoadData(string id)
		{
			try
			{
				...
				{
					currentData = Factory.TradeLicenseSystem.GetTradeLicenseByID(id.Trim());
		...
		private void FillData()
		{
			if (currentData != null && currentData.Tables.Count != 0 && currentData.Tables[0].Rows.Count != 0)
			{
				...
				textBoxCode.Text = dataRow["TradeLicenseID"].ToString();
				textBoxName.Text = dataRow["Description"].ToString();
				textBoxSponsors.Text = dataRow["Sponsors"].ToString();
				comboBoxContact.SelectedID = dataRow["ContactID"].ToString();
				textBoxPartners.Text = dataRow["Partners"].ToString();
				textBoxRegisterNumber.Text = dataRow["RegisterNumber"].ToString();
				textBoxLegalType.Text = dataRow["LegalType"].ToString();
				...
				{
					dateTimePickerRenewDate.Value = DateTime.Parse(dataRow["RenewDate"].ToString());
					dateTimePickerRenewDate.Checked = true;
				}
				else
				{
					dateTimePickerRenewDate.Checked = false;
				}
		...
		private bool SaveData()
		{
			...
			try
			{
				bool flag = (!isNewRecord) ? Factory.TradeLicenseSystem.UpdateTradeLicense(currentData) : Factory.TradeLicenseSystem.CreateTradeLicense(currentData);
				if (!flag)
				{
		...
		private bool ValidateData()
		{
			...
			if (isNewRecord && Factory.DatabaseSystem.ExistFieldValue("Trade_License", "TradeLicenseID", textBoxCode.Text.Trim()))
			{
		...
		{
			textBoxCode.Text = PublicFunctions.GetNextCardNumber("Trade_License", "TradeLicenseID");
			textBoxName.Clear();
			textBoxSponsors.Clear();
			comboBoxContact.Clear();
			textBoxPartners.Clear();
			textBoxRegisterNumber.Clear();
			textBoxLegalType.Clear();
		...
		private void TradeLicenseGroupDetailsForm_Validating(object sender, CancelEventArgs e)
		{
		}

		private void TradeLicenseGroupDetailsForm_Validated(object sender, EventArgs e)
		{
		}
		...
		private bool Delete()
		{
			try
			{
				...
				return Factory.TradeLicenseSystem.DeleteTradeLicense(textBoxCode.Text);
			}
			catch (Exception e)
			{
				ErrorHelper.ProcessError(e);
		...
		{
			LoadData(DatabaseHelper.GetNextID("Trade_License", "TradeLicenseID", textBoxCode.Text));
		}

		private void toolStripButtonPrevious_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetPreviousID("Trade_License", "TradeLicenseID", textBoxCode.Text));
		}

		private void toolStripButtonLast_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetLastID("Trade_License", "TradeLicenseID"));
		}

		private void toolStripButtonFirst_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetFirstID("Trade_License", "TradeLicenseID"));
		}
		...
		private void toolStripButtonFind_Click(object sender, EventArgs e)
		{
			try
			{
				...
				else if (Factory.DatabaseSystem.ExistFieldValue("Trade_License", "TradeLicenseID", toolStripTextBoxFind.Text.Trim()))
				{
		...
		private void TradeLicenseDetailsForm_Load(object sender, EventArgs e)
		{
			try
			{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Employees.TradeLicenseDetailsForm));
			...
			textBoxSponsors = new Micromind.UISupport.MMTextBox();
			mmLabel3 = new Micromind.UISupport.MMLabel();
			textBoxPartners = new Micromind.UISupport.MMTextBox();
			mmLabel5 = new Micromind.UISupport.MMLabel();
			textBoxRegisterNumber = new Micromind.UISupport.MMTextBox();
			mmLabel6 = new Micromind.UISupport.MMLabel();
			textBoxLegalType = new Micromind.UISupport.MMTextBox();
			...
			dateTimePickerRenewDate = new Micromind.UISupport.MMSDateTimePicker(components);
			...
			toolStrip1.Size = new System.Drawing.Size(570, 31);
			...
			panelButtons.Size = new System.Drawing.Size(570, 40);
			...
			linePanelDown.Size = new System.Drawing.Size(570, 1);
			...
			xpButton1.Location = new System.Drawing.Point(460, 8);
			...
			labelCode.Location = new System.Drawing.Point(11, 38);
			labelCode.Name = "labelCode";
			labelCode.PenWidth = 1f;
			labelCode.ShowBorder = false;
			labelCode.Size = new System.Drawing.Size(112, 13);
			labelCode.TabIndex = 0;
			labelCode.Text = "Trade License No:";
			...
			textBoxCode.Location = new System.Drawing.Point(138, 36);
			...
			textBoxName.Location = new System.Drawing.Point(138, 58);
			...
			dateTimePickerExpiryDate.Location = new System.Drawing.Point(138, 234);
			...
			dateTimePickerExpiryDate.TabIndex = 13;
			...
			mmLabel2.Location = new System.Drawing.Point(11, 237);
			mmLabel2.Name = "mmLabel2";
			mmLabel2.PenWidth = 1f;
			mmLabel2.ShowBorder = false;
			mmLabel2.Size = new System.Drawing.Size(67, 13);
			mmLabel2.TabIndex = 58;
			...
			dateTimePickerIssueDate.Location = new System.Drawing.Point(138, 212);
			...
			dateTimePickerIssueDate.TabIndex = 10;
			...
			comboBoxContact.Location = new System.Drawing.Point(138, 102);
			...
			comboBoxContact.Size = new System.Drawing.Size(154, 20);
			...
			mmLabel7.Location = new System.Drawing.Point(412, 39);
			...
			comboBoxStatus.Location = new System.Drawing.Point(463, 35);
			...
			textBoxNote.Location = new System.Drawing.Point(138, 256);
			...
			mmLabel4.Location = new System.Drawing.Point(11, 259);
			mmLabel4.Name = "mmLabel4";
			mmLabel4.PenWidth = 1f;
			mmLabel4.ShowBorder = false;
			mmLabel4.Size = new System.Drawing.Size(33, 13);
			mmLabel4.TabIndex = 67;
			mmLabel4.Text = "Note:";
			textBoxSponsors.BackColor = System.Drawing.Color.White;
			textBoxSponsors.CustomReportFieldName = "";
			textBoxSponsors.CustomReportKey = "";
			textBoxSponsors.CustomReportValueType = 1;
			textBoxSponsors.IsComboTextBox = false;
			textBoxSponsors.Location = new System.Drawing.Point(138, 80);
			textBoxSponsors.MaxLength = 255;
			textBoxSponsors.Name = "textBoxSponsors";
			textBoxSponsors.Size = new System.Drawing.Size(421, 20);
			textBoxSponsors.TabIndex = 4;
			mmLabel3.AutoSize = true;
			mmLabel3.BorderColor = System.Drawing.Color.FromArgb(78, 122, 171);
			mmLabel3.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25f);
			mmLabel3.IsFieldHeader = false;
			mmLabel3.IsRequired = false;
			mmLabel3.Location = new System.Drawing.Point(11, 82);
			mmLabel3.Name = "mmLabel3";
			mmLabel3.PenWidth = 1f;
			mmLabel3.ShowBorder = false;
			mmLabel3.Size = new System.Drawing.Size(54, 13);
			mmLabel3.TabIndex = 68;
			mmLabel3.Text = "Sponsors:";
			textBoxPartners.BackColor = System.Drawing.Color.White;
			textBoxPartners.CustomReportFieldName = "";
			textBoxPartners.CustomReportKey = "";
			textBoxPartners.CustomReportValueType = 1;
			textBoxPartners.IsComboTextBox = false;
			textBoxPartners.Location = new System.Drawing.Point(138, 124);
			textBoxPartners.MaxLength = 255;
			textBoxPartners.Name = "textBoxPartners";
			textBoxPartners.Size = new System.Drawing.Size(421, 20);
			textBoxPartners.TabIndex = 6;
			mmLabel5.AutoSize = true;
			mmLabel5.BorderColor = System.Drawing.Color.FromArgb(78, 122, 171);
			mmLabel5.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25f);
			mmLabel5.IsFieldHeader = false;
			mmLabel5.IsRequired = false;
			mmLabel5.Location = new System.Drawing.Point(11, 127);
			mmLabel5.Name = "mmLabel5";
			mmLabel5.PenWidth = 1f;
			mmLabel5.ShowBorder = false;
			mmLabel5.Size = new System.Drawing.Size(49, 13);
			mmLabel5.TabIndex = 68;
			mmLabel5.Text = "Partners:";
			...
			textBoxRegisterNumber.Location = new System.Drawing.Point(138, 146);
			textBoxRegisterNumber.MaxLength = 20;
			textBoxRegisterNumber.Name = "textBoxRegisterNumber";
			textBoxRegisterNumber.Size = new System.Drawing.Size(154, 20);
			textBoxRegisterNumber.TabIndex = 7;
			mmLabel6.AutoSize = true;
			mmLabel6.BorderColor = System.Drawing.Color.FromArgb(78, 122, 171);
			mmLabel6.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25f);
			mmLabel6.IsFieldHeader = false;
			mmLabel6.IsRequired = false;
			mmLabel6.Location = new System.Drawing.Point(11, 149);
			mmLabel6.Name = "mmLabel6";
			mmLabel6.PenWidth = 1f;
			mmLabel6.ShowBorder = false;
			mmLabel6.Size = new System.Drawing.Size(89, 13);
			mmLabel6.TabIndex = 68;
			mmLabel6.Text = "Registeration No:";
			textBoxLegalType.BackColor = System.Drawing.Color.White;
			textBoxLegalType.CustomReportFieldName = "";
			textBoxLegalType.CustomReportKey = "";
			textBoxLegalType.CustomReportValueType = 1;
			textBoxLegalType.IsComboTextBox = false;
			textBoxLegalType.Location = new System.Drawing.Point(138, 168);
			textBoxLegalType.MaxLength = 30;
			textBoxLegalType.Name = "textBoxLegalType";
			textBoxLegalType.Size = new System.Drawing.Size(154, 20);
			textBoxLegalType.TabIndex = 8;
			mmLabel9.AutoSize = true;
			mmLabel9.BorderColor = System.Drawing.Color.FromArgb(78, 122, 171);
			mmLabel9.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25f);
			mmLabel9.IsFieldHeader = false;
			mmLabel9.IsRequired = false;
			mmLabel9.Location = new System.Drawing.Point(11, 193);
			mmLabel9.Name = "mmLabel9";
			mmLabel9.PenWidth = 1f;
			mmLabel9.ShowBorder = false;
			mmLabel9.Size = new System.Drawing.Size(65, 13);
			mmLabel9.TabIndex = 68;
			...
			textBoxIssuePlace.Location = new System.Drawing.Point(138, 190);
			textBoxIssuePlace.MaxLength = 30;
			textBoxIssuePlace.Name = "textBoxIssuePlace";
			textBoxIssuePlace.Size = new System.Drawing.Size(154, 20);
			textBoxIssuePlace.TabIndex = 9;
			...
			mmLabel10.Location = new System.Drawing.Point(11, 171);
			mmLabel10.Name = "mmLabel10";
			mmLabel10.PenWidth = 1f;
			mmLabel10.ShowBorder = false;
			mmLabel10.Size = new System.Drawing.Size(63, 13);
			mmLabel10.TabIndex = 68;
			mmLabel10.Text = "Legal Type:";
			...
			mmLabel11.Location = new System.Drawing.Point(273, 216);
			mmLabel11.Name = "mmLabel11";
			mmLabel11.PenWidth = 1f;
			mmLabel11.ShowBorder = false;
			mmLabel11.Size = new System.Drawing.Size(70, 13);
			mmLabel11.TabIndex = 11;
			mmLabel11.Text = "Renew Date:";
			dateTimePickerRenewDate.Checked = false;
			dateTimePickerRenewDate.CustomFormat = " ";
			dateTimePickerRenewDate.Format = System.Windows.Forms.DateTimePickerFormat.Custom;
			dateTimePickerRenewDate.Location = new System.Drawing.Point(351, 212);
			dateTimePickerRenewDate.Name = "dateTimePickerRenewDate";
			dateTimePickerRenewDate.ShowCheckBox = true;
			dateTimePickerRenewDate.Size = new System.Drawing.Size(125, 20);
			dateTimePickerRenewDate.TabIndex = 12;
			dateTimePickerRenewDate.Value = new System.DateTime(0L);
			mmLabel1.AutoSize = true;
			mmLabel1.BorderColor = System.Drawing.Color.FromArgb(78, 122, 171);
			mmLabel1.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25f);
			mmLabel1.IsFieldHeader = false;
			mmLabel1.IsRequired = false;
			mmLabel1.Location = new System.Drawing.Point(11, 61);
			mmLabel1.Name = "mmLabel1";
			mmLabel1.PenWidth = 1f;
			mmLabel1.ShowBorder = false;
			mmLabel1.Size = new System.Drawing.Size(63, 13);
			mmLabel1.TabIndex = 68;
			mmLabel1.Text = "Description:";
			ultraFormattedLinkLabel1.AutoSize = true;
			ultraFormattedLinkLabel1.Location = new System.Drawing.Point(14, 104);
			...
			base.ClientSize = new System.Drawing.Size(570, 408);
			...
			base.Name = "TradeLicenseDetailsForm";
			Text = "Trade License Details";
