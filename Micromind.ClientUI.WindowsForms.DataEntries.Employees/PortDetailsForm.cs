...
{
	public class PortDetailsForm : Form, IForm
	{
		private PortData currentData;

		private const string TABLENAME_CONST = "Port";

		private const string IDFIELD_CONST = "PortID";
		...
		{
			base.Load += PortDetailsForm_Load;
		}
		...
		private bool GetData()
		{
			try
			{
				...
				{
					currentData = new PortData();
				}
				DataRow dataRow = (!isNewRecord) ? currentData.PortTable.Rows[0] : currentData.PortTable.NewRow();
				dataRow.BeginEdit();
				dataRow["PortID"] = textBoxCode.Text.Trim();
				dataRow["PortName"] = textBoxName.Text.Trim();
				...
				if (isNewRecord)
				{
					currentData.PortTable.Rows.Add(dataRow);
				}
				return true;
			}
			catch (Exception e)
		...
		public void LoadData(string id)
		{
			try
			{
				...
				{
					currentData = Factory.PortSystem.GetPortByID(id.Trim());
		...
		private void FillData()
		{
			if (currentData != null && currentData.Tables.Count != 0 && currentData.Tables[0].Rows.Count != 0)
			{
				...
				textBoxCode.Text = dataRow["PortID"].ToString();
				textBoxName.Text = dataRow["PortName"].ToString();
		...
		private bool SaveData()
		{
			...
			try
			{
				...
				if (isNewRecord)
				{
					flag = Factory.PortSystem.CreatePort(currentData);
					if (flag)
					{
						ComboDataHelper.SetRefreshStatus(DataComboType.Port, needRefresh: true);
					}
				}
				else
				{
					flag = Factory.PortSystem.UpdatePort(currentData);
				}
				if (!flag)
				{
		...
		private bool ValidateData()
		{
			...
			if (isNewRecord && Factory.DatabaseSystem.ExistFieldValue("Port", "PortID", textBoxCode.Text.Trim()))
			{
		...
		{
			textBoxCode.Text = PublicFunctions.GetNextCardNumber("Port", "PortID");
			textBoxName.Clear();
			textBoxNote.Clear();
		...
		private void PortGroupDetailsForm_Validating(object sender, CancelEventArgs e)
		{
		}

		private void PortGroupDetailsForm_Validated(object sender, EventArgs e)
		{
		}
		...
		private bool Delete()
		{
			try
			{
				...
				return Factory.PortSystem.DeletePort(textBoxCode.Text);
			}
			catch (Exception e)
			{
				ErrorHelper.ProcessError(e);
		...
		{
			LoadData(DatabaseHelper.GetNextID("Port", "PortID", textBoxCode.Text));
		}

		private void toolStripButtonPrevious_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetPreviousID("Port", "PortID", textBoxCode.Text));
		}

		private void toolStripButtonLast_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetLastID("Port", "PortID"));
		}

		private void toolStripButtonFirst_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetFirstID("Port", "PortID"));
		}
		...
		private void toolStripButtonFind_Click(object sender, EventArgs e)
		{
			try
			{
				...
				else if (Factory.DatabaseSystem.ExistFieldValue("Port", "PortID", toolStripTextBoxFind.Text.Trim()))
				{
		...
		private void PortDetailsForm_Load(object sender, EventArgs e)
		{
			try
			{
				SetSecurity();
		...
		{
			new FormHelper().ShowList(DataComboType.Port);
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Employees.PortDetailsForm));
			...
			comboBoxCountry.DisplayLayout.Appearance = appearance2;
			...
			comboBoxCountry.DisplayLayout.GroupByBox.Appearance = appearance3;
			appearance4.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxCountry.DisplayLayout.GroupByBox.BandLabelAppearance = appearance4;
			...
			comboBoxCountry.DisplayLayout.GroupByBox.PromptAppearance = appearance5;
			...
			comboBoxCountry.DisplayLayout.Override.ActiveCellAppearance = appearance6;
			appearance7.BackColor = System.Drawing.SystemColors.Highlight;
			appearance7.ForeColor = System.Drawing.SystemColors.HighlightText;
			comboBoxCountry.DisplayLayout.Override.ActiveRowAppearance = appearance7;
			...
			comboBoxCountry.DisplayLayout.Override.CardAreaAppearance = appearance8;
			appearance9.BorderColor = System.Drawing.Color.Silver;
			appearance9.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxCountry.DisplayLayout.Override.CellAppearance = appearance9;
			...
			comboBoxCountry.DisplayLayout.Override.GroupByRowAppearance = appearance10;
			appearance11.TextHAlignAsString = "Left";
			comboBoxCountry.DisplayLayout.Override.HeaderAppearance = appearance11;
			...
			comboBoxCountry.DisplayLayout.Override.RowAppearance = appearance12;
			comboBoxCountry.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance13.BackColor = System.Drawing.SystemColors.ControlLight;
			comboBoxCountry.DisplayLayout.Override.TemplateAddRowAppearance = appearance13;
			...
			comboBoxCountry.Location = new System.Drawing.Point(108, 80);
			...
			comboBoxCountry.Size = new System.Drawing.Size(179, 20);
			...
			textBoxNote.Location = new System.Drawing.Point(108, 102);
			...
			labelCode.Text = "Port Code:";
			base.AutoScaleDimensions = new System.Drawing.SizeF(6f, 13f);
			base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			BackColor = System.Drawing.Color.WhiteSmoke;
			base.ClientSize = new System.Drawing.Size(470, 174);
