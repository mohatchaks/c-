...
{
	public class EmployeeLoanTypeDetailsForm : Form, IForm
	{
		private EmployeeLoanTypeData currentData;

		private const string TABLENAME_CONST = "Employee_Loan_Type";

		private const string IDFIELD_CONST = "LoanTypeID";
		...
		public EmployeeLoanTypeDetailsForm()
		{
			InitializeComponent();
			AddEvents();
		}
		...
		{
			base.Load += EmployeeLoanTypeDetailsForm_Load;
		}
		...
		private bool GetData()
		{
			try
			{
				...
				{
					currentData = new EmployeeLoanTypeData();
				}
				DataRow dataRow = (!isNewRecord) ? currentData.EmployeeLoanTypeTable.Rows[0] : currentData.EmployeeLoanTypeTable.NewRow();
				dataRow.BeginEdit();
				dataRow["LoanTypeID"] = textBoxCode.Text.Trim();
				dataRow["LoanTypeName"] = textBoxName.Text.Trim();
				...
				if (isNewRecord)
				{
					currentData.EmployeeLoanTypeTable.Rows.Add(dataRow);
				}
				return true;
			}
			catch (Exception e)
		...
		public void LoadData(string id)
		{
			try
			{
				...
				{
					currentData = Factory.EmployeeLoanTypeSystem.GetEmployeeLoanTypeByID(id.Trim());
		...
		private void FillData()
		{
			if (currentData != null && currentData.Tables.Count != 0 && currentData.Tables[0].Rows.Count != 0)
			{
				...
				textBoxCode.Text = dataRow["LoanTypeID"].ToString();
				textBoxName.Text = dataRow["LoanTypeName"].ToString();
		...
		private bool SaveData()
		{
			...
			try
			{
				...
				if (isNewRecord)
				{
					flag = Factory.EmployeeLoanTypeSystem.CreateEmployeeLoanType(currentData);
					if (flag)
					{
						ComboDataHelper.SetRefreshStatus(DataComboType.EmployeeLoanType, needRefresh: true);
					}
				}
				else
				{
					flag = Factory.EmployeeLoanTypeSystem.UpdateEmployeeLoanType(currentData);
				}
				if (!flag)
				{
		...
		private bool ValidateData()
		{
			...
			if (isNewRecord && Factory.DatabaseSystem.ExistFieldValue("Employee_Loan_Type", "LoanTypeID", textBoxCode.Text.Trim()))
			{
		...
		private void EmployeeLoanTypeGroupDetailsForm_Validating(object sender, CancelEventArgs e)
		{
		}

		private void EmployeeLoanTypeGroupDetailsForm_Validated(object sender, EventArgs e)
		{
		}
		...
		private bool Delete()
		{
			try
			{
				...
				return Factory.EmployeeLoanTypeSystem.DeleteEmployeeLoanType(textBoxCode.Text);
			}
			catch (Exception e)
			{
				ErrorHelper.ProcessError(e);
		...
		{
			LoadData(DatabaseHelper.GetNextID("Employee_Loan_Type", "LoanTypeID", textBoxCode.Text));
		}

		private void toolStripButtonPrevious_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetPreviousID("Employee_Loan_Type", "LoanTypeID", textBoxCode.Text));
		}

		private void toolStripButtonLast_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetLastID("Employee_Loan_Type", "LoanTypeID"));
		}

		private void toolStripButtonFirst_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetFirstID("Employee_Loan_Type", "LoanTypeID"));
		}
		...
		private void toolStripButtonFind_Click(object sender, EventArgs e)
		{
			try
			{
				...
				else if (Factory.DatabaseSystem.ExistFieldValue("Employee_Loan_Type", "LoanTypeID", toolStripTextBoxFind.Text.Trim()))
				{
		...
		private void EmployeeLoanTypeDetailsForm_Load(object sender, EventArgs e)
		{
			try
			{
				SetSecurity();
		...
		{
			new FormHelper().ShowList(DataComboType.EmployeeLoanType);
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Employees.EmployeeLoanTypeDetailsForm));
			...
			panelButtons.Location = new System.Drawing.Point(0, 192);
			...
			labelCode.Size = new System.Drawing.Size(104, 13);
			labelCode.TabIndex = 0;
			labelCode.Text = "Loan Type Code:";
			...
			textBoxCode.Location = new System.Drawing.Point(118, 36);
			textBoxCode.MaxLength = 15;
			textBoxCode.Name = "textBoxCode";
			textBoxCode.Size = new System.Drawing.Size(169, 21);
			...
			mmLabel1.Size = new System.Drawing.Size(107, 13);
			mmLabel1.TabIndex = 3;
			mmLabel1.Text = "Loan Type Name:";
			...
			textBoxName.Location = new System.Drawing.Point(118, 58);
			textBoxName.MaxLength = 64;
			textBoxName.Name = "textBoxName";
			textBoxName.Size = new System.Drawing.Size(314, 21);
			...
			mmLabel4.Location = new System.Drawing.Point(8, 128);
			...
			textBoxNote.Location = new System.Drawing.Point(118, 127);
			textBoxNote.MaxLength = 255;
			textBoxNote.Name = "textBoxNote";
			textBoxNote.Size = new System.Drawing.Size(314, 21);
			...
			ultraFormattedLinkLabel6.Location = new System.Drawing.Point(11, 82);
			...
			textBoxAccountName.Location = new System.Drawing.Point(118, 103);
			textBoxAccountName.MaxLength = 15;
			textBoxAccountName.Name = "textBoxAccountName";
			textBoxAccountName.Size = new System.Drawing.Size(312, 21);
			...
			comboBoxAccount.Location = new System.Drawing.Point(118, 80);
			...
			comboBoxAccount.Size = new System.Drawing.Size(169, 21);
			...
			base.ClientSize = new System.Drawing.Size(470, 232);
			...
			base.Name = "EmployeeLoanTypeDetailsForm";
			Text = "Emploee LoanType";
