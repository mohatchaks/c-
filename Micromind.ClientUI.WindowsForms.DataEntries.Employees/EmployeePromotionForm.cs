...
{
	public class EmployeePromotionForm : Form, IForm
	{
		private EmployeeActivityData currentData;

		private const string TABLENAME_CONST = "Employee_Promotion";
		...
		private MMTextBox textBoxFromGradeName;
		...
		private MMTextBox textBoxFromGradeID;
		...
		{
			base.Load += EmployeePromotionForm_Load;
		}
		...
		private bool GetData()
		{
			try
			{
				...
				{
					currentData = new EmployeeActivityData(EmployeeActivityTypes.Promotion);
				}
				...
				dataRow = ((!isNewRecord) ? currentData.EmployeePromotionTable.Rows[0] : currentData.EmployeePromotionTable.NewRow());
				dataRow["RequestedBy"] = textBoxRequestedBy.Text;
				if (textBoxFromGradeID.Text != "")
				{
					dataRow["FromGrade"] = textBoxFromGradeID.Text;
				}
				else
				{
					dataRow["FromGrade"] = DBNull.Value;
				}
				...
				if (comboBoxToGrade.SelectedID != "")
				{
					dataRow["ToGrade"] = comboBoxToGrade.SelectedID;
				}
				else
				{
					dataRow["ToGrade"] = DBNull.Value;
				}
				...
				if (isNewRecord)
				{
					currentData.EmployeePromotionTable.Rows.Add(dataRow);
				}
				return true;
			}
			catch (Exception e)
		...
		private void FillData()
		{
			if (currentData != null && currentData.Tables.Count != 0 && currentData.Tables[0].Rows.Count != 0)
			{
				...
				dataRow = currentData.Tables["Employee_Promotion"].Rows[0];
				textBoxRequestedBy.Text = dataRow["RequestedBy"].ToString();
				textBoxFromPositionID.Text = dataRow["FromPosition"].ToString();
				textBoxFromGradeID.Text = dataRow["FromGrade"].ToString();
				comboBoxToGrade.SelectedID = dataRow["ToGrade"].ToString();
				comboBoxToPosition.SelectedID = dataRow["ToPosition"].ToString();
				textBoxFromPositionName.Text = dataRow["PositionName"].ToString();
				textBoxFromGradeName.Text = dataRow["GradeName"].ToString();
			}
		}
		...
		private bool SaveData()
		{
			...
			try
			{
				bool flag = (!isNewRecord) ? Factory.EmployeeActivitySystem.CreateEmployeeActivity(currentData, EmployeeActivityTypes.Promotion, isUpdate: true) : Factory.EmployeeActivitySystem.CreateEmployeeActivity(currentData, EmployeeActivityTypes.Promotion, isUpdate: false);
				if (!flag)
				{
		...
		private void ClearForm()
		{
			...
			textBoxFromGradeID.Clear();
			textBoxFromGradeName.Clear();
			textBoxFromPositionID.Clear();
			textBoxFromPositionName.Clear();
			comboBoxToGrade.Clear();
			comboBoxToPosition.Clear();
			formManager.ResetDirty();
		...
		{
			int result = -1;
			int.TryParse(DatabaseHelper.GetNextID("Employee_Promotion", "ActivityID", textBoxCode.Text), out result);
			if (result > 0)
			{
				LoadData(result);
			}
		...
		{
			int result = -1;
			int.TryParse(DatabaseHelper.GetPreviousID("Employee_Promotion", "ActivityID", textBoxCode.Text), out result);
			if (result > 0)
			{
				LoadData(result);
			}
		...
		{
			int result = -1;
			int.TryParse(DatabaseHelper.GetLastID("Employee_Promotion", "ActivityID"), out result);
			if (result > 0)
			{
				LoadData(result);
			}
		...
		{
			int result = -1;
			int.TryParse(DatabaseHelper.GetFirstID("Employee_Promotion", "ActivityID"), out result);
			if (result > 0)
			{
				LoadData(result);
			}
			...
			try
			{
				...
				else
				{
					...
					if (employeeBriefInfo != null && employeeBriefInfo.Tables.Count > 0 && employeeBriefInfo.Tables[0].Rows.Count > 0)
					{
						...
						string text3 = textBoxFromPositionName.Text = (textBoxDesignation.Text = dataRow["PositionName"].ToString());
						textBoxFromGradeName.Text = dataRow["GradeName"].ToString();
						textBoxFromPositionID.Text = dataRow["PositionID"].ToString();
						textBoxFromGradeID.Text = dataRow["GradeID"].ToString();
					}
				}
			}
			catch (Exception e2)
		...
		{
			new FormHelper().EditGrade(comboBoxToGrade.SelectedID);
		}

		private void ultraFormattedLinkLabel2_LinkClicked(object sender, Infragistics.Win.FormattedLinkLabel.LinkClickedEventArgs e)
		{
			new FormHelper().EditPosition(comboBoxToPosition.SelectedID);
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Employees.EmployeePromotionForm));
			...
			textBoxFromGradeName = new Micromind.UISupport.MMTextBox();
			...
			textBoxFromGradeID = new Micromind.UISupport.MMTextBox();
			...
			textBoxReason.Location = new System.Drawing.Point(112, 204);
			...
			mmLabel1.Location = new System.Drawing.Point(11, 207);
			...
			mmLabel8.Location = new System.Drawing.Point(11, 229);
			...
			textBoxRequestedBy.Location = new System.Drawing.Point(112, 226);
			...
			mmLabel9.Location = new System.Drawing.Point(258, 229);
			...
			textBoxReference.Location = new System.Drawing.Point(329, 226);
			...
			mmLabel10.Location = new System.Drawing.Point(11, 264);
			...
			mmLabel12.Location = new System.Drawing.Point(11, 129);
			mmLabel12.Name = "mmLabel12";
			mmLabel12.PenWidth = 1f;
			mmLabel12.ShowBorder = false;
			mmLabel12.Size = new System.Drawing.Size(98, 13);
			mmLabel12.TabIndex = 0;
			mmLabel12.Text = "Promotion Date:";
			dateTimePickerDate.Format = System.Windows.Forms.DateTimePickerFormat.Short;
			dateTimePickerDate.Location = new System.Drawing.Point(112, 125);
			dateTimePickerDate.Name = "dateTimePickerDate";
			dateTimePickerDate.Size = new System.Drawing.Size(126, 20);
			dateTimePickerDate.TabIndex = 2;
			dateTimePickerDate.Value = new System.DateTime(2016, 2, 17, 12, 12, 4, 295);
			...
			textBoxFromGradeName.BackColor = System.Drawing.Color.WhiteSmoke;
			textBoxFromGradeName.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper;
			textBoxFromGradeName.CustomReportFieldName = "";
			textBoxFromGradeName.CustomReportKey = "";
			textBoxFromGradeName.CustomReportValueType = 1;
			textBoxFromGradeName.IsComboTextBox = false;
			textBoxFromGradeName.Location = new System.Drawing.Point(112, 148);
			textBoxFromGradeName.MaxLength = 15;
			textBoxFromGradeName.Name = "textBoxFromGradeName";
			textBoxFromGradeName.ReadOnly = true;
			textBoxFromGradeName.Size = new System.Drawing.Size(140, 20);
			textBoxFromGradeName.TabIndex = 18;
			textBoxFromGradeName.TabStop = false;
			mmLabel6.AutoSize = true;
			mmLabel6.BorderColor = System.Drawing.Color.FromArgb(78, 122, 171);
			mmLabel6.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25f);
			mmLabel6.IsFieldHeader = false;
			mmLabel6.IsRequired = false;
			mmLabel6.Location = new System.Drawing.Point(11, 151);
			mmLabel6.Name = "mmLabel6";
			mmLabel6.PenWidth = 1f;
			mmLabel6.ShowBorder = false;
			mmLabel6.Size = new System.Drawing.Size(65, 13);
			mmLabel6.TabIndex = 19;
			mmLabel6.Text = "From Grade:";
			...
			textBoxFromPositionName.Location = new System.Drawing.Point(112, 170);
			...
			textBoxFromPositionName.Size = new System.Drawing.Size(140, 20);
			textBoxFromPositionName.TabIndex = 18;
			...
			comboBoxToGrade.DisplayLayout.Appearance = appearance13;
			...
			comboBoxToGrade.DisplayLayout.GroupByBox.Appearance = appearance14;
			appearance15.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxToGrade.DisplayLayout.GroupByBox.BandLabelAppearance = appearance15;
			...
			comboBoxToGrade.DisplayLayout.GroupByBox.PromptAppearance = appearance16;
			...
			comboBoxToGrade.DisplayLayout.Override.ActiveCellAppearance = appearance17;
			appearance18.BackColor = System.Drawing.SystemColors.Highlight;
			appearance18.ForeColor = System.Drawing.SystemColors.HighlightText;
			comboBoxToGrade.DisplayLayout.Override.ActiveRowAppearance = appearance18;
			...
			comboBoxToGrade.DisplayLayout.Override.CardAreaAppearance = appearance19;
			appearance20.BorderColor = System.Drawing.Color.Silver;
			appearance20.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxToGrade.DisplayLayout.Override.CellAppearance = appearance20;
			...
			comboBoxToGrade.DisplayLayout.Override.GroupByRowAppearance = appearance21;
			appearance22.TextHAlignAsString = "Left";
			comboBoxToGrade.DisplayLayout.Override.HeaderAppearance = appearance22;
			...
			comboBoxToGrade.DisplayLayout.Override.RowAppearance = appearance23;
			comboBoxToGrade.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance24.BackColor = System.Drawing.SystemColors.ControlLight;
			comboBoxToGrade.DisplayLayout.Override.TemplateAddRowAppearance = appearance24;
			...
			comboBoxToGrade.Location = new System.Drawing.Point(329, 148);
			...
			comboBoxToGrade.Size = new System.Drawing.Size(141, 20);
			comboBoxToGrade.TabIndex = 1;
			...
			comboBoxToPosition.DisplayLayout.Appearance = appearance25;
			...
			comboBoxToPosition.DisplayLayout.GroupByBox.Appearance = appearance26;
			appearance27.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxToPosition.DisplayLayout.GroupByBox.BandLabelAppearance = appearance27;
			...
			comboBoxToPosition.DisplayLayout.GroupByBox.PromptAppearance = appearance28;
			...
			comboBoxToPosition.DisplayLayout.Override.ActiveCellAppearance = appearance29;
			appearance30.BackColor = System.Drawing.SystemColors.Highlight;
			appearance30.ForeColor = System.Drawing.SystemColors.HighlightText;
			comboBoxToPosition.DisplayLayout.Override.ActiveRowAppearance = appearance30;
			...
			comboBoxToPosition.DisplayLayout.Override.CardAreaAppearance = appearance31;
			appearance32.BorderColor = System.Drawing.Color.Silver;
			appearance32.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxToPosition.DisplayLayout.Override.CellAppearance = appearance32;
			...
			comboBoxToPosition.DisplayLayout.Override.GroupByRowAppearance = appearance33;
			appearance34.TextHAlignAsString = "Left";
			comboBoxToPosition.DisplayLayout.Override.HeaderAppearance = appearance34;
			...
			comboBoxToPosition.DisplayLayout.Override.RowAppearance = appearance35;
			comboBoxToPosition.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance36.BackColor = System.Drawing.SystemColors.ControlLight;
			comboBoxToPosition.DisplayLayout.Override.TemplateAddRowAppearance = appearance36;
			...
			comboBoxToPosition.Location = new System.Drawing.Point(329, 170);
			...
			comboBoxToPosition.Size = new System.Drawing.Size(141, 20);
			comboBoxToPosition.TabIndex = 2;
			comboBoxToPosition.UseFlatMode = Infragistics.Win.DefaultableBoolean.True;
			textBoxFromGradeID.BackColor = System.Drawing.Color.WhiteSmoke;
			textBoxFromGradeID.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper;
			textBoxFromGradeID.CustomReportFieldName = "";
			textBoxFromGradeID.CustomReportKey = "";
			textBoxFromGradeID.CustomReportValueType = 1;
			textBoxFromGradeID.IsComboTextBox = false;
			textBoxFromGradeID.Location = new System.Drawing.Point(68, 286);
			textBoxFromGradeID.MaxLength = 15;
			textBoxFromGradeID.Name = "textBoxFromGradeID";
			textBoxFromGradeID.ReadOnly = true;
			textBoxFromGradeID.Size = new System.Drawing.Size(38, 20);
			textBoxFromGradeID.TabIndex = 22;
			textBoxFromGradeID.Visible = false;
			...
			textBoxFromPositionID.Location = new System.Drawing.Point(68, 308);
			...
			textBoxFromPositionID.TabIndex = 23;
			...
			ultraFormattedLinkLabel6.Location = new System.Drawing.Point(14, 33);
			...
			ultraFormattedLinkLabel1.Location = new System.Drawing.Point(257, 151);
			...
			ultraFormattedLinkLabel1.Value = "To Grade:";
			...
			ultraFormattedLinkLabel2.Location = new System.Drawing.Point(257, 172);
			ultraFormattedLinkLabel2.Name = "ultraFormattedLinkLabel2";
			ultraFormattedLinkLabel2.Size = new System.Drawing.Size(69, 15);
			ultraFormattedLinkLabel2.TabIndex = 132;
			ultraFormattedLinkLabel2.TabStop = true;
			ultraFormattedLinkLabel2.TreatValueAs = Infragistics.Win.FormattedLinkLabel.TreatValueAs.URL;
			ultraFormattedLinkLabel2.UnderlineLinks = Infragistics.Win.FormattedLinkLabel.UnderlineLink.WhenHovered;
			ultraFormattedLinkLabel2.Value = "To Position:";
			...
			base.ClientSize = new System.Drawing.Size(595, 388);
			...
			base.Controls.Add(textBoxFromGradeID);
			...
			base.Controls.Add(textBoxFromGradeName);
			...
			base.Name = "EmployeePromotionForm";
			Text = "Employee Promotion Entry";
