...
{
	public class AccountAnalysisPivotReportForm : Form, IForm
	{
		...
		public AccountAnalysisPivotReportForm()
		{
			InitializeComponent();
		...
		{
			DataSet data = Factory.JournalSystem.GetAnalysisTransactionsPivotReport(dateControl1.FromDate, dateControl1.ToDate, accountSelector.FromAccount, accountSelector.ToAccount, analysisSelector.FromAnalysis, analysisSelector.ToAnalysis, analysisSelector.FromGroup, analysisSelector.ToGroup, locationSelector.FromLocation, locationSelector.ToLocation, divisionSelector.FromDivision, divisionSelector.ToDivision);
			...
			XtraReport report = reportHelper.GetReport("Account Analysis Pivot");
			if (report == null)
			{
				ErrorHelper.ErrorMessage("Cannot find the report file", "Account Analysis Pivot.repx", "Please make sure you have access to reports path and the files are not corrupted.");
				return;
			}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.Accounts.AccountAnalysisPivotReportForm));
			...
			panelButtons.Location = new System.Drawing.Point(0, 372);
			...
			label1.Location = new System.Drawing.Point(368, 26);
			label1.Name = "label1";
			label1.Size = new System.Drawing.Size(50, 13);
			label1.TabIndex = 5;
			label1.Text = "Account:";
			label1.Visible = false;
			groupBox2.Controls.Add(accountSelector);
			groupBox2.Controls.Add(comboBoxAccount);
			groupBox2.Location = new System.Drawing.Point(11, 12);
			groupBox2.Name = "groupBox2";
			groupBox2.Size = new System.Drawing.Size(437, 69);
			...
			accountSelector.Location = new System.Drawing.Point(5, 17);
			...
			comboBoxAccount.Location = new System.Drawing.Point(224, 19);
			...
			dateControl1.Location = new System.Drawing.Point(16, 271);
			dateControl1.Name = "dateControl1";
			dateControl1.SelectedPeriod = Micromind.DataControls.DatePeriods.ThisMonthToDate;
			dateControl1.Size = new System.Drawing.Size(354, 49);
			...
			ultraGroupBox2.Location = new System.Drawing.Point(12, 187);
			ultraGroupBox2.Name = "ultraGroupBox2";
			ultraGroupBox2.Size = new System.Drawing.Size(436, 81);
			...
			groupBox1.Location = new System.Drawing.Point(11, 83);
			groupBox1.Name = "groupBox1";
			groupBox1.Size = new System.Drawing.Size(437, 99);
			...
			ultraGroupBox1.Location = new System.Drawing.Point(14, 186);
			...
			base.ClientSize = new System.Drawing.Size(455, 412);
			...
			base.Name = "AccountAnalysisPivotReportForm";
			Text = "Account Analysis Pivot Report";
