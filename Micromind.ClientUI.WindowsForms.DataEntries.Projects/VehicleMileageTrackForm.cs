...
{
	public class VehicleMileageTrackForm : Form, IForm, IWorkFlowForm
	{
		...
		private VehicleMileageTrackData currentData;

		private DataSet currentDataset;

		private const string TABLENAME_CONST = "Vehicle_Mileage_Track";

		private const string TABLENAMEDETAIL_CONST = "Vehicle_Mileage_Track_Detail";
		...
		private DateTime dtTripTime = DateTime.MinValue;

		private VehicleSelector vehicleObj;

		private Form vehiclFormObj;
		...
		private UltraFormattedLinkLabel VehicleNumberLinkLabel;
		...
		private VehicleComboBox vehicleComboBox;

		private DriverComboBox driverComboBox1;

		private MMTextBox textboxVehicleName;

		private ToolStripMenuItem loadAllVehicleToolStripMenuItem;
		...
		public VehicleMileageTrackForm()
		{
			InitializeComponent();
			AddEvents();
		...
		private void GetData(string vehicleID)
		{
			try
			{
				currentDataset = Factory.VehicleMileageTrackSystem.GetPreviousReadingValue(vehicleID);
				if (currentDataset != null && currentDataset.Tables.Count > 0 && currentDataset.Tables[1].Rows.Count > 0 && currentDataset.Tables[0].Rows.Count == 0)
				{
					DataRow dataRow = currentDataset.Tables[1].Rows[0];
					dataGridItems.ActiveRow.Cells["Previous Reading"].Value = dataRow["CurrentReading"];
				}
				else
				{
					dataGridItems.ActiveRow.Cells["Previous Reading"].Value = 0;
				}
			}
			catch (Exception e)
			{
			...
			checked
			{
				try
				{
					if (dataGridItems.ActiveRow != null && dataGridItems.ActiveRow != null)
					{
						...
						int result2 = 0;
						int result3 = 0;
						int.TryParse(dataGridItems.ActiveRow.Cells["Previous Reading"].Value.ToString(), out result);
						int.TryParse(dataGridItems.ActiveRow.Cells["Current Reading"].Value.ToString(), out result2);
						int.TryParse(dataGridItems.ActiveRow.Cells["Mileage"].Value.ToString(), out result3);
						if (key == "Previous Reading" && dataGridItems.ActiveCell != null && dataGridItems.ActiveCell.Column.Key == "Previous Reading")
						{
							result3 = result2 - result;
							dataGridItems.ActiveRow.Cells["Mileage"].Value = result3;
						}
						else if (key == "Current Reading" && dataGridItems.ActiveCell != null && dataGridItems.ActiveCell.Column.Key == "Current Reading")
						{
							dataGridItems.ActiveRow.Cells["Mileage"].Value = result2 - result;
						}
						else if (key == "Mileage" && dataGridItems.ActiveCell != null && dataGridItems.ActiveCell.Column.Key == "Mileage")
						{
							dataGridItems.ActiveRow.Cells["Current Reading"].Value = result3 - result;
						}
						if (key == "Vehicle No" && dataGridItems.ActiveCell != null && dataGridItems.ActiveCell.Column.Key == "Vehicle No")
						{
							GetData(dataGridItems.ActiveRow.Cells["Vehicle No"].Value.ToString());
							dataGridItems.ActiveRow.Cells["Name"].Value = vehicleComboBox.SelectedName.ToString();
						}
					}
				}
				catch (Exception e2)
		...
		private bool GetData()
		{
			try
			{
				...
				{
					currentData = new VehicleMileageTrackData();
				}
				DataRow dataRow = (!isNewRecord) ? currentData.VehicleMileageTrackTable.Rows[0] : currentData.VehicleMileageTrackTable.NewRow();
				dataRow["SysDocID"] = comboBoxSysDoc.SelectedID;
				dataRow["VoucherID"] = textBoxVoucherNumber.Text;
				dataRow["IsDateWise"] = checkBoxDatewise.Checked;
				dataRow["TransactionDate"] = dateTimePickerDate.Value;
				dataRow["Note"] = textBoxNote.Text;
				dataRow.EndEdit();
				if (IsNewRecord)
				{
					currentData.VehicleMileageTrackTable.Rows.Add(dataRow);
				}
				currentData.VehicleMileageTrackDetailTable.Rows.Clear();
				foreach (UltraGridRow row in dataGridItems.Rows)
				{
					DataRow dataRow2 = currentData.VehicleMileageTrackDetailTable.NewRow();
					dataRow2.BeginEdit();
					...
					{
						dataRow2["TripDate"] = DateTime.Parse(row.Cells["Date"].Value.ToString());
					}
					else
					{
						dataRow2["TripDate"] = DBNull.Value;
					}
					if (row.Cells["Time"].Value != null && row.Cells["Time"].Value.ToString() != "")
					{
						dataRow2["TripTime"] = DateTime.Parse(Convert.ToString(row.Cells["Time"].Value.ToString().Replace('.', ':')));
					}
					else
					{
						dataRow2["TripTime"] = DBNull.Value;
					}
					if (row.Cells["Vehicle No"].Value != null && row.Cells["Vehicle No"].Value.ToString() != "")
					{
						dataRow2["VehicleID"] = row.Cells["Vehicle No"].Value.ToString();
					}
					else
					{
						dataRow2["VehicleID"] = vehicleComboBox.SelectedID;
					}
					...
					{
						dataRow2["Name"] = DBNull.Value;
					}
					if (row.Cells["Purpose"].Value.ToString() != "")
					{
						dataRow2["Purpose"] = row.Cells["Purpose"].Value.ToString();
					}
					else
					{
						dataRow2["Purpose"] = DBNull.Value;
					}
					if (row.Cells["Driver"].Value.ToString() != "")
					{
						dataRow2["DriverID"] = row.Cells["Driver"].Value.ToString();
					}
					else
					{
						dataRow2["DriverID"] = DBNull.Value;
					}
					if (row.Cells["Previous Reading"].Value.ToString() != "")
					{
						dataRow2["PreviousReading"] = row.Cells["Previous Reading"].Value.ToString();
					}
					else
					{
						dataRow2["PreviousReading"] = DBNull.Value;
					}
					if (row.Cells["Current Reading"].Value.ToString() != "")
					{
						dataRow2["CurrentReading"] = row.Cells["Current Reading"].Value.ToString();
					}
					else
					{
						dataRow2["CurrentReading"] = DBNull.Value;
					}
					if (row.Cells["Mileage"].Value.ToString() != "")
					{
						dataRow2["Mileage"] = row.Cells["Mileage"].Value.ToString();
					}
					else
					{
						dataRow2["Mileage"] = DBNull.Value;
					}
					dataRow2["Remarks"] = row.Cells["Remarks"].Value.ToString();
					dataRow2["RowIndex"] = row.Index;
					dataRow2.EndEdit();
					currentData.VehicleMileageTrackDetailTable.Rows.Add(dataRow2);
				}
				return true;
			}
			catch (Exception e)
		...
		private void FillData()
		{
			try
			{
				...
				{
					DataRow dataRow = currentData.Tables["Vehicle_Mileage_Track"].Rows[0];
					DataRow dataRow2 = currentData.Tables["Vehicle_Mileage_Track_Detail"].Rows[0];
					textBoxVoucherNumber.Text = dataRow["VoucherID"].ToString();
					comboBoxSysDoc.SelectedID = dataRow["SysDocID"].ToString();
					textBoxNote.Text = dataRow["Note"].ToString();
					if (dataRow["IsDateWise"] != null && dataRow["IsDateWise"].ToString() != string.Empty)
					{
						checkBoxDatewise.Checked = bool.Parse(dataRow["IsDateWise"].ToString());
					}
					vehicleComboBox.SelectedID = dataRow2["VehicleID"].ToString();
					textboxVehicleName.Text = vehicleComboBox.SelectedName;
					...
					if (currentData.Tables.Contains("Vehicle_Mileage_Track_Detail") && currentData.VehicleMileageTrackDetailTable.Rows.Count != 0)
					{
						dataGridItems.BeginUpdate();
						foreach (DataRow row in currentData.Tables["Vehicle_Mileage_Track_Detail"].Rows)
						{
							DataRow dataRow4 = dataTable.NewRow();
							string text = "";
							if (row["TripDate"] != DBNull.Value)
							{
								dataRow4["Date"] = DateTime.Parse(row["TripDate"].ToString());
							}
							else
							{
								dataRow4["Date"] = DBNull.Value;
							}
							if (row["TripTime"] != DBNull.Value)
							{
								dtTripTime = DateTime.Parse(row["TripTime"].ToString());
							}
							text = dtTripTime.ToString("HH:mm");
							if (text == "00:00")
							{
								dataRow4["Time"] = null;
							}
							...
							{
								dataRow4["Time"] = text.ToString();
							}
							if (row["VehicleID"] != DBNull.Value)
							{
								dataRow4["Vehicle No"] = row["VehicleID"];
							}
							if (row["Name"] != DBNull.Value)
							{
								dataRow4["Name"] = row["Name"];
							}
							if (row["Purpose"] != DBNull.Value)
							{
								dataRow4["Purpose"] = row["Purpose"].ToString();
							}
							else
							{
								dataRow4["Purpose"] = DBNull.Value;
							}
							if (row["DriverID"] != DBNull.Value)
							{
								dataRow4["Driver"] = row["DriverID"].ToString();
							}
							else
							{
								dataRow4["Driver"] = DBNull.Value;
							}
							if (row["PreviousReading"] != DBNull.Value)
							{
								dataRow4["Previous Reading"] = row["PreviousReading"];
							}
							if (row["CurrentReading"] != DBNull.Value)
							{
								dataRow4["Current Reading"] = row["CurrentReading"].ToString();
							}
							else
							{
								dataRow4["Current Reading"] = DBNull.Value;
							}
							if (row["Mileage"] != DBNull.Value)
							{
								dataRow4["Mileage"] = row["Mileage"].ToString();
							}
							else
							{
								dataRow4["Mileage"] = DBNull.Value;
							}
							if (row["Remarks"] != DBNull.Value)
							{
								dataRow4["Remarks"] = row["Remarks"].ToString();
							}
							else
							{
		...
		private void SetupGrid()
		{
			try
			{
				...
				dataTable.Columns.Add("Previous Reading");
				dataTable.Columns.Add("Current Reading");
				dataTable.Columns.Add("Mileage");
				dataTable.Columns.Add("Remarks");
				dataGridItems.DataSource = dataTable;
				dataGridItems.LoadLayout();
				dataGridItems.DisplayLayout.Bands[0].Columns["Vehicle No"].CharacterCasing = CharacterCasing.Upper;
				dataGridItems.DisplayLayout.Bands[0].Columns["Vehicle No"].MaxLength = 15;
				dataGridItems.DisplayLayout.Bands[0].Columns["Vehicle No"].InvalidValueBehavior = InvalidValueBehavior.RetainValueAndFocus;
				dataGridItems.DisplayLayout.Bands[0].Columns["Vehicle No"].Style = Infragistics.Win.UltraWinGrid.ColumnStyle.DropDownValidate;
				dataGridItems.DisplayLayout.Bands[0].Columns["Vehicle No"].ValueList = vehicleComboBox;
				dataGridItems.DisplayLayout.Bands[0].Columns["Vehicle No"].Header.Caption = "Vehicle No";
				dataGridItems.DisplayLayout.Bands[0].Columns["Driver"].CharacterCasing = CharacterCasing.Upper;
				dataGridItems.DisplayLayout.Bands[0].Columns["Driver"].MaxLength = 15;
				dataGridItems.DisplayLayout.Bands[0].Columns["Driver"].InvalidValueBehavior = InvalidValueBehavior.RetainValueAndFocus;
				dataGridItems.DisplayLayout.Bands[0].Columns["Driver"].Style = Infragistics.Win.UltraWinGrid.ColumnStyle.DropDownValidate;
				dataGridItems.DisplayLayout.Bands[0].Columns["Driver"].ValueList = driverComboBox1;
				dataGridItems.DisplayLayout.Bands[0].Columns["Driver"].Header.Caption = "Driver";
				dataGridItems.DisplayLayout.Bands[0].Columns["Remarks"].CellMultiLine = DefaultableBoolean.True;
				dataGridItems.DisplayLayout.Bands[0].Columns["Purpose"].CellMultiLine = DefaultableBoolean.True;
				new EditorWithMask().SpinButtonDisplayStyle = SpinButtonDisplayStyle.OnRight;
				dataGridItems.DisplayLayout.Bands[0].Columns["Time"].Format = "hh:mm tt";
				dataGridItems.DisplayLayout.Bands[0].Columns["Time"].CellAppearance.TextHAlign = HAlign.Center;
		...
		public void LoadData(string voucherID)
		{
			try
			{
				...
				{
					currentData = Factory.VehicleMileageTrackSystem.GetVehicleMileageTrackByID(SystemDocID, voucherID);
					if (currentData != null)
					{
						FillData();
						IsNewRecord = false;
		...
		private bool SaveData(bool clearAfter)
		{
			...
			try
			{
				bool flag = Factory.VehicleMileageTrackSystem.CreateVehicleMileageTrack(currentData, !isNewRecord);
				if (!flag)
				{
		...
		public void ShowForApproval(string sysDocID, string voucherID, int approvalTaskID)
		{
			...
			formManager.ShowApprovalPanel(approvalTaskID, "Vehicle_Mileage_Track", "VoucherID");
		}
		...
		private void ClearForm()
		{
			try
			{
				...
				checkBoxDatewise.Checked = false;
		...
		private bool Delete()
		{
			try
			{
				...
				return Factory.VehicleMileageTrackSystem.DeleteVehicleMileageTrack(textBoxVoucherNumber.Text);
			}
			catch (Exception e)
			{
				ErrorHelper.ProcessError(e);
		...
		{
			string nextID = DatabaseHelper.GetNextID("Vehicle_Mileage_Track", "VoucherID", textBoxVoucherNumber.Text, "SysDocID", SystemDocID);
			if (!(nextID == ""))
			{
				LoadData(nextID);
			}
		...
		{
			string previousID = DatabaseHelper.GetPreviousID("Vehicle_Mileage_Track", "VoucherID", textBoxVoucherNumber.Text, "SysDocID", SystemDocID);
			if (!(previousID == ""))
			{
				LoadData(previousID);
			}
		...
		{
			string lastID = DatabaseHelper.GetLastID("Vehicle_Mileage_Track", "VoucherID", "SysDocID", SystemDocID);
			if (!(lastID == ""))
			{
				LoadData(lastID);
			}
		...
		{
			string firstID = DatabaseHelper.GetFirstID("Vehicle_Mileage_Track", "VoucherID", "SysDocID", SystemDocID);
			if (!(firstID == ""))
			{
				LoadData(firstID);
			}
		...
		private void toolStripButtonFind_Click(object sender, EventArgs e)
		{
			try
			{
				...
				{
					string text = Factory.DatabaseSystem.FindDocumentByNumber("Vehicle_Mileage_Track", "VoucherID", SystemDocID, toolStripTextBoxFind.Text);
					if (text != "")
					{
						LoadData(text);
					}
		...
		private void JournalLeavesForm_Load(object sender, EventArgs e)
		{
			try
			{
				...
				dateTimePickerDate.Value = DateTime.Now;
				comboBoxSysDoc.FilterByType(SysDocTypes.VehicleMileageTrack);
				SetSecurity();
				if (!base.IsDisposed)
				{
					IsNewRecord = true;
		...
		private void Print(bool isPrint, bool showPrintDialog, bool saveChanges)
		{
			try
			{
				if (!(IsDirty && saveChanges) || (ErrorHelper.QuestionMessage(MessageBoxButtons.YesNo, "You must save the document before printing.", "Do you want to save?") == DialogResult.Yes && SaveData(clearAfter: false)))
				{
					...
					DataSet vehicleMileageTrackToPrint = Factory.VehicleMileageTrackSystem.GetVehicleMileageTrackToPrint(selectedID, text);
					if (vehicleMileageTrackToPrint == null || vehicleMileageTrackToPrint.Tables.Count == 0)
					{
					...
					else
					{
						...
						{
							PrintHelper.PrintDocument(vehicleMileageTrackToPrint, selectedID, printTemplateName, SysDocTypes.VehicleMileageTrack, isPrint, showPrintDialog);
						}
						else
						{
							PrintHelper.PrintDocument(vehicleMileageTrackToPrint, selectedID, "Vehicle Mileage Track", SysDocTypes.VehicleMileageTrack, isPrint, showPrintDialog);
						}
					}
				}
			}
		...
		private void checkBoxDatewise_CheckedChanged(object sender, EventArgs e)
		{
			...
			{
				VehicleNumberLinkLabel.Visible = checkBoxDatewise.Checked;
				vehicleComboBox.Visible = checkBoxDatewise.Checked;
				textboxVehicleName.Visible = checkBoxDatewise.Checked;
				dataGridItems.DisplayLayout.Bands[0].Columns["Vehicle No"].Hidden = checkBoxDatewise.Checked;
				loadAllVehicleToolStripMenuItem.Visible = false;
			}
			else
			{
				VehicleNumberLinkLabel.Visible = checkBoxDatewise.Checked;
				...
				textboxVehicleName.Visible = checkBoxDatewise.Checked;
				dataGridItems.DisplayLayout.Bands[0].Columns["Vehicle No"].Hidden = checkBoxDatewise.Checked;
				loadAllVehicleToolStripMenuItem.Visible = true;
			}
		}
		...
		{
			FormActivator.BringFormToFront(FormActivator.VehicleMileageTrackListFormObj);
		}
		...
		{
			new FormHelper().EditSysDoc(comboBoxSysDoc.SelectedID, SysDocTypes.VehicleMileageTrack);
		}
		...
		private void VehicleNumberLinkLabel_LinkClicked(object sender, Infragistics.Win.FormattedLinkLabel.LinkClickedEventArgs e)
		{
			new FormHelper().EditVehicle(vehicleComboBox.SelectedID);
		}
		...
		private void loadAllVehicleToolStripMenuItem_Click(object sender, EventArgs e)
		{
			setupDesignVehicleSelector();
		}

		private void setupDesignVehicleSelector()
		{
			vehicleObj = new VehicleSelector();
			vehicleObj.BackColor = Color.Transparent;
			vehicleObj.CustomReportFieldName = "";
			vehicleObj.CustomReportKey = "";
			vehicleObj.CustomReportValueType = 1;
			vehicleObj.Location = new Point(6, 15);
			vehicleObj.Name = "VehicleSelector";
			vehicleObj.Size = new Size(430, 48);
			vehicleObj.TabIndex = 0;
			GroupBox groupBox = new GroupBox();
			groupBox.Controls.Add(vehicleObj);
			groupBox.Location = new Point(2, 12);
			groupBox.Name = "groupBoxCC";
			groupBox.Size = new Size(453, 69);
			groupBox.TabIndex = 10;
			groupBox.TabStop = false;
			groupBox.Text = "Vehicle";
			Button button = new Button();
			button.Anchor = (AnchorStyles.Bottom | AnchorStyles.Right);
			button.Location = new Point(249, 120);
			...
			vehiclFormObj = new Form();
			vehiclFormObj.Size = new Size(481, 190);
			vehiclFormObj.Controls.Add(button);
			vehiclFormObj.Controls.Add(button2);
			vehiclFormObj.Controls.Add(groupBox);
			ComponentResourceManager componentResourceManager = new ComponentResourceManager(typeof(VehicleMileageTrackForm));
			vehiclFormObj.Icon = (Icon)componentResourceManager.GetObject("$this.Icon");
			vehiclFormObj.Text = "Select Vehicle";
			vehiclFormObj.ShowDialog();
		}

		private void buttonOK_Click(object sender, EventArgs e)
		{
			DataSet dataSet = new DataSet();
			dataSet = Factory.VehicleSystem.GetVehicleList(vehicleObj.FromVehicle, vehicleObj.ToVehicle);
			FillDataVehicle(dataSet);
			vehiclFormObj.Close();
		}

		private void FillDataVehicle(DataSet dt)
		{
			DataTable dataTable = dataGridItems.DataSource as DataTable;
			dataTable.Rows.Clear();
			if (dt.Tables.Contains("Vehicle") && dt.Tables["Vehicle"].Rows.Count != 0)
			{
				dataGridItems.BeginUpdate();
				foreach (DataRow row in dt.Tables["Vehicle"].Rows)
				{
					DataRow dataRow2 = dataTable.NewRow();
					if (row["VehicleID"] != DBNull.Value)
					{
						dataRow2["Vehicle No"] = row["VehicleID"];
					}
					if (row["VehicleName"] != DBNull.Value)
					{
						dataRow2["Name"] = row["VehicleName"];
					}
					dataRow2.EndEdit();
					dataTable.Rows.Add(dataRow2);
				}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Projects.VehicleMileageTrackForm));
			...
			loadAllVehicleToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			...
			VehicleNumberLinkLabel = new Infragistics.Win.FormattedLinkLabel.UltraFormattedLinkLabel();
			ultraFormattedLinkLabel5 = new Infragistics.Win.FormattedLinkLabel.UltraFormattedLinkLabel();
			vehicleComboBox = new Micromind.DataControls.VehicleComboBox();
			...
			((System.ComponentModel.ISupportInitialize)vehicleComboBox).BeginInit();
			...
			toolStrip1.Size = new System.Drawing.Size(1172, 31);
			...
			toolStripDropDownButton1.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[2]
			{
				...
				loadAllVehicleToolStripMenuItem
			});
			...
			loadAllVehicleToolStripMenuItem.Name = "loadAllVehicleToolStripMenuItem";
			loadAllVehicleToolStripMenuItem.Size = new System.Drawing.Size(157, 22);
			loadAllVehicleToolStripMenuItem.Text = "Load All Vehicle";
			loadAllVehicleToolStripMenuItem.Click += new System.EventHandler(loadAllVehicleToolStripMenuItem_Click);
			...
			panelButtons.Size = new System.Drawing.Size(1172, 40);
			...
			linePanelDown.Size = new System.Drawing.Size(1172, 1);
			...
			xpButton1.Location = new System.Drawing.Point(1062, 8);
			...
			dateTimePickerDate.Location = new System.Drawing.Point(52, 2);
			dateTimePickerDate.Name = "dateTimePickerDate";
			dateTimePickerDate.Size = new System.Drawing.Size(139, 20);
			dateTimePickerDate.TabIndex = 3;
			textBoxVoucherNumber.Location = new System.Drawing.Point(360, 4);
			...
			textBoxNote.Location = new System.Drawing.Point(49, 437);
			textBoxNote.MaxLength = 4000;
			textBoxNote.Multiline = true;
			textBoxNote.Name = "textBoxNote";
			textBoxNote.ScrollBars = System.Windows.Forms.ScrollBars.Vertical;
			textBoxNote.Size = new System.Drawing.Size(652, 45);
			...
			label3.TabIndex = 20;
			label3.Text = "Note:";
			panelDetails.Controls.Add(textboxVehicleName);
			panelDetails.Controls.Add(VehicleNumberLinkLabel);
			panelDetails.Controls.Add(ultraFormattedLinkLabel5);
			panelDetails.Controls.Add(vehicleComboBox);
			...
			textboxVehicleName.Location = new System.Drawing.Point(255, 27);
			textboxVehicleName.MaxLength = 64;
			textboxVehicleName.Name = "textboxVehicleName";
			textboxVehicleName.ReadOnly = true;
			textboxVehicleName.Size = new System.Drawing.Size(352, 20);
			textboxVehicleName.TabIndex = 138;
			textboxVehicleName.TabStop = false;
			textboxVehicleName.Visible = false;
			appearance.FontData.BoldAsString = "True";
			appearance.FontData.Name = "Tahoma";
			VehicleNumberLinkLabel.Appearance = appearance;
			VehicleNumberLinkLabel.AutoSize = true;
			VehicleNumberLinkLabel.Location = new System.Drawing.Point(11, 30);
			VehicleNumberLinkLabel.Name = "VehicleNumberLinkLabel";
			VehicleNumberLinkLabel.Size = new System.Drawing.Size(96, 15);
			VehicleNumberLinkLabel.TabIndex = 129;
			VehicleNumberLinkLabel.TabStop = true;
			VehicleNumberLinkLabel.TreatValueAs = Infragistics.Win.FormattedLinkLabel.TreatValueAs.URL;
			VehicleNumberLinkLabel.UnderlineLinks = Infragistics.Win.FormattedLinkLabel.UnderlineLink.WhenHovered;
			VehicleNumberLinkLabel.Value = "Vehicle Number:";
			VehicleNumberLinkLabel.Visible = false;
			appearance2.ForeColor = System.Drawing.Color.Blue;
			VehicleNumberLinkLabel.VisitedLinkAppearance = appearance2;
			VehicleNumberLinkLabel.LinkClicked += new Infragistics.Win.FormattedLinkLabel.LinkClickedEventHandler(VehicleNumberLinkLabel_LinkClicked);
			...
			vehicleComboBox.Assigned = false;
			vehicleComboBox.AutoCompleteMode = Infragistics.Win.AutoCompleteMode.Append;
			vehicleComboBox.CalcManager = ultraCalcManager1;
			vehicleComboBox.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper;
			vehicleComboBox.CustomReportFieldName = "";
			vehicleComboBox.CustomReportKey = "";
			vehicleComboBox.CustomReportValueType = 1;
			vehicleComboBox.DescriptionTextBox = null;
			appearance5.BackColor = System.Drawing.SystemColors.Window;
			appearance5.BorderColor = System.Drawing.SystemColors.InactiveCaption;
			vehicleComboBox.DisplayLayout.Appearance = appearance5;
			vehicleComboBox.DisplayLayout.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid;
			vehicleComboBox.DisplayLayout.CaptionVisible = Infragistics.Win.DefaultableBoolean.False;
			appearance6.BackColor = System.Drawing.SystemColors.ActiveBorder;
			appearance6.BackColor2 = System.Drawing.SystemColors.ControlDark;
			appearance6.BackGradientStyle = Infragistics.Win.GradientStyle.Vertical;
			appearance6.BorderColor = System.Drawing.SystemColors.Window;
			vehicleComboBox.DisplayLayout.GroupByBox.Appearance = appearance6;
			appearance7.ForeColor = System.Drawing.SystemColors.GrayText;
			vehicleComboBox.DisplayLayout.GroupByBox.BandLabelAppearance = appearance7;
			vehicleComboBox.DisplayLayout.GroupByBox.BorderStyle = Infragistics.Win.UIElementBorderStyle.Solid;
			appearance8.BackColor = System.Drawing.SystemColors.ControlLightLight;
			appearance8.BackColor2 = System.Drawing.SystemColors.Control;
			appearance8.BackGradientStyle = Infragistics.Win.GradientStyle.Horizontal;
			appearance8.ForeColor = System.Drawing.SystemColors.GrayText;
			vehicleComboBox.DisplayLayout.GroupByBox.PromptAppearance = appearance8;
			vehicleComboBox.DisplayLayout.MaxColScrollRegions = 1;
			vehicleComboBox.DisplayLayout.MaxRowScrollRegions = 1;
			appearance9.BackColor = System.Drawing.SystemColors.Window;
			appearance9.ForeColor = System.Drawing.SystemColors.ControlText;
			vehicleComboBox.DisplayLayout.Override.ActiveCellAppearance = appearance9;
			appearance10.BackColor = System.Drawing.SystemColors.Highlight;
			appearance10.ForeColor = System.Drawing.SystemColors.HighlightText;
			vehicleComboBox.DisplayLayout.Override.ActiveRowAppearance = appearance10;
			vehicleComboBox.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.Dotted;
			vehicleComboBox.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.Dotted;
			appearance11.BackColor = System.Drawing.SystemColors.Window;
			vehicleComboBox.DisplayLayout.Override.CardAreaAppearance = appearance11;
			appearance12.BorderColor = System.Drawing.Color.Silver;
			appearance12.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			vehicleComboBox.DisplayLayout.Override.CellAppearance = appearance12;
			vehicleComboBox.DisplayLayout.Override.CellClickAction = Infragistics.Win.UltraWinGrid.CellClickAction.EditAndSelectText;
			vehicleComboBox.DisplayLayout.Override.CellPadding = 0;
			appearance13.BackColor = System.Drawing.SystemColors.Control;
			appearance13.BackColor2 = System.Drawing.SystemColors.ControlDark;
			appearance13.BackGradientAlignment = Infragistics.Win.GradientAlignment.Element;
			appearance13.BackGradientStyle = Infragistics.Win.GradientStyle.Horizontal;
			appearance13.BorderColor = System.Drawing.SystemColors.Window;
			vehicleComboBox.DisplayLayout.Override.GroupByRowAppearance = appearance13;
			appearance14.TextHAlignAsString = "Left";
			vehicleComboBox.DisplayLayout.Override.HeaderAppearance = appearance14;
			vehicleComboBox.DisplayLayout.Override.HeaderClickAction = Infragistics.Win.UltraWinGrid.HeaderClickAction.SortMulti;
			vehicleComboBox.DisplayLayout.Override.HeaderStyle = Infragistics.Win.HeaderStyle.WindowsXPCommand;
			appearance15.BackColor = System.Drawing.SystemColors.Window;
			appearance15.BorderColor = System.Drawing.Color.Silver;
			vehicleComboBox.DisplayLayout.Override.RowAppearance = appearance15;
			vehicleComboBox.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance16.BackColor = System.Drawing.SystemColors.ControlLight;
			vehicleComboBox.DisplayLayout.Override.TemplateAddRowAppearance = appearance16;
			vehicleComboBox.DisplayLayout.ScrollBounds = Infragistics.Win.UltraWinGrid.ScrollBounds.ScrollToFill;
			vehicleComboBox.DisplayLayout.ScrollStyle = Infragistics.Win.UltraWinGrid.ScrollStyle.Immediate;
			vehicleComboBox.DisplayLayout.ViewStyleBand = Infragistics.Win.UltraWinGrid.ViewStyleBand.OutlookGroupBy;
			vehicleComboBox.DropDownSearchMethod = Infragistics.Win.UltraWinGrid.DropDownSearchMethod.Linear;
			vehicleComboBox.Editable = true;
			vehicleComboBox.FilterString = "";
			vehicleComboBox.HasAllAccount = false;
			vehicleComboBox.HasCustom = false;
			vehicleComboBox.IsDataLoaded = false;
			vehicleComboBox.Location = new System.Drawing.Point(110, 27);
			vehicleComboBox.MaxDropDownItems = 12;
			vehicleComboBox.Name = "vehicleComboBox";
			vehicleComboBox.ShowInactiveItems = false;
			vehicleComboBox.ShowQuickAdd = true;
			vehicleComboBox.Size = new System.Drawing.Size(139, 20);
			vehicleComboBox.TabIndex = 5;
			vehicleComboBox.UseFlatMode = Infragistics.Win.DefaultableBoolean.True;
			vehicleComboBox.Visible = false;
			vehicleComboBox.SelectedIndexChanged += new System.EventHandler(vehicleComboBox_SelectedIndexChanged);
			...
			linkLabelVoucherNumber.Appearance = appearance29;
			linkLabelVoucherNumber.AutoSize = true;
			linkLabelVoucherNumber.Location = new System.Drawing.Point(255, 7);
			...
			linkLabelVoucherNumber.VisitedLinkAppearance = appearance30;
			...
			checkBoxDatewise.Location = new System.Drawing.Point(707, 7);
			checkBoxDatewise.Name = "checkBoxDatewise";
			checkBoxDatewise.Size = new System.Drawing.Size(82, 17);
			checkBoxDatewise.TabIndex = 4;
			checkBoxDatewise.Text = "Vehiclewise";
			...
			panelDate.Location = new System.Drawing.Point(502, 2);
			panelDate.Name = "panelDate";
			panelDate.Size = new System.Drawing.Size(199, 24);
			...
			labelVoided.Size = new System.Drawing.Size(1138, 20);
			...
			driverComboBox1.DisplayLayout.Appearance = appearance43;
			...
			driverComboBox1.DisplayLayout.GroupByBox.Appearance = appearance44;
			appearance45.ForeColor = System.Drawing.SystemColors.GrayText;
			driverComboBox1.DisplayLayout.GroupByBox.BandLabelAppearance = appearance45;
			...
			driverComboBox1.DisplayLayout.GroupByBox.PromptAppearance = appearance46;
			...
			driverComboBox1.DisplayLayout.Override.ActiveCellAppearance = appearance47;
			...
			driverComboBox1.DisplayLayout.Override.ActiveRowAppearance = appearance48;
			...
			driverComboBox1.DisplayLayout.Override.CardAreaAppearance = appearance49;
			appearance50.BorderColor = System.Drawing.Color.Silver;
			appearance50.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			driverComboBox1.DisplayLayout.Override.CellAppearance = appearance50;
			...
			driverComboBox1.DisplayLayout.Override.GroupByRowAppearance = appearance51;
			appearance52.TextHAlignAsString = "Left";
			driverComboBox1.DisplayLayout.Override.HeaderAppearance = appearance52;
			...
			driverComboBox1.DisplayLayout.Override.RowAppearance = appearance53;
			...
			driverComboBox1.DisplayLayout.Override.TemplateAddRowAppearance = appearance54;
			...
			comboBoxMonth.Location = new System.Drawing.Point(844, 36);
			comboBoxMonth.Name = "comboBoxMonth";
			comboBoxMonth.Size = new System.Drawing.Size(10, 21);
			...
			dataGridItems.Location = new System.Drawing.Point(11, 86);
			...
			dataGridItems.Size = new System.Drawing.Size(1139, 347);
			...
			comboBoxPayrolItem.DisplayLayout.Appearance = appearance67;
			...
			comboBoxPayrolItem.DisplayLayout.GroupByBox.Appearance = appearance68;
			appearance69.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxPayrolItem.DisplayLayout.GroupByBox.BandLabelAppearance = appearance69;
			...
			comboBoxPayrolItem.DisplayLayout.GroupByBox.PromptAppearance = appearance70;
			...
			comboBoxPayrolItem.DisplayLayout.Override.ActiveCellAppearance = appearance71;
			...
			comboBoxPayrolItem.DisplayLayout.Override.ActiveRowAppearance = appearance72;
			...
			comboBoxPayrolItem.DisplayLayout.Override.CardAreaAppearance = appearance73;
			...
			comboBoxPayrolItem.DisplayLayout.Override.CellAppearance = appearance74;
			...
			comboBoxPayrolItem.DisplayLayout.Override.GroupByRowAppearance = appearance75;
			appearance76.TextHAlignAsString = "Left";
			comboBoxPayrolItem.DisplayLayout.Override.HeaderAppearance = appearance76;
			...
			comboBoxPayrolItem.DisplayLayout.Override.RowAppearance = appearance77;
			...
			comboBoxPayrolItem.DisplayLayout.Override.TemplateAddRowAppearance = appearance78;
			...
			comboBoxOverTime.DisplayLayout.Appearance = appearance79;
			...
			comboBoxOverTime.DisplayLayout.GroupByBox.Appearance = appearance80;
			appearance81.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxOverTime.DisplayLayout.GroupByBox.BandLabelAppearance = appearance81;
			...
			comboBoxOverTime.DisplayLayout.GroupByBox.PromptAppearance = appearance82;
			...
			comboBoxOverTime.DisplayLayout.Override.ActiveCellAppearance = appearance83;
			...
			comboBoxOverTime.DisplayLayout.Override.ActiveRowAppearance = appearance84;
			...
			comboBoxOverTime.DisplayLayout.Override.CardAreaAppearance = appearance85;
			...
			comboBoxOverTime.DisplayLayout.Override.CellAppearance = appearance86;
			...
			comboBoxOverTime.DisplayLayout.Override.GroupByRowAppearance = appearance87;
			appearance88.TextHAlignAsString = "Left";
			comboBoxOverTime.DisplayLayout.Override.HeaderAppearance = appearance88;
			...
			comboBoxOverTime.DisplayLayout.Override.RowAppearance = appearance89;
			...
			comboBoxOverTime.DisplayLayout.Override.TemplateAddRowAppearance = appearance90;
			...
			comboBoxGridEmployee.DisplayLayout.Appearance = appearance91;
			...
			comboBoxGridEmployee.DisplayLayout.GroupByBox.Appearance = appearance92;
			appearance93.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxGridEmployee.DisplayLayout.GroupByBox.BandLabelAppearance = appearance93;
			...
			comboBoxGridEmployee.DisplayLayout.GroupByBox.PromptAppearance = appearance94;
			...
			comboBoxGridEmployee.DisplayLayout.Override.ActiveCellAppearance = appearance95;
			...
			comboBoxGridEmployee.DisplayLayout.Override.ActiveRowAppearance = appearance96;
			...
			comboBoxGridEmployee.DisplayLayout.Override.CardAreaAppearance = appearance97;
			...
			comboBoxGridEmployee.DisplayLayout.Override.CellAppearance = appearance98;
			...
			comboBoxGridEmployee.DisplayLayout.Override.GroupByRowAppearance = appearance99;
			appearance100.TextHAlignAsString = "Left";
			comboBoxGridEmployee.DisplayLayout.Override.HeaderAppearance = appearance100;
			...
			comboBoxGridEmployee.DisplayLayout.Override.RowAppearance = appearance101;
			...
			comboBoxGridEmployee.DisplayLayout.Override.TemplateAddRowAppearance = appearance102;
			...
			comboBoxLocation.DisplayLayout.Appearance = appearance103;
			...
			comboBoxLocation.DisplayLayout.GroupByBox.Appearance = appearance104;
			appearance105.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxLocation.DisplayLayout.GroupByBox.BandLabelAppearance = appearance105;
			...
			comboBoxLocation.DisplayLayout.GroupByBox.PromptAppearance = appearance106;
			...
			comboBoxLocation.DisplayLayout.Override.ActiveCellAppearance = appearance107;
			...
			comboBoxLocation.DisplayLayout.Override.ActiveRowAppearance = appearance108;
			...
			comboBoxLocation.DisplayLayout.Override.CardAreaAppearance = appearance109;
			...
			comboBoxLocation.DisplayLayout.Override.CellAppearance = appearance110;
			...
			comboBoxLocation.DisplayLayout.Override.GroupByRowAppearance = appearance111;
			appearance112.TextHAlignAsString = "Left";
			comboBoxLocation.DisplayLayout.Override.HeaderAppearance = appearance112;
			...
			comboBoxLocation.DisplayLayout.Override.RowAppearance = appearance113;
			...
			comboBoxLocation.DisplayLayout.Override.TemplateAddRowAppearance = appearance114;
			...
			jobComboBox1.DisplayLayout.Appearance = appearance115;
			...
			jobComboBox1.DisplayLayout.GroupByBox.Appearance = appearance116;
			appearance117.ForeColor = System.Drawing.SystemColors.GrayText;
			jobComboBox1.DisplayLayout.GroupByBox.BandLabelAppearance = appearance117;
			...
			jobComboBox1.DisplayLayout.GroupByBox.PromptAppearance = appearance118;
			...
			jobComboBox1.DisplayLayout.Override.ActiveCellAppearance = appearance119;
			...
			jobComboBox1.DisplayLayout.Override.ActiveRowAppearance = appearance120;
			...
			jobComboBox1.DisplayLayout.Override.CardAreaAppearance = appearance121;
			...
			jobComboBox1.DisplayLayout.Override.CellAppearance = appearance122;
			...
			jobComboBox1.DisplayLayout.Override.GroupByRowAppearance = appearance123;
			appearance124.TextHAlignAsString = "Left";
			jobComboBox1.DisplayLayout.Override.HeaderAppearance = appearance124;
			...
			jobComboBox1.DisplayLayout.Override.RowAppearance = appearance125;
			...
			jobComboBox1.DisplayLayout.Override.TemplateAddRowAppearance = appearance126;
			...
			base.ClientSize = new System.Drawing.Size(1172, 528);
			...
			base.Name = "VehicleMileageTrackForm";
			Text = "Vehicle Mileage Track";
			...
			((System.ComponentModel.ISupportInitialize)vehicleComboBox).EndInit();
