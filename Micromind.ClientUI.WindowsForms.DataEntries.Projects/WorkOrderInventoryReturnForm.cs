...
{
	public class WorkOrderInventoryReturnForm : Form, IForm
	{
		private bool supressInventoryMessage;

		private WorkOrderInventoryReturnData currentData;

		private const string TABLENAME_CONST = "EA_WorkOrder_Inventory_Return";
		...
		public WorkOrderInventoryReturnForm()
		{
			InitializeComponent();
			AddEvents();
			checked
		...
		private bool GetData()
		{
			try
			{
				...
				{
					currentData = new WorkOrderInventoryReturnData();
				}
				DataRow dataRow = (!isNewRecord) ? currentData.WorkOrderInventoryReturnTable.Rows[0] : currentData.WorkOrderInventoryReturnTable.NewRow();
				...
				if (IsNewRecord)
				{
					currentData.WorkOrderInventoryReturnTable.Rows.Add(dataRow);
				}
				currentData.WorkOrderInventoryReturnDetailTable.Rows.Clear();
				foreach (UltraGridRow row in dataGridItems.Rows)
				{
					DataRow dataRow2 = currentData.WorkOrderInventoryReturnDetailTable.NewRow();
					dataRow2.BeginEdit();
					...
					dataRow2.EndEdit();
					currentData.WorkOrderInventoryReturnDetailTable.Rows.Add(dataRow2);
				}
				return true;
			}
			catch (Exception e)
		...
		public void LoadData(string voucherID)
		{
			try
			{
				...
				{
					currentData = Factory.WorkOrderInventoryReturnSystem.GetWorkOrderInventoryReturnByID(SystemDocID, voucherID);
					if (currentData != null)
					{
						FillData();
						IsNewRecord = false;
		...
		private void FillData()
		{
			try
			{
				...
				{
					DataRow dataRow = currentData.Tables["EA_WorkOrder_Inventory_Return"].Rows[0];
					...
					if (currentData.Tables.Contains("EA_WorkOrder_Inventory_Return_Detail") && currentData.WorkOrderInventoryReturnDetailTable.Rows.Count != 0)
					{
						dataGridItems.BeginUpdate();
						foreach (DataRow row in currentData.Tables["EA_WorkOrder_Inventory_Return_Detail"].Rows)
						{
		...
		private bool SaveData(bool clearAfter)
		{
			...
			try
			{
				bool flag = Factory.WorkOrderInventoryReturnSystem.CreateWorkOrderInventoryReturn(currentData, !isNewRecord);
				if (!flag)
				{
		...
		{
			if (!IsNewRecord && !Global.IsUserAdmin && !AllowEditTransaction && Global.CurrentUser != Factory.SystemDocumentSystem.GetTransUserID("EA_WorkOrder_Inventory_Return", "VoucherID", SystemDocID, textBoxVoucherNumber.Text))
			{
			...
			checked
			{
				...
				if (formManager.IsFieldDirty(textBoxVoucherNumber) && Factory.SystemDocumentSystem.ExistDocumentNumber("EA_WorkOrder_Inventory_Return", "VoucherID", SystemDocID, textBoxVoucherNumber.Text))
				{
					ErrorHelper.WarningMessage(UIMessages.DocumentNumberInUse);
		...
		private bool Delete()
		{
			try
			{
				...
				return Factory.WorkOrderInventoryReturnSystem.DeleteWorkOrderInventoryReturn(SystemDocID, textBoxVoucherNumber.Text);
			}
			catch (Exception e)
			{
				ErrorHelper.ProcessError(e);
		...
		{
			string nextID = DatabaseHelper.GetNextID("EA_WorkOrder_Inventory_Return", "VoucherID", textBoxVoucherNumber.Text, "SysDocID", SystemDocID);
			if (!(nextID == ""))
			{
				LoadData(nextID);
			}
		...
		{
			string previousID = DatabaseHelper.GetPreviousID("EA_WorkOrder_Inventory_Return", "VoucherID", textBoxVoucherNumber.Text, "SysDocID", SystemDocID);
			if (!(previousID == ""))
			{
				LoadData(previousID);
			}
		...
		{
			string lastID = DatabaseHelper.GetLastID("EA_WorkOrder_Inventory_Return", "VoucherID", "SysDocID", SystemDocID);
			if (!(lastID == ""))
			{
				LoadData(lastID);
			}
		...
		{
			string firstID = DatabaseHelper.GetFirstID("EA_WorkOrder_Inventory_Return", "VoucherID", "SysDocID", SystemDocID);
			if (!(firstID == ""))
			{
				LoadData(firstID);
			}
		...
		private void toolStripButtonFind_Click(object sender, EventArgs e)
		{
			try
			{
				...
				{
					string text = Factory.DatabaseSystem.FindDocumentByNumber("EA_WorkOrder_Inventory_Return", "VoucherID", SystemDocID, toolStripTextBoxFind.Text);
					if (text != "")
					{
						LoadData(text);
					}
		...
		private void JournalLeavesForm_Load(object sender, EventArgs e)
		{
			try
			{
				...
				SetupGrid();
				comboBoxSysDoc.FilterByType(SysDocTypes.WorkOrderInventoryReturn);
				dateTimePickerDate.Value = DateTime.Now;
				SetSecurity();
				if (!base.IsDisposed)
				{
		...
		{
			new FormHelper().EditSysDoc(comboBoxSysDoc.SelectedID, SysDocTypes.WorkOrderInventoryReturn);
		}
		...
		private bool SaveDraft()
		{
			try
			{
				if (GetData())
				{
					...
					{
						return Global.CompanySettings.SaveTransactionDraft(currentData, enterNameDialog.EnteredName, SysDocTypes.WorkOrderInventoryReturn);
					}
				}
				return false;
			}
		...
		private bool LoadDraft()
		{
			try
			{
				DataSet settingsList = Factory.SettingSystem.GetSettingsList("", 230.ToString());
				...
				if (selectDocumentDialog.ShowDialog(this) == DialogResult.OK)
				{
					...
					DataSet dataSet = Global.CompanySettings.LoadTransactionDraft(key, SysDocTypes.WorkOrderInventoryReturn);
					currentData = (dataSet as WorkOrderInventoryReturnData);
					FillData();
				}
				return true;
			}
		...
		private void Print(bool isPrint, bool showPrintDialog, bool saveChanges)
		{
			try
			{
				if (!(IsDirty && saveChanges) || (ErrorHelper.QuestionMessage(MessageBoxButtons.YesNo, "You must save the document before printing.", "Do you want to save?") == DialogResult.Yes && SaveData(clearAfter: false)))
				{
					...
					{
						DataSet workOrderInventoryReturnToPrint = Factory.WorkOrderInventoryReturnSystem.GetWorkOrderInventoryReturnToPrint(selectedID, text);
						if (workOrderInventoryReturnToPrint == null || workOrderInventoryReturnToPrint.Tables.Count == 0)
						{
							ErrorHelper.ErrorMessage("Cannot print the document.", "Document not found.");
						}
						else
						{
							PrintHelper.PrintDocument(workOrderInventoryReturnToPrint, selectedID, "Work Order Inventory Return", SysDocTypes.WorkOrderInventoryReturn, isPrint, showPrintDialog);
						}
					}
				}
			}
		...
		{
			FormActivator.BringFormToFront(FormActivator.WorkOrderInventoryReturnListFormObj);
		}
		...
		private void createFromWorkOrderToolStripMenuItem_Click(object sender, EventArgs e)
		{
			if (!IsNewRecord)
			{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Projects.WorkOrderInventoryReturnForm));
			...
			label1.Location = new System.Drawing.Point(11, 49);
			label1.Name = "label1";
			label1.Size = new System.Drawing.Size(60, 13);
			label1.TabIndex = 20;
			label1.Text = "Reference:";
			textBoxRef1.Location = new System.Drawing.Point(81, 47);
			textBoxRef1.MaxLength = 30;
			textBoxRef1.Name = "textBoxRef1";
			textBoxRef1.Size = new System.Drawing.Size(146, 20);
			textBoxRef1.TabIndex = 5;
			textBoxNote.Location = new System.Drawing.Point(81, 69);
			textBoxNote.MaxLength = 255;
			textBoxNote.Name = "textBoxNote";
			textBoxNote.Size = new System.Drawing.Size(556, 20);
			textBoxNote.TabIndex = 7;
			label3.AutoSize = true;
			label3.Location = new System.Drawing.Point(11, 72);
			label3.Name = "label3";
			...
			ultraFormattedLinkLabel2.TabIndex = 8;
			...
			panelDetails.Size = new System.Drawing.Size(688, 96);
			...
			buttonSelectDocument.Location = new System.Drawing.Point(228, 24);
			...
			textBoxWorkOrder.Location = new System.Drawing.Point(81, 25);
			textBoxWorkOrder.MaxLength = 255;
			textBoxWorkOrder.Name = "textBoxWorkOrder";
			textBoxWorkOrder.ReadOnly = true;
			textBoxWorkOrder.Size = new System.Drawing.Size(146, 20);
			textBoxWorkOrder.TabIndex = 9;
			...
			label2.Location = new System.Drawing.Point(236, 51);
			label2.Name = "label2";
			label2.Size = new System.Drawing.Size(77, 13);
			label2.TabIndex = 127;
			label2.Text = "Requested By:";
			textBoxRequestedBy.Location = new System.Drawing.Point(315, 47);
			...
			comboBoxSysDoc.Location = new System.Drawing.Point(81, 3);
			...
			dataGridItems.Location = new System.Drawing.Point(11, 133);
			...
			dataGridItems.Size = new System.Drawing.Size(715, 311);
			...
			comboBoxGridProductUnit.DisplayLayout.Appearance = appearance29;
			...
			comboBoxGridProductUnit.DisplayLayout.GroupByBox.Appearance = appearance30;
			appearance31.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxGridProductUnit.DisplayLayout.GroupByBox.BandLabelAppearance = appearance31;
			...
			comboBoxGridProductUnit.DisplayLayout.GroupByBox.PromptAppearance = appearance32;
			...
			comboBoxGridProductUnit.DisplayLayout.Override.ActiveCellAppearance = appearance33;
			appearance34.BackColor = System.Drawing.SystemColors.Highlight;
			appearance34.ForeColor = System.Drawing.SystemColors.HighlightText;
			comboBoxGridProductUnit.DisplayLayout.Override.ActiveRowAppearance = appearance34;
			...
			comboBoxGridProductUnit.DisplayLayout.Override.CardAreaAppearance = appearance35;
			appearance36.BorderColor = System.Drawing.Color.Silver;
			appearance36.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxGridProductUnit.DisplayLayout.Override.CellAppearance = appearance36;
			...
			comboBoxGridProductUnit.DisplayLayout.Override.GroupByRowAppearance = appearance37;
			appearance38.TextHAlignAsString = "Left";
			comboBoxGridProductUnit.DisplayLayout.Override.HeaderAppearance = appearance38;
			...
			comboBoxGridProductUnit.DisplayLayout.Override.RowAppearance = appearance39;
			comboBoxGridProductUnit.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance40.BackColor = System.Drawing.SystemColors.ControlLight;
			comboBoxGridProductUnit.DisplayLayout.Override.TemplateAddRowAppearance = appearance40;
			...
			comboBoxGridItem.DisplayLayout.Appearance = appearance41;
			...
			comboBoxGridItem.DisplayLayout.GroupByBox.Appearance = appearance42;
			appearance43.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxGridItem.DisplayLayout.GroupByBox.BandLabelAppearance = appearance43;
			...
			comboBoxGridItem.DisplayLayout.GroupByBox.PromptAppearance = appearance44;
			...
			comboBoxGridItem.DisplayLayout.Override.ActiveCellAppearance = appearance45;
			...
			comboBoxGridItem.DisplayLayout.Override.ActiveRowAppearance = appearance46;
			...
			comboBoxGridItem.DisplayLayout.Override.CardAreaAppearance = appearance47;
			appearance48.BorderColor = System.Drawing.Color.Silver;
			appearance48.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxGridItem.DisplayLayout.Override.CellAppearance = appearance48;
			...
			comboBoxGridItem.DisplayLayout.Override.GroupByRowAppearance = appearance49;
			appearance50.TextHAlignAsString = "Left";
			comboBoxGridItem.DisplayLayout.Override.HeaderAppearance = appearance50;
			...
			comboBoxGridItem.DisplayLayout.Override.RowAppearance = appearance51;
			...
			comboBoxGridItem.DisplayLayout.Override.TemplateAddRowAppearance = appearance52;
			...
			base.Name = "WorkOrderInventoryReturnForm";
			Text = "Work Order Inventory Return";
