...
{
	public class JobExpenseIssueForm : Form, IForm
	{
		private bool supressExpenseMessage;

		private JobExpenseIssueData currentData;

		private const string TABLENAME_CONST = "Job_Expense_Issue";
		...
		public JobExpenseIssueForm()
		{
			InitializeComponent();
			AddEvents();
			comboBoxGridExpenseCode.ExpenseCodeType = ExpenseCodeTypes.Project;
			checked
			{
				int num;
		...
		private void AddEvents()
		{
			...
			comboBoxGridExpenseCode.SelectedIndexChanged += comboBoxGridExpenseCode_SelectedIndexChanged;
		...
		private void dataGridItems_BeforeRowUpdate(object sender, CancelableRowEventArgs e)
		{
			...
			if (activeRow != null && activeRow.Cells["ExpenseID"].Value != null)
			{
				_ = (activeRow.Cells["ExpenseID"].Value.ToString() == "");
			}
		}
		...
		private void dataGridItems_AfterCellUpdate(object sender, CellEventArgs e)
		{
			try
			{
				...
				{
					if (e.Cell.Column.Key == "ExpenseID")
					{
						dataGridItems.ActiveRow.Cells["Description"].Value = comboBoxGridExpenseCode.SelectedName;
						dataGridItems.ActiveRow.Cells["Price"].Value = comboBoxGridExpenseCode.ExpenseRate;
		...
		{
			if (dataGridItems.ActiveRow != null && dataGridItems.ActiveCell.Column.Key == "ExpenseID" && dataGridItems.ActiveRow.Cells["ExpenseID"].Value.ToString() == "")
			{
		...
		private void dataGrid_BeforeRowDeactivate(object sender, CancelEventArgs e)
		{
			...
			if (activeRow != null)
			{
				if (activeRow.Cells["ExpenseID"].Value.ToString() == "")
				{
					ErrorHelper.InformationMessage("Please select an item.");
					e.Cancel = true;
					activeRow.Cells["ExpenseID"].Activate();
				}
		...
		{
			if (dataGridItems.ActiveCell.Column.Key.ToString() == "ExpenseID")
			{
				e.RaiseErrorEvent = false;
				comboBoxGridExpenseCode.Text = dataGridItems.ActiveCell.Text;
				comboBoxGridExpenseCode.QuickAddItem();
			}
			...
			else if (dataGridItems.ActiveCell.Column.Key.ToString() == "Price" || dataGridItems.ActiveCell.Column.Key.ToString() == "Amount")
			{
				e.RaiseErrorEvent = false;
		...
		private bool GetData()
		{
			try
			{
				...
				{
					currentData = new JobExpenseIssueData();
				}
				DataRow dataRow = (!isNewRecord) ? currentData.JobExpenseIssueTable.Rows[0] : currentData.JobExpenseIssueTable.NewRow();
				...
				if (IsNewRecord)
				{
					currentData.JobExpenseIssueTable.Rows.Add(dataRow);
				}
				currentData.JobExpenseIssueDetailTable.Rows.Clear();
				foreach (UltraGridRow row in dataGridItems.Rows)
				{
					DataRow dataRow2 = currentData.JobExpenseIssueDetailTable.NewRow();
					dataRow2.BeginEdit();
					...
					dataRow2["ExpenseID"] = row.Cells["ExpenseID"].Value.ToString();
					...
					dataRow2.EndEdit();
					currentData.JobExpenseIssueDetailTable.Rows.Add(dataRow2);
				}
				return true;
			}
			catch (Exception e)
		...
		private void SetupGrid()
		{
			try
			{
				...
				dataTable.Columns.Add("ExpenseID");
				...
				dataGridItems.DisplayLayout.Bands[0].Columns["ExpenseID"].CharacterCasing = CharacterCasing.Upper;
				dataGridItems.DisplayLayout.Bands[0].Columns["ExpenseID"].MaxLength = 15;
				dataGridItems.DisplayLayout.Bands[0].Columns["ExpenseID"].InvalidValueBehavior = InvalidValueBehavior.RetainValueAndFocus;
				dataGridItems.DisplayLayout.Bands[0].Columns["ExpenseID"].Style = Infragistics.Win.UltraWinGrid.ColumnStyle.DropDownValidate;
				dataGridItems.DisplayLayout.Bands[0].Columns["ExpenseID"].ValueList = comboBoxGridExpenseCode;
				dataGridItems.DisplayLayout.Bands[0].Columns["ExpenseID"].Header.Caption = "Expense Code";
				dataGridItems.DisplayLayout.Bands[0].Columns["EmployeeID"].CharacterCasing = CharacterCasing.Upper;
				dataGridItems.DisplayLayout.Bands[0].Columns["EmployeeID"].MaxLength = 15;
				...
				dataGridItems.DisplayLayout.Bands[0].Columns["EmployeeID"].ValueList = comboBoxGridEmployee;
				dataGridItems.DisplayLayout.Bands[0].Columns["EmployeeID"].Width = 130;
				dataGridItems.DisplayLayout.Bands[0].Columns["EmployeeID"].Header.Caption = "Employee Code";
				dataGridItems.DisplayLayout.Bands[0].Columns["Description"].MaxLength = 255;
				dataGridItems.DisplayLayout.Bands[0].Columns["Remarks"].MaxLength = 150;
				...
				dataGridItems.DisplayLayout.Bands[0].Columns["ExpenseID"].Width = checked(18 * dataGridItems.Width) / 100;
		...
		public void LoadData(string voucherID)
		{
			try
			{
				...
				{
					currentData = Factory.JobExpenseIssueSystem.GetJobExpenseIssueByID(SystemDocID, voucherID);
					if (currentData != null)
					{
						FillData();
						IsNewRecord = false;
		...
		private void FillData()
		{
			try
			{
				...
				{
					DataRow dataRow = currentData.Tables["Job_Expense_Issue"].Rows[0];
					...
					if (currentData.Tables.Contains("Job_Expense_Issue_Detail") && currentData.JobExpenseIssueDetailTable.Rows.Count != 0)
					{
						dataGridItems.BeginUpdate();
						foreach (DataRow row in currentData.Tables["Job_Expense_Issue_Detail"].Rows)
						{
							DataRow dataRow3 = dataTable.NewRow();
							dataRow3["JobID"] = row["JobID"];
							dataRow3["CostCategoryID"] = row["CostCategoryID"];
							dataRow3["ExpenseID"] = row["ExpenseID"];
		...
		private bool SaveData(bool clearAfter)
		{
			...
			try
			{
				bool flag = Factory.JobExpenseIssueSystem.CreateJobExpenseIssue(currentData, !isNewRecord);
				if (!flag)
				{
		...
		{
			if (!IsNewRecord && !Global.IsUserAdmin && !AllowEditTransaction && Global.CurrentUser != Factory.SystemDocumentSystem.GetTransUserID("Job_Expense_Issue", "VoucherID", SystemDocID, textBoxVoucherNumber.Text))
			{
			...
			checked
			{
				...
				for (int i = 0; i < dataGridItems.Rows.Count; i++)
				{
					...
					if (dataGridItems.Rows[i].Cells["ExpenseID"].Value.ToString() == "")
					{
						ErrorHelper.InformationMessage("Please select an item.");
				...
				if (formManager.IsFieldDirty(textBoxVoucherNumber) && Factory.SystemDocumentSystem.ExistDocumentNumber("Job_Expense_Issue", "VoucherID", SystemDocID, textBoxVoucherNumber.Text))
				{
					ErrorHelper.WarningMessage(UIMessages.DocumentNumberInUse);
		...
		private bool Delete()
		{
			try
			{
				...
				return Factory.JobExpenseIssueSystem.DeleteJobExpenseIssue(SystemDocID, textBoxVoucherNumber.Text);
			}
			catch (Exception e)
			{
				ErrorHelper.ProcessError(e);
		...
		{
			string nextID = DatabaseHelper.GetNextID("Job_Expense_Issue", "VoucherID", textBoxVoucherNumber.Text, "SysDocID", SystemDocID);
			if (!(nextID == ""))
			{
				LoadData(nextID);
			}
		...
		{
			string previousID = DatabaseHelper.GetPreviousID("Job_Expense_Issue", "VoucherID", textBoxVoucherNumber.Text, "SysDocID", SystemDocID);
			if (!(previousID == ""))
			{
				LoadData(previousID);
			}
		...
		{
			string lastID = DatabaseHelper.GetLastID("Job_Expense_Issue", "VoucherID", "SysDocID", SystemDocID);
			if (!(lastID == ""))
			{
				LoadData(lastID);
			}
		...
		{
			string firstID = DatabaseHelper.GetFirstID("Job_Expense_Issue", "VoucherID", "SysDocID", SystemDocID);
			if (!(firstID == ""))
			{
				LoadData(firstID);
			}
		...
		private void toolStripButtonFind_Click(object sender, EventArgs e)
		{
			try
			{
				...
				{
					string text = Factory.DatabaseSystem.FindDocumentByNumber("Job_Expense_Issue", "VoucherID", SystemDocID, toolStripTextBoxFind.Text);
					if (text != "")
					{
						LoadData(text);
					}
		...
		public void ShowForApproval(string sysDocID, string voucherID, int approvalTaskID)
		{
			...
			formManager.ShowApprovalPanel(approvalTaskID, "Job_Expense_Issue", "VoucherID");
		}
		...
		private void JournalLeavesForm_Load(object sender, EventArgs e)
		{
			try
			{
				...
				SetupGrid();
				comboBoxSysDoc.FilterByType(SysDocTypes.JobExpenseIssue);
				dateTimePickerDate.Value = DateTime.Now;
				SetSecurity();
				if (!base.IsDisposed)
				{
		...
		{
			new FormHelper().EditSysDoc(comboBoxSysDoc.SelectedID, SysDocTypes.JobExpenseIssue);
		}
		...
		private bool SaveDraft()
		{
			try
			{
				if (GetData())
				{
					...
					{
						return Global.CompanySettings.SaveTransactionDraft(currentData, enterNameDialog.EnteredName, SysDocTypes.JobExpenseIssue);
					}
				}
				return false;
			}
		...
		private bool LoadDraft()
		{
			try
			{
				DataSet settingsList = Factory.SettingSystem.GetSettingsList("", 73.ToString());
				...
				if (selectDocumentDialog.ShowDialog(this) == DialogResult.OK)
				{
					...
					DataSet dataSet = Global.CompanySettings.LoadTransactionDraft(key, SysDocTypes.JobExpenseIssue);
					currentData = (dataSet as JobExpenseIssueData);
					FillData();
				}
				return true;
			}
		...
		private void Print(bool isPrint, bool showPrintDialog, bool saveChanges)
		{
			try
			{
				if (!(IsDirty && saveChanges) || (ErrorHelper.QuestionMessage(MessageBoxButtons.YesNo, "You must save the document before printing.", "Do you want to save?") == DialogResult.Yes && SaveData(clearAfter: false)))
				{
					...
					DataSet jobExpenseIssueToPrint = Factory.JobExpenseIssueSystem.GetJobExpenseIssueToPrint(selectedID, text);
					if (jobExpenseIssueToPrint == null || jobExpenseIssueToPrint.Tables.Count == 0)
					{
						ErrorHelper.ErrorMessage("Cannot print the document.", "Document not found.");
					}
					else
					{
						PrintHelper.PrintDocument(jobExpenseIssueToPrint, selectedID, "Project Expense Issue", SysDocTypes.JobExpenseIssue, isPrint, showPrintDialog);
					}
				}
			}
			catch (Exception e)
				...
				foreach (UltraGridRow row2 in dataGridItems.Rows)
				{
					if (row2.Cells["Item Code"].Value.ToString() != "")
					{
						...
						if (Factory.DatabaseSystem.ExistFieldValue("Product", "ProductID", text3))
						{
							...
							byte.Parse(Factory.DatabaseSystem.GetFieldValue("Product", "TaxOption", "ProductID", text3).ToString() ?? null);
		...
		private void toolStripButtonAttach_Click(object sender, EventArgs e)
		{
			try
			{
				if (!isNewRecord)
				{
					...
					docManagementForm.EntityType = EntityTypesEnum.JobExpenseIssue;
		...
		{
			FormActivator.BringFormToFront(FormActivator.JobExpenseIssueListFormObj);
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Projects.JobExpenseIssueForm));
			...
			toolStrip1.Size = new System.Drawing.Size(812, 31);
			...
			panelButtons.Size = new System.Drawing.Size(812, 40);
			...
			linePanelDown.Size = new System.Drawing.Size(812, 1);
			...
			xpButton1.Location = new System.Drawing.Point(702, 8);
			...
			labelVoided.Size = new System.Drawing.Size(776, 81);
			...
			dataGridItems.Size = new System.Drawing.Size(779, 381);
			...
			comboBoxGridExpenseCode.DisplayLayout.Appearance = appearance65;
			...
			comboBoxGridExpenseCode.DisplayLayout.GroupByBox.Appearance = appearance66;
			appearance67.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxGridExpenseCode.DisplayLayout.GroupByBox.BandLabelAppearance = appearance67;
			...
			comboBoxGridExpenseCode.DisplayLayout.GroupByBox.PromptAppearance = appearance68;
			...
			comboBoxGridExpenseCode.DisplayLayout.Override.ActiveCellAppearance = appearance69;
			...
			comboBoxGridExpenseCode.DisplayLayout.Override.ActiveRowAppearance = appearance70;
			...
			comboBoxGridExpenseCode.DisplayLayout.Override.CardAreaAppearance = appearance71;
			...
			comboBoxGridExpenseCode.DisplayLayout.Override.CellAppearance = appearance72;
			...
			comboBoxGridExpenseCode.DisplayLayout.Override.GroupByRowAppearance = appearance73;
			appearance74.TextHAlignAsString = "Left";
			comboBoxGridExpenseCode.DisplayLayout.Override.HeaderAppearance = appearance74;
			...
			comboBoxGridExpenseCode.DisplayLayout.Override.RowAppearance = appearance75;
			...
			comboBoxGridExpenseCode.DisplayLayout.Override.TemplateAddRowAppearance = appearance76;
			...
			comboBoxGridExpenseCode.Location = new System.Drawing.Point(619, 153);
			...
			comboBoxGridExpenseCode.TabIndex = 126;
			...
			comboBoxGridEmployee.DisplayLayout.Appearance = appearance77;
			...
			comboBoxGridEmployee.DisplayLayout.GroupByBox.Appearance = appearance78;
			appearance79.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxGridEmployee.DisplayLayout.GroupByBox.BandLabelAppearance = appearance79;
			...
			comboBoxGridEmployee.DisplayLayout.GroupByBox.PromptAppearance = appearance80;
			...
			comboBoxGridEmployee.DisplayLayout.Override.ActiveCellAppearance = appearance81;
			...
			comboBoxGridEmployee.DisplayLayout.Override.ActiveRowAppearance = appearance82;
			...
			comboBoxGridEmployee.DisplayLayout.Override.CardAreaAppearance = appearance83;
			...
			comboBoxGridEmployee.DisplayLayout.Override.CellAppearance = appearance84;
			...
			comboBoxGridEmployee.DisplayLayout.Override.GroupByRowAppearance = appearance85;
			appearance86.TextHAlignAsString = "Left";
			comboBoxGridEmployee.DisplayLayout.Override.HeaderAppearance = appearance86;
			...
			comboBoxGridEmployee.DisplayLayout.Override.RowAppearance = appearance87;
			...
			comboBoxGridEmployee.DisplayLayout.Override.TemplateAddRowAppearance = appearance88;
			...
			comboBoxGridEmployee.Location = new System.Drawing.Point(643, 179);
			...
			comboBoxGridEmployee.TabIndex = 127;
			...
			base.ClientSize = new System.Drawing.Size(812, 553);
			...
			base.Name = "JobExpenseIssueForm";
			Text = "Project Expense Entry";
