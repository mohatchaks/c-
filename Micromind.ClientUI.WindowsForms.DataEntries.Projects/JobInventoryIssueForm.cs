...
{
	public class JobInventoryIssueForm : Form, IForm
	{
		private bool supressInventoryMessage;

		private JobInventoryIssueData currentData;

		private const string TABLENAME_CONST = "Job_Inventory_Issue";
		...
		private ToolStripMenuItem loadFromMRToolStripMenuItem;

		private ToolStripMenuItem loadFromGRNToolStripMenuItem;

		private ToolStripMenuItem loadFromPurchaseOrderToolStripMenuItem;
		...
		private void dataGridItems_BeforeRowUpdate(object sender, CancelableRowEventArgs e)
		{
			...
			{
				flag = Factory.ProductSystem.IsSufficientQuantityOnhand(activeRow.Cells["Item Code"].Value.ToString(), activeRow.Cells["Unit"].Value.ToString(), activeRow.Cells["LocationID"].Value.ToString(), "Job_Inventory_Issue_Detail", sysDocID, voucherID, decimal.Parse(activeRow.Cells["Quantity"].Value.ToString()));
			}
			if (flag)
			{
				return;
		...
		private void dataGridItems_AfterCellUpdate(object sender, CellEventArgs e)
		{
			try
			{
				...
				checked
				{
					...
					if (e.Cell.Column.Key == "JOBID")
					{
						for (int j = e.Cell.Row.Index + 1; j < dataGridItems.Rows.Count; j++)
						{
							if (dataGridItems.Rows[j].Cells["JOBID"].Value.ToString() == "")
							{
								dataGridItems.Rows[j].Cells["JOBID"].Value = e.Cell.Value.ToString();
							}
						}
					}
					if (e.Cell.Column.Key == "CostCategoryID")
					{
						for (int k = e.Cell.Row.Index + 1; k < dataGridItems.Rows.Count; k++)
						{
							if (dataGridItems.Rows[k].Cells["CostCategoryID"].Value.ToString() == "")
							{
								dataGridItems.Rows[k].Cells["CostCategoryID"].Value = e.Cell.Value.ToString();
							}
						}
					}
		...
		private void dataGrid_BeforeCellUpdate(object sender, BeforeCellUpdateEventArgs e)
		{
			...
			if (CompanyPreferences.NegativeQuantityAction == 1 || supressInventoryMessage)
			{
				return;
			}
			string sysDocID = "";
			...
			if (Factory.ProductSystem.IsSufficientQuantityOnhand(activeRow.Cells["Item Code"].Value.ToString(), activeRow.Cells["Unit"].Value.ToString(), activeRow.Cells["LocationID"].Value.ToString(), "Job_Inventory_Issue_Detail", sysDocID, voucherID, decimal.Parse(e.NewValue.ToString())))
			{
				return;
			}
			if (itemTypes == ItemTypes.ConsignmentItem)
		...
		private bool GetData()
		{
			try
			{
				...
				{
					currentData = new JobInventoryIssueData();
				}
				DataRow dataRow = (!isNewRecord) ? currentData.JobInventoryIssueTable.Rows[0] : currentData.JobInventoryIssueTable.NewRow();
				...
				if (IsNewRecord)
				{
					currentData.JobInventoryIssueTable.Rows.Add(dataRow);
				}
				currentData.JobInventoryIssueDetailTable.Rows.Clear();
				foreach (UltraGridRow row in dataGridItems.Rows)
				{
					DataRow dataRow2 = currentData.JobInventoryIssueDetailTable.NewRow();
					dataRow2.BeginEdit();
					...
					if (!(d == 0m))
					{
						...
						dataRow2.EndEdit();
						currentData.JobInventoryIssueDetailTable.Rows.Add(dataRow2);
					}
				}
				return true;
			}
		...
		public void LoadData(string voucherID)
		{
			try
			{
				...
				{
					currentData = Factory.JobInventoryIssueSystem.GetJobInventoryIssueByID(SystemDocID, voucherID);
					if (currentData != null)
					{
						IsNewRecord = false;
						FillData();
		...
		private void FillData()
		{
			try
			{
				...
				{
					DataRow dataRow = currentData.Tables["Job_Inventory_Issue"].Rows[0];
					...
					if (!string.IsNullOrEmpty(dataRow["SourceSysDocID"].ToString()))
					{
						SourceSysDocID = dataRow["SourceSysDocID"].ToString();
					}
					if (!string.IsNullOrEmpty(dataRow["SourceVoucherID"].ToString()))
					{
						SourceVoucherID = dataRow["SourceVoucherID"].ToString();
					}
					DataTable dataTable = dataGridItems.DataSource as DataTable;
					dataTable.Rows.Clear();
					if (currentData.Tables.Contains("Job_Inventory_Issue_Detail") && currentData.JobInventoryIssueDetailTable.Rows.Count != 0)
					{
						dataGridItems.BeginUpdate();
						foreach (DataRow row in currentData.Tables["Job_Inventory_Issue_Detail"].Rows)
						{
		...
		private bool SaveData(bool clearAfter)
		{
			...
			try
			{
				bool flag = Factory.JobInventoryIssueSystem.CreateJobInventoryIssue(currentData, !isNewRecord);
				if (!flag)
				{
		...
		{
			if (!IsNewRecord && !Global.IsUserAdmin && !AllowEditTransaction && Global.CurrentUser != Factory.SystemDocumentSystem.GetTransUserID("Job_Inventory_Issue", "VoucherID", SystemDocID, textBoxVoucherNumber.Text))
			{
			...
			checked
			{
				...
				if (formManager.IsFieldDirty(textBoxVoucherNumber) && Factory.SystemDocumentSystem.ExistDocumentNumber("Job_Inventory_Issue", "VoucherID", SystemDocID, textBoxVoucherNumber.Text))
				{
					ErrorHelper.WarningMessage(UIMessages.DocumentNumberInUse);
		...
		private bool Delete()
		{
			try
			{
				...
				return Factory.JobInventoryIssueSystem.DeleteJobInventoryIssue(SystemDocID, textBoxVoucherNumber.Text);
			}
			catch (Exception e)
			{
				ErrorHelper.ProcessError(e);
		...
		{
			string nextID = DatabaseHelper.GetNextID("Job_Inventory_Issue", "VoucherID", textBoxVoucherNumber.Text, "SysDocID", SystemDocID);
			if (!(nextID == ""))
			{
				LoadData(nextID);
			}
		...
		{
			string previousID = DatabaseHelper.GetPreviousID("Job_Inventory_Issue", "VoucherID", textBoxVoucherNumber.Text, "SysDocID", SystemDocID);
			if (!(previousID == ""))
			{
				LoadData(previousID);
			}
		...
		{
			string lastID = DatabaseHelper.GetLastID("Job_Inventory_Issue", "VoucherID", "SysDocID", SystemDocID);
			if (!(lastID == ""))
			{
				LoadData(lastID);
			}
		...
		{
			string firstID = DatabaseHelper.GetFirstID("Job_Inventory_Issue", "VoucherID", "SysDocID", SystemDocID);
			if (!(firstID == ""))
			{
				LoadData(firstID);
			}
		...
		private void toolStripButtonFind_Click(object sender, EventArgs e)
		{
			try
			{
				...
				{
					string text = Factory.DatabaseSystem.FindDocumentByNumber("Job_Inventory_Issue", "VoucherID", SystemDocID, toolStripTextBoxFind.Text);
					if (text != "")
					{
						LoadData(text);
					}
		...
		public void ShowForApproval(string sysDocID, string voucherID, int approvalTaskID)
		{
			...
			formManager.ShowApprovalPanel(approvalTaskID, "Job_Inventory_Issue", "VoucherID");
		}
		...
		private void JournalLeavesForm_Load(object sender, EventArgs e)
		{
			try
			{
				...
				comboBoxSysDoc.FilterByType(SysDocTypes.JobInventoryIssue);
				dateTimePickerDate.Value = DateTime.Now;
				SetSecurity();
				if (!base.IsDisposed)
				{
		...
		{
			new FormHelper().EditSysDoc(comboBoxSysDoc.SelectedID, SysDocTypes.JobInventoryIssue);
		}
		...
		private bool LoadDraft()
		{
			try
			{
				...
				if (selectDocumentDialog.ShowDialog(this) == DialogResult.OK)
				{
					...
					currentData = (dataSet as JobInventoryIssueData);
					FillData();
				}
				return true;
			}
		...
		private void Print(bool isPrint, bool showPrintDialog, bool saveChanges)
		{
			try
			{
				if (!(IsDirty && saveChanges) || (ErrorHelper.QuestionMessage(MessageBoxButtons.YesNo, "You must save the document before printing.", "Do you want to save?") == DialogResult.Yes && SaveData(clearAfter: false)))
				{
					...
					{
						DataSet jobInventoryIssueToPrint = Factory.JobInventoryIssueSystem.GetJobInventoryIssueToPrint(selectedID, text);
						if (jobInventoryIssueToPrint == null || jobInventoryIssueToPrint.Tables.Count == 0)
						{
							ErrorHelper.ErrorMessage("Cannot print the document.", "Document not found.");
						}
						else
						{
							PrintHelper.PrintDocument(jobInventoryIssueToPrint, selectedID, "Project Inventory Issue", SysDocTypes.JobInventoryIssue, isPrint, showPrintDialog);
						}
					}
				}
			}
		...
		{
			FormActivator.BringFormToFront(FormActivator.JobInventoryIssueListFormObj);
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Projects.JobInventoryIssueForm));
			...
			loadFromMRToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			loadFromGRNToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			loadFromPurchaseOrderToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			...
			toolStripButton1.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[5]
			{
				...
				loadFromMRToolStripMenuItem,
				loadFromGRNToolStripMenuItem,
				loadFromPurchaseOrderToolStripMenuItem
			});
			...
			saveADraftToolStripMenuItem.Size = new System.Drawing.Size(215, 22);
			...
			loadDraftToolStripMenuItem.Size = new System.Drawing.Size(215, 22);
			...
			loadFromMRToolStripMenuItem.Name = "loadFromMRToolStripMenuItem";
			loadFromMRToolStripMenuItem.Size = new System.Drawing.Size(215, 22);
			loadFromMRToolStripMenuItem.Text = "Load from MR";
			loadFromMRToolStripMenuItem.Click += new System.EventHandler(loadFromMRToolStripMenuItem_Click);
			loadFromGRNToolStripMenuItem.Name = "loadFromGRNToolStripMenuItem";
			loadFromGRNToolStripMenuItem.Size = new System.Drawing.Size(215, 22);
			loadFromGRNToolStripMenuItem.Text = "Load from GRN";
			loadFromGRNToolStripMenuItem.Click += new System.EventHandler(loadFromGRNToolStripMenuItem_Click);
			loadFromPurchaseOrderToolStripMenuItem.Name = "loadFromPurchaseOrderToolStripMenuItem";
			loadFromPurchaseOrderToolStripMenuItem.Size = new System.Drawing.Size(215, 22);
			loadFromPurchaseOrderToolStripMenuItem.Text = "Load From Purchase Order";
			loadFromPurchaseOrderToolStripMenuItem.Click += new System.EventHandler(loadFromPurchaseOrderToolStripMenuItem_Click);
			...
			textBoxRef1.Location = new System.Drawing.Point(79, 24);
			textBoxRef1.MaxLength = 30;
			textBoxRef1.Name = "textBoxRef1";
			textBoxRef1.Size = new System.Drawing.Size(125, 20);
			textBoxRef1.TabIndex = 7;
			textBoxNote.Location = new System.Drawing.Point(80, 46);
			...
			comboBoxSysDoc.Location = new System.Drawing.Point(78, 3);
			...
			base.Name = "JobInventoryIssueForm";
			Text = "Project Inventory Issue";
