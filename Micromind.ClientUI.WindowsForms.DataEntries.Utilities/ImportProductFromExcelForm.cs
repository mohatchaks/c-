...
{
	public class ImportProductFromExcelForm : Form
	{
		...
		private CheckBox checkBoxAutoUPC;

		private CheckBox chkAutoProductCode;

		public ImportProductFromExcelForm()
		{
			InitializeComponent();
		}

		private void ImportProductFromExcelForm_Load(object sender, EventArgs e)
		{
			try
			{
		...
		private bool ValidateMapping()
		{
			...
			if (nameFieldKey != "")
			{
				...
				{
					if (row2.Cells[0].Value.ToString() == nameFieldKey)
					{
						flag2 = true;
						break;
					}
				...
				try
				{
					...
					else if (e.Page.Name == "wizardPageMapping")
					{
						...
						else
						{
							...
							foreach (UltraGridRow row3 in dataGridMapping.Rows)
							{
								list.Add(row3.Cells[0].Value.ToString());
							}
			...
			try
			{
				...
				else if (radioButtonProduct.Checked)
				{
					...
					foreach (UltraGridRow row2 in dataGridDataView.Rows)
					{
						...
						if (!row2.Cells["ProductID"].Value.ToString().ToLower().Contains("items"))
						{
							foreach (UltraGridColumn column2 in dataGridDataView.DisplayLayout.Bands[0].Columns)
							{
								if (column2.Key == "ItemType")
								{
									if (row2.Cells[column2.Key].Value.ToString() == "")
									{
										ItemTypes itemTypes = ItemTypes.Inventory;
										dataRow2["ItemType"] = itemTypes;
									}
								}
								else
								{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Utilities.ImportProductFromExcelForm));
			...
			checkBoxAutoUPC = new System.Windows.Forms.CheckBox();
			chkAutoProductCode = new System.Windows.Forms.CheckBox();
			...
			wizardPageEntityType.Visible = false;
			...
			wizardPageBrowse.Controls.Add(checkBoxAutoUPC);
			wizardPageBrowse.Controls.Add(chkAutoProductCode);
			...
			checkBoxAutoUPC.AutoSize = true;
			checkBoxAutoUPC.Location = new System.Drawing.Point(24, 148);
			checkBoxAutoUPC.Name = "checkBoxAutoUPC";
			checkBoxAutoUPC.Size = new System.Drawing.Size(118, 17);
			checkBoxAutoUPC.TabIndex = 6;
			checkBoxAutoUPC.Text = "Auto generate UPC";
			checkBoxAutoUPC.UseVisualStyleBackColor = true;
			chkAutoProductCode.AutoSize = true;
			chkAutoProductCode.Location = new System.Drawing.Point(24, 125);
			chkAutoProductCode.Name = "chkAutoProductCode";
			chkAutoProductCode.Size = new System.Drawing.Size(161, 17);
			chkAutoProductCode.TabIndex = 5;
			chkAutoProductCode.Text = "Auto generate Product Code";
			chkAutoProductCode.UseVisualStyleBackColor = true;
			...
			base.Name = "ImportProductFromExcelForm";
			Text = "Import Product Data";
			base.Load += new System.EventHandler(ImportProductFromExcelForm_Load);
