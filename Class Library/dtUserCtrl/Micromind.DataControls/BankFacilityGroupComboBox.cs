...
{
	public class BankFacilityGroupComboBox : MultiColumnComboBox
	{
		...
		public BankFacilityGroupComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.Area;
			TABLENAME_FIELD = "Bank_Facility_Group";
			ID_FIELD = "GroupID";
		...
		{
			return CombosData.GetBankFacilityGroupList(isReferesh);
		}
