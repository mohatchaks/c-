...
{
	public class VendorClassComboBox : MultiColumnComboBox
	{
		...
		public VendorClassComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.VendorClass;
			TABLENAME_FIELD = "Vendor_Class";
			ID_FIELD = "ClassID";
		...
		{
			return CombosData.GetVendorClasssList(isReferesh);
		}
