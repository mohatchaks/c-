...
{
	public class ProductSpecificationComboBox : MultiColumnComboBox
	{
		...
		public ProductSpecificationComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.ProductSpecification;
			TABLENAME_FIELD = "Product_Specification";
			ID_FIELD = "SpecificationID";
			NAME_FIELD = "SpecificationName";
		}
		...
		{
			return CombosData.GetProductSpecification(isReferesh);
		}
