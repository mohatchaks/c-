...
{
	public class BuyerComboBox : MultiColumnComboBox
	{
		...
		public BuyerComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.Buyer;
			TABLENAME_FIELD = "Buyer";
			ID_FIELD = "BuyerID";
			NAME_FIELD = "FullName";
		}
		...
		{
			return CombosData.GetBuyerList(isReferesh);
		}
