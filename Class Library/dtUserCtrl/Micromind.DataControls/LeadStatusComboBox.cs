...
{
	public class LeadStatusComboBox : MultiColumnComboBox
	{
		...
		{
			InitializeComponent();
			base.ComboType = DataComboType.LeadStatus;
			TABLENAME_FIELD = "Lead_Status";
			ID_FIELD = "LeadStatusID";
			NAME_FIELD = "Name";
		}
		...
		{
			return CombosData.GetLeadStatusList(isReferesh);
		}
