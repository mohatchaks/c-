...
{
	public class PackageComboBox : MultiColumnComboBox
	{
		...
		public decimal SelectedAmount
		{
			get
			{
				if (base.SelectedRow == null || base.SelectedRow.Cells["Amount"].Value == null || base.SelectedRow.Cells["Amount"].Value.ToString() == "")
				{
					return 0m;
				}
				return decimal.Parse(base.SelectedRow.Cells["Amount"].Value.ToString());
			}
		}
		...
		{
			return CombosData.GetPackageList(isReferesh);
		}
