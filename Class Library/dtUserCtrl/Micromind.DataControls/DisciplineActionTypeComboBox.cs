...
{
	public class DisciplineActionTypeComboBox : MultiColumnComboBox
	{
		...
		public DisciplineActionTypeComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.DisciplineActionType;
			TABLENAME_FIELD = "Discipline_Action_Type";
			ID_FIELD = "ActionTypeID";
			NAME_FIELD = "ActionTypeName";
		}
		...
		{
			return CombosData.GetDisciplineActionTypeList(isReferesh);
		}
