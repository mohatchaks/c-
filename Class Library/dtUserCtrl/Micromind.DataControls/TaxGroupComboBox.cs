...
{
	public class TaxGroupComboBox : MultiColumnComboBox
	{
		...
		public decimal TaxRate
		{
			get
			{
				...
				if (base.SelectedRow == null || !base.IsDataLoaded)
				{
					return 0m;
				}
				return decimal.Parse(base.SelectedRow.Cells["TaxRate"].Value.ToString());
			}
		}

		public TaxGroupComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.Tax;
			TABLENAME_FIELD = "Tax_Group";
			ID_FIELD = "TaxGroupID";
			NAME_FIELD = "TaxGroupName";
			base.ReadOnly = true;
		}
		...
		{
			return CombosData.GetTaxGroupList(isReferesh);
		}
