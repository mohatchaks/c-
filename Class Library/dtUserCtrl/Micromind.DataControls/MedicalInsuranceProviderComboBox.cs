...
{
	public class MedicalInsuranceProviderComboBox : MultiColumnComboBox
	{
		...
		public MedicalInsuranceProviderComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.MedicalInsuranceProvider;
			TABLENAME_FIELD = "Insurance_Provider";
			ID_FIELD = "InsuranceProviderID";
			NAME_FIELD = "InsuranceProviderName";
		}
		...
		{
			return CombosData.GetMedicalInsuranceProviderList(isReferesh);
		}
