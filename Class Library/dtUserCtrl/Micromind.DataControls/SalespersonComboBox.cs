...
{
	public class SalespersonComboBox : MultiColumnComboBox
	{
		...
		public SalespersonComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.Salesperson;
			TABLENAME_FIELD = "Salesperson";
			ID_FIELD = "SalespersonID";
			NAME_FIELD = "FullName";
		...
		{
			return CombosData.GetSalespersonList(isReferesh);
		}
