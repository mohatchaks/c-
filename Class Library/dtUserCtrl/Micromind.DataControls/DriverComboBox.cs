...
{
	public class DriverComboBox : MultiColumnComboBox
	{
		...
		{
			InitializeComponent();
			base.ComboType = DataComboType.Driver;
			TABLENAME_FIELD = "Driver";
			ID_FIELD = "DriverID";
			NAME_FIELD = "DriverName";
		}
		...
		{
			return CombosData.GetDriverList(isReferesh);
		}
