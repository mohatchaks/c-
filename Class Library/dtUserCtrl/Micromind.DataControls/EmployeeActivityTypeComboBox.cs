...
{
	public class EmployeeActivityTypeComboBox : MultiColumnComboBox
	{
		...
		public EmployeeActivityTypeComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.EmployeeActivityType;
			TABLENAME_FIELD = "Employee_Activity_Type";
			ID_FIELD = "ActivityTypeID";
		...
		{
			return CombosData.GetEmployeeActivityTypeList(isReferesh);
		}
