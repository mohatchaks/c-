...
{
	public class ServiceActivityComboBox : MultiColumnComboBox
	{
		...
		public ServiceActivityComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.ServiceActivity;
			TABLENAME_FIELD = "Service_Activity";
			ID_FIELD = "ServiceActivityID";
			NAME_FIELD = "ServiceActivityName";
		}
		...
		{
			return CombosData.GetServiceActivityList(isReferesh);
		}
