...
{
	public class ProductBrandComboBox : MultiColumnComboBox
	{
		...
		public ProductBrandComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.ProductBrand;
			TABLENAME_FIELD = "Product_Brand";
			ID_FIELD = "BrandID";
		...
		{
			return CombosData.GetProductBrandList(isReferesh);
		}
