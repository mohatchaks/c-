...
{
	public class FiscalYearComboBox : MultiColumnComboBox
	{
		...
		public FiscalYearComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.FiscalYear;
			TABLENAME_FIELD = "FiscalYear";
			ID_FIELD = "FiscalYearID";
			NAME_FIELD = "FiscalYearName";
		}
		...
		{
			return CombosData.GetFiscalYearList(isReferesh);
		}
