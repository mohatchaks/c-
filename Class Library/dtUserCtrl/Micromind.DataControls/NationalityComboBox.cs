...
{
	public class NationalityComboBox : MultiColumnComboBox
	{
		...
		{
			InitializeComponent();
			base.ComboType = DataComboType.Nationality;
			TABLENAME_FIELD = "Nationality";
			ID_FIELD = "NationalityID";
			NAME_FIELD = "NationalityName";
		}
		...
		{
			return CombosData.GetNationalityList(isReferesh);
		}
