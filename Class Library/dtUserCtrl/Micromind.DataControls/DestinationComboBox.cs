...
{
	public class DestinationComboBox : MultiColumnComboBox
	{
		...
		{
			InitializeComponent();
			base.ComboType = DataComboType.Destination;
			TABLENAME_FIELD = "Destination";
			ID_FIELD = "DestinationID";
			NAME_FIELD = "DestinationName";
		}
		...
		{
			return CombosData.GetDestinationList(isReferesh);
		}
