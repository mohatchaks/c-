...
{
	public class EquipmentTypeComboBox : MultiColumnComboBox
	{
		...
		public EquipmentTypeComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.EquipmentType;
			TABLENAME_FIELD = "EA_Equipment_Type";
			ID_FIELD = "EquipmentTypeID";
			NAME_FIELD = "EquipmentTypeName";
		}
		...
		{
			return CombosData.GetEquipmentTypeList(isReferesh);
		}
