...
{
	public class ProductTypeComboBox : MultiColumnComboBox
	{
		...
		public ProductTypeComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.ProductMake;
			TABLENAME_FIELD = "Product_Make";
			ID_FIELD = "MakeID";
			NAME_FIELD = "MakeName";
		}
		...
		{
			return CombosData.GetProductTypeList(isReferesh);
		}
