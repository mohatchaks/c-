...
{
	public class UserGroupComboBox : MultiColumnComboBox
	{
		...
		public UserGroupComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.UserGroup;
			TABLENAME_FIELD = "User_Group";
			ID_FIELD = "GroupID";
		...
		{
			return CombosData.GetUserGroupList(isReferesh);
		}
