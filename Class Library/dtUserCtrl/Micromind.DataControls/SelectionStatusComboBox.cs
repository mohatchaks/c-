...
{
	public class SelectionStatusComboBox : ComboBox
	{
		...
		public SelectionStatusComboBox()
		{
			InitializeComponent();
		}
		...
		{
			base.Items.Clear();
			base.Items.Add("In Process");
			base.Items.Add("On Hold");
			base.Items.Add("Approved");
			base.Items.Add("Selected");
			base.Items.Add("Rejected");
		}
