...
{
	public class GradeComboBox : MultiColumnComboBox
	{
		...
		{
			InitializeComponent();
			base.ComboType = DataComboType.Grade;
			TABLENAME_FIELD = "Employee_Grade";
			ID_FIELD = "GradeID";
			NAME_FIELD = "GradeName";
		}
		...
		{
			return CombosData.GetGradeList(isReferesh);
		}
