...
{
	public class RequisitionTypeComboBox : MultiColumnComboBox
	{
		...
		public RequisitionTypeComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.RequisitionType;
			TABLENAME_FIELD = "EA_Requisition_Type";
			ID_FIELD = "RequisitionTypeID";
			NAME_FIELD = "RequisitionTypeName";
		}
		...
		{
			return CombosData.GetRequisitionTypeList(isReferesh);
		}
