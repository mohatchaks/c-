...
{
	public class CampaignComboBox : MultiColumnComboBox
	{
		...
		public CampaignComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.Campaign;
			TABLENAME_FIELD = "Campaign";
			ID_FIELD = "CampaignID";
			NAME_FIELD = "CampaignName";
		}
		...
		{
			return CombosData.GetCampaignList(isReferesh);
		}
