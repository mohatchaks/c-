...
{
	public class ConsignInComboBox : MultiColumnComboBox
	{
		...
		public ConsignInComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.ConsignIn;
			TABLENAME_FIELD = "Consign_In";
			ID_FIELD = "VoucherID";
			NAME_FIELD = "SysDocID";
		}
		...
		{
			return CombosData.GetConsignInList(isReferesh);
		}
