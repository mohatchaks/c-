...
{
	public class LeadSourceComboBox : MultiColumnComboBox
	{
		...
		public LeadSourceComboBox()
		{
			...
			TABLENAME_FIELD = "Lead_Source";
			ID_FIELD = "LeadSourceID";
			NAME_FIELD = "LeadSourceName";
		}
		...
		protected DataSet GetData(bool isReferesh)
		{
			try
			{
				return CombosData.GetLeadSourceList(isReferesh);
			}
