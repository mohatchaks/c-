...
{
	public class RiderComboBox : MultiColumnComboBox
	{
		...
		public RiderComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.RiderSummary;
			TABLENAME_FIELD = "Rider_Summary";
			ID_FIELD = "RiderID";
			NAME_FIELD = "RiderName";
		}
		...
		{
			return CombosData.GetRiderList(isReferesh);
		}
