...
{
	public class LeaveSelector : UserControl, ICustomReportControl
	{
		...
		private RadioButton radioButtonApproved;

		private Label label3;

		private RadioButton radioButtonSingle;

		private LeaveTypeComboBox comboBoxSingle;

		private Panel panel1;

		private RadioButton radioButtonNotApproved;

		private LeaveTypeComboBox comboBoxFrom;

		private LeaveTypeComboBox comboBoxTo;
		...
		public LeaveApprovalType ApprovalType
		{
			get
			{
				if (radioButtonApproved.Checked)
				{
					return LeaveApprovalType.Approved;
				}
				if (radioButtonNotApproved.Checked)
				{
					return LeaveApprovalType.NotApproved;
				}
				return LeaveApprovalType.Both;
			}
		}
		...
		public bool IsPanelVisible
		{
			get
			{
				return panel1.Visible = ispanelvisible;
			}
			set
			{
		...
		public string GetParameterValue()
		{
			if (crValueType == 1)
			{
				...
				{
					return "ANY(SELECT LeaveTypeID FROM Leave_Type)";
				}
				if (radioButtonSingle.Checked)
				{
					return "'" + comboBoxSingle.SelectedID + "'";
				...
				if (radioButtonRange.Checked)
				{
					return "ANY(SELECT LeaveTypeID FROM Leave_Type WHERE LeaveTypeID Between '" + comboBoxFrom.SelectedID + "' AND '" + comboBoxTo.SelectedID + "')";
				}
				return "1=1";
			}
			if (crFieldName == "")
		...
		private void EnableDisableControls()
		{
			...
			LeaveTypeComboBox leaveTypeComboBox = comboBoxFrom;
			bool enabled = comboBoxTo.Enabled = radioButtonRange.Checked;
			leaveTypeComboBox.Enabled = enabled;
		}
		...
		private void InitializeComponent()
		{
			...
			radioButtonApproved = new System.Windows.Forms.RadioButton();
			label3 = new System.Windows.Forms.Label();
			radioButtonSingle = new System.Windows.Forms.RadioButton();
			panel1 = new System.Windows.Forms.Panel();
			radioButtonNotApproved = new System.Windows.Forms.RadioButton();
			radioButtonBoth = new System.Windows.Forms.RadioButton();
			comboBoxTo = new Micromind.DataControls.LeaveTypeComboBox();
			comboBoxFrom = new Micromind.DataControls.LeaveTypeComboBox();
			comboBoxSingle = new Micromind.DataControls.LeaveTypeComboBox();
			...
			labelTo.Location = new System.Drawing.Point(280, 29);
			...
			radioButtonAll.Size = new System.Drawing.Size(101, 17);
			radioButtonAll.TabIndex = 0;
			radioButtonAll.TabStop = true;
			radioButtonAll.Text = "All Leave Types";
			...
			radioButtonApproved.AutoSize = true;
			radioButtonApproved.Location = new System.Drawing.Point(42, 7);
			radioButtonApproved.Name = "radioButtonApproved";
			radioButtonApproved.Size = new System.Drawing.Size(71, 17);
			radioButtonApproved.TabIndex = 10;
			radioButtonApproved.Text = "Approved";
			radioButtonApproved.UseVisualStyleBackColor = true;
			radioButtonApproved.CheckedChanged += new System.EventHandler(radioButtons_CheckedChanged);
			label3.AutoSize = true;
			label3.Location = new System.Drawing.Point(131, 29);
			label3.Name = "label3";
			label3.Size = new System.Drawing.Size(33, 13);
			label3.TabIndex = 4;
			label3.Text = "From:";
			radioButtonSingle.AutoSize = true;
			radioButtonSingle.Location = new System.Drawing.Point(116, 5);
			...
			panel1.Controls.Add(radioButtonBoth);
			panel1.Controls.Add(radioButtonNotApproved);
			panel1.Controls.Add(radioButtonApproved);
			panel1.Location = new System.Drawing.Point(3, 45);
			panel1.Name = "panel1";
			panel1.Size = new System.Drawing.Size(406, 25);
			panel1.TabIndex = 14;
			radioButtonNotApproved.AutoSize = true;
			radioButtonNotApproved.Location = new System.Drawing.Point(114, 7);
			radioButtonNotApproved.Name = "radioButtonNotApproved";
			radioButtonNotApproved.Size = new System.Drawing.Size(91, 17);
			radioButtonNotApproved.TabIndex = 11;
			radioButtonNotApproved.Text = "Not Approved";
			radioButtonNotApproved.UseVisualStyleBackColor = true;
			radioButtonBoth.AutoSize = true;
			radioButtonBoth.Checked = true;
			radioButtonBoth.Location = new System.Drawing.Point(3, 7);
			radioButtonBoth.Name = "radioButtonBoth";
			radioButtonBoth.Size = new System.Drawing.Size(36, 17);
			radioButtonBoth.TabIndex = 12;
			radioButtonBoth.Text = "All";
			...
			comboBoxTo.DisplayLayout.Appearance = appearance;
			...
			comboBoxTo.DisplayLayout.GroupByBox.Appearance = appearance2;
			appearance3.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxTo.DisplayLayout.GroupByBox.BandLabelAppearance = appearance3;
			...
			comboBoxTo.DisplayLayout.GroupByBox.PromptAppearance = appearance4;
			comboBoxTo.DisplayLayout.MaxColScrollRegions = 1;
			comboBoxTo.DisplayLayout.MaxRowScrollRegions = 1;
			appearance5.BackColor = System.Drawing.SystemColors.Window;
			appearance5.ForeColor = System.Drawing.SystemColors.ControlText;
			comboBoxTo.DisplayLayout.Override.ActiveCellAppearance = appearance5;
			appearance6.BackColor = System.Drawing.SystemColors.Highlight;
			appearance6.ForeColor = System.Drawing.SystemColors.HighlightText;
			comboBoxTo.DisplayLayout.Override.ActiveRowAppearance = appearance6;
			...
			comboBoxTo.DisplayLayout.Override.CardAreaAppearance = appearance7;
			appearance8.BorderColor = System.Drawing.Color.Silver;
			appearance8.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxTo.DisplayLayout.Override.CellAppearance = appearance8;
			...
			comboBoxTo.DisplayLayout.Override.GroupByRowAppearance = appearance9;
			appearance10.TextHAlignAsString = "Left";
			comboBoxTo.DisplayLayout.Override.HeaderAppearance = appearance10;
			...
			comboBoxTo.DisplayLayout.Override.RowAppearance = appearance11;
			comboBoxTo.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance12.BackColor = System.Drawing.SystemColors.ControlLight;
			comboBoxTo.DisplayLayout.Override.TemplateAddRowAppearance = appearance12;
			...
			comboBoxTo.Location = new System.Drawing.Point(303, 25);
			comboBoxTo.MaxDropDownItems = 12;
			comboBoxTo.Name = "comboBoxTo";
			comboBoxTo.ShowInactiveItems = false;
			comboBoxTo.ShowQuickAdd = true;
			comboBoxTo.Size = new System.Drawing.Size(106, 20);
			comboBoxTo.TabIndex = 16;
			...
			comboBoxFrom.Location = new System.Drawing.Point(174, 25);
			...
			comboBoxFrom.Size = new System.Drawing.Size(106, 20);
			comboBoxFrom.TabIndex = 15;
			...
			comboBoxSingle.DisplayLayout.Appearance = appearance25;
			...
			comboBoxSingle.DisplayLayout.GroupByBox.Appearance = appearance26;
			appearance27.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxSingle.DisplayLayout.GroupByBox.BandLabelAppearance = appearance27;
			...
			comboBoxSingle.DisplayLayout.GroupByBox.PromptAppearance = appearance28;
			...
			comboBoxSingle.DisplayLayout.Override.ActiveCellAppearance = appearance29;
			appearance30.BackColor = System.Drawing.SystemColors.Highlight;
			appearance30.ForeColor = System.Drawing.SystemColors.HighlightText;
			comboBoxSingle.DisplayLayout.Override.ActiveRowAppearance = appearance30;
			...
			comboBoxSingle.DisplayLayout.Override.CardAreaAppearance = appearance31;
			appearance32.BorderColor = System.Drawing.Color.Silver;
			appearance32.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxSingle.DisplayLayout.Override.CellAppearance = appearance32;
			...
			comboBoxSingle.DisplayLayout.Override.GroupByRowAppearance = appearance33;
			appearance34.TextHAlignAsString = "Left";
			comboBoxSingle.DisplayLayout.Override.HeaderAppearance = appearance34;
			...
			comboBoxSingle.DisplayLayout.Override.RowAppearance = appearance35;
			comboBoxSingle.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance36.BackColor = System.Drawing.SystemColors.ControlLight;
			comboBoxSingle.DisplayLayout.Override.TemplateAddRowAppearance = appearance36;
			...
			comboBoxSingle.Location = new System.Drawing.Point(174, 3);
			...
			comboBoxSingle.Size = new System.Drawing.Size(235, 20);
			comboBoxSingle.TabIndex = 13;
			...
			base.Name = "LeaveSelector";
			base.Size = new System.Drawing.Size(414, 76);
