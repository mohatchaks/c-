...
{
	public class CompetitorComboBox : MultiColumnComboBox
	{
		...
		public CompetitorComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.Competitor;
			TABLENAME_FIELD = "Competitor";
			ID_FIELD = "CompetitorID";
			NAME_FIELD = "CompetitorName";
		}
		...
		{
			return CombosData.GetCompetitorList(isReferesh);
		}
