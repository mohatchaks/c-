...
{
	public class SkillComboBox : MultiColumnComboBox
	{
		...
		{
			InitializeComponent();
			base.ComboType = DataComboType.Skill;
			TABLENAME_FIELD = "Skill";
			ID_FIELD = "SkillID";
			NAME_FIELD = "SkillName";
		}
		...
		{
			return CombosData.GetSkillList(isReferesh);
		}
