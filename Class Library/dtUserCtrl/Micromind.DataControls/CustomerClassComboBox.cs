...
{
	public class CustomerClassComboBox : MultiColumnComboBox
	{
		...
		public CustomerClassComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.CustomerClass;
			TABLENAME_FIELD = "Customer_Class";
			ID_FIELD = "ClassID";
		...
		{
			return CombosData.GetCustomerClasssList(isReferesh);
		}
