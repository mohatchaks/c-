...
{
	public class MatrixTemplateComboBox : MultiColumnComboBox
	{
		...
		public MatrixTemplateComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.MatrixTemplate;
			TABLENAME_FIELD = "Matrix_Template";
			ID_FIELD = "TemplateID";
		...
		{
			return CombosData.GetMatrixTemplateList(isReferesh);
		}
