...
{
	public class FixedAssetsComboBox : MultiColumnComboBox
	{
		...
		public FixedAssetsComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.FixedAsset;
			TABLENAME_FIELD = "FixedAsset";
			ID_FIELD = "AssetID";
			NAME_FIELD = "AssetName";
		}
		...
		{
			return CombosData.GetFixedAssetList(isReferesh);
		}
