...
{
	public class ReleaseTypeComboBox : MultiColumnComboBox
	{
		...
		public ReleaseTypeComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.ReleaseType;
			TABLENAME_FIELD = "Release_Type";
			ID_FIELD = "ReleaseTypeID";
			NAME_FIELD = "ReleaseTypeName";
		}
		...
		{
			return CombosData.GetReleaseTypeList(isReferesh);
		}
