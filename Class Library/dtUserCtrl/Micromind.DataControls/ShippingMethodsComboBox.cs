...
{
	public class ShippingMethodsComboBox : MultiColumnComboBox
	{
		...
		public ShippingMethodsComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.ShippingMethod;
			TABLENAME_FIELD = "Shipping_Method";
			ID_FIELD = "ShippingMethodID";
			NAME_FIELD = "ShippingMethodName";
		}
		...
		{
			return CombosData.GetShippingMethodsList(isReferesh);
		}
