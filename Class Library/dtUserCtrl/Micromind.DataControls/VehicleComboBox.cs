...
{
	public class VehicleComboBox : MultiColumnComboBox
	{
		...
		public VehicleComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.Vehicle;
			TABLENAME_FIELD = "Vehicle";
			ID_FIELD = "VehicleID";
		...
		{
			return CombosData.GetVehicleList(isReferesh);
		}
