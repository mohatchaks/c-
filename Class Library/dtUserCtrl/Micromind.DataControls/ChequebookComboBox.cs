...
{
	public class ChequebookComboBox : MultiColumnComboBox
	{
		...
		public ChequebookComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.Chequebook;
			TABLENAME_FIELD = "Chequebook";
			ID_FIELD = "ChequebookID";
			NAME_FIELD = "ChequebookName";
		}
		...
		{
			return CombosData.GetChequebookList(isReferesh);
		}
