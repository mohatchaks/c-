...
{
	public class FixedAssetClassComboBox : MultiColumnComboBox
	{
		...
		public FixedAssetClassComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.FixedAssetClass;
			TABLENAME_FIELD = "FixedAsset_Class";
			ID_FIELD = "AssetClassID";
			NAME_FIELD = "AssetClassName";
		}
		...
		{
			return CombosData.GetFixedAssetClassList(isReferesh);
		}
