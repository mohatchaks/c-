...
{
	public class EmployeeGroupComboBox : MultiColumnComboBox
	{
		...
		public EmployeeGroupComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.EmployeeGroup;
			TABLENAME_FIELD = "Employee_Group";
			ID_FIELD = "GroupID";
		...
		{
			return CombosData.GetEmployeeGroupList(isReferesh);
		}
