...
{
	public class CasePartyComboBox : MultiColumnComboBox
	{
		...
		public CasePartyComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.CaseParty;
			TABLENAME_FIELD = "Case_Party";
			ID_FIELD = "CasePartyID";
			NAME_FIELD = "CasePartyName";
		}
		...
		{
			return CombosData.GetCasePartyList(isReferesh);
		}
