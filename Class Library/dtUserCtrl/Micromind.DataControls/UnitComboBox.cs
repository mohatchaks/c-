...
{
	public class UnitComboBox : MultiColumnComboBox
	{
		...
		public void Filter(bool a, int unitID, int customerID)
		{
		}

		public void Filter(int unitID, int customerID)
		{
		}

		private DataSet GetData(bool isReferesh)
		{
			return CombosData.GetUnitList(isReferesh);
		}
