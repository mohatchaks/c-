...
{
	public class EmployeeTypeComboBox : MultiColumnComboBox
	{
		...
		public EmployeeTypeComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.EmployeeType;
			TABLENAME_FIELD = "Employee_Type";
			ID_FIELD = "TypeID";
			NAME_FIELD = "TypeName";
		}
		...
		{
			return CombosData.GetEmployeeTypeList(isReferesh);
		}
