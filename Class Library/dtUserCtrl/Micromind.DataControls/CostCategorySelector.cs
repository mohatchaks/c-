...
{
	public class CostCategorySelector : UserControl, ICustomReportControl
	{
		...
		private CostCategoryComboBox comboBoxSingle;

		private CostCategoryComboBox comboBoxFrom;

		private CostCategoryComboBox comboBoxTo;
		...
		public string FromCostCategory
		{
			get
			{
		...
		public CostCategorySelector()
		{
			InitializeComponent();
		}

		private void JobCostCategorySelector_Load(object sender, EventArgs e)
		{
		}
		...
		public string GetParameterValue()
		{
			if (crValueType == 1)
			{
				...
				{
					return " ANY(SELECT CostCategoryID FROM Job_Cost_Category)";
				}
				if (radioButtonSingle.Checked)
				{
					return "'" + comboBoxSingle.SelectedID + "'";
				...
				if (radioButtonRange.Checked)
				{
					return "ANY(SELECT CostCategoryID FROM Job_Cost_Category WHERE CostCategoryID Between '" + comboBoxFrom.SelectedID + "' AND '" + comboBoxTo.SelectedID + "')";
				}
				return " 1=1 ";
			}
			if (crFieldName == "")
		...
		private void EnableDisableControls()
		{
			...
			CostCategoryComboBox costCategoryComboBox = comboBoxFrom;
			bool enabled = comboBoxTo.Enabled = radioButtonRange.Checked;
			costCategoryComboBox.Enabled = enabled;
		}
		...
		private void InitializeComponent()
		{
			...
			comboBoxTo = new Micromind.DataControls.CostCategoryComboBox();
			comboBoxFrom = new Micromind.DataControls.CostCategoryComboBox();
			comboBoxSingle = new Micromind.DataControls.CostCategoryComboBox();
			...
			radioButtonRange.Location = new System.Drawing.Point(6, 23);
			...
			label3.Location = new System.Drawing.Point(120, 25);
			label3.Name = "label3";
			label3.Size = new System.Drawing.Size(33, 13);
			label3.TabIndex = 11;
			label3.Text = "From:";
			labelTo.AutoSize = true;
			labelTo.Location = new System.Drawing.Point(296, 25);
			...
			comboBoxFrom.Location = new System.Drawing.Point(182, 23);
			...
			comboBoxFrom.Size = new System.Drawing.Size(114, 20);
			...
			comboBoxSingle.Location = new System.Drawing.Point(182, 0);
			...
			comboBoxSingle.Size = new System.Drawing.Size(245, 20);
			comboBoxSingle.TabIndex = 14;
			...
			base.Name = "CostCategorySelector";
			base.Size = new System.Drawing.Size(433, 46);
			base.Load += new System.EventHandler(JobCostCategorySelector_Load);
