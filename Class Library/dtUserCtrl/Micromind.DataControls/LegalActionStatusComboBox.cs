...
{
	public class LegalActionStatusComboBox : MultiColumnComboBox
	{
		...
		public LegalActionStatusComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.LegalActionStatus;
			TABLENAME_FIELD = "Legal_Action_Status";
			ID_FIELD = "LegalActionStatusID";
			NAME_FIELD = "LegalActionStatusName";
		}
		...
		{
			return CombosData.GetLegalActionStatusList(isReferesh);
		}
