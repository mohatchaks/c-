...
{
	public class ProductManufacturerComboBox : MultiColumnComboBox
	{
		...
		public ProductManufacturerComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.ProductManufacturer;
			TABLENAME_FIELD = "Product_Manufacturer";
		...
		{
			return CombosData.GetProductManufacturerList(isReferesh);
		}
