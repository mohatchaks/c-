...
{
	public class PropertyComboBox : MultiColumnComboBox
	{
		...
		public bool IsPeriodicInv
		{
			get
			{
				string text = GetSelectedCellValue("IsPeriodicInvoice").ToString();
				bool result = false;
		...
		{
			return CombosData.GetPropertyList(isReferesh);
		}
