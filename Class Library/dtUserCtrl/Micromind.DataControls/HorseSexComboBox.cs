...
{
	public class HorseSexComboBox : MultiColumnComboBox
	{
		...
		public HorseSexComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.HorseSex;
			TABLENAME_FIELD = "Horse_Sex";
			ID_FIELD = "HorseSexID";
			NAME_FIELD = "HorseSexName";
		}
		...
		{
			return CombosData.GetHorseSexList(isReferesh);
		}
