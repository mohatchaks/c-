...
{
	public class InsuranceProviderComboBox : MultiColumnComboBox
	{
		...
		public InsuranceProviderComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.InsuranceProvider;
		...
		{
			return CombosData.GetInsuranceProviderList(isReferesh);
		}
