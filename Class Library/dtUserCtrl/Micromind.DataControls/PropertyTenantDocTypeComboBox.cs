...
{
	public class PropertyTenantDocTypeComboBox : MultiColumnComboBox
	{
		...
		public PropertyTenantDocTypeComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.PropertyTenantDocType;
			TABLENAME_FIELD = "Property_Tenant_Doc_Type";
			ID_FIELD = "TypeID";
			NAME_FIELD = "TypeName";
		}
		...
		{
			return CombosData.GetPropertyTenantDocTypeList(isReferesh);
		}
