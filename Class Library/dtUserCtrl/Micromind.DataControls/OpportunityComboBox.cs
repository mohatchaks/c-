...
{
	public class OpportunityComboBox : MultiColumnComboBox
	{
		...
		public OpportunityComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.Opportunity;
			TABLENAME_FIELD = "Opportunity";
		...
		{
			return CombosData.GetOpportunityList(isReferesh);
		}
