...
{
	public class HorseComboBox : MultiColumnComboBox
	{
		...
		public HorseComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.HorseSummary;
			TABLENAME_FIELD = "Horse_Summary";
			ID_FIELD = "HorseCode";
			NAME_FIELD = "HorseName";
		}
		...
		{
			return CombosData.GethorseList(isReferesh);
		}
