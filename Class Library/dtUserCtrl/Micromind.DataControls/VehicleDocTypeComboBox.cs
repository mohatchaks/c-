...
{
	public class VehicleDocTypeComboBox : MultiColumnComboBox
	{
		...
		public VehicleDocTypeComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.VehicleDocType;
			TABLENAME_FIELD = "Vehicle_Doc_Type";
			ID_FIELD = "TypeID";
			NAME_FIELD = "TypeName";
		}
		...
		{
			return CombosData.GetVehicleDocTypeList(isReferesh);
		}
