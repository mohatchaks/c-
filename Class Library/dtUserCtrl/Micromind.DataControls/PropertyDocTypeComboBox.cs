...
{
	public class PropertyDocTypeComboBox : MultiColumnComboBox
	{
		...
		public PropertyDocTypeComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.PropertyDocType;
			TABLENAME_FIELD = "Property_Doc_Type";
			ID_FIELD = "TypeID";
			NAME_FIELD = "TypeName";
		}
		...
		{
			return CombosData.GetPropertyDocTypeList(isReferesh);
		}
