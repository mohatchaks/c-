...
{
	public class vendorsFlatComboBox : MultiColumnComboBox
	{
		...
		public bool AllowOAP
		{
			get
			{
				object selectedCellValue = GetSelectedCellValue("AllowOAP");
		...
		protected DataSet GetData(bool isReferesh)
		{
			try
			{
				return CombosData.GetVendorsList(isReferesh);
			}
