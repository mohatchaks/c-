...
{
	public class ProductParentComboBox : MultiColumnComboBox
	{
		...
		public ItemTypes SelectedItemType
		{
			get
			{
				...
				if (base.SelectedRow.Cells["ParentType"].Value == null || base.SelectedRow.Cells["ParentType"].Value.ToString() == "")
				{
					return ItemTypes.None;
				}
				return (ItemTypes)int.Parse(base.SelectedRow.Cells["ParentType"].Value.ToString());
			}
		}

		public ProductParentComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.Product;
			TABLENAME_FIELD = "Product_Parent";
			ID_FIELD = "ProductParentID";
		...
		{
			return CombosData.GetProductParentList(isReferesh);
		}
