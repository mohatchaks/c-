...
{
	public class JobTaskComboBox : MultiColumnComboBox
	{
		...
		public JobTaskComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.JobTask;
			TABLENAME_FIELD = "Job_Task";
			ID_FIELD = "TaskID";
		...
		{
			return CombosData.GetJobTaskList(isReferesh);
		}
