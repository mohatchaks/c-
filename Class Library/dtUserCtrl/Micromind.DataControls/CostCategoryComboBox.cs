...
{
	public class CostCategoryComboBox : MultiColumnComboBox
	{
		...
		public CostCategoryComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.Job;
			TABLENAME_FIELD = "Job_Cost_Category";
			ID_FIELD = "CostCategoryID";
			NAME_FIELD = "CostCategoryName";
		}
		...
		{
			return CombosData.GetCostCategoryList(isReferesh);
		}
