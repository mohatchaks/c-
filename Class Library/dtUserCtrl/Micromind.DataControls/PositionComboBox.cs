...
{
	public class PositionComboBox : MultiColumnComboBox
	{
		...
		public PositionComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.Position;
			TABLENAME_FIELD = "Position";
			ID_FIELD = "PositionID";
		...
		{
			return CombosData.GetPositionList(isReferesh);
		}
