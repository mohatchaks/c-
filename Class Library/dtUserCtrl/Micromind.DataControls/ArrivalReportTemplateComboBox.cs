...
{
	public class ArrivalReportTemplateComboBox : MultiColumnComboBox
	{
		...
		public ArrivalReportTemplateComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.ArrivalReportTemplate;
			TABLENAME_FIELD = "Arrival_Report_Template";
			ID_FIELD = "TemplateID";
		...
		{
			return CombosData.GetArrivalReportTemplateList(isReferesh);
		}
