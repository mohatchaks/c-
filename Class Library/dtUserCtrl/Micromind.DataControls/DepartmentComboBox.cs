...
{
	public class DepartmentComboBox : MultiColumnComboBox
	{
		...
		{
			InitializeComponent();
			base.ComboType = DataComboType.Department;
			TABLENAME_FIELD = "Department";
		...
		{
			return CombosData.GetDepartmentList(isReferesh);
		}
