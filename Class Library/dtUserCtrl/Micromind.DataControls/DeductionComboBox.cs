...
{
	public class DeductionComboBox : MultiColumnComboBox
	{
		...
		public DeductionComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.Deduction;
			TABLENAME_FIELD = "Deduction";
			ID_FIELD = "DeductionID";
			NAME_FIELD = "DeductionName";
		}
		...
		{
			return CombosData.GetDeductionList(isReferesh);
		}
