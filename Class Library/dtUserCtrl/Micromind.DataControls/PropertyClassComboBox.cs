...
{
	public class PropertyClassComboBox : MultiColumnComboBox
	{
		...
		public PropertyClassComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.PropertyClass;
			TABLENAME_FIELD = "Property_Class";
			ID_FIELD = "PropertyClassID";
			NAME_FIELD = "PropertyClassName";
		}
		...
		{
			return CombosData.GetPropertyClassList(isReferesh);
		}
