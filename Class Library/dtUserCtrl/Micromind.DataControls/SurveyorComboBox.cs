...
{
	public class SurveyorComboBox : MultiColumnComboBox
	{
		...
		public SurveyorComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.Surveyor;
			TABLENAME_FIELD = "Surveyor";
			ID_FIELD = "SurveyorID";
			NAME_FIELD = "SurveyorName";
		}
		...
		{
			return CombosData.GetSurveyorList(isReferesh);
		}
