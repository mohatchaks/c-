...
{
	public class ItemClassComboBox : MultiColumnComboBox
	{
		...
		public ItemClassComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.ProductClass;
			TABLENAME_FIELD = "Product_Class";
			ID_FIELD = "ClassID";
		...
		{
			return CombosData.GetProductClassList(isReferesh);
		}
