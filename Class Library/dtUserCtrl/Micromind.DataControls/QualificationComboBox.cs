...
{
	public class QualificationComboBox : MultiColumnComboBox
	{
		...
		public QualificationComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.Qualification;
		...
		{
			return CombosData.GetGenericListList(isReferesh, GenericListTypes.Qualification);
		}
		...
		public void LoadData(bool isReferesh)
		{
			...
			try
			{
				...
				DataRow[] rows = dataSet.Tables[0].Select("GenericListType = " + 6.ToString());
