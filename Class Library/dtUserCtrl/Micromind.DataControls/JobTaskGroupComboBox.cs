...
{
	public class JobTaskGroupComboBox : MultiColumnComboBox
	{
		...
		public JobTaskGroupComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.JobTaskGroup;
			TABLENAME_FIELD = "Job_Task_Group";
			ID_FIELD = "TaskGroupID";
			NAME_FIELD = "TaskGroupName";
		}
		...
		{
			return CombosData.GetJobTaskGroupList(isReferesh);
		}
