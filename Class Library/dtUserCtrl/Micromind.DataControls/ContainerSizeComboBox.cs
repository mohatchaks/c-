...
{
	public class ContainerSizeComboBox : MultiColumnComboBox
	{
		...
		public ContainerSizeComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.ContainerSize;
			TABLENAME_FIELD = "ContainerSize";
			ID_FIELD = "ContainerSizeID";
			NAME_FIELD = "ContainerSizeName";
		}
		...
		{
			return CombosData.GetContainerSizeList(isReferesh);
		}
