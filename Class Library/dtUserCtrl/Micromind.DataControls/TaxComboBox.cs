...
{
	public class TaxComboBox : MultiColumnComboBox
	{
		...
		{
			InitializeComponent();
			base.ComboType = DataComboType.Tax;
			TABLENAME_FIELD = "Tax";
			ID_FIELD = "TaxCode";
			NAME_FIELD = "TaxName";
		}
		...
		{
			return CombosData.GetTaxList(isReferesh);
		}
		...
		public void LoadData(bool isReferesh)
		{
			...
			try
			{
				...
				FillData(dataSet);
				base.DisplayLayout.Bands[0].Columns["TaxRate"].Hidden = false;
