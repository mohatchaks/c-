...
{
	public class DimensionComboBox : MultiColumnComboBox
	{
		...
		public DimensionComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.Dimension;
			TABLENAME_FIELD = "Dimension";
			ID_FIELD = "DimensionID";
			NAME_FIELD = "DimensionName";
		}
		...
		{
			return CombosData.GetDimensionList(isReferesh);
		}
