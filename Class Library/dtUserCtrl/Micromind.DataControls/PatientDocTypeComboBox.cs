...
{
	public class PatientDocTypeComboBox : MultiColumnComboBox
	{
		...
		public PatientDocTypeComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.PatientDocType;
			TABLENAME_FIELD = "Patient_Doc_Type";
			ID_FIELD = "TypeID";
			NAME_FIELD = "TypeName";
		}
		...
		{
			return CombosData.GetPatientDocTypeList(isReferesh);
		}
