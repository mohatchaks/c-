...
{
	public class ProductCategoryComboBox : MultiColumnComboBox
	{
		...
		private string filteredProductID = "asdr323f@$@";
		...
		public ProductCategoryComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.ProductCategory;
			TABLENAME_FIELD = "Product_Category";
			ID_FIELD = "CategoryID";
		...
		{
			return CombosData.GetProductCategoryList(isReferesh);
		}
