...
{
	public class PaymentTermComboBox : MultiColumnComboBox
	{
		...
		public PaymentTermComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.PaymentTerm;
			TABLENAME_FIELD = "Payment_Term";
			ID_FIELD = "PaymentTermID";
			NAME_FIELD = "TermName";
		}
		...
		{
			return CombosData.GetPaymentTermList(isReferesh);
		}
