...
{
	public class CustomerGroupComboBox : MultiColumnComboBox
	{
		...
		public CustomerGroupComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.CustomerGroup;
			TABLENAME_FIELD = "Customer_Group";
			ID_FIELD = "GroupID";
		...
		{
			return CombosData.GetCustomerGroupsList(isReferesh);
		}
