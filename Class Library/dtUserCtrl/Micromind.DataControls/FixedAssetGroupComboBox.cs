...
{
	public class FixedAssetGroupComboBox : MultiColumnComboBox
	{
		...
		public FixedAssetGroupComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.FixedAssetGroup;
			TABLENAME_FIELD = "FixedAsset_Group";
			ID_FIELD = "AssetGroupID";
			NAME_FIELD = "AssetGroupName";
		}
		...
		{
			return CombosData.GetFixedAssetGroupList(isReferesh);
		}
