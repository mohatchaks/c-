...
{
	public class EmployeeLoanTypeComboBox : MultiColumnComboBox
	{
		...
		public EmployeeLoanTypeComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.EmployeeLoanType;
			TABLENAME_FIELD = "Employee_Loan_Type";
			ID_FIELD = "LoanTypeID";
			NAME_FIELD = "LoanTypeName";
		}
		...
		{
			return CombosData.GetEmployeeLoanTypeList(isReferesh);
		}
