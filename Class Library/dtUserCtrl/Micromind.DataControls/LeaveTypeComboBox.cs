...
{
	public class LeaveTypeComboBox : MultiColumnComboBox
	{
		...
		public LeaveTypeComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.LeaveType;
			TABLENAME_FIELD = "Leave_Type";
			ID_FIELD = "LeaveTypeID";
			NAME_FIELD = "LeaveTypeName";
		}
		...
		{
			return CombosData.GetLeaveTypeList(isReferesh);
		}
