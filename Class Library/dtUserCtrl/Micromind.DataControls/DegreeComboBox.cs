...
{
	public class DegreeComboBox : MultiColumnComboBox
	{
		...
		public DegreeComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.Degree;
			TABLENAME_FIELD = "Degree";
			ID_FIELD = "DegreeID";
			NAME_FIELD = "DegreeName";
		}
		...
		{
			return CombosData.GetDegreeList(isReferesh);
		}
