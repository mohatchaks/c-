...
{
	public class PropertyAgentComboBox : MultiColumnComboBox
	{
		...
		public PropertyAgentComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.PropertyAgent;
			TABLENAME_FIELD = "Property_Agent";
			ID_FIELD = "PropertyAgentID";
			NAME_FIELD = "PropertyAgentName";
		}
		...
		{
			return CombosData.GetPropertyAgentList(isReferesh);
		}
