...
{
	public class ActivityComboBox : MultiColumnComboBox
	{
		...
		{
			InitializeComponent();
			base.ComboType = DataComboType.Activity;
			TABLENAME_FIELD = "Activity";
			ID_FIELD = "VoucherID";
			NAME_FIELD = "ActivityName";
		}
		...
		{
			return CombosData.GetActivityList(isReferesh);
		}
