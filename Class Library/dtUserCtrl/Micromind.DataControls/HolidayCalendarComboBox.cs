...
{
	public class HolidayCalendarComboBox : MultiColumnComboBox
	{
		...
		public HolidayCalendarComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.HolidayCalendar;
			TABLENAME_FIELD = "Holiday_Calendar";
			ID_FIELD = "CalendarID";
			NAME_FIELD = "CalendarName";
		}
		...
		{
			if (!Security.HasComboAccessRight(ScreenAreas.HR, suppressMessage: true))
			{
				showQuickAdd = false;
				return;
			}
		...
		{
			return CombosData.GetHolidayList(isReferesh);
		}
