...
{
	public class RouteGroupComboBox : MultiColumnComboBox
	{
		...
		public RouteGroupComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.RouteGroup;
			TABLENAME_FIELD = "Route_Group";
			ID_FIELD = "RouteGroupID";
			NAME_FIELD = "RouteGroupName";
		}
		...
		{
			return CombosData.GetRouteGroupList(isReferesh);
		}
