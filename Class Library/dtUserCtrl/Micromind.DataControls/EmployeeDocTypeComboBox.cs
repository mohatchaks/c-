...
{
	public class EmployeeDocTypeComboBox : MultiColumnComboBox
	{
		...
		public EmployeeDocTypeComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.EmployeeDocType;
			TABLENAME_FIELD = "Employee_Doc_Type";
			ID_FIELD = "TypeID";
			NAME_FIELD = "TypeName";
		}
		...
		{
			return CombosData.GetEmployeeDocTypeList(isReferesh);
		}
