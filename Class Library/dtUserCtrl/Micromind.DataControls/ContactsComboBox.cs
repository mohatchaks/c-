...
{
	public class ContactsComboBox : MultiColumnComboBox
	{
		...
		public ContactsComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.Contact;
			TABLENAME_FIELD = "Contact";
			ID_FIELD = "ContactID";
		...
		{
			return CombosData.GetContactsList(isReferesh);
		}
