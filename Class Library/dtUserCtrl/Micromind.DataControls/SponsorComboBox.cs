...
{
	public class SponsorComboBox : MultiColumnComboBox
	{
		...
		public SponsorComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.Sponsor;
			TABLENAME_FIELD = "Sponsor";
			ID_FIELD = "SponsorID";
			NAME_FIELD = "SponsorName";
		}
		...
		{
			return CombosData.GetSponsorList(isReferesh);
		}
