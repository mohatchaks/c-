...
{
	public class JobTypeComboBox : MultiColumnComboBox
	{
		...
		public JobTypeComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.JobType;
			TABLENAME_FIELD = "Job_Type";
			ID_FIELD = "JobTypeID";
			NAME_FIELD = "JobTypeName";
		}
		...
		{
			return CombosData.GetJobTypeList(isReferesh);
		}
