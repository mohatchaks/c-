...
{
	public class CountryComboBox : MultiColumnComboBox
	{
		...
		{
			InitializeComponent();
			base.ComboType = DataComboType.Country;
			TABLENAME_FIELD = "Country";
			ID_FIELD = "CountryID";
		...
		{
			return CombosData.GetCountryList(isReferesh);
		}
