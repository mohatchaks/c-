...
{
	public class HorseTypeComboBox : MultiColumnComboBox
	{
		...
		public HorseTypeComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.HorseType;
			TABLENAME_FIELD = "Horse_Type";
			ID_FIELD = "HorseTypeID";
			NAME_FIELD = "HorseTypeName";
		}
		...
		{
			return CombosData.GetHorseTypeList(isReferesh);
		}
