...
{
	public class ActivityTypesComboBox : SingleColumnComboBox
	{
		...
		{
			base.Items.Clear();
			foreach (CRMActivityTypes value in Enum.GetValues(typeof(CRMActivityTypes)))
			{
