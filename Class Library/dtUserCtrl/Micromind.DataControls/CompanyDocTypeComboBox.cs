...
{
	public class CompanyDocTypeComboBox : MultiColumnComboBox
	{
		...
		public CompanyDocTypeComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.CompanyDocType;
			TABLENAME_FIELD = "Company_Doc_Type";
			ID_FIELD = "TypeID";
			NAME_FIELD = "TypeName";
		}
		...
		{
			return CombosData.GetCompanyDocTypeList(isReferesh);
		}
