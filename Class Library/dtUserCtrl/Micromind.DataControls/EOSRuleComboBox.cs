...
{
	public class EOSRuleComboBox : MultiColumnComboBox
	{
		...
		public EOSRuleComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.EOSRule;
			TABLENAME_FIELD = "Employee_EOSRule";
			ID_FIELD = "EOSRuleID";
			NAME_FIELD = "EOSRuleName";
		}
		...
		{
			return CombosData.GetEOSRuleList(isReferesh);
		}
