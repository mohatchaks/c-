...
{
	public class POSCashRegisterComboBox : MultiColumnComboBox
	{
		...
		public POSCashRegisterComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.POSCashRegister;
			TABLENAME_FIELD = "POS_CashRegister";
			ID_FIELD = "CashRegisterID";
			NAME_FIELD = "CashRegisterName";
		}
		...
		{
			return CombosData.GetPOSCashRegisterList(isReferesh);
		}
