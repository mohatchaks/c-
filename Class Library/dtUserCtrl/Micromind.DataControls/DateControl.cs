...
{
	public class DateControl : UserControl, ICustomReportControl
	{
		...
		public DateControl()
		{
			...
			SelectedIndexChanged += dateControl_SelectedIndexChanged;
		}
		...
		private void dateControl_SelectedIndexChanged(object sender, EventArgs e)
		{
		}
