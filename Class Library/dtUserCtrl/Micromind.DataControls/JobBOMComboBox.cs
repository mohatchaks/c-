...
{
	public class JobBOMComboBox : MultiColumnComboBox
	{
		...
		public JobBOMComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.BOM;
			TABLENAME_FIELD = "Job_BOM";
			ID_FIELD = "JobBOMID";
			NAME_FIELD = "BOMName";
		}
		...
		{
			return CombosData.GetJobBOMList(isReferesh);
		}
