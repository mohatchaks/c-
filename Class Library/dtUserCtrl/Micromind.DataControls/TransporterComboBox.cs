...
{
	public class TransporterComboBox : MultiColumnComboBox
	{
		...
		public TransporterComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.Transporter;
			TABLENAME_FIELD = "Transporter";
			ID_FIELD = "TransporterID";
			NAME_FIELD = "TransporterName";
		}
		...
		{
			return CombosData.GetTransporterList(isReferesh);
		}
