...
{
	public class ReligionComboBox : MultiColumnComboBox
	{
		...
		public ReligionComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.Religion;
			TABLENAME_FIELD = "Religion";
			ID_FIELD = "ReligionID";
			NAME_FIELD = "ReligionName";
		}
		...
		{
			return CombosData.GetReligionList(isReferesh);
		}
