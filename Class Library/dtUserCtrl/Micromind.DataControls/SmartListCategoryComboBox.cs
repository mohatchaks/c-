...
{
	public class SmartListCategoryComboBox : MultiColumnComboBox
	{
		...
		public SmartListCategoryComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.SmartListCategory;
			allowSort = false;
			TABLENAME_FIELD = "SmartList_Category";
			ID_FIELD = "CategoryID";
		...
		{
			return CombosData.GetSmartListCategoryList(isReferesh);
		}
