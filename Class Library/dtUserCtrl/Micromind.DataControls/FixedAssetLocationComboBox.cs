...
{
	public class FixedAssetLocationComboBox : MultiColumnComboBox
	{
		...
		public FixedAssetLocationComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.FixedAssetLocation;
			TABLENAME_FIELD = "FixedAsset_Location";
			ID_FIELD = "AssetLocationID";
			NAME_FIELD = "AssetLocationName";
		}
		...
		{
			return CombosData.GetFixedAssetLocationList(isReferesh);
		}
