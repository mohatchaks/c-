...
{
	public class PivotGroupComboBox : MultiColumnComboBox
	{
		...
		public PivotGroupComboBox()
		{
			InitializeComponent();
			base.ComboType = DataComboType.PivotGroup;
			TABLENAME_FIELD = "Pivot_Group";
			ID_FIELD = "GroupID";
		...
		{
			return CombosData.GetPivotGroupList(isReferesh);
		}
