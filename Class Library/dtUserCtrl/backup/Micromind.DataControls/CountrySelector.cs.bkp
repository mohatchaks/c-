...
{
	public class CountrySelector : UserControl, ICustomReportControl
	{
		...
		private CountryComboBox comboBoxSingle;

		private CountryComboBox comboBoxFrom;

		private CountryComboBox comboBoxTo;
		...
		private void CountrySelector_Load(object sender, EventArgs e)
		{
		}
		...
		public string GetParameterValue()
		{
			if (crValueType == 1)
			{
				...
				{
					return "ANY(SELECT CountryID FROM Country)";
				}
				if (radioButtonSingle.Checked)
				{
					return "'" + comboBoxSingle.SelectedID + "'";
				...
				if (radioButtonRange.Checked)
				{
					return "ANY(SELECT CountryID FROM Country WHERE CountryID Between '" + comboBoxFrom.SelectedID + "' AND '" + comboBoxTo.SelectedID + "')";
				}
				return "1=1";
			}
			if (crFieldName == "")
		...
		private void EnableDisableControls()
		{
			...
			CountryComboBox countryComboBox = comboBoxFrom;
		...
		private void InitializeComponent()
		{
			...
			comboBoxTo = new Micromind.DataControls.CountryComboBox();
			comboBoxFrom = new Micromind.DataControls.CountryComboBox();
			comboBoxSingle = new Micromind.DataControls.CountryComboBox();
			...
			labelTo.Location = new System.Drawing.Point(288, 29);
			...
			radioButtonAll.Size = new System.Drawing.Size(80, 17);
			radioButtonAll.TabIndex = 0;
			radioButtonAll.TabStop = true;
			radioButtonAll.Text = "All Countrys";
			...
			label3.Location = new System.Drawing.Point(136, 29);
			label3.Name = "label3";
			label3.Size = new System.Drawing.Size(33, 13);
			label3.TabIndex = 4;
			label3.Text = "From:";
			radioButtonSingle.AutoSize = true;
			radioButtonSingle.Location = new System.Drawing.Point(120, 5);
			...
			comboBoxTo.Location = new System.Drawing.Point(309, 26);
			...
			comboBoxFrom.Location = new System.Drawing.Point(181, 26);
			...
			comboBoxFrom.Size = new System.Drawing.Size(108, 20);
			...
			comboBoxSingle.Location = new System.Drawing.Point(181, 4);
			...
			comboBoxSingle.Size = new System.Drawing.Size(236, 20);
			comboBoxSingle.TabIndex = 7;
			...
			base.Name = "CountrySelector";
			base.Size = new System.Drawing.Size(434, 50);
			base.Load += new System.EventHandler(CountrySelector_Load);
