...
{
	public class JobSelector : UserControl, ICustomReportControl
	{
		...
		public string GetParameterValue()
		{
			if (crValueType == 1)
			{
				...
				{
					return "ANY(SELECT JobID FROM Job)";
				}
				if (radioButtonSingle.Checked)
				{
					return "'" + comboBoxSingle.SelectedID + "'";
				...
				if (radioButtonRange.Checked)
				{
					return "ANY(SELECT JobID FROM Job WHERE JobID Between '" + comboBoxFrom.SelectedID + "' AND '" + comboBoxTo.SelectedID + "')";
				}
				return " 1=1 ";
			}
			if (crFieldName == "")
		...
		private void InitializeComponent()
		{
			...
			radioButtonAll.Size = new System.Drawing.Size(61, 17);
			radioButtonAll.TabIndex = 3;
			radioButtonAll.TabStop = true;
			radioButtonAll.Text = "All Jobs";
