...
{
	public class ContainerSelector : UserControl, ICustomReportControl
	{
		...
		private JobComboBox comboBoxSingle;
		...
		private JobComboBox comboBoxFrom;

		private JobComboBox comboBoxTo;
		...
		public string GetParameterValue()
		{
			if (crValueType == 1)
			{
				...
				{
					return "ANY(SELECT ContainerNumber FROM Container_Tracking)";
				}
				if (radioButtonSingle.Checked)
				{
					return "'" + comboBoxSingle.SelectedID + "'";
				...
				if (radioButtonRange.Checked)
				{
					return "ANY(SELECT ContainerNumber FROM Container_Tracking WHERE ContainerNumber Between '" + comboBoxFrom.SelectedID + "' AND '" + comboBoxTo.SelectedID + "')";
				}
				return " 1=1 ";
			}
			if (crFieldName == "")
		...
		private void EnableDisableControls()
		{
			...
			JobComboBox jobComboBox = comboBoxFrom;
			bool enabled = comboBoxTo.Enabled = radioButtonRange.Checked;
			jobComboBox.Enabled = enabled;
		}
		...
		private void InitializeComponent()
		{
			...
			comboBoxTo = new Micromind.DataControls.JobComboBox();
			comboBoxFrom = new Micromind.DataControls.JobComboBox();
			comboBoxSingle = new Micromind.DataControls.JobComboBox();
			...
			radioButtonAll.Text = "All Containers";
			...
			labelTo.Location = new System.Drawing.Point(298, 25);
			labelTo.Name = "labelTo";
			labelTo.Size = new System.Drawing.Size(23, 13);
			labelTo.TabIndex = 12;
			labelTo.Text = "To:";
			comboBoxTo.Assigned = false;
			...
			comboBoxFrom.IsDataLoaded = false;
			comboBoxFrom.Location = new System.Drawing.Point(185, 23);
			...
			comboBoxFrom.Size = new System.Drawing.Size(112, 20);
			comboBoxFrom.TabIndex = 14;
			comboBoxFrom.UseFlatMode = Infragistics.Win.DefaultableBoolean.True;
			comboBoxSingle.Assigned = false;
			...
			comboBoxSingle.IsDataLoaded = false;
			comboBoxSingle.Location = new System.Drawing.Point(185, 0);
			...
			comboBoxSingle.Size = new System.Drawing.Size(244, 20);
			comboBoxSingle.TabIndex = 5;
			...
			base.Name = "ContainerSelector";
			base.Size = new System.Drawing.Size(434, 46);
