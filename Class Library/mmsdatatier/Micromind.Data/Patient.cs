...
{
	public sealed class Patient : StoreObject
	{
		...
		private const string FILEOPENDATE_PARM = "@FileOpenDate";
		...
		private const string CHRONICSCONTROLID_PARM = "@ChronicsControlID";

		private const string ALLERGYCONTROLID_PARM = "@AllergyControlID";

		private const string FORMTYPE_PARM = "@FormType";

		private const string FORMID_PARM = "@FormID";

		private const string CONTROLLID_PARM = "@ControlID";

		private const string LISTVALUE_PARM = "@ListValue";

		private const string LISTNAME_PARM = "@ListName";

		private const string VALUEINDEX_PARM = "@ValueIndex";

		private const string RELATIVENAME_PARM = "@RelativeName";

		private const string RELATION_PARM = "@Relation";

		private const string REMARKS_PARM = "@Remarks";

		private const string AGE_PARM = "@Age";

		private const string SLNO_PARM = "@SlNo";

		public Patient(Config config)
			: base(config)
		{
		}
		...
		private string GetInsertUpdatePatientText(bool isUpdate)
		{
			SqlBuilder sqlBuilder = new SqlBuilder();
			sqlBuilder.AddInsertUpdateParameters("Patient", new FieldValue("CustomerID", "@CustomerID", isUpdateConditionField: true), new FieldValue("FileOpenDate", "@FileOpenDate"), new FieldValue("FileNo", "@FileNo"), new FieldValue("LastName", "@LastName"), new FieldValue("FirstName", "@FirstName"), new FieldValue("MiddleName", "@MiddleName"), new FieldValue("BloodGroup", "@BloodGroup"), new FieldValue("BirthDate", "@BirthDate"), new FieldValue("BirthPlace", "@BirthPlace"), new FieldValue("NationalityID", "@NationalityID"), new FieldValue("ReligionID", "@ReligionID"), new FieldValue("LocationID", "@LocationID"), new FieldValue("Gender", "@Gender"), new FieldValue("MaritalStatus", "@MaritalStatus"), new FieldValue("NationalID", "@NationalID"), new FieldValue("UID", "@UID"), new FieldValue("ChronicsControlID", "@ChronicsControlID"), new FieldValue("AllergyControlID", "@AllergyControlID"));
			if (isUpdate)
			{
				sqlBuilder.AddInsertUpdateParameters("Patient", new FieldValue("DateUpdated", "@DateUpdated", isUpdateConditionField: true, checkForNullValue: true));
			}
			if (isUpdate)
			{
				return sqlBuilder.GetUpdateExpression();
		...
		private SqlCommand GetInsertUpdatePatientCommand(bool isUpdate)
		{
			SqlCommand sqlCommand = null;
			SqlParameterCollection parameters;
			if (isUpdate)
			{
				sqlCommand = new SqlCommand(GetInsertUpdatePatientText(isUpdate: true), base.DBConfig.Connection);
				sqlCommand.CommandType = CommandType.Text;
				parameters = sqlCommand.Parameters;
			}
			else
			{
				sqlCommand = new SqlCommand(GetInsertUpdatePatientText(isUpdate: false), base.DBConfig.Connection);
				sqlCommand.CommandType = CommandType.Text;
				parameters = sqlCommand.Parameters;
			}
			parameters.Add("@CustomerID", SqlDbType.NVarChar);
			parameters.Add("@FileOpenDate", SqlDbType.DateTime);
			...
			parameters.Add("@ChronicsControlID", SqlDbType.NVarChar);
			parameters.Add("@AllergyControlID", SqlDbType.NVarChar);
			parameters["@CustomerID"].SourceColumn = "CustomerID";
			parameters["@FileOpenDate"].SourceColumn = "FileOpenDate";
			...
			parameters["@ChronicsControlID"].SourceColumn = "ChronicsControlID";
			parameters["@AllergyControlID"].SourceColumn = "AllergyControlID";
			if (isUpdate)
			{
				parameters.Add("@DateUpdated", SqlDbType.DateTime);
				parameters["@DateUpdated"].SourceColumn = "DateUpdated";
		...
		private string GetInsertUpdateFormDetailsText(bool isUpdate)
		{
			SqlBuilder sqlBuilder = new SqlBuilder();
			sqlBuilder.AddInsertUpdateParameters("FormList_Details", new FieldValue("FormType", "@FormType"), new FieldValue("FormID", "@FormID"), new FieldValue("ControlID", "@ControlID"), new FieldValue("ListValue", "@ListValue"), new FieldValue("ListName", "@ListName"), new FieldValue("ValueIndex", "@ValueIndex"));
			if (isUpdate)
			{
				sqlBuilder.AddInsertUpdateParameters("FormList_Details", new FieldValue("DateUpdated", "@DateUpdated", isUpdateConditionField: true, checkForNullValue: true));
			}
			if (isUpdate)
			{
				return sqlBuilder.GetUpdateExpression();
		...
		private SqlCommand GetInsertUpdateFormDetailsCommand(bool isUpdate)
		{
			SqlCommand sqlCommand;
			SqlParameterCollection parameters;
			if (isUpdate)
			{
				sqlCommand = new SqlCommand(GetInsertUpdateFormDetailsText(isUpdate: true), base.DBConfig.Connection);
				sqlCommand.CommandType = CommandType.Text;
				parameters = sqlCommand.Parameters;
			}
			else
			{
				sqlCommand = new SqlCommand(GetInsertUpdateFormDetailsText(isUpdate: false), base.DBConfig.Connection);
				sqlCommand.CommandType = CommandType.Text;
				parameters = sqlCommand.Parameters;
			}
			parameters.Add("@FormType", SqlDbType.NVarChar);
			parameters.Add("@FormID", SqlDbType.NVarChar);
			parameters.Add("@ControlID", SqlDbType.NVarChar);
			parameters.Add("@ListValue", SqlDbType.NVarChar);
			parameters.Add("@ListName", SqlDbType.NVarChar);
			parameters.Add("@ValueIndex", SqlDbType.Int);
			parameters["@FormType"].SourceColumn = "FormType";
			parameters["@FormID"].SourceColumn = "FormID";
			parameters["@ControlID"].SourceColumn = "ControlID";
			parameters["@ListValue"].SourceColumn = "ListValue";
			parameters["@ListName"].SourceColumn = "ListName";
			parameters["@ValueIndex"].SourceColumn = "ValueIndex";
			if (isUpdate)
			{
				parameters.Add("@DateUpdated", SqlDbType.DateTime);
				parameters["@DateUpdated"].SourceColumn = "DateUpdated";
		...
		private string GetInsertUpdatePatientDetailsText(bool isUpdate)
		{
			SqlBuilder sqlBuilder = new SqlBuilder();
			sqlBuilder.AddInsertUpdateParameters("Patient_Detail_Table", new FieldValue("CustomerID", "@CustomerID"), new FieldValue("RelativeName", "@RelativeName"), new FieldValue("Age", "@Age"), new FieldValue("Relation", "@Relation"), new FieldValue("RowIndex", "@RowIndex"), new FieldValue("SlNo", "@SlNo"), new FieldValue("Remarks", "@Remarks"));
			if (isUpdate)
			{
				return sqlBuilder.GetUpdateExpression();
			}
		...
		private SqlCommand GetInsertUpdatePatientDetailsCommand(bool isUpdate)
		{
			SqlCommand sqlCommand;
			SqlParameterCollection parameters;
			if (isUpdate)
			{
				sqlCommand = new SqlCommand(GetInsertUpdatePatientDetailsText(isUpdate: true), base.DBConfig.Connection);
				sqlCommand.CommandType = CommandType.Text;
				parameters = sqlCommand.Parameters;
			}
			else
			{
				sqlCommand = new SqlCommand(GetInsertUpdatePatientDetailsText(isUpdate: false), base.DBConfig.Connection);
				sqlCommand.CommandType = CommandType.Text;
				parameters = sqlCommand.Parameters;
			}
			parameters.Add("@CustomerID", SqlDbType.NVarChar);
			parameters.Add("@RelativeName", SqlDbType.NVarChar);
			parameters.Add("@Age", SqlDbType.Int);
			parameters.Add("@Relation", SqlDbType.NVarChar);
			parameters.Add("@Remarks", SqlDbType.NVarChar);
			parameters.Add("@RowIndex", SqlDbType.Int);
			parameters.Add("@SlNo", SqlDbType.Int);
			parameters["@CustomerID"].SourceColumn = "CustomerID";
			parameters["@RelativeName"].SourceColumn = "RelativeName";
			parameters["@Age"].SourceColumn = "Age";
			parameters["@Relation"].SourceColumn = "Relation";
			parameters["@Remarks"].SourceColumn = "Remarks";
			parameters["@RowIndex"].SourceColumn = "RowIndex";
			parameters["@SlNo"].SourceColumn = "SlNo";
			return sqlCommand;
		}

		public bool InsertUpdateCustomer(PatientData accountPatientData, bool isUpdate)
		{
			bool flag = true;
			...
			try
			{
				...
				if (isUpdate)
				{
					...
					if (flag2)
					{
						string text = accountPatientData.CustomerTable.Rows[0]["CustomerID"].ToString();
				...
				flag = ((!isUpdate) ? Insert(accountPatientData, "Customer", insertUpdateCommand) : Update(accountPatientData, "Customer", insertUpdateCommand));
				insertUpdateCommand = GetInsertUpdatePatientCommand(isUpdate);
				insertUpdateCommand.Transaction = sqlTransaction;
				if (flag)
				{
					if (isUpdate)
					{
						flag = Update(accountPatientData, "Patient", insertUpdateCommand);
					}
					else
					{
						flag = Insert(accountPatientData, "Patient", insertUpdateCommand);
						if (accountPatientData.Tables["Analysis"].Rows.Count > 0)
						{
							DataTable table = accountPatientData.Tables["Analysis"].Copy();
				...
				if (flag)
				{
					string cardID = accountPatientData.CustomerTable.Rows[0]["CustomerID"].ToString();
					insertUpdateCommand = GetInsertUpdateFormDetailsCommand(isUpdate: false);
					insertUpdateCommand.Transaction = sqlTransaction;
					if (isUpdate)
					{
						flag &= DeleteFormDetails(sqlTransaction, cardID);
					}
					if (accountPatientData.FormListDetailsTable.Rows.Count > 0)
					{
						flag &= Insert(accountPatientData, "FormList_Details", insertUpdateCommand);
					}
				}
				if (flag)
				{
					string cardID2 = accountPatientData.CustomerTable.Rows[0]["CustomerID"].ToString();
					insertUpdateCommand = GetInsertUpdatePatientDetailsCommand(isUpdate: false);
					insertUpdateCommand.Transaction = sqlTransaction;
					if (isUpdate)
					{
						flag &= DeletePatientDetails(sqlTransaction, cardID2);
					}
					if (accountPatientData.PatientDetailsTable.Rows.Count > 0)
					{
						flag &= Insert(accountPatientData, "Patient_Detail_Table", insertUpdateCommand);
					}
				}
				if (flag)
				{
					...
					if (isUpdate)
					{
						flag &= Update(accountPatientData, "Customer_Address", insertUpdateCommand);
					}
					else if (accountPatientData.CustomerAddressTable.Rows.Count > 0)
					{
						flag &= Insert(accountPatientData, "Customer_Address", insertUpdateCommand);
					}
				}
				string text2 = accountPatientData.CustomerTable.Rows[0]["CustomerID"].ToString();
				if (isUpdate)
				{
					AddActivityLog("Patient", text2, "", ActivityTypes.Update, "", null, SysDocTypes.None, DataComboType.Patient, null, sqlTransaction);
				}
				else
				{
					AddActivityLog("Patient", text2, "", ActivityTypes.Add, "", null, SysDocTypes.None, DataComboType.Patient, null, sqlTransaction);
				}
				UpdateTableRowInsertUpdateInfo("Customer", "CustomerID", text2, sqlTransaction, !isUpdate);
				UpdateTableRowInsertUpdateInfo("Patient", "CustomerID", text2, sqlTransaction, !isUpdate);
				UpdateTableRowInsertUpdateInfo("FormList_Details", "FormID", text2, sqlTransaction, !isUpdate);
				flag &= new Approval(base.DBConfig).CreateCardApprovalTasks(DataComboType.Patient, text2.ToString(), "Customer", "CustomerID", sqlTransaction);
				return flag;
			}
			catch
			{
		...
		public bool UpdateCustomerParentChildRelation(PatientData PatientData, bool isUpdate)
		{
			bool flag = true;
			SqlTransaction sqlTransaction = null;
			try
			{
				...
				string text = PatientData.CustomerTable.Rows[0]["ParentCustomerID"].ToString();
				flag &= DeleteCustomerParentChildRelation(sqlTransaction, text);
				flag &= UpdateCustomerParentChildRelation(sqlTransaction, PatientData);
				if (isUpdate)
				{
		...
		private bool UpdateCustomerParentChildRelation(SqlTransaction sqlTransaction, PatientData PatientData)
		{
			bool flag = true;
			string text = string.Empty;
			string text2 = PatientData.CustomerTable.Rows[0]["ParentCustomerID"].ToString();
			try
			{
				for (int i = 0; i < PatientData.CustomerTable.Rows.Count; i++)
				{
					text = text + "'" + PatientData.CustomerTable.Rows[i]["CustomerID"].ToString() + "'";
					text += ((i < PatientData.CustomerTable.Rows.Count - 1) ? "," : string.Empty);
				}
		...
		private bool DeleteFormDetails(SqlTransaction sqlTransaction, string cardID)
		{
			bool flag = true;
			try
			{
				string commandText = "DELETE FROM FormList_Details WHERE FormID = '" + cardID + "'";
				return Delete(commandText, sqlTransaction);
			}
			catch
			{
		...
		private bool DeletePatientDetails(SqlTransaction sqlTransaction, string cardID)
		{
			bool flag = true;
			try
			{
				string commandText = "DELETE FROM Patient_Detail_Table WHERE CustomerID = '" + cardID + "'";
				return Delete(commandText, sqlTransaction);
			}
			catch
			{
		...
		public PatientData GetCustomer()
		{
			SqlBuilder sqlBuilder = new SqlBuilder();
			sqlBuilder.AddTable("Customer");
			PatientData patientData = new PatientData();
			sqlBuilder.UseDistinct = false;
			FillDataSet(patientData, "Customer", sqlBuilder);
			return patientData;
		}
		...
		public bool DeleteCustomer(string customerID)
		{
			...
			try
			{
				...
				string commandText = "DELETE FROM FormList_Details  WHERE FormID = '" + customerID + "'";
				flag = Delete(commandText, trans);
				commandText = "DELETE FROM Customer_Address  WHERE CustomerID = '" + customerID + "'";
				flag &= Delete(commandText, trans);
				commandText = "DELETE FROM Patient_Detail_Table  WHERE CustomerID = '" + customerID + "'";
				flag &= Delete(commandText, trans);
				commandText = "DELETE FROM Customer WHERE CustomerID = '" + customerID + "'";
				flag &= Delete(commandText, trans);
				commandText = "DELETE FROM Patient WHERE CustomerID = '" + customerID + "'";
				flag &= Delete(commandText, trans);
				if (!flag)
				{
					return flag;
				}
				AddActivityLog("Patient", customerID, ActivityTypes.Delete, null);
				return flag;
			}
			catch
			{
		...
		public PatientData GetCustomerByID(string id)
		{
			new SqlBuilder();
			...
			PatientData patientData = new PatientData();
			FillDataSet(patientData, "Customer", textCommand);
			textCommand = "select *,CASE WHEN Photo IS NULL THEN 'False' ELSE 'True' END AS HasPhoto from Patient where CustomerID = '" + id + "'";
			FillDataSet(patientData, "Patient", textCommand);
			textCommand = "select * from FormList_Details where FormID =  '" + id + "'";
			FillDataSet(patientData, "FormList_Details", textCommand);
			textCommand = "select * from Patient_Detail_Table where CustomerID =  '" + id + "'";
			FillDataSet(patientData, "Patient_Detail_Table", textCommand);
			if (patientData == null || patientData.Tables.Count == 0 || patientData.Tables[0].Rows.Count == 0)
			{
				return patientData;
			}
			string a = "";
			...
			a = patientData.Tables["Customer"].Rows[0]["PrimaryAddressID"].ToString();
			textCommand = "SELECT * FROM Customer_Address\r\n                            WHERE CustomerID='" + id + "' AND AddressID='" + a + "'";
			FillDataSet(patientData, "Customer_Address", textCommand);
			...
			FillDataSet(patientData, "Customer_Contact_Detail", textCommand);
			textCommand = "SELECT * FROM UDF_Customer WHERE EntityID = '" + id + "'";
			FillDataSet(patientData, "UDF", textCommand);
			return patientData;
		}
		...
		public DataSet GetCustomerDataToPrint(string fromCustomer, string toCustomer)
		{
			DataSet dataSet = new DataSet();
			...
			FillDataSet(dataSet, "Customer", text);
			DataSet dataSet2 = new DataSet();
			text = "select P.*, NA.NationalityName,\r\n                    Case  MaritalStatus WHEN 1 THEN 'SINGLE'WHEN 2 THEN 'MARRIED' WHEN 3 THEN 'DIVORCED' WHEN 4 THEN 'WIDOW' ELSE 'NA' END AS [Marital Status]\r\n                        from Patient P\r\n                    LEFT OUTER JOIN Nationality NA ON P.NationalityID=NA.NationalityID where 1=1\r\n                          ";
			if (fromCustomer != "")
			{
				text = text + " AND P.CustomerID = '" + fromCustomer + "'";
			}
			FillDataSet(dataSet2, "Patient", text);
			dataSet.Merge(dataSet2);
			DataSet dataSet3 = new DataSet();
			text = "select * from Patient_Detail_Table PD where 1=1";
			if (fromCustomer != "")
			{
				text = text + " AND PD.CustomerID = '" + fromCustomer + "'";
			}
			FillDataSet(dataSet3, "PatientDetail", text);
			dataSet.Merge(dataSet3);
			DataSet dataSet4 = new DataSet();
			text = "select * from FormList_Details FD \r\n                    LEFT OUTER JOIN Generic_List GL ON FD.ListValue=GL.GenericListID  where 1=1";
			if (fromCustomer != "")
			{
				text = text + " AND FD.FormID = '" + fromCustomer + "'";
			}
			FillDataSet(dataSet4, "formDetail", text);
			dataSet.Merge(dataSet4);
			dataSet.Relations.Add("PatientCustomer", dataSet.Tables["Customer"].Columns["CustomerID"], dataSet.Tables["Patient"].Columns["CustomerID"], createConstraints: false);
			dataSet.Relations.Add("DetailsList", dataSet.Tables["Customer"].Columns["CustomerID"], dataSet.Tables["PatientDetail"].Columns["CustomerID"], createConstraints: false);
			dataSet.Relations.Add("FormDetailsList", dataSet.Tables["Customer"].Columns["CustomerID"], dataSet.Tables["formDetail"].Columns["FormID"], createConstraints: false);
			return dataSet;
		}
		...
		public PatientData GetCustomerParentChildRelation(string parentID)
		{
			PatientData patientData = new PatientData();
			...
			str += " ORDER BY ARJ.CustomerID ";
			FillDataSet(patientData, "Customer", str);
			return patientData;
		}
		...
		{
			DataSet dataSet = new DataSet();
			string textCommand = "SELECT CustomerID [Code],FirstName AS Name,FileNo AS [File#],FileOpenDate FROM Patient\r\n                                ORDER BY CustomerID,FirstName";
			FillDataSet(dataSet, "Patient", textCommand);
			return dataSet;
		}
		...
		public byte[] GetPatientThumbnailImage(string patientID)
		{
			string exp = "SELECT Photo\r\n\t\t\t\t\t\t   FROM Patient P WHERE CustomerID='" + patientID + "'";
			object obj = ExecuteScalar(exp);
			if (obj != null && obj.ToString() != "")
			{
				return (byte[])obj;
		...
		public bool AddPatientPhoto(string patientID, byte[] image)
		{
			bool result = true;
			try
			{
				SqlTransaction transaction = base.DBConfig.StartNewTransaction();
				SqlCommand sqlCommand = new SqlCommand("Update Patient SET Photo=@Photo WHERE CustomerID='" + patientID + "'");
		...
		public bool RemovePatientPhoto(string patientID)
		{
			bool result = true;
			try
			{
				SqlTransaction transaction = base.DBConfig.StartNewTransaction();
				SqlCommand sqlCommand = new SqlCommand("Update Patient SET Photo= Null WHERE CustomerID='" + patientID + "'");
				sqlCommand.Transaction = transaction;
				result = (ExecuteNonQuery(sqlCommand) > 0);
				return result;
			}
