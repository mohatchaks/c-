...
{
	public sealed class PropertyTenantDocType : StoreObject
	{
		...
		private const string PROPERTTENANTYDOCUMENTTYPE_TABLE = "Property_Doc_Type";
		...
		public PropertyTenantDocType(Config config)
			: base(config)
		{
		}
		...
		public bool InsertPropertyTenantDocType(PropertyTenantDocTypeData accountPropertyTenantDocTypeData)
		{
			bool result = true;
		...
		public bool UpdatePropertyTenantDocType(PropertyTenantDocTypeData accountPropertyTenantDocTypeData)
		{
			bool flag = true;
		...
		public bool DeletePropertyTenantDocType(string typeID)
		{
			bool flag = true;
			try
			{
		...
		{
			return GetPropertyTenantDocTypeByFields(null, isInactive: true, columns);
		}

		public DataSet GetPropertyTenantDocTypeByFields(string[] typeID, params string[] columns)
		{
			return GetPropertyTenantDocTypeByFields(typeID, isInactive: true, columns);
		}
