...
namespace LicenseManager
{
	...
	{
		private string passPhrase = "P3fd3@2ddw2";

		private string saltValue = "3s4f@dwf3";
		...
		{
			keySize = int.Parse("256");
			passwordIterations = int.Parse("2");
		}

		public RijndaelCryptor(string passPhrase, string saltValue, string hashAlgorithm, string initVector, int keySize, int passwordIterations)
		{
