...
namespace Micromind.Common.Data
{
	...
	public class FixedAssetPurchaseOrderData : DataSet
	{
		public const string PURCHASEORDER_TABLE = "FixedAsset_Purchase_Order";

		public const string PURCHASEORDERDETAIL_TABLE = "FixedAsset_Purchase_Order_Detail";
		...
		public DataTable PurchaseOrderTable => base.Tables["FixedAsset_Purchase_Order"];

		public DataTable PurchaseOrderDetailTable => base.Tables["FixedAsset_Purchase_Order_Detail"];

		public DataTable TaxDetailsTable => base.Tables["Tax_Detail"];

		public FixedAssetPurchaseOrderData()
		{
			BuildDataTables();
		}
		...
		{
			DataTable dataTable = new DataTable("FixedAsset_Purchase_Order");
			...
			dataTable = new DataTable("FixedAsset_Purchase_Order_Detail");
