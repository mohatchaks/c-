...
namespace Micromind.Common.Data
{
	...
	public class CaseClientAddressData : DataSet
	{
		...
		public const string ADDRESSNAME_FIELD = "AddressName";
		...
		public CaseClientAddressData()
		{
			BuildDataTables();
		}

		public CaseClientAddressData(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
		...
		{
			DataTable dataTable = new DataTable("Case_Client_Address");
			DataColumnCollection columns = dataTable.Columns;
			DataColumn dataColumn = columns.Add("AddressID", typeof(string));
			dataColumn.AllowDBNull = false;
			dataColumn.AutoIncrement = false;
			DataColumn dataColumn2 = columns.Add("CaseClientID", typeof(string));
			dataColumn.AllowDBNull = false;
			dataColumn.AutoIncrement = false;
			...
			columns.Add("AddressName", typeof(string));
			...
			columns.Add("Latitude", typeof(string));
