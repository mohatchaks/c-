...
namespace Micromind.Common.Data
{
	...
	public class ConsignOutSettlementData : DataSet
	{
		public const string CONSIGNOUTSETTLEMENT_TABLE = "ConsignOut_Settlement";

		public const string CONSIGNOUTSETTLEMENTDETAIL_TABLE = "ConsignOut_Settlement_Detail";

		public const string CONSIGNOUTEXPENSE_TABLE = "ConsignOut_Expense";
		...
		public DataTable ExpenseTable => base.Tables["ConsignOut_Expense"];

		public DataTable ConsignOutSettlementTable => base.Tables["ConsignOut_Settlement"];

		public DataTable ConsignOutSettlementDetailTable => base.Tables["ConsignOut_Settlement_Detail"];

		public ConsignOutSettlementData()
		{
			BuildDataTables();
		}

		public ConsignOutSettlementData(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
		...
		{
			DataTable dataTable = new DataTable("ConsignOut_Settlement");
			...
			dataTable = new DataTable("ConsignOut_Settlement_Detail");
			...
			base.Tables.Add(dataTable);
			dataTable = new DataTable("ConsignOut_Expense");
			columns = dataTable.Columns;
			columns.Add("SysDocID", typeof(string));
			columns.Add("VoucherID", typeof(string));
