...
namespace Micromind.Common.Data
{
	...
	public class ExportPickListData : DataSet
	{
		public const string EXPORTPICKLIST_TABLE = "Export_PickList";

		public const string EXPORTPICKLISTDETAIL_TABLE = "Export_PickList_Detail";
		...
		public DataTable ExportPickListTable => base.Tables["Export_PickList"];

		public DataTable ExportPickListDetailTable => base.Tables["Export_PickList_Detail"];

		public DataTable TaxDetailsTable => base.Tables["Tax_Detail"];

		public ExportPickListData()
		{
			BuildDataTables();
		}

		public ExportPickListData(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
		...
		{
			DataTable dataTable = new DataTable("Export_PickList");
			...
			dataTable = new DataTable("Export_PickList_Detail");
