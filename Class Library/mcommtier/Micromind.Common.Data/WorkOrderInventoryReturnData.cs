...
namespace Micromind.Common.Data
{
	...
	public class WorkOrderInventoryReturnData : DataSet
	{
		...
		public const string WORKORDERINVENTORYRETURN_TABLE = "EA_WorkOrder_Inventory_Return";
		...
		public const string WORKORDERINVENTORYRETURNDETAIL_TABLE = "EA_WorkOrder_Inventory_Return_Detail";

		public DataTable WorkOrderInventoryReturnTable => base.Tables["EA_WorkOrder_Inventory_Return"];

		public DataTable WorkOrderInventoryReturnDetailTable => base.Tables["EA_WorkOrder_Inventory_Return_Detail"];

		public WorkOrderInventoryReturnData()
		{
			BuildDataTables();
		}

		public WorkOrderInventoryReturnData(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
		...
		{
			DataTable dataTable = new DataTable("EA_WorkOrder_Inventory_Return");
			...
			dataTable = new DataTable("EA_WorkOrder_Inventory_Return_Detail");
