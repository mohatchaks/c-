...
namespace Micromind.Common.Data
{
	...
	public class CompanyAddressData : DataSet
	{
		...
		public CompanyAddressData(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
		...
		{
			DataTable dataTable = new DataTable("Company_Address");
