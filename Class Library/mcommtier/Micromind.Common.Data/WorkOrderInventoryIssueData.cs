...
namespace Micromind.Common.Data
{
	...
	public class WorkOrderInventoryIssueData : DataSet
	{
		...
		public const string WORKORDERINVENTORYISSUE_TABLE = "EA_WorkOrder_Inventory_Issue";
		...
		public const string WORKORDERINVENTORYISSUEDETAIL_TABLE = "EA_WorkOrder_Inventory_Issue_Detail";

		public DataTable WorkOrderInventoryIssueTable => base.Tables["EA_WorkOrder_Inventory_Issue"];

		public DataTable WorkOrderInventoryIssueDetailTable => base.Tables["EA_WorkOrder_Inventory_Issue_Detail"];

		public WorkOrderInventoryIssueData()
		{
			BuildDataTables();
		}

		public WorkOrderInventoryIssueData(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
		...
		{
			DataTable dataTable = new DataTable("EA_WorkOrder_Inventory_Issue");
			...
			dataTable = new DataTable("EA_WorkOrder_Inventory_Issue_Detail");
