...
namespace Micromind.Common.Data
{
	...
	public class VendorAddressData : DataSet
	{
		...
		public VendorAddressData()
		{
			BuildDataTables();
		}

		public VendorAddressData(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
		...
		{
			DataTable dataTable = new DataTable("Vendor_Address");
			DataColumnCollection columns = dataTable.Columns;
			DataColumn dataColumn = columns.Add("AddressID", typeof(string));
			dataColumn.AllowDBNull = false;
			dataColumn.AutoIncrement = false;
			DataColumn dataColumn2 = columns.Add("VendorID", typeof(string));
			dataColumn.AllowDBNull = false;
			dataColumn.AutoIncrement = false;
