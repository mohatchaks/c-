...
namespace Micromind.Common.Data
{
	...
	public class LeadAddressData : DataSet
	{
		...
		public LeadAddressData()
		{
			BuildDataTables();
		}

		public LeadAddressData(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
		...
		{
			DataTable dataTable = new DataTable("Lead_Address");
			DataColumnCollection columns = dataTable.Columns;
			DataColumn dataColumn = columns.Add("AddressID", typeof(string));
			dataColumn.AllowDBNull = false;
			dataColumn.AutoIncrement = false;
			DataColumn dataColumn2 = columns.Add("LeadID", typeof(string));
			dataColumn.AllowDBNull = false;
			dataColumn.AutoIncrement = false;
