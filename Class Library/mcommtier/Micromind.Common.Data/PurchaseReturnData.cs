...
namespace Micromind.Common.Data
{
	...
	public class PurchaseReturnData : DataSet
	{
		public const string PURCHASERETURN_TABLE = "Purchase_Return";

		public const string PURCHASERETURNDETAIL_TABLE = "Purchase_Return_Detail";
		...
		public const string TAXAMOUNTLC_FIELD = "TaxAmountLC";
		...
		public DataTable PurchaseReturnTable => base.Tables["Purchase_Return"];

		public DataTable PurchaseReturnDetailTable => base.Tables["Purchase_Return_Detail"];

		public DataTable PaymentTable => base.Tables["Invoice_Payment"];

		public DataTable TaxDetailsTable => base.Tables["Tax_Detail"];

		public PurchaseReturnData()
		{
			BuildDataTables();
		}

		public PurchaseReturnData(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
		...
		{
			DataTable dataTable = new DataTable("Purchase_Return");
			...
			dataTable = new DataTable("Purchase_Return_Detail");
			...
			columns.Add("TaxAmount", typeof(decimal));
			columns.Add("TaxAmountLC", typeof(decimal));
