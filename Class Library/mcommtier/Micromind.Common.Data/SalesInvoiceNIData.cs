...
namespace Micromind.Common.Data
{
	...
	public class SalesInvoiceNIData : DataSet
	{
		public const string SALESINVOICE_TABLE = "Sales_Invoice_NonInv";

		public const string SALESINVOICEDETAIL_TABLE = "Sales_Invoice_NonInv_Detail";
		...
		public const string SALESINVOICEEXPENSETABLE_TABLE = "Sales_Invoice_NonInv_Expense";
		...
		public DataTable InvoiceExpenseTable => base.Tables["Sales_Invoice_NonInv_Expense"];

		public DataTable SalesInvoiceTable => base.Tables["Sales_Invoice_NonInv"];

		public DataTable SalesInvoiceDetailTable => base.Tables["Sales_Invoice_NonInv_Detail"];

		public DataTable TaxDetailsTable => base.Tables["Tax_Detail"];

		public SalesInvoiceNIData()
		{
			BuildDataTables();
		}

		public SalesInvoiceNIData(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
		...
		{
			DataTable dataTable = new DataTable("Sales_Invoice_NonInv");
			...
			columns.Add("AgentID", typeof(string));
			columns.Add("InvoiceType", typeof(int));
			columns.Add("DriverID", typeof(string));
			columns.Add("VehicleID", typeof(string));
			base.Tables.Add(dataTable);
			dataTable = new DataTable("Sales_Invoice_NonInv_Detail");
			...
			columns.Add("SourceDocType", typeof(byte));
			base.Tables.Add(dataTable);
			dataTable = new DataTable("Sales_Invoice_NonInv_Expense");
			columns = dataTable.Columns;
			columns.Add("InvoiceSysDocID", typeof(string));
			columns.Add("InvoiceVoucherID", typeof(string));
