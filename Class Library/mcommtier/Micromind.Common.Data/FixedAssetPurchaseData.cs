...
namespace Micromind.Common.Data
{
	...
	public class FixedAssetPurchaseData : DataSet
	{
		public const string FIXEDASSETPURCHASE_TABLE = "FixedAsset_Purchase";

		public const string FIXEDASSETPURCHASEDETAIL_TABLE = "FixedAsset_Purchase_Detail";
		...
		public DataTable FixedAssetPurchaseTable => base.Tables["FixedAsset_Purchase"];

		public DataTable FixedAssetPurchaseDetailTable => base.Tables["FixedAsset_Purchase_Detail"];

		public DataTable TaxDetailsTable => base.Tables["Tax_Detail"];

		public FixedAssetPurchaseData()
		{
			BuildDataTables();
		}

		public FixedAssetPurchaseData(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
		...
		{
			DataTable dataTable = new DataTable("FixedAsset_Purchase");
			...
			dataTable = new DataTable("FixedAsset_Purchase_Detail");
