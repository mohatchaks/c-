...
namespace Micromind.Common.Data
{
	...
	public class EmployeeDocTypeData : DataSet
	{
		public const string EMPDOCUMENTTYPE_TABLE = "Employee_Doc_Type";
		...
		public DataTable EmpDocumentTypeTable => base.Tables["Employee_Doc_Type"];

		public EmployeeDocTypeData()
		{
			BuildDataTables();
		}

		public EmployeeDocTypeData(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
		...
		{
			DataTable dataTable = new DataTable("Employee_Doc_Type");
