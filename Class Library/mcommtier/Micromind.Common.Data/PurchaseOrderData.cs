...
namespace Micromind.Common.Data
{
	...
	{
		public const string PURCHASEORDER_TABLE = "Purchase_Order";

		public const string PURCHASEORDERDETAIL_TABLE = "Purchase_Order_Detail";
		...
		public const string DELIVERYADDRESSID_FIELD = "DeliveryAddressID";

		public const string VENDORADDRESS_FIELD = "VendorAddress";

		public const string BILLINGADDRESSID_FIELD = "BillingAddressID";

		public const string DELIVERYADDRESS_FIELD = "DeliveryAddress";
		...
		public const string PREPAIDAMOUNT_FIELD = "PrepaidAmount";
		...
		public const string ACTUALREQDATE_FIELD = "ActualReqDate";
		...
		public const string ALLOWPOEDIT_FIELD = "AllowPOEdit";
		...
		public const string MINGUARANTEE_FIELD = "MinGuarantee";
		...
		public DataTable PurchaseOrderTable => base.Tables["Purchase_Order"];

		public DataTable PurchaseQuoteTable => base.Tables["Purchase_Quote"];

		public DataTable PurchaseOrderDetailTable => base.Tables["Purchase_Order_Detail"];
		...
		public PurchaseOrderData(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
		...
		{
			DataTable dataTable = new DataTable("Purchase_Order");
			...
			columns.Add("DeliveryAddressID", typeof(string));
			columns.Add("BillingAddressID", typeof(string));
			columns.Add("DeliveryAddress", typeof(string));
			...
			columns.Add("ActualReqDate", typeof(DateTime));
			...
			columns.Add("AllowPOEdit", typeof(bool)).DefaultValue = 0;
			base.Tables.Add(dataTable);
			dataTable = new DataTable("Purchase_Order_Detail");
			...
			columns.Add("SourceDocType", typeof(byte));
			columns.Add("JobID", typeof(string));
			columns.Add("MinGuarantee", typeof(decimal)).DefaultValue = 0;
			columns.Add("TaxAmount", typeof(decimal));
			...
			columns.Add("CostCategoryID", typeof(string));
			columns.Add("Length", typeof(decimal)).DefaultValue = 0;
			columns.Add("Width", typeof(decimal)).DefaultValue = 0;
			columns.Add("Height", typeof(decimal)).DefaultValue = 0;
			columns.Add("Number", typeof(decimal)).DefaultValue = 0;
			...
			base.Tables.Add(dataTable);
			dataTable = new DataTable("Purchase_Quote");
			columns = dataTable.Columns;
			columns.Add("SysDocID", typeof(string));
			columns.Add("VoucherID", typeof(string));
			columns.Add("SourceSysDocID", typeof(string));
