...
namespace Micromind.Common.Data
{
	...
	public class BankFacilityPaymentData : DataSet
	{
		...
		public const string TRANSACTIONVOUCHERID_FIELD = "TransactionVoucherID";
		...
		public const string PAYFROMACCOUNTID_FIELD = "PayFromAccountID";

		public const string PAYTOACCOUNTID_FIELD = "PayToAccountID";

		public const string DIVISIONID_FIELD = "DivisionID";

		public const string COMPANYID_FIELD = "CompanyID";

		public const string BANKFACILITYPAYMENT_TABLE = "Bank_Facility_Payment";
		...
		public const string BANKFACILITYPAYMENTDETAILS_TABLE = "Bank_Facility_Payment_Details";
		...
		public DataTable BankFacilityPaymentTable => base.Tables["Bank_Facility_Payment"];

		public DataTable BankFacilityPaymentDetailsTable => base.Tables["Bank_Facility_Payment_Details"];

		public DataTable BankFeeDetailsTable => base.Tables["Bank_Fee_Details"];

		public DataTable TaxDetailsTable => base.Tables["Tax_Detail"];

		public BankFacilityPaymentData()
		{
			BuildDataTables();
		}

		public BankFacilityPaymentData(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
		...
		{
			DataTable dataTable = new DataTable("Bank_Facility_Payment");
			...
			columns.Add("TransactionVoucherID", typeof(string));
			...
			columns.Add("PayFromAccountID", typeof(string));
			columns.Add("PayToAccountID", typeof(string));
			columns.Add("ChequebookID", typeof(string));
			columns.Add("EmployeeID", typeof(string));
			base.Tables.Add(dataTable);
			dataTable = new DataTable("Bank_Facility_Payment_Details");
