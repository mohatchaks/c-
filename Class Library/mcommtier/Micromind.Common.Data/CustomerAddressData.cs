...
namespace Micromind.Common.Data
{
	...
	public class CustomerAddressData : DataSet
	{
		...
		public CustomerAddressData(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
		...
		{
			DataTable dataTable = new DataTable("Customer_Address");
			DataColumnCollection columns = dataTable.Columns;
			DataColumn dataColumn = columns.Add("AddressID", typeof(string));
			dataColumn.AllowDBNull = false;
			dataColumn.AutoIncrement = false;
			DataColumn dataColumn2 = columns.Add("CustomerID", typeof(string));
			dataColumn.AllowDBNull = false;
			dataColumn.AutoIncrement = false;
