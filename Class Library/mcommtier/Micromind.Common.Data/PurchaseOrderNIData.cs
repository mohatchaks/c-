...
namespace Micromind.Common.Data
{
	...
	public class PurchaseOrderNIData : DataSet
	{
		public const string PURCHASEORDER_TABLE = "Purchase_Order_NonInv";

		public const string PURCHASEORDERDETAIL_TABLE = "Purchase_Order_NonInv_Detail";
		...
		public DataTable PurchaseOrderTable => base.Tables["Purchase_Order_NonInv"];

		public DataTable PurchaseOrderDetailTable => base.Tables["Purchase_Order_NonInv_Detail"];

		public DataTable TaxDetailsTable => base.Tables["Tax_Detail"];

		public PurchaseOrderNIData()
		{
			BuildDataTables();
		}

		public PurchaseOrderNIData(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
		...
		{
			DataTable dataTable = new DataTable("Purchase_Order_NonInv");
			...
			dataTable = new DataTable("Purchase_Order_NonInv_Detail");
