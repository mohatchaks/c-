...
namespace Micromind.Common.Data
{
	...
	public class W3PLDeliveryData : DataSet
	{
		public const string W3PLDELIVERY_TABLE = "W3PL_Delivery";

		public const string W3PLDELIVERYDETAIL_TABLE = "W3PL_Delivery_Detail";
		...
		public DataTable W3PLDeliveryTable => base.Tables["W3PL_Delivery"];

		public DataTable W3PLDeliveryDetailTable => base.Tables["W3PL_Delivery_Detail"];

		public DataTable InvoiceDNoteTable => base.Tables["Invoice_DNote"];

		public W3PLDeliveryData()
		{
			BuildDataTables();
		}

		public W3PLDeliveryData(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
		...
		{
			DataTable dataTable = new DataTable("W3PL_Delivery");
			...
			dataTable = new DataTable("W3PL_Delivery_Detail");
