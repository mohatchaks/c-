...
namespace Micromind.Common.Data
{
	...
	public class PropertyDocTypeData : DataSet
	{
		public const string PROPERTYDOCUMENTTYPE_TABLE = "Property_Doc_Type";
		...
		public DataTable PropertyDocumentTypeTable => base.Tables["Property_Doc_Type"];

		public PropertyDocTypeData()
		{
			BuildDataTables();
		}

		public PropertyDocTypeData(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
		...
		{
			DataTable dataTable = new DataTable("Property_Doc_Type");
