...
namespace Micromind.Common.Data
{
	...
	public class CompanyDocTypeData : DataSet
	{
		public const string COMPANYDOCUMENTTYPE_TABLE = "Company_Doc_Type";
		...
		public DataTable CompanyDocumentTypeTable => base.Tables["Company_Doc_Type"];

		public CompanyDocTypeData()
		{
			BuildDataTables();
		}

		public CompanyDocTypeData(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
		...
		{
			DataTable dataTable = new DataTable("Company_Doc_Type");
