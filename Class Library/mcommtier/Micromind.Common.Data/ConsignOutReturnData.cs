...
namespace Micromind.Common.Data
{
	...
	public class ConsignOutReturnData : DataSet
	{
		public const string CONSIGNOUTRETURN_TABLE = "ConsignOut_Return";

		public const string CONSIGNOUTRETURNDETAIL_TABLE = "ConsignOut_Return_Detail";
		...
		public DataTable ConsignOutReturnTable => base.Tables["ConsignOut_Return"];

		public DataTable ConsignOutReturnDetailTable => base.Tables["ConsignOut_Return_Detail"];

		public ConsignOutReturnData()
		{
			BuildDataTables();
		}

		public ConsignOutReturnData(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
		...
		{
			DataTable dataTable = new DataTable("ConsignOut_Return");
			...
			dataTable = new DataTable("ConsignOut_Return_Detail");
