...
namespace Micromind.Common.Data
{
	...
	public class PurchaseInvoiceNIData : DataSet
	{
		public const string PURCHASEINVOICE_TABLE = "Purchase_Invoice_NonInv";

		public const string PURCHASEINVOICEDETAIL_TABLE = "Purchase_Invoice_NonInv_Detail";
		...
		public const string SUPPLIERINVOICENUMBER_FIELD = "SupplierInvoiceNumber";
		...
		public DataTable PurchaseInvoiceTable => base.Tables["Purchase_Invoice_NonInv"];

		public DataTable PurchaseInvoiceDetailTable => base.Tables["Purchase_Invoice_NonInv_Detail"];

		public DataTable TaxDetailsTable => base.Tables["Tax_Detail"];

		public PurchaseInvoiceNIData()
		{
			BuildDataTables();
		}

		public PurchaseInvoiceNIData(SerializationInfo info, StreamingContext context)
			: base(info, context)
		{
		}
		...
		{
			DataTable dataTable = new DataTable("Purchase_Invoice_NonInv");
			...
			columns.Add("SupplierInvoiceNumber", typeof(string));
			columns.Add("TaxOption", typeof(byte));
			columns.Add("PayeeTaxGroupID", typeof(string));
			base.Tables.Add(dataTable);
			dataTable = new DataTable("Purchase_Invoice_NonInv_Detail");
