...
{
	public class FixedAssetTransactionsReport : Form, IForm
	{
		...
		public FixedAssetTransactionsReport()
		{
			InitializeComponent();
			base.Load += Form_Load;
		}
		...
		{
			DataSet data = Factory.FixedAssetSystem.GetAssetTransactionReport(dateControl1.FromDate, dateControl1.ToDate, FixedAssetSelector.FromLocation, FixedAssetSelector.ToLocation, FixedAssetSelector.FromFixedAsset, FixedAssetSelector.ToFixedAsset, FixedAssetSelector.FromClass, FixedAssetSelector.ToClass, FixedAssetSelector.FromGroup, FixedAssetSelector.ToGroup, checkBoxbyAsset.Checked, checkBoxShowInactiveItems.Checked);
			ReportHelper reportHelper = new ReportHelper();
			string reportFilter = "From:" + dateControl1.FromDate.ToShortDateString() + "  To:" + dateControl1.ToDate.ToShortDateString();
			reportHelper.AddGeneralReportData(ref data, reportFilter);
			reportHelper.AddFilterData(ref data, GetAllFormControls(this));
			XtraReport report = reportHelper.GetReport("Fixed Asset Transaction");
			if (report == null)
			{
				ErrorHelper.ErrorMessage("Cannot find the report file", "'Fixed Asset Transaction.repx'", "Please make sure you have access to reports path and the files are not corrupted.");
				return;
			}
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.Customers.FixedAssetTransactionsReport));
			...
			base.Name = "FixedAssetTransactionsReport";
			Text = "Fixed Asset Transaction";
