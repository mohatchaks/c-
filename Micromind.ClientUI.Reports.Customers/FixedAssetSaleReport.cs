...
{
	public class FixedAssetSaleReport : Form, IForm
	{
		...
		private void buttonOK_Click(object sender, EventArgs e)
		{
			try
			{
				...
				DataSet data = Factory.FixedAssetSystem.GetAssetSaleDetailReport(dateControl1.FromDate, dateControl1.ToDate, FixedAssetSelector.FromFixedAsset, FixedAssetSelector.ToFixedAsset, FixedAssetSelector.FromClass, FixedAssetSelector.ToClass, FixedAssetSelector.FromGroup, FixedAssetSelector.ToGroup);
				xtraReport = reportHelper.GetReport("Fixed Asset Sale");
				string reportFilter = "From:" + dateControl1.FromDate.ToShortDateString() + "  To:" + dateControl1.ToDate.ToShortDateString();
				reportHelper.AddGeneralReportData(ref data, reportFilter);
				reportHelper.AddFilterData(ref data, GetAllFormControls(this));
				if (xtraReport == null)
				{
					ErrorHelper.ErrorMessage("Cannot find the report file", "'Fixed Asset Sale.repx'", "Please make sure you have access to reports path and the files are not corrupted.");
				}
				else
				{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.Customers.FixedAssetSaleReport));
			...
			base.Name = "FixedAssetSaleReport";
