...
{
	public class PurchaseByVendorGroupReport : Form, IForm
	{
		...
		private VendorGroupSelector vendorGroupSelector;
		...
		public int ScreenID => 7031;

		public ScreenTypes ScreenType => ScreenTypes.Report;

		public PurchaseByVendorGroupReport()
		{
			InitializeComponent();
			base.Load += Form_Load;
		}
		...
		private void buttonOK_Click(object sender, EventArgs e)
		{
			...
			{
				data = Factory.VendorSystem.GetPurchaseByVendorGroupDetailReport(dateControl1.FromDate, dateControl1.ToDate, vendorGroupSelector.FromVendorGroup, vendorGroupSelector.ToVendorGroup);
				...
				xtraReport = reportHelper.GetReport("Purchase By Vendor Group Detail");
			}
			else
			{
				data = Factory.VendorSystem.GetPurchaseByVendorGroupSummaryReport(dateControl1.FromDate, dateControl1.ToDate, vendorGroupSelector.FromVendorGroup, vendorGroupSelector.ToVendorGroup);
				...
				xtraReport = reportHelper.GetReport("Purchase By Vendor Group Summary");
			}
			...
			if (xtraReport == null)
			{
				ErrorHelper.ErrorMessage("Cannot find the report file", "Please make sure you have access to reports path and the files are not corrupted.", "'Purchase By Vendor Group Summary.repx'");
				return;
			}
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.Customers.PurchaseByVendorGroupReport));
			buttonOK = new System.Windows.Forms.Button();
			vendorGroupSelector = new Micromind.DataControls.VendorGroupSelector();
			...
			vendorGroupSelector.BackColor = System.Drawing.Color.Transparent;
			vendorGroupSelector.Location = new System.Drawing.Point(6, 19);
			vendorGroupSelector.Name = "vendorGroupSelector";
			vendorGroupSelector.Size = new System.Drawing.Size(436, 55);
			vendorGroupSelector.TabIndex = 0;
			ultraGroupBox1.Controls.Add(vendorGroupSelector);
			...
			ultraGroupBox1.Text = "Vendor Groups";
			...
			base.Name = "PurchaseByVendorGroupReport";
			Text = "Purchase by Vendor Group Report";
