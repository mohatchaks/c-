...
{
	public class FixedAssetDepreciationReport : Form, IForm
	{
		...
		public FixedAssetDepreciationReport()
		{
			InitializeComponent();
			base.Load += Form_Load;
		}
		...
		{
			DataSet data = Factory.FixedAssetSystem.GetAssetDepreciationReport(dateControl1.FromDate, dateControl1.ToDate, FixedAssetSelector.FromLocation, FixedAssetSelector.ToLocation, FixedAssetSelector.FromFixedAsset, FixedAssetSelector.ToFixedAsset, FixedAssetSelector.FromClass, FixedAssetSelector.ToClass, FixedAssetSelector.FromGroup, FixedAssetSelector.ToGroup, checkBoxbyAsset.Checked, checkBoxShowInactiveItems.Checked);
			...
			XtraReport xtraReport = checkBoxbyAsset.Checked ? reportHelper.GetReport("Fixed Asset Depreciation By Asset") : reportHelper.GetReport("Fixed Asset Depreciation By Date");
			if (xtraReport == null)
			{
				ErrorHelper.ErrorMessage("Cannot find the report file", "'Fixed Asset Depreciation.repx'", "Please make sure you have access to reports path and the files are not corrupted.");
				return;
			}
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.Customers.FixedAssetDepreciationReport));
			...
			base.Name = "FixedAssetDepreciationReport";
