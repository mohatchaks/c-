...
{
	public class PurchaseByBuyerReport : Form, IForm
	{
		...
		public int ScreenID => 7027;

		public ScreenTypes ScreenType => ScreenTypes.Report;

		public PurchaseByBuyerReport()
		{
			InitializeComponent();
			base.Load += Form_Load;
		}
		...
		private void buttonOK_Click(object sender, EventArgs e)
		{
			...
			{
				data = Factory.BuyerSystem.GetPurchaseByBuyerDetailReport(dateControl1.FromDate, dateControl1.ToDate, buyerSelector.FromBuyer, buyerSelector.ToBuyer);
				...
				xtraReport = reportHelper.GetReport("Purchase By Buyer Detail");
			}
			else
			{
				data = Factory.BuyerSystem.GetPurchaseByBuyerSummaryReport(dateControl1.FromDate, dateControl1.ToDate, buyerSelector.FromBuyer, buyerSelector.ToBuyer);
				...
				xtraReport = reportHelper.GetReport("Purchase By Buyer Summary");
			}
			...
			if (xtraReport == null)
			{
				ErrorHelper.ErrorMessage("Cannot find the report file", "Please make sure you have access to reports path and the files are not corrupted.", "'Purchase By Buyer Summary.repx'");
				return;
			}
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.Customers.PurchaseByBuyerReport));
			...
			buyerSelector.Location = new System.Drawing.Point(6, 19);
			buyerSelector.Name = "buyerSelector";
			buyerSelector.Size = new System.Drawing.Size(436, 55);
			buyerSelector.TabIndex = 0;
			ultraGroupBox1.Controls.Add(buyerSelector);
			...
			base.Name = "PurchaseByBuyerReport";
			Text = "Purchase by Buyer Report";
