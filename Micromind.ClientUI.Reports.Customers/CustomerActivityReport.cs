...
{
	public class CustomerActivityReport : Form, IForm
	{
		...
		private void buttonOK_Click(object sender, EventArgs e)
		{
			...
			XtraReport report = reportHelper.GetReport("Customer Activity");
			if (report == null)
			{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.Customers.CustomerActivityReport));
			...
			buttonOK.Location = new System.Drawing.Point(286, 269);
			...
			buttonClose.Location = new System.Drawing.Point(390, 269);
			...
			dateControl1.Location = new System.Drawing.Point(12, 209);
			...
			base.ClientSize = new System.Drawing.Size(498, 300);
			...
			base.Name = "CustomerActivityReport";
