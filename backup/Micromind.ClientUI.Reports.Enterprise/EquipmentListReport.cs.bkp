...
{
	public class EquipmentListReport : Form, IForm
	{
		...
		{
			DataSet data = Factory.EAEquipmentSystem.GetEquipmentListReport(equipmentSelector.FromEquipment, equipmentSelector.ToEquipment, equipmentSelector.FromType, equipmentSelector.ToType, equipmentSelector.FromCategory, equipmentSelector.ToCategory, workLocationSelector.FromLocation, workLocationSelector.ToLocation, jobSelector.FromJob, jobSelector.ToJob, checkBoxShowInactive.Checked);
			ReportHelper reportHelper = new ReportHelper();
			string reportFilter = "";
			reportHelper.AddGeneralReportData(ref data, reportFilter);
			reportHelper.AddFilterData(ref data, GetAllFormControls(this));
			XtraReport report = reportHelper.GetReport("Equipment List");
			if (report == null)
			{
				ErrorHelper.ErrorMessage("Cannot find the report file", "'Equipment List.repx'", "Please make sure you have access to reports path and the files are not corrupted.");
				return;
			}
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.Enterprise.EquipmentListReport));
			...
			buttonOK.Location = new System.Drawing.Point(286, 366);
			...
			checkBoxShowInactive.Location = new System.Drawing.Point(9, 320);
			checkBoxShowInactive.Name = "checkBoxShowInactive";
			checkBoxShowInactive.Size = new System.Drawing.Size(152, 17);
			checkBoxShowInactive.TabIndex = 4;
			checkBoxShowInactive.Text = "Show Inactive Equipments";
			checkBoxShowInactive.UseVisualStyleBackColor = true;
			buttonClose.Anchor = (System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Right);
			buttonClose.DialogResult = System.Windows.Forms.DialogResult.Cancel;
			buttonClose.Location = new System.Drawing.Point(390, 366);
			...
			jobSelector.Location = new System.Drawing.Point(15, 17);
			...
			ultraGroupBox1.Size = new System.Drawing.Size(476, 130);
			ultraGroupBox1.TabIndex = 11;
			ultraGroupBox1.Text = "Equipments";
			ultraGroupBox4.Controls.Add(workLocationSelector);
			ultraGroupBox4.Location = new System.Drawing.Point(9, 229);
			...
			workLocationSelector.Location = new System.Drawing.Point(15, 17);
