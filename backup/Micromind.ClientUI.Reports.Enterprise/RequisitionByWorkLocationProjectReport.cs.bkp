...
{
	public class RequisitionByWorkLocationProjectReport : Form, IForm
	{
		...
		public RequisitionByWorkLocationProjectReport()
		{
			InitializeComponent();
			base.Load += Form_Load;
		}
		...
		private void buttonOK_Click(object sender, EventArgs e)
		{
			try
			{
				...
				DataSet data = Factory.RequisitionSystem.GetRequisitionByEquipmentLocationProjectReport(dateControl1.FromDate, dateControl1.ToDate, equipmentSelector.FromEquipment, equipmentSelector.ToEquipment, equipmentSelector.FromType, equipmentSelector.ToType, equipmentSelector.FromCategory, equipmentSelector.ToCategory, workLocationSelector.FromLocation, workLocationSelector.ToLocation, jobSelector.FromJob, jobSelector.ToJob);
				xtraReport = reportHelper.GetReport("Requisition Report");
				string reportFilter = "From:" + dateControl1.FromDate.ToShortDateString() + "  To:" + dateControl1.ToDate.ToShortDateString();
				reportHelper.AddGeneralReportData(ref data, reportFilter);
				reportHelper.AddFilterData(ref data, GetAllFormControls(this));
				if (xtraReport == null)
				{
					ErrorHelper.ErrorMessage("Cannot find the report file", "Please make sure you have access to reports path and the files are not corrupted.", "'Requisition Report.repx'");
				}
				else
				{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.Enterprise.RequisitionByWorkLocationProjectReport));
			...
			buttonOK.Location = new System.Drawing.Point(283, 399);
			...
			buttonClose.Location = new System.Drawing.Point(387, 399);
			...
			ultraGroupBox4.Location = new System.Drawing.Point(9, 154);
			...
			groupBoxJob.Location = new System.Drawing.Point(9, 242);
			...
			dateControl1.Location = new System.Drawing.Point(9, 318);
			...
			base.ClientSize = new System.Drawing.Size(502, 435);
			...
			base.Name = "RequisitionByWorkLocationProjectReport";
			Text = "Requisition Report";
