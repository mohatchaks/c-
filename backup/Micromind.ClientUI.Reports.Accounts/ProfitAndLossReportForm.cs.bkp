...
{
	public class ProfitAndLossReportForm : Form, IForm
	{
		...
		private void buttonOK_Click(object sender, EventArgs e)
		{
			...
			checked
			{
				...
				{
					dataSet = Factory.JournalSystem.GetProfitAndLossReportSummary(dateControl1.FromDate, dateControl1.ToDate, locationSelector.FromLocation, locationSelector.ToLocation, divisionSelector.FromDivision, divisionSelector.ToDivision, comboBoxLevel.SelectedIndex + 1, allowposting);
				}
				...
				XtraReport xtraReport = (!checkBoxDetail.Checked) ? reportHelper.GetReport("Profit and Loss") : reportHelper.GetReport("Profit and Loss Levelwise");
				if (xtraReport == null)
				{
					ErrorHelper.ErrorMessage("Cannot find the report file", "'Profit and Loss.repx'", "Please make sure you have access to reports path and the files are not corrupted.");
					return;
				}
		...
		private void checkBoxDetail_CheckStateChanged(object sender, EventArgs e)
		{
			...
			else
			{
				...
				bool visible = comboBoxLevel.Visible = false;
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.Accounts.ProfitAndLossReportForm));
			...
			panelButtons.Location = new System.Drawing.Point(0, 207);
			...
			ultraGroupBox2.Location = new System.Drawing.Point(29, 76);
			...
			base.ClientSize = new System.Drawing.Size(486, 247);
			...
			base.Name = "ProfitAndLossReportForm";
