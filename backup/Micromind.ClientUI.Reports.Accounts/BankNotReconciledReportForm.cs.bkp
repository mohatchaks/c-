...
{
	public class BankNotReconciledReportForm : Form, IForm
	{
		...
		public BankNotReconciledReportForm()
		{
			InitializeComponent();
			base.Load += Form_Load;
		...
		{
			DataSet data = Factory.BankReconciliationSystem.GetBankNotReconciledReport(accountSelector.FromAccount, accountSelector.ToAccount, locationSelector.FromLocation, locationSelector.ToLocation, divisionSelector.FromDivision, divisionSelector.ToDivision, dateTimePickerAsOfDate.Value);
			ReportHelper reportHelper = new ReportHelper();
			string reportFilter = "From:" + dateTimePickerAsOfDate.Value.ToShortDateString();
			reportHelper.AddGeneralReportData(ref data, reportFilter);
			reportHelper.AddFilterData(ref data, GetAllFormControls(this));
			XtraReport report = reportHelper.GetReport("Bank Not Reconciliations");
			if (report == null)
			{
				ErrorHelper.ErrorMessage("Cannot find the report file", "'Bank Not Reconciliations.repx'", "Please make sure you have access to reports path and the files are not corrupted.");
				return;
			}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.Accounts.BankNotReconciledReportForm));
			...
			buttonOK.Location = new System.Drawing.Point(311, 8);
			...
			panelButtons.Location = new System.Drawing.Point(0, 228);
			panelButtons.Name = "panelButtons";
			panelButtons.Size = new System.Drawing.Size(521, 40);
			...
			linePanelDown.Size = new System.Drawing.Size(521, 1);
			...
			xpButton1.Location = new System.Drawing.Point(411, 8);
			...
			label2.Location = new System.Drawing.Point(10, 205);
			label2.Name = "label2";
			...
			dateTimePickerAsOfDate.Location = new System.Drawing.Point(71, 202);
			...
			ultraGroupBox2.Location = new System.Drawing.Point(13, 96);
			...
			ultraGroupBox1.Location = new System.Drawing.Point(13, 96);
			ultraGroupBox1.Name = "ultraGroupBox1";
			ultraGroupBox1.Size = new System.Drawing.Size(453, 81);
			ultraGroupBox1.TabIndex = 21;
			...
			base.ClientSize = new System.Drawing.Size(521, 268);
			...
			base.Name = "BankNotReconciledReportForm";
			Text = "Bank Not Reconciled ";
