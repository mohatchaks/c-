...
{
	public class BalanceSheetComparisonReportForm : Form, IForm
	{
		...
		public BalanceSheetComparisonReportForm()
		{
			InitializeComponent();
		}
		...
		private void buttonOK_Click(object sender, EventArgs e)
		{
			try
			{
				...
				DataSet data = Factory.JournalSystem.GetBalanceSheetComparisonReport(value, locationSelector.FromLocation, locationSelector.ToLocation, divisionSelector.FromDivision, divisionSelector.ToDivision, checked(comboBoxLevel.SelectedIndex + 1), checkBoxAccount.Checked, allowposting);
				...
				string reportFilter = "As Of : ";
				reportHelper.AddGeneralReportData(ref data, reportFilter);
				reportHelper.AddFilterData(ref data, GetAllFormControls(this));
				string fileName = "";
				if (printTemplateSelector.SelectedTemplate != "")
				{
					fileName = printTemplateSelector.SelectedTemplate;
				}
				else
				{
					printTemplateSelector.DefaultTemplate = "Balance Sheet Comp";
				}
				XtraReport report = reportHelper.GetReport(fileName);
				if (report == null)
				{
					ErrorHelper.ErrorMessage("Cannot find the report file", "'Balance Sheet Comp.repx'", "Please make sure you have access to reports path and the files are not corrupted.");
				}
				else
				{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.Accounts.BalanceSheetComparisonReportForm));
			...
			comboBoxLevel.Location = new System.Drawing.Point(88, 53);
			...
			checkBoxAccount.Location = new System.Drawing.Point(11, 176);
			...
			ultraGroupBox2.Location = new System.Drawing.Point(8, 81);
			...
			ultraGroupBox1.Location = new System.Drawing.Point(8, 81);
			...
			printTemplateSelector.DefaultTemplate = "Balance Sheet Comp";
			printTemplateSelector.FormID = "BalanceSheetComparisonReportForm";
			printTemplateSelector.Location = new System.Drawing.Point(8, 197);
			...
			dateTimePickerDate.Location = new System.Drawing.Point(88, 24);
			dateTimePickerDate.Name = "dateTimePickerDate";
			dateTimePickerDate.Size = new System.Drawing.Size(138, 20);
			dateTimePickerDate.TabIndex = 26;
			...
			base.ClientSize = new System.Drawing.Size(449, 277);
			...
			base.Name = "BalanceSheetComparisonReportForm";
			Text = "Balance Sheet Comparison Report";
