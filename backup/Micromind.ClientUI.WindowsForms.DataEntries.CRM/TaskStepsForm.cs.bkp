...
{
	public class TaskStepsForm : Form, IForm
	{
		private TaskStepsData currentData;

		private const string TABLENAME_CONST = "Task_Steps";

		private const string IDFIELD_CONST = "TaskStepID";
		...
		private bool GetData()
		{
			try
			{
				...
				{
					currentData = new TaskStepsData();
				}
				DataRow dataRow = (!isNewRecord) ? currentData.TaskStepsTable.Rows[0] : currentData.TaskStepsTable.NewRow();
				dataRow.BeginEdit();
				dataRow["TaskStepID"] = textBoxCode.Text.Trim();
				...
				if (isNewRecord)
				{
					currentData.TaskStepsTable.Rows.Add(dataRow);
				}
				return true;
			}
			catch (Exception e)
		...
		public void LoadData(string id)
		{
			try
			{
				...
				{
					currentData = Factory.TaskStepsSystem.GetTaskStepsByID(id.Trim());
		...
		private void FillData()
		{
			try
			{
				if (currentData != null && currentData.Tables.Count != 0 && currentData.Tables[0].Rows.Count != 0)
				{
					...
					textBoxCode.Text = dataRow["TaskStepID"].ToString();
		...
		private bool SaveData()
		{
			...
			try
			{
				...
				if (isNewRecord)
				{
					flag = Factory.TaskStepsSystem.CreateTaskSteps(currentData);
					if (flag)
					{
						ComboDataHelper.SetRefreshStatus(DataComboType.TaskSteps, needRefresh: true);
					}
				}
				else
				{
					flag = Factory.TaskStepsSystem.UpdateTaskSteps(currentData);
				}
				if (!flag)
				{
		...
		private bool ValidateData()
		{
			...
			if (isNewRecord && Factory.DatabaseSystem.ExistFieldValue("Task_Steps", "TaskStepID", textBoxCode.Text.Trim()))
			{
		...
		{
			textBoxCode.Text = PublicFunctions.GetNextCardNumber("Task_Steps", "TaskStepID");
			textBoxName.Clear();
			textBoxNote.Clear();
		...
		private bool Delete()
		{
			try
			{
				...
				bool num = Factory.TaskStepsSystem.DeleteTaskSteps(textBoxCode.Text);
				if (num)
				{
		...
		{
			LoadData(DatabaseHelper.GetNextID("Task_Steps", "TaskStepID", textBoxCode.Text));
		}

		private void toolStripButtonPrevious_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetPreviousID("Task_Steps", "TaskStepID", textBoxCode.Text));
		}

		private void toolStripButtonLast_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetLastID("Task_Steps", "TaskStepID"));
		}

		private void toolStripButtonFirst_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetFirstID("Task_Steps", "TaskStepID"));
		}
		...
		private void toolStripButtonFind_Click(object sender, EventArgs e)
		{
			try
			{
				...
				else if (Factory.DatabaseSystem.ExistFieldValue("Task_Steps", "TaskStepID", toolStripTextBoxFind.Text.Trim()))
				{
		...
		{
			new FormHelper().ShowList(DataComboType.TaskSteps);
		}
		...
		private void TaskStepsForm_Load(object sender, EventArgs e)
		{
			try
			{
				SetSecurity();
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.CRM.TaskStepsForm));
			...
			toolStrip1.Size = new System.Drawing.Size(474, 31);
			...
			panelButtons.Location = new System.Drawing.Point(0, 151);
			...
			mmLabel4.Location = new System.Drawing.Point(8, 84);
			...
			comboBoxTaskType.DisplayLayout.Appearance = appearance;
			...
			comboBoxTaskType.DisplayLayout.GroupByBox.Appearance = appearance2;
			appearance3.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxTaskType.DisplayLayout.GroupByBox.BandLabelAppearance = appearance3;
			...
			comboBoxTaskType.DisplayLayout.GroupByBox.PromptAppearance = appearance4;
			...
			comboBoxTaskType.DisplayLayout.Override.ActiveCellAppearance = appearance5;
			appearance6.BackColor = System.Drawing.SystemColors.Highlight;
			appearance6.ForeColor = System.Drawing.SystemColors.HighlightText;
			comboBoxTaskType.DisplayLayout.Override.ActiveRowAppearance = appearance6;
			...
			comboBoxTaskType.DisplayLayout.Override.CardAreaAppearance = appearance7;
			appearance8.BorderColor = System.Drawing.Color.Silver;
			appearance8.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxTaskType.DisplayLayout.Override.CellAppearance = appearance8;
			...
			comboBoxTaskType.DisplayLayout.Override.GroupByRowAppearance = appearance9;
			appearance10.TextHAlignAsString = "Left";
			comboBoxTaskType.DisplayLayout.Override.HeaderAppearance = appearance10;
			...
			comboBoxTaskType.DisplayLayout.Override.RowAppearance = appearance11;
			comboBoxTaskType.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance12.BackColor = System.Drawing.SystemColors.ControlLight;
			comboBoxTaskType.DisplayLayout.Override.TemplateAddRowAppearance = appearance12;
			...
			comboBoxTaskType.Location = new System.Drawing.Point(131, 102);
			...
			comboBoxTaskType.Size = new System.Drawing.Size(173, 20);
			comboBoxTaskType.TabIndex = 5;
			...
			ultraFormattedLinkLabel1.Size = new System.Drawing.Size(32, 15);
			ultraFormattedLinkLabel1.TabIndex = 128;
			ultraFormattedLinkLabel1.TabStop = true;
			ultraFormattedLinkLabel1.TreatValueAs = Infragistics.Win.FormattedLinkLabel.TreatValueAs.URL;
			ultraFormattedLinkLabel1.UnderlineLinks = Infragistics.Win.FormattedLinkLabel.UnderlineLink.WhenHovered;
			ultraFormattedLinkLabel1.Value = "Type:";
			...
			base.ClientSize = new System.Drawing.Size(474, 191);
			...
			base.Name = "TaskStepsForm";
			Text = "Task Steps";
			base.FormClosing += new System.Windows.Forms.FormClosingEventHandler(AccountGroupDetailsForm_FormClosing);
			base.Load += new System.EventHandler(TaskStepsForm_Load);
