...
{
	public class W3PLGRNForm : Form, IForm
	{
		private bool allowEdit = true;

		private bool hasUsedLots;

		private W3PLGRNData currentData;

		private const string TABLENAME_CONST = "W3PL_GRN";
		...
		private void AddEvents()
		{
			...
			comboBoxCustomer.SelectedIndexChanged += comboBoxVendor_SelectedIndexChanged;
		...
		{
			textBoxVendorName.Text = comboBoxCustomer.SelectedName;
		}
		...
		private bool GetData()
		{
			try
			{
				...
				{
					currentData = new W3PLGRNData();
				}
				DataRow dataRow = (!isNewRecord) ? currentData.W3PLGRNTable.Rows[0] : currentData.W3PLGRNTable.NewRow();
				...
				if (IsNewRecord)
				{
					currentData.W3PLGRNTable.Rows.Add(dataRow);
				}
				currentData.W3PLGRNDetailTable.Rows.Clear();
				currentData.Tables["Product_Lot_Receiving_Detail"].Rows.Clear();
				foreach (UltraGridRow row in dataGridItems.Rows)
				{
					DataRow dataRow2 = currentData.W3PLGRNDetailTable.NewRow();
					dataRow2.BeginEdit();
					...
					dataRow2.EndEdit();
					currentData.W3PLGRNDetailTable.Rows.Add(dataRow2);
		...
		public void LoadData(string voucherID)
		{
			try
			{
				...
				{
					currentData = Factory.W3PLGRNSystem.GetGRNByID(SystemDocID, voucherID);
					if (currentData != null)
					{
						FillData();
						IsNewRecord = false;
		...
		private void FillData()
		{
			try
			{
				...
				{
					DataRow dataRow = currentData.Tables["W3PL_GRN"].Rows[0];
					...
					if (currentData.Tables.Contains("W3PL_GRN_Detail") && currentData.W3PLGRNDetailTable.Rows.Count != 0)
					{
						foreach (DataRow row in currentData.Tables["W3PL_GRN_Detail"].Rows)
						{
						...
						if (currentData.Tables.Contains("W3PL_Invoice"))
						{
							labelSelectedDocs.Visible = true;
							checkedListBoxsettled.Visible = true;
							foreach (DataRow row3 in currentData.Tables["W3PL_Invoice"].Rows)
							{
		...
		private bool SaveData(bool clearAfter)
		{
			...
			try
			{
				bool flag2 = Factory.W3PLGRNSystem.CreateGRN(currentData, !isNewRecord);
				if (flag2)
				{
					flag = true;
				}
		...
		private bool ValidateData()
		{
			...
			if (!IsNewRecord && !Global.IsUserAdmin && !AllowEditTransaction && Global.CurrentUser != Factory.SystemDocumentSystem.GetTransUserID("W3PL_GRN", "VoucherID", SystemDocID, textBoxVoucherNumber.Text))
			{
			...
			checked
			{
				...
				if (!isNewRecord && !Factory.W3PLGRNSystem.AllowModify(comboBoxSysDoc.SelectedID, textBoxVoucherNumber.Text))
				{
				...
				if (formManager.IsFieldDirty(textBoxVoucherNumber) && Factory.SystemDocumentSystem.ExistDocumentNumber("W3PL_GRN", "VoucherID", SystemDocID, textBoxVoucherNumber.Text))
				{
					ErrorHelper.WarningMessage(UIMessages.DocumentNumberInUse);
		...
		private bool Delete()
		{
			try
			{
				...
				if (!Factory.W3PLGRNSystem.AllowModify(comboBoxSysDoc.SelectedID, textBoxVoucherNumber.Text))
				{
					ErrorHelper.ErrorMessage("Document is in use by another transaction. Unable to modify.");
					return false;
				}
				return Factory.W3PLGRNSystem.DeleteGRN(SystemDocID, textBoxVoucherNumber.Text);
			}
			catch (Exception e)
			{
				ErrorHelper.ProcessError(e);
		...
		{
			string nextID = DatabaseHelper.GetNextID("W3PL_GRN", "VoucherID", textBoxVoucherNumber.Text, "SysDocID", SystemDocID);
			if (!(nextID == ""))
			{
				LoadData(nextID);
			}
		...
		{
			string previousID = DatabaseHelper.GetPreviousID("W3PL_GRN", "VoucherID", textBoxVoucherNumber.Text, "SysDocID", SystemDocID);
			if (!(previousID == ""))
			{
				LoadData(previousID);
			}
		...
		{
			string lastID = DatabaseHelper.GetLastID("W3PL_GRN", "VoucherID", "SysDocID", SystemDocID);
			if (!(lastID == ""))
			{
				LoadData(lastID);
			}
		...
		{
			string firstID = DatabaseHelper.GetFirstID("W3PL_GRN", "VoucherID", "SysDocID", SystemDocID);
			if (!(firstID == ""))
			{
				LoadData(firstID);
			}
		...
		private void toolStripButtonFind_Click(object sender, EventArgs e)
		{
			try
			{
				...
				{
					string text = Factory.DatabaseSystem.FindDocumentByNumber("W3PL_GRN", "VoucherID", SystemDocID, toolStripTextBoxFind.Text);
					if (text != "")
					{
						LoadData(text);
					}
		...
		private void JournalLeavesForm_Load(object sender, EventArgs e)
		{
			try
			{
				...
				SetupGrid();
				comboBoxSysDoc.FilterByType(SysDocTypes.W3PLGRN);
				SetSecurity();
				if (!base.IsDisposed)
				{
					IsNewRecord = true;
		...
		private bool Void(bool isVoid)
		{
			try
			{
				...
				return Factory.W3PLGRNSystem.VoidGRN(SystemDocID, textBoxVoucherNumber.Text, isVoid);
			}
			catch (Exception e)
			{
				ErrorHelper.ProcessError(e);
		...
		{
			new FormHelper().EditSysDoc(comboBoxSysDoc.SelectedID, SysDocTypes.W3PLGRN);
		}
		...
		private void Print(bool isPrint, bool showPrintDialog, bool saveChanges)
		{
			try
			{
				if (!(IsDirty && saveChanges) || (ErrorHelper.QuestionMessage(MessageBoxButtons.YesNo, "You must save the document before printing.", "Do you want to save?") == DialogResult.Yes && SaveData(clearAfter: false)))
				{
					...
					string text = textBoxVoucherNumber.Text;
					DataSet gRNToPrint = Factory.W3PLGRNSystem.GetGRNToPrint(selectedID, text);
					if (gRNToPrint == null || gRNToPrint.Tables.Count == 0)
					{
					...
					else
					{
						...
						{
							PrintHelper.PrintDocument(gRNToPrint, selectedID, printTemplateName, SysDocTypes.W3PLGRN, isPrint, showPrintDialog);
						}
						else
						{
							PrintHelper.PrintDocument(gRNToPrint, selectedID, "W3PL GRN", SysDocTypes.W3PLGRN, isPrint, showPrintDialog);
						}
					}
				}
			}
		...
		{
			FormActivator.BringFormToFront(FormActivator.W3PLGRNListFormObj);
		}
		...
		private void checkedListBoxsettled_DoubleClick(object sender, EventArgs e)
		{
			if (checkedListBoxsettled.SelectedItem.ToString() != "")
			{
				...
				new FormHelper().EditTransaction(TransactionListType.W3PLInvoice, nameValue.ID, nameValue.Name);
			}
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.W3PL.W3PLGRNForm));
			...
			comboBoxCustomer.DisplayLayout.Appearance = appearance3;
			...
			comboBoxCustomer.DisplayLayout.GroupByBox.Appearance = appearance4;
			appearance5.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxCustomer.DisplayLayout.GroupByBox.BandLabelAppearance = appearance5;
			...
			comboBoxCustomer.DisplayLayout.GroupByBox.PromptAppearance = appearance6;
			...
			comboBoxCustomer.DisplayLayout.Override.ActiveCellAppearance = appearance7;
			appearance8.BackColor = System.Drawing.SystemColors.Highlight;
			appearance8.ForeColor = System.Drawing.SystemColors.HighlightText;
			comboBoxCustomer.DisplayLayout.Override.ActiveRowAppearance = appearance8;
			...
			comboBoxCustomer.DisplayLayout.Override.CardAreaAppearance = appearance9;
			appearance10.BorderColor = System.Drawing.Color.Silver;
			appearance10.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxCustomer.DisplayLayout.Override.CellAppearance = appearance10;
			...
			comboBoxCustomer.DisplayLayout.Override.GroupByRowAppearance = appearance11;
			appearance12.TextHAlignAsString = "Left";
			comboBoxCustomer.DisplayLayout.Override.HeaderAppearance = appearance12;
			...
			comboBoxCustomer.DisplayLayout.Override.RowAppearance = appearance13;
			comboBoxCustomer.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance14.BackColor = System.Drawing.SystemColors.ControlLight;
			comboBoxCustomer.DisplayLayout.Override.TemplateAddRowAppearance = appearance14;
			...
			labelSelectedDocs.Location = new System.Drawing.Point(433, 466);
			labelSelectedDocs.Name = "labelSelectedDocs";
			labelSelectedDocs.Size = new System.Drawing.Size(100, 13);
			labelSelectedDocs.TabIndex = 129;
			labelSelectedDocs.Text = "Settled Documents:";
			...
			comboBoxGridLocation.DisplayLayout.Appearance = appearance45;
			...
			comboBoxGridLocation.DisplayLayout.GroupByBox.Appearance = appearance46;
			appearance47.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxGridLocation.DisplayLayout.GroupByBox.BandLabelAppearance = appearance47;
			...
			comboBoxGridLocation.DisplayLayout.GroupByBox.PromptAppearance = appearance48;
			...
			comboBoxGridLocation.DisplayLayout.Override.ActiveCellAppearance = appearance49;
			...
			comboBoxGridLocation.DisplayLayout.Override.ActiveRowAppearance = appearance50;
			...
			comboBoxGridLocation.DisplayLayout.Override.CardAreaAppearance = appearance51;
			appearance52.BorderColor = System.Drawing.Color.Silver;
			appearance52.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxGridLocation.DisplayLayout.Override.CellAppearance = appearance52;
			...
			comboBoxGridLocation.DisplayLayout.Override.GroupByRowAppearance = appearance53;
			appearance54.TextHAlignAsString = "Left";
			comboBoxGridLocation.DisplayLayout.Override.HeaderAppearance = appearance54;
			...
			comboBoxGridLocation.DisplayLayout.Override.RowAppearance = appearance55;
			...
			comboBoxGridLocation.DisplayLayout.Override.TemplateAddRowAppearance = appearance56;
			...
			dataGridItems.DisplayLayout.Appearance = appearance57;
			...
			dataGridItems.DisplayLayout.GroupByBox.Appearance = appearance58;
			appearance59.ForeColor = System.Drawing.SystemColors.GrayText;
			dataGridItems.DisplayLayout.GroupByBox.BandLabelAppearance = appearance59;
			...
			dataGridItems.DisplayLayout.GroupByBox.PromptAppearance = appearance60;
			dataGridItems.DisplayLayout.MaxColScrollRegions = 1;
			dataGridItems.DisplayLayout.MaxRowScrollRegions = 1;
			appearance61.BackColor = System.Drawing.SystemColors.Window;
			appearance61.ForeColor = System.Drawing.SystemColors.ControlText;
			dataGridItems.DisplayLayout.Override.ActiveCellAppearance = appearance61;
			...
			dataGridItems.DisplayLayout.Override.ActiveRowAppearance = appearance62;
			dataGridItems.DisplayLayout.Override.AllowAddNew = Infragistics.Win.UltraWinGrid.AllowAddNew.No;
			dataGridItems.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.Dotted;
			dataGridItems.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.Dotted;
			appearance63.BackColor = System.Drawing.SystemColors.Window;
			dataGridItems.DisplayLayout.Override.CardAreaAppearance = appearance63;
			...
			dataGridItems.DisplayLayout.Override.CellAppearance = appearance64;
			...
			dataGridItems.DisplayLayout.Override.GroupByRowAppearance = appearance65;
			appearance66.TextHAlignAsString = "Left";
			dataGridItems.DisplayLayout.Override.HeaderAppearance = appearance66;
			dataGridItems.DisplayLayout.Override.HeaderClickAction = Infragistics.Win.UltraWinGrid.HeaderClickAction.SortMulti;
			dataGridItems.DisplayLayout.Override.HeaderStyle = Infragistics.Win.HeaderStyle.WindowsXPCommand;
			appearance67.BackColor = System.Drawing.SystemColors.Window;
			appearance67.BorderColor = System.Drawing.Color.Silver;
			dataGridItems.DisplayLayout.Override.RowAppearance = appearance67;
			dataGridItems.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance68.BackColor = System.Drawing.SystemColors.ControlLight;
			dataGridItems.DisplayLayout.Override.TemplateAddRowAppearance = appearance68;
