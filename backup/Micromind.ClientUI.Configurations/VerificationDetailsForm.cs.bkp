...
{
	public class VerificationDetailsForm : Form, IForm
	{
		...
		public VerificationDetailsForm()
		{
			InitializeComponent();
			AddEvents();
			comboBoxObjectType.SelectedIndex = 0;
			comboBoxSysDocType.ApprovalType = ApprovalTypes.Verification;
			comboBoxCardType.LoadData();
			comboBoxSysDocType.LoadData();
			comboBoxSysDocType.Sorted = true;
			comboBoxCardType.Sorted = true;
			comboBoxUserGroup.LoadData();
		}

		private void AddEvents()
		{
			base.Load += VerificationDetailsForm_Load;
			...
			comboBoxSysDocType.SelectedIndexChanged += comboBoxSysDocType_SelectedIndexChanged;
		}
		...
		private void dataGridItems_AfterCellUpdate(object sender, CellEventArgs e)
		{
			...
			{
				int num = int.Parse(e.Cell.Value.ToString());
				e.Cell.Row.Cells["ApproverID"].Activation = Activation.AllowEdit;
				switch (num)
				{
				case 1:
				...
				case 2:
					...
					break;
				case 3:
					e.Cell.Row.Cells["ApproverID"].Activation = Activation.NoEdit;
					e.Cell.Row.Cells["ApproverID"].ValueList = null;
					e.Cell.Row.Cells["ApproverID"].Value = null;
					break;
				}
			}
		}
		...
		public void LoadData(string id)
		{
			try
			{
				...
				{
					currentData = Factory.ApprovalSystem.GetApprovalByID(ApprovalTypes.Verification, id.Trim());
		...
		private bool ValidateData()
		{
			...
			if (isNewRecord && Factory.DatabaseSystem.ExistFieldValue("Approval", "ApprovalID", textBoxCode.Text.Trim(), "ApprovalType", 2))
			{
		...
		{
			textBoxCode.Text = PublicFunctions.GetNextCardNumber("Approval", "ApprovalID", "ApprovalType", 2.ToString());
			textBoxName.Clear();
			checkBoxInactive.Checked = false;
		...
		private void SetupGrid()
		{
			try
			{
				...
				valueList.ValueListItems.Add(3, "Salesperson");
		...
		private bool Delete()
		{
			try
			{
				...
				return Factory.ApprovalSystem.DeleteApproval(ApprovalTypes.Verification, textBoxCode.Text);
			}
			catch (Exception e)
			{
				ErrorHelper.ProcessError(e);
		...
		{
			LoadData(DatabaseHelper.GetNextID("Approval", "ApprovalID", textBoxCode.Text, "ApprovalType", ((byte)2).ToString()));
		}

		private void toolStripButtonPrevious_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetPreviousID("Approval", "ApprovalID", textBoxCode.Text, "ApprovalType", ((byte)2).ToString()));
		}

		private void toolStripButtonLast_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetLastID("Approval", "ApprovalID", "ApprovalType", ((byte)2).ToString()));
		}

		private void toolStripButtonFirst_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetFirstID("Approval", "ApprovalID", "ApprovalType", ((byte)2).ToString()));
		}
		...
		private void toolStripButtonFind_Click(object sender, EventArgs e)
		{
			try
			{
				...
				else if (Factory.DatabaseSystem.ExistFieldValue("Approval", "ApprovalID", toolStripTextBoxFind.Text.Trim(), "ApprovalType", (byte)2))
				{
		...
		private void VerificationDetailsForm_Load(object sender, EventArgs e)
		{
			try
			{
				SetupGrid();
		...
		{
			new FormHelper().ShowList(DataComboType.Verification);
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Configurations.VerificationDetailsForm));
			...
			mmLabel1.Size = new System.Drawing.Size(111, 13);
			mmLabel1.TabIndex = 3;
			mmLabel1.Text = "Verification Name:";
			...
			labelCode.Size = new System.Drawing.Size(108, 13);
			...
			panelCard.Size = new System.Drawing.Size(508, 62);
			...
			comboBoxCardType.Location = new System.Drawing.Point(139, 4);
			...
			dataGridItems.Location = new System.Drawing.Point(15, 193);
			...
			dataGridItems.Size = new System.Drawing.Size(667, 212);
			...
			comboBoxUserGroup.DisplayLayout.Appearance = appearance25;
			...
			comboBoxUserGroup.DisplayLayout.GroupByBox.Appearance = appearance26;
			appearance27.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxUserGroup.DisplayLayout.GroupByBox.BandLabelAppearance = appearance27;
			...
			comboBoxUserGroup.DisplayLayout.GroupByBox.PromptAppearance = appearance28;
			...
			comboBoxUserGroup.DisplayLayout.Override.ActiveCellAppearance = appearance29;
			appearance30.BackColor = System.Drawing.SystemColors.Highlight;
			appearance30.ForeColor = System.Drawing.SystemColors.HighlightText;
			comboBoxUserGroup.DisplayLayout.Override.ActiveRowAppearance = appearance30;
			...
			comboBoxUserGroup.DisplayLayout.Override.CardAreaAppearance = appearance31;
			appearance32.BorderColor = System.Drawing.Color.Silver;
			appearance32.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxUserGroup.DisplayLayout.Override.CellAppearance = appearance32;
			...
			comboBoxUserGroup.DisplayLayout.Override.GroupByRowAppearance = appearance33;
			appearance34.TextHAlignAsString = "Left";
			comboBoxUserGroup.DisplayLayout.Override.HeaderAppearance = appearance34;
			...
			comboBoxUserGroup.DisplayLayout.Override.RowAppearance = appearance35;
			comboBoxUserGroup.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance36.BackColor = System.Drawing.SystemColors.ControlLight;
			comboBoxUserGroup.DisplayLayout.Override.TemplateAddRowAppearance = appearance36;
			...
			comboBoxUserGroup.Location = new System.Drawing.Point(586, 215);
			...
			comboBoxUser.DisplayLayout.Appearance = appearance37;
			...
			comboBoxUser.DisplayLayout.GroupByBox.Appearance = appearance38;
			appearance39.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxUser.DisplayLayout.GroupByBox.BandLabelAppearance = appearance39;
			...
			comboBoxUser.DisplayLayout.GroupByBox.PromptAppearance = appearance40;
			comboBoxUser.DisplayLayout.MaxColScrollRegions = 1;
			comboBoxUser.DisplayLayout.MaxRowScrollRegions = 1;
			appearance41.BackColor = System.Drawing.SystemColors.Window;
			appearance41.ForeColor = System.Drawing.SystemColors.ControlText;
			comboBoxUser.DisplayLayout.Override.ActiveCellAppearance = appearance41;
			appearance42.BackColor = System.Drawing.SystemColors.Highlight;
			appearance42.ForeColor = System.Drawing.SystemColors.HighlightText;
			comboBoxUser.DisplayLayout.Override.ActiveRowAppearance = appearance42;
			...
			comboBoxUser.DisplayLayout.Override.CardAreaAppearance = appearance43;
			appearance44.BorderColor = System.Drawing.Color.Silver;
			appearance44.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxUser.DisplayLayout.Override.CellAppearance = appearance44;
			...
			comboBoxUser.DisplayLayout.Override.GroupByRowAppearance = appearance45;
			appearance46.TextHAlignAsString = "Left";
			comboBoxUser.DisplayLayout.Override.HeaderAppearance = appearance46;
			...
			comboBoxUser.DisplayLayout.Override.RowAppearance = appearance47;
			comboBoxUser.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance48.BackColor = System.Drawing.SystemColors.ControlLight;
			comboBoxUser.DisplayLayout.Override.TemplateAddRowAppearance = appearance48;
			...
			comboBoxUser.Location = new System.Drawing.Point(586, 227);
			...
			base.Name = "VerificationDetailsForm";
			Text = "Verification";
