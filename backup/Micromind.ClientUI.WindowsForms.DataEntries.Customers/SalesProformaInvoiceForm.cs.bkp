...
{
	public class SalesProformaInvoiceForm : Form, IForm, IWorkFlowForm
	{
		...
		public SalesProformaInvoiceForm()
		{
			InitializeComponent();
			AddEvents();
		...
		private bool SaveData(bool clearAfter)
		{
			...
			try
			{
				...
				else
				{
					if (key != null && key != "")
					{
						flag2 = Factory.SettingSystem.DeleteSetting(key, "", 119.ToString());
					}
					bool result = false;
		...
		private void ClearForm()
		{
			try
			{
				...
				{
					dataTable.Columns.Remove("SOSysDocID");
					dataTable.Columns.Remove("SOVoucherID");
					dataTable.Columns.Remove("SORowIndex");
				}
				SetApprovalStatus();
				IsVoid = false;
				formManager.ResetDirty();
		...
		private void Form_Load(object sender, EventArgs e)
		{
			checked
			{
				try
				{
					...
					comboBoxSysDoc.FilterByType(SysDocTypes.SalesProforma);
					SetSecurity();
					if (!base.IsDisposed)
					{
						IsNewRecord = true;
		...
		{
			new FormHelper().EditSysDoc(comboBoxSysDoc.SelectedID, SysDocTypes.SalesProforma);
		}
		...
		private void Print(bool isPrint, bool showPrintDialog, bool saveChanges)
		{
			try
			{
				if (!(IsDirty && saveChanges) || (ErrorHelper.QuestionMessage(MessageBoxButtons.YesNo, "You must save the document before printing.", "Do you want to save?") == DialogResult.Yes && SaveData(clearAfter: false)))
				{
					...
					{
						PrintHelper.PrintDocument(salesOrderToPrint, selectedID, "Sales ProformaInv", SysDocTypes.SalesProforma, isPrint, showPrintDialog);
					}
				}
			}
			catch (Exception e)
		...
		{
			FormActivator.BringFormToFront(FormActivator.SalesProformaListFormObj);
		}
		...
		private void saveDraftToolStripMenuItem_Click(object sender, EventArgs e)
		{
			try
			{
				if (GetData())
				{
					...
					{
						Global.CompanySettings.SaveTransactionDraft(currentData, enterNameDialog.EnteredName, SysDocTypes.SalesProforma);
					}
				}
			}
			catch
		...
		private bool LoadDraft()
		{
			try
			{
				DataSet settingsList = Factory.SettingSystem.GetSettingsList("", 119.ToString());
				...
				if (selectDocumentDialog.ShowDialog(this) == DialogResult.OK)
				{
					...
					DataSet dataSet = Global.CompanySettings.LoadTransactionDraft(key, SysDocTypes.SalesProforma);
		...
		private void toolStripButtonMultiPreview_Click(object sender, EventArgs e)
		{
			...
			attachementDetailsForm.SysDocType = SysDocTypes.SalesProforma;
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Customers.SalesProformaInvoiceForm));
			...
			duplicateToolStripMenuItem.Size = new System.Drawing.Size(199, 22);
			...
			saveDraftToolStripMenuItem.Size = new System.Drawing.Size(199, 22);
			...
			createFromSalesOrderToolStripMenuItem.Size = new System.Drawing.Size(199, 22);
			...
			xpProductSelection.Location = new System.Drawing.Point(741, 115);
			...
			labelcostcategory.Location = new System.Drawing.Point(403, 143);
			...
			comboBoxPayeeTaxGroup.Size = new System.Drawing.Size(106, 20);
			...
			labelJob.Location = new System.Drawing.Point(239, 143);
			...
			ultraFormattedLinkShipping.Location = new System.Drawing.Point(7, 143);
			...
			labelCurrency.Location = new System.Drawing.Point(660, 94);
			...
			comboBoxBillingAddress.TabIndex = 13;
			...
			comboBoxShippingAddressID.TabIndex = 15;
			...
			textBoxBilltoAddress.TabIndex = 14;
			...
			dateTimePickerDueDate.TabIndex = 18;
			...
			comboBoxSalesperson.TabIndex = 11;
			...
			comboBoxSpecification.DisplayLayout.Appearance = appearance147;
			...
			comboBoxSpecification.DisplayLayout.GroupByBox.Appearance = appearance148;
			appearance149.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxSpecification.DisplayLayout.GroupByBox.BandLabelAppearance = appearance149;
			...
			comboBoxSpecification.DisplayLayout.GroupByBox.PromptAppearance = appearance150;
			...
			comboBoxSpecification.DisplayLayout.Override.ActiveCellAppearance = appearance151;
			...
			comboBoxSpecification.DisplayLayout.Override.ActiveRowAppearance = appearance152;
			...
			comboBoxSpecification.DisplayLayout.Override.CardAreaAppearance = appearance153;
			...
			comboBoxSpecification.DisplayLayout.Override.CellAppearance = appearance154;
			...
			comboBoxSpecification.DisplayLayout.Override.GroupByRowAppearance = appearance155;
			appearance156.TextHAlignAsString = "Left";
			comboBoxSpecification.DisplayLayout.Override.HeaderAppearance = appearance156;
			...
			comboBoxSpecification.DisplayLayout.Override.RowAppearance = appearance157;
			...
			comboBoxSpecification.DisplayLayout.Override.TemplateAddRowAppearance = appearance158;
			...
			comboBoxStyle.DisplayLayout.Appearance = appearance159;
			...
			comboBoxStyle.DisplayLayout.GroupByBox.Appearance = appearance160;
			appearance161.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxStyle.DisplayLayout.GroupByBox.BandLabelAppearance = appearance161;
			...
			comboBoxStyle.DisplayLayout.GroupByBox.PromptAppearance = appearance162;
			...
			comboBoxStyle.DisplayLayout.Override.ActiveCellAppearance = appearance163;
			...
			comboBoxStyle.DisplayLayout.Override.ActiveRowAppearance = appearance164;
			...
			comboBoxStyle.DisplayLayout.Override.CardAreaAppearance = appearance165;
			...
			comboBoxStyle.DisplayLayout.Override.CellAppearance = appearance166;
			...
			comboBoxStyle.DisplayLayout.Override.GroupByRowAppearance = appearance167;
			appearance168.TextHAlignAsString = "Left";
			comboBoxStyle.DisplayLayout.Override.HeaderAppearance = appearance168;
			...
			comboBoxStyle.DisplayLayout.Override.RowAppearance = appearance169;
			...
			comboBoxStyle.DisplayLayout.Override.TemplateAddRowAppearance = appearance170;
			...
			base.Name = "SalesProformaInvoiceForm";
