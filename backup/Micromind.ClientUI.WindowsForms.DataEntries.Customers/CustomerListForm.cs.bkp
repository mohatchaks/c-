...
{
	public class CustomerListForm : Form, IDataForm, IDataList, IExternalReport
	{
		...
		public CustomerListForm()
		{
			IsCRMList = false;
			InitializeComponent();
			base.Activated += CustomerListForm_Activated;
			...
			base.FormClosing += CustomerListForm_FormClosing;
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Customers.CustomerListForm));
			...
			contextMenuStrip1.Size = new System.Drawing.Size(153, 98);
			...
			salesStatisticsToolStripMenuItem.Size = new System.Drawing.Size(152, 22);
			...
			deleteToolStripMenuItem.Size = new System.Drawing.Size(152, 22);
			...
			addActivityToolStripMenuItem.Size = new System.Drawing.Size(152, 22);
			...
			Text = "Customer List";
			base.Load += new System.EventHandler(CustomerListForm_Load);
		...
		private void LoadData()
		{
			if (Factory.IsDBConnected)
			{
				try
				{
					...
					customerData = Factory.CustomerSystem.GetCustomerList(toolStripButtonShowInactive.Checked);
					...
					dataGridList.AddColumnRowCount(dataGridList.DisplayLayout.Bands[0].Columns["Customer Code"]);
				}
		...
		private void OpenForEdit()
		{
			...
			if (!(selectedID == ""))
			{
				if (IsCRMList)
				{
					FormActivator.CRMCustomerDetailsFormObj.LoadData(selectedID);
					FormActivator.BringFormToFront(FormActivator.CRMCustomerDetailsFormObj);
				}
				else
				{
		...
		private string GetSelectedID()
		{
			...
			return dataGridList.ActiveRow.Cells["Customer Code"].Text.ToString();
		}
