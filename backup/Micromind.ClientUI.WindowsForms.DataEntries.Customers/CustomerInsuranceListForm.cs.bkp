...
{
	public class CustomerInsuranceListForm : Form, IDataForm, IDataList, IExternalReport
	{
		...
		public CustomerInsuranceListForm()
		{
			IsCRMList = false;
			InitializeComponent();
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Customers.CustomerInsuranceListForm));
			...
			base.Name = "CustomerInsuranceListForm";
			Text = "Credit Insurance Review";
		...
		private void LoadData()
		{
			if (Factory.IsDBConnected)
			{
				try
				{
					...
					customerData = Factory.CustomerInsuranceSystem.GetList(customerID);
		...
		private void OpenForEdit()
		{
			...
			if (!(selectedID == ""))
			{
				FormActivator.BringFormToFront(FormActivator.CustomerInsuranceDetailsFormObj);
				FormActivator.CustomerInsuranceDetailsFormObj.LoadData(selectedID);
			}
		}
		...
		private string GetSelectedID()
		{
			...
			return dataGridList.ActiveRow.Cells["Voucher ID"].Text.ToString();
		}
