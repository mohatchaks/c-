...
{
	public class CustomerSalesStatisticForm : Form, IDataForm, IDataList, IExternalReport
	{
		...
		public CustomerSalesStatisticForm()
		{
			InitializeComponent();
			...
			base.FormClosing += CustomerSalesStatisticForm_FormClosing;
			dataGridDetail.AllowUnfittedView = true;
			tabControlTab.Tabs["PriceChart"].Visible = false;
		}

		private void CustomerSalesStatisticForm_FormClosing(object sender, FormClosingEventArgs e)
		{
			if (listData != null)
			{
				SaveUserSettings();
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Customers.CustomerSalesStatisticForm));
			...
			((ISupportInitialize)dataGridSalesperson).BeginInit();
			...
			tabPageGeneral.Size = new System.Drawing.Size(805, 359);
			...
			panel1.Name = "panel1";
			panel1.Size = new System.Drawing.Size(805, 359);
			panel1.TabIndex = 7;
			label3.Anchor = (System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left);
			label3.BorderStyle = System.Windows.Forms.BorderStyle.FixedSingle;
			label3.Location = new System.Drawing.Point(104, 313);
			label3.Name = "label3";
			...
			textBoxTotalAmount.Location = new System.Drawing.Point(104, 331);
			...
			label1.Location = new System.Drawing.Point(8, 313);
			label1.Name = "label1";
			...
			textBoxTotalQty.Location = new System.Drawing.Point(8, 331);
			...
			dataGridDetail.ShowNewMenu = false;
			dataGridDetail.Size = new System.Drawing.Size(796, 304);
			...
			panelCOGS.Location = new System.Drawing.Point(202, 309);
			...
			label6.Location = new System.Drawing.Point(97, 4);
			label6.Name = "label6";
			...
			textBoxMargin.Location = new System.Drawing.Point(97, 22);
			...
			label7.Location = new System.Drawing.Point(1, 4);
			label7.Name = "label7";
			...
			textBoxProfit.Location = new System.Drawing.Point(1, 22);
			...
			tabPageSalesperson.Size = new System.Drawing.Size(805, 374);
			...
			splitContainer1.Size = new System.Drawing.Size(805, 374);
			...
			devXChartSalesperson.Size = new System.Drawing.Size(805, 153);
			...
			ultraTabControl.Size = new System.Drawing.Size(805, 374);
			...
			splitContainer2.Size = new System.Drawing.Size(805, 374);
			...
			devXChartItems.Size = new System.Drawing.Size(805, 153);
			...
			ultraTabPageControl1.Size = new System.Drawing.Size(805, 374);
			...
			splitContainer3.Size = new System.Drawing.Size(805, 374);
			...
			devXChartCategory.Size = new System.Drawing.Size(805, 153);
			...
			ultraTabPageControl2.Size = new System.Drawing.Size(805, 374);
			...
			splitContainer4.Size = new System.Drawing.Size(805, 374);
			...
			devXChartCustomer.Size = new System.Drawing.Size(805, 153);
			...
			ultraTabPageControl3.Size = new System.Drawing.Size(805, 374);
			chartControlPrice.CrossHairPattern = null;
			chartControlPrice.DataBindings = null;
			xYDiagram5.AxisX.VisibleInPanesSerializable = "0";
			xYDiagram5.AxisY.VisibleInPanesSerializable = "-1";
			xYDiagram5.DefaultPane.Weight = 5.0;
			...
			textBoxCode.Location = new System.Drawing.Point(83, 59);
			...
			label2.Location = new System.Drawing.Point(83, 80);
			label2.Name = "label2";
			label2.Size = new System.Drawing.Size(262, 13);
			label2.TabIndex = 294;
			label2.Text = "* Use wild character '%' to select range of customers";
			...
			radioButtonItem.Size = new System.Drawing.Size(72, 17);
			radioButtonItem.TabIndex = 0;
			radioButtonItem.TabStop = true;
			radioButtonItem.Text = "Customer:";
			...
			ultraTabSharedControlsPage1.Size = new System.Drawing.Size(805, 359);
			...
			comboBoxCustomer.DisplayLayout.Appearance = appearance62;
			...
			comboBoxCustomer.DisplayLayout.GroupByBox.Appearance = appearance63;
			appearance64.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxCustomer.DisplayLayout.GroupByBox.BandLabelAppearance = appearance64;
			...
			comboBoxCustomer.DisplayLayout.GroupByBox.PromptAppearance = appearance65;
			...
			comboBoxCustomer.DisplayLayout.Override.ActiveCellAppearance = appearance66;
			...
			comboBoxCustomer.DisplayLayout.Override.ActiveRowAppearance = appearance67;
			...
			comboBoxCustomer.DisplayLayout.Override.CardAreaAppearance = appearance68;
			...
			comboBoxCustomer.DisplayLayout.Override.CellAppearance = appearance69;
			...
			comboBoxCustomer.DisplayLayout.Override.GroupByRowAppearance = appearance70;
			appearance71.TextHAlignAsString = "Left";
			comboBoxCustomer.DisplayLayout.Override.HeaderAppearance = appearance71;
			...
			comboBoxCustomer.DisplayLayout.Override.RowAppearance = appearance72;
			...
			comboBoxCustomer.DisplayLayout.Override.TemplateAddRowAppearance = appearance73;
			...
			comboBoxCustomer.Location = new System.Drawing.Point(83, 35);
			...
			comboBoxCustomer.Size = new System.Drawing.Size(139, 20);
			...
			base.Name = "CustomerSalesStatisticForm";
		...
		private void SetupList()
		{
			try
			{
				...
				if (dataGridDetail.DisplayLayout != null && dataGridDetail.DisplayLayout.Bands.Count > 0)
				{
					...
					{
						UltraGridColumn ultraGridColumn3 = dataGridDetail.DisplayLayout.Bands[0].Columns["UnitPrice"];
						UltraGridColumn ultraGridColumn4 = dataGridDetail.DisplayLayout.Bands[0].Columns["AverageCost"];
						ExcludeFromColumnChooser excludeFromColumnChooser7 = dataGridDetail.DisplayLayout.Bands[0].Columns["COGS"].ExcludeFromColumnChooser = ExcludeFromColumnChooser.False;
						excludeFromColumnChooser3 = (ultraGridColumn3.ExcludeFromColumnChooser = (ultraGridColumn4.ExcludeFromColumnChooser = excludeFromColumnChooser7));
					}
				}
		...
		private void LoadData()
		{
			if (Factory.IsDBConnected)
			{
				try
				{
					...
					listData = Factory.CustomerSystem.GetCustomerSalesDetail(dateControl1.FromDate, dateControl1.ToDate, SelectedID);
					...
					if (listData != null && listData.Tables.Count > 0)
					{
						...
						foreach (DataRow row in dataView.ToTable(true, "SalespersonID", "Salesperson Name").Rows)
						{
							...
							{
								d2 = Math.Round(decimal.Parse(obj.ToString()), Global.CurDecimalPoints);
							}
							obj = ((!(text == "")) ? dataTable2.Compute("SUM(Amount)", "SalespersonID = '" + text + "' AND Amount < 0") : dataTable2.Compute("SUM(Amount)", "(SalesPersonID IS NULL OR SalespersonID = '" + text + "') AND Amount < 0"));
							if (obj != null && !string.IsNullOrEmpty(obj.ToString()))
							{
								d3 = Math.Abs(Math.Round(decimal.Parse(obj.ToString()), Global.CurDecimalPoints));
							}
							...
							if (obj != null && !string.IsNullOrEmpty(obj.ToString()))
							{
								num3 = Math.Round(decimal.Parse(obj.ToString()), Global.CurDecimalPoints);
							}
							...
							if (obj != null && !string.IsNullOrEmpty(obj.ToString()))
							{
								num5 = Math.Abs(Math.Round(decimal.Parse(obj.ToString()), Global.CurDecimalPoints));
							}
							...
							dataRow2["QuantitySold"] = num4;
							dataRow2["QuantityReturn"] = num5;
							dataRow2["NetQuantity"] = num4 - num5;
							dataRow2["Sales"] = d2 - d3;
							if (num4 - num5 != 0m)
							{
								dataRow2["AvgPrice"] = (d2 - d3) / (num4 - num5);
							}
							else
							{
								dataRow2["AvgPrice"] = 0;
							...
							if (num4 - num5 != 0m)
							{
								dataRow2["AvgCost"] = num3 / (num4 - num5);
							}
							else
							{
								dataRow2["AvgCost"] = 0;
							...
							dataRow2["COGS"] = num3;
							decimal num6 = d2 - d3 - num3;
							dataRow2["Profit"] = num6;
							if (d2 - d3 != 0m)
							{
								dataRow2["Margin"] = num6 / (d2 - d3) * 100m;
							}
							else
							{
								dataRow2["Margin"] = 0;
					...
					textBoxTotalQty.Text = num2.ToString(Format.QuantityFormat);
					textBoxTotalAmount.Text = num.ToString(Format.TotalAmountFormat);
					textBoxProfit.Text = (num - d).ToString(Format.TotalAmountFormat);
					if (num != 0m)
					{
						textBoxMargin.Text = Math.Round((num - d) / num * 100m, Global.CurDecimalPoints).ToString(Format.TotalAmountFormat);
					}
					else
					{
					...
					if (listData != null && listData.Tables.Count > 0)
					{
						...
						foreach (DataRow row2 in dataView2.ToTable(true, "ProductID", "ProductDescription").Rows)
						{
							...
							{
								d4 = Math.Round(decimal.Parse(obj2.ToString()), 2);
							}
							obj2 = dataTable3.Compute("SUM(Amount)", "ProductID = '" + text2 + "' AND Amount < 0");
							if (obj2 != null && !string.IsNullOrEmpty(obj2.ToString()))
							{
								d5 = Math.Abs(Math.Round(decimal.Parse(obj2.ToString()), Global.CurDecimalPoints));
							}
							obj2 = dataTable3.Compute("SUM(COGS)", "ProductID = '" + text2 + "'");
							if (obj2 != null && !string.IsNullOrEmpty(obj2.ToString()))
							{
								num7 = Math.Round(decimal.Parse(obj2.ToString()), Global.CurDecimalPoints);
							}
							...
							if (obj2 != null && !string.IsNullOrEmpty(obj2.ToString()))
							{
								num9 = Math.Abs(Math.Round(decimal.Parse(obj2.ToString()), Global.CurDecimalPoints));
							}
							...
							dataRow4["QuantitySold"] = num8;
							dataRow4["QuantityReturn"] = num9;
							dataRow4["NetQuantity"] = num8 - num9;
							dataRow4["Sales"] = d4 - d5;
							if (num8 - num9 != 0m)
							{
								dataRow4["AvgPrice"] = (d4 - d5) / (num8 - num9);
							}
							else
							{
								dataRow4["AvgPrice"] = 0;
							...
							if (num8 - num9 != 0m)
							{
								dataRow4["AvgCost"] = num7 / (num8 - num9);
							}
							else
							{
								dataRow4["AvgCost"] = 0;
							...
							dataRow4["COGS"] = num7;
							decimal num10 = d4 - d5 - num7;
							dataRow4["Profit"] = num10;
							if (d4 - d5 != 0m)
							{
								dataRow4["Margin"] = num10 / (d4 - d5) * 100m;
							}
							else
							{
								dataRow4["Margin"] = 0;
					...
					if (listData != null && listData.Tables.Count > 0)
					{
						...
						foreach (DataRow row3 in dataView3.ToTable(true, "CategoryID", "Category").Rows)
						{
							...
							if (dataTable.Select("CategoryID = '" + text3.Trim() + "'").Length == 0)
							{
								...
								{
									d6 = Math.Round(decimal.Parse(obj3.ToString()), Global.CurDecimalPoints);
								}
								obj3 = ((!(text3 == "")) ? dataTable4.Compute("SUM(Amount)", "CategoryID = '" + text3 + "' AND Amount < 0") : dataTable4.Compute("SUM(Amount)", "(CategoryID IS NULL OR CategoryID = '" + text3 + "') AND Amount<0"));
								if (obj3 != null && !string.IsNullOrEmpty(obj3.ToString()))
								{
									d7 = Math.Abs(Math.Round(decimal.Parse(obj3.ToString()), Global.CurDecimalPoints));
								}
								obj3 = dataTable4.Compute("SUM(COGS)", "CategoryID = '" + text3 + "'");
								if (obj3 != null && !string.IsNullOrEmpty(obj3.ToString()))
								{
									num11 = Math.Round(decimal.Parse(obj3.ToString()), Global.CurDecimalPoints);
								}
								...
								if (obj3 != null && !string.IsNullOrEmpty(obj3.ToString()))
								{
									num13 = Math.Abs(Math.Round(decimal.Parse(obj3.ToString()), Global.CurDecimalPoints));
								}
								...
								dataRow6["QuantitySold"] = num12;
								dataRow6["QuantityReturn"] = num13;
								dataRow6["NetQuantity"] = num12 - num13;
								dataRow6["Sales"] = d6 - d7;
								if (num12 - num13 != 0m)
								{
									dataRow6["AvgPrice"] = (d6 - d7) / (num12 - num13);
								}
								else
								{
									dataRow6["AvgPrice"] = 0;
								...
								if (num12 - num13 != 0m)
								{
									dataRow6["AvgCost"] = num11 / (num12 - num13);
								}
								else
								{
									dataRow6["AvgCost"] = 0;
								...
								dataRow6["COGS"] = num11;
								decimal num14 = d6 - d7 - num11;
								dataRow6["Profit"] = num14;
								if (d6 - d7 != 0m)
								{
									dataRow6["Margin"] = num14 / (d6 - d7) * 100m;
								}
								else
								{
									dataRow6["Margin"] = 0;
					...
					if (listData != null && listData.Tables.Count > 0)
					{
						...
						foreach (DataRow row4 in dataView4.ToTable(true, "CustomerID", "CustomerName").Rows)
						{
							...
							{
								d8 = Math.Round(decimal.Parse(obj4.ToString()), Global.CurDecimalPoints);
							}
							obj4 = dataTable5.Compute("SUM(Amount)", "CustomerID = '" + text4 + "' AND Amount < 0");
							if (obj4 != null && !string.IsNullOrEmpty(obj4.ToString()))
							{
								d9 = Math.Abs(Math.Round(decimal.Parse(obj4.ToString()), Global.CurDecimalPoints));
							}
							obj4 = dataTable5.Compute("SUM(COGS)", "CustomerID = '" + text4 + "'");
							if (obj4 != null && !string.IsNullOrEmpty(obj4.ToString()))
							{
								num15 = Math.Round(decimal.Parse(obj4.ToString()), Global.CurDecimalPoints);
							}
							...
							if (obj4 != null && !string.IsNullOrEmpty(obj4.ToString()))
							{
								num17 = Math.Abs(Math.Round(decimal.Parse(obj4.ToString()), Global.CurDecimalPoints));
							}
							...
							dataRow8["QuantitySold"] = num16;
							dataRow8["QuantityReturn"] = num17;
							dataRow8["NetQuantity"] = num16 - num17;
							dataRow8["Sales"] = d8 - d9;
							if (num16 - num17 != 0m)
							{
								dataRow8["AvgPrice"] = (d8 - d9) / (num16 - num17);
							}
							else
							{
								dataRow8["AvgPrice"] = 0;
							...
							if (num16 - num17 != 0m)
							{
								dataRow8["AvgCost"] = num15 / (num16 - num17);
							}
							else
							{
								dataRow8["AvgCost"] = 0;
							...
							dataRow8["COGS"] = num15;
							decimal num18 = d8 - d9 - num15;
							dataRow8["Profit"] = num18;
							if (d8 - d9 != 0m)
							{
								dataRow8["Margin"] = num18 / (d8 - d9) * 100m;
							}
							else
							{
								dataRow8["Margin"] = 0;
