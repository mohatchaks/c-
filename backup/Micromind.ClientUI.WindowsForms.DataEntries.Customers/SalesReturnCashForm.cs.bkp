...
{
	public class SalesReturnCashForm : Form, IForm
	{
		...
		private ToolStripMenuItem transferToSalesReturnToolStripMenuItem;
		...
		private ToolStripMenuItem grantToEditToolStripMenuItem;
		...
		private bool IsNewRecord
		{
			...
			set
			{
				...
				else if (!screenRight.Edit && !isNewRecord)
				{
					buttonSave.Enabled = false;
					buttonVoid.Enabled = false;
					grantToEditToolStripMenuItem.Visible = false;
				}
				else
				{
				...
				foreach (UltraGridRow row in dataGridItems.Rows)
				{
					...
					if (!(result == 0m))
					{
						...
						if (dataGridItems.DisplayLayout.Bands[0].Columns.Exists("SourceSysDocID"))
						{
							...
							{
								dataRow2["SourceSysDocID"] = (sourceSysDocID = row.Cells["SourceSysDocID"].Value.ToString());
							}
							if (row.Cells["SourceVoucherID"].Value.ToString() != "")
							{
								dataRow2["SourceVoucherID"] = (sourceVoucherID = row.Cells["SourceVoucherID"].Value.ToString());
							}
		...
		private void SetupGrid()
		{
			try
			{
				...
				UltraGridColumn ultraGridColumn8 = dataGridItems.DisplayLayout.Bands[0].Columns["TaxOption"];
				...
				hidden = (ultraGridColumn9.Hidden = flag4);
		...
		private bool ValidateData()
		{
			...
			checked
			{
				...
				if (textBoxVoucherNumber.Text.Trim() == "" || comboBoxSysDoc.SelectedID == "" || comboBoxRegister.SelectedID == "" || comboBoxCustomer.SelectedID == "")
				{
				...
				for (int i = 0; i < dataGridItems.Rows.Count; i++)
				{
					...
					{
						decimal num2 = decimal.Parse(ultraGridRow.Cells["Quantity"].Value.ToString());
						...
						if (Math.Abs(Math.Round(num2 * (d2 + default(decimal)), Global.CurDecimalPoints) - d3) > 0.1m)
						{
		...
		private void Form_Load(object sender, EventArgs e)
		{
			checked
			{
				try
				{
					...
					comboBoxSysDoc.FilterByType(SysDocTypes.CashSalesReturn);
					SetSecurity();
					if (!base.IsDisposed)
					{
						IsNewRecord = true;
		...
		{
			new FormHelper().EditSysDoc(comboBoxSysDoc.SelectedID, SysDocTypes.CashSalesReturn);
		}
		...
		private void Print(bool isPrint, bool showPrintDialog, bool saveChanges)
		{
			try
			{
				if (!(IsDirty && saveChanges) || (ErrorHelper.QuestionMessage(MessageBoxButtons.YesNo, "You must save the document before printing.", "Do you want to save?") == DialogResult.Yes && SaveData(clearAfter: false)))
				{
					...
					{
						PrintHelper.PrintDocument(salesReturnToPrint, selectedID, "Cash Sales Return", SysDocTypes.CashSalesReturn, isPrint, showPrintDialog);
					}
				}
			}
			catch (Exception e)
		...
		private void transferToSalesReturnToolStripMenuItem_Click(object sender, EventArgs e)
		{
			try
			{
				if (!IsNewRecord)
				...
				else
				{
					...
					selectDocumentDialog.Text = "Select Sales Receipt to Return";
		...
		private void form_RequireDataRefresh(object sender, DateRangeStruct e)
		{
			...
			if (Security.IsAllowedSecurityRole(GeneralSecurityRoles.DefaultLocationSales) && !Global.isUserAdmin)
			{
				...
				dataSet = Factory.SalesReturnSystem.GetInvoicesToReturn(comboBoxSysDoc.SelectedID, comboBoxCustomer.SelectedID, cashOnly: true, e.From, e.To, num, defaultLocationID);
			}
			else
			{
				dataSet = Factory.SalesReturnSystem.GetInvoicesToReturn(comboBoxSysDoc.SelectedID, comboBoxCustomer.SelectedID, cashOnly: true, e.From, e.To, num);
			}
		...
		{
			transferToSalesReturnToolStripMenuItem_Click(sender, e);
		}
		...
		{
			new FormHelper().EditRegister(comboBoxRegister.Text);
		}
		...
		private void toolStripButtonMultiPreview_Click(object sender, EventArgs e)
		{
			...
			attachementDetailsForm.SysDocType = SysDocTypes.CashSalesReturn;
		...
		private void grantToEditToolStripMenuItem_Click(object sender, EventArgs e)
		{
			DataSet dataSet = new DataSet();
			...
			if (selectDocumentDialog.ShowDialog(this) == DialogResult.OK)
			{
				...
				foreach (UltraGridRow selectedRow in selectDocumentDialog.SelectedRows)
				{
					...
					if (0 == 0)
					{
						...
						flag = Factory.SalesReturnSystem.ModifyTransactions(comboBoxSysDoc.SelectedID, textBoxVoucherNumber.Text, text, isModify: true, "");
					}
				}
				if (flag)
				{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Customers.SalesReturnCashForm));
			...
			transferToSalesReturnToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			grantToEditToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			...
			toolStripDropDownButton1.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[7]
			{
				...
				toolStripMenuItem2,
				toolStripSeparator6,
				transferToSalesReturnToolStripMenuItem,
				grantToEditToolStripMenuItem
			});
			...
			transferToSalesReturnToolStripMenuItem.Name = "transferToSalesReturnToolStripMenuItem";
			transferToSalesReturnToolStripMenuItem.Size = new System.Drawing.Size(217, 22);
			transferToSalesReturnToolStripMenuItem.Text = "Create from Sales Receipt...";
			transferToSalesReturnToolStripMenuItem.Click += new System.EventHandler(transferToSalesReturnToolStripMenuItem_Click);
			grantToEditToolStripMenuItem.Name = "grantToEditToolStripMenuItem";
			grantToEditToolStripMenuItem.Size = new System.Drawing.Size(217, 22);
			grantToEditToolStripMenuItem.Text = "Grant Edit Permission";
			grantToEditToolStripMenuItem.Click += new System.EventHandler(grantToEditToolStripMenuItem_Click);
			...
			dataGridItems.Size = new System.Drawing.Size(874, 248);
			dataGridItems.TabIndex = 1;
			dataGridItems.Text = "dataEntryGrid1";
			dateTimePickerDate.Format = System.Windows.Forms.DateTimePickerFormat.Short;
			dateTimePickerDate.Location = new System.Drawing.Point(743, 5);
			dateTimePickerDate.Name = "dateTimePickerDate";
			dateTimePickerDate.Size = new System.Drawing.Size(87, 20);
			dateTimePickerDate.TabIndex = 11;
			textBoxVoucherNumber.Location = new System.Drawing.Point(299, 1);
			textBoxVoucherNumber.MaxLength = 15;
			textBoxVoucherNumber.Name = "textBoxVoucherNumber";
			textBoxVoucherNumber.Size = new System.Drawing.Size(115, 20);
			textBoxVoucherNumber.TabIndex = 1;
			label1.AutoSize = true;
			label1.Location = new System.Drawing.Point(660, 30);
			label1.Name = "label1";
			...
			mmLabel1.Location = new System.Drawing.Point(660, 7);
			...
			textBoxNote.Size = new System.Drawing.Size(381, 97);
			textBoxNote.TabIndex = 2;
			label3.Anchor = (System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left);
			label3.AutoSize = true;
			label3.Location = new System.Drawing.Point(9, 490);
			label3.Name = "label3";
			...
			ultraFormattedLinkLabel2.Location = new System.Drawing.Point(214, 3);
			...
			comboBoxPayeeTaxGroup.Location = new System.Drawing.Point(429, 49);
			...
			labelJob.Location = new System.Drawing.Point(258, 147);
			labelJob.Name = "labelJob";
			labelJob.Size = new System.Drawing.Size(42, 15);
			labelJob.TabIndex = 163;
			...
			labelCurrency.Location = new System.Drawing.Point(663, 118);
			labelCurrency.Name = "labelCurrency";
			labelCurrency.Size = new System.Drawing.Size(52, 15);
			labelCurrency.TabIndex = 161;
			...
			comboBoxCostCategory.Location = new System.Drawing.Point(503, 143);
			...
			comboBoxJob.Location = new System.Drawing.Point(302, 143);
			...
			comboBoxReturnReason.Location = new System.Drawing.Point(99, 143);
			...
			buttonSelectDocument.Location = new System.Drawing.Point(622, 22);
			...
			comboBoxRegister.DisplayLayout.Appearance = appearance61;
			...
			comboBoxRegister.DisplayLayout.GroupByBox.Appearance = appearance62;
			appearance63.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxRegister.DisplayLayout.GroupByBox.BandLabelAppearance = appearance63;
			...
			comboBoxRegister.DisplayLayout.GroupByBox.PromptAppearance = appearance64;
			...
			comboBoxRegister.DisplayLayout.Override.ActiveCellAppearance = appearance65;
			appearance66.BackColor = System.Drawing.SystemColors.Highlight;
			appearance66.ForeColor = System.Drawing.SystemColors.HighlightText;
			comboBoxRegister.DisplayLayout.Override.ActiveRowAppearance = appearance66;
			...
			comboBoxRegister.DisplayLayout.Override.CardAreaAppearance = appearance67;
			appearance68.BorderColor = System.Drawing.Color.Silver;
			appearance68.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxRegister.DisplayLayout.Override.CellAppearance = appearance68;
			...
			comboBoxRegister.DisplayLayout.Override.GroupByRowAppearance = appearance69;
			appearance70.TextHAlignAsString = "Left";
			comboBoxRegister.DisplayLayout.Override.HeaderAppearance = appearance70;
			...
			comboBoxRegister.DisplayLayout.Override.RowAppearance = appearance71;
			comboBoxRegister.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance72.BackColor = System.Drawing.SystemColors.ControlLight;
			comboBoxRegister.DisplayLayout.Override.TemplateAddRowAppearance = appearance72;
			...
			comboBoxRegister.Location = new System.Drawing.Point(506, 2);
			...
			comboBoxRegister.Size = new System.Drawing.Size(144, 20);
			...
			comboBoxSalesperson.DisplayLayout.Appearance = appearance73;
			...
			comboBoxSalesperson.DisplayLayout.GroupByBox.Appearance = appearance74;
			appearance75.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxSalesperson.DisplayLayout.GroupByBox.BandLabelAppearance = appearance75;
			...
			comboBoxSalesperson.DisplayLayout.GroupByBox.PromptAppearance = appearance76;
			...
			comboBoxSalesperson.DisplayLayout.Override.ActiveCellAppearance = appearance77;
			...
			comboBoxSalesperson.DisplayLayout.Override.ActiveRowAppearance = appearance78;
			...
			comboBoxSalesperson.DisplayLayout.Override.CardAreaAppearance = appearance79;
			...
			comboBoxSalesperson.DisplayLayout.Override.CellAppearance = appearance80;
			...
			comboBoxSalesperson.DisplayLayout.Override.GroupByRowAppearance = appearance81;
			appearance82.TextHAlignAsString = "Left";
			comboBoxSalesperson.DisplayLayout.Override.HeaderAppearance = appearance82;
			...
			comboBoxSalesperson.DisplayLayout.Override.RowAppearance = appearance83;
			...
			comboBoxSalesperson.DisplayLayout.Override.TemplateAddRowAppearance = appearance84;
			...
			comboBoxSalesperson.Location = new System.Drawing.Point(743, 90);
			...
			comboBoxSalesperson.Size = new System.Drawing.Size(122, 20);
			comboBoxSalesperson.TabIndex = 15;
			...
			ultraFormattedLinkLabel6.Location = new System.Drawing.Point(660, 93);
			...
			label2.Location = new System.Drawing.Point(660, 72);
			label2.Name = "label2";
			label2.Size = new System.Drawing.Size(79, 13);
			label2.TabIndex = 132;
			label2.Text = "Customer PO#:";
			textBoxPONumber.Location = new System.Drawing.Point(743, 68);
			textBoxPONumber.MaxLength = 30;
			textBoxPONumber.Name = "textBoxPONumber";
			textBoxPONumber.Size = new System.Drawing.Size(122, 20);
			textBoxPONumber.TabIndex = 14;
			...
			textBoxCustomerName.Size = new System.Drawing.Size(410, 20);
			...
			comboBoxCurrency.Location = new System.Drawing.Point(743, 112);
			...
			labelVoided.Location = new System.Drawing.Point(13, 394);
			labelVoided.Name = "labelVoided";
			labelVoided.Size = new System.Drawing.Size(872, 59);
			...
			comboBoxGridItem.DisplayLayout.Appearance = appearance117;
			...
			comboBoxGridItem.DisplayLayout.GroupByBox.Appearance = appearance118;
			appearance119.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxGridItem.DisplayLayout.GroupByBox.BandLabelAppearance = appearance119;
			...
			comboBoxGridItem.DisplayLayout.GroupByBox.PromptAppearance = appearance120;
			...
			comboBoxGridItem.DisplayLayout.Override.ActiveCellAppearance = appearance121;
			...
			comboBoxGridItem.DisplayLayout.Override.ActiveRowAppearance = appearance122;
			...
			comboBoxGridItem.DisplayLayout.Override.CardAreaAppearance = appearance123;
			...
			comboBoxGridItem.DisplayLayout.Override.CellAppearance = appearance124;
			...
			comboBoxGridItem.DisplayLayout.Override.GroupByRowAppearance = appearance125;
			appearance126.TextHAlignAsString = "Left";
			comboBoxGridItem.DisplayLayout.Override.HeaderAppearance = appearance126;
			...
			comboBoxGridItem.DisplayLayout.Override.RowAppearance = appearance127;
			...
			comboBoxGridItem.DisplayLayout.Override.TemplateAddRowAppearance = appearance128;
			...
			panel1.Location = new System.Drawing.Point(668, 462);
			panel1.Name = "panel1";
			panel1.Size = new System.Drawing.Size(220, 113);
			panel1.TabIndex = 4;
			...
			panelNonTax.Size = new System.Drawing.Size(219, 64);
			...
			label10.Location = new System.Drawing.Point(3, 23);
			...
			textBoxRoundOff.Location = new System.Drawing.Point(80, 20);
			...
			linkLabelTax.Appearance = appearance129;
			linkLabelTax.AutoSize = true;
			linkLabelTax.Location = new System.Drawing.Point(6, 4);
			linkLabelTax.Name = "linkLabelTax";
			linkLabelTax.Size = new System.Drawing.Size(25, 15);
			linkLabelTax.TabIndex = 161;
			...
			linkLabelTax.VisitedLinkAppearance = appearance130;
			...
			label8.Location = new System.Drawing.Point(4, 45);
			label8.Name = "label8";
			...
			textBoxTotal.Location = new System.Drawing.Point(80, 41);
			...
			comboBoxGridLocation.DisplayLayout.Appearance = appearance131;
			...
			comboBoxGridLocation.DisplayLayout.GroupByBox.Appearance = appearance132;
			appearance133.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxGridLocation.DisplayLayout.GroupByBox.BandLabelAppearance = appearance133;
			...
			comboBoxGridLocation.DisplayLayout.GroupByBox.PromptAppearance = appearance134;
			...
			comboBoxGridLocation.DisplayLayout.Override.ActiveCellAppearance = appearance135;
			...
			comboBoxGridLocation.DisplayLayout.Override.ActiveRowAppearance = appearance136;
			...
			comboBoxGridLocation.DisplayLayout.Override.CardAreaAppearance = appearance137;
			...
			comboBoxGridLocation.DisplayLayout.Override.CellAppearance = appearance138;
			...
			comboBoxGridLocation.DisplayLayout.Override.GroupByRowAppearance = appearance139;
			appearance140.TextHAlignAsString = "Left";
			comboBoxGridLocation.DisplayLayout.Override.HeaderAppearance = appearance140;
			...
			comboBoxGridLocation.DisplayLayout.Override.RowAppearance = appearance141;
			...
			comboBoxGridLocation.DisplayLayout.Override.TemplateAddRowAppearance = appearance142;
			...
			comboBoxSpecification.DisplayLayout.Appearance = appearance143;
			...
			comboBoxSpecification.DisplayLayout.GroupByBox.Appearance = appearance144;
			appearance145.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxSpecification.DisplayLayout.GroupByBox.BandLabelAppearance = appearance145;
			...
			comboBoxSpecification.DisplayLayout.GroupByBox.PromptAppearance = appearance146;
			...
			comboBoxSpecification.DisplayLayout.Override.ActiveCellAppearance = appearance147;
			...
			comboBoxSpecification.DisplayLayout.Override.ActiveRowAppearance = appearance148;
			...
			comboBoxSpecification.DisplayLayout.Override.CardAreaAppearance = appearance149;
			...
			comboBoxSpecification.DisplayLayout.Override.CellAppearance = appearance150;
			...
			comboBoxSpecification.DisplayLayout.Override.GroupByRowAppearance = appearance151;
			appearance152.TextHAlignAsString = "Left";
			comboBoxSpecification.DisplayLayout.Override.HeaderAppearance = appearance152;
			...
			comboBoxSpecification.DisplayLayout.Override.RowAppearance = appearance153;
			...
			comboBoxSpecification.DisplayLayout.Override.TemplateAddRowAppearance = appearance154;
			...
			comboBoxSpecification.Location = new System.Drawing.Point(497, 303);
			...
			comboBoxStyle.DisplayLayout.Appearance = appearance155;
			...
			comboBoxStyle.DisplayLayout.GroupByBox.Appearance = appearance156;
			appearance157.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxStyle.DisplayLayout.GroupByBox.BandLabelAppearance = appearance157;
			...
			comboBoxStyle.DisplayLayout.GroupByBox.PromptAppearance = appearance158;
			...
			comboBoxStyle.DisplayLayout.Override.ActiveCellAppearance = appearance159;
			...
			comboBoxStyle.DisplayLayout.Override.ActiveRowAppearance = appearance160;
			...
			comboBoxStyle.DisplayLayout.Override.CardAreaAppearance = appearance161;
			...
			comboBoxStyle.DisplayLayout.Override.CellAppearance = appearance162;
			...
			comboBoxStyle.DisplayLayout.Override.GroupByRowAppearance = appearance163;
			appearance164.TextHAlignAsString = "Left";
			comboBoxStyle.DisplayLayout.Override.HeaderAppearance = appearance164;
			...
			comboBoxStyle.DisplayLayout.Override.RowAppearance = appearance165;
			...
			comboBoxStyle.DisplayLayout.Override.TemplateAddRowAppearance = appearance166;
			...
			comboBoxStyle.Location = new System.Drawing.Point(303, 276);
			...
			checkBoxPriceIncludeTax.Location = new System.Drawing.Point(517, 472);
			...
			base.ClientSize = new System.Drawing.Size(900, 616);
			...
			base.Name = "SalesReturnCashForm";
			Text = "Sales Return - Cash";
