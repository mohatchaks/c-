...
{
	public class DestinationDetailsForm : Form, IForm
	{
		private DestinationData currentData;

		private const string TABLENAME_CONST = "Destination";

		private const string IDFIELD_CONST = "DestinationID";
		...
		{
			base.Load += DestinationDetailsForm_Load;
		}
		...
		private bool GetData()
		{
			try
			{
				...
				{
					currentData = new DestinationData();
				}
				DataRow dataRow = (!isNewRecord) ? currentData.DestinationTable.Rows[0] : currentData.DestinationTable.NewRow();
				dataRow.BeginEdit();
				dataRow["DestinationID"] = textBoxCode.Text.Trim();
				dataRow["DestinationName"] = textBoxName.Text.Trim();
				dataRow["Note"] = textBoxNote.Text;
				dataRow["Inactive"] = checkBoxInactive.Checked;
				dataRow["TicketFixedAmount"] = textBoxTicketAmount.Text;
				dataRow["AccountID"] = comboBoxAccount.SelectedID;
				dataRow.EndEdit();
				if (isNewRecord)
				{
					currentData.DestinationTable.Rows.Add(dataRow);
				}
				return true;
			}
			catch (Exception e)
		...
		public void LoadData(string id)
		{
			try
			{
				...
				{
					currentData = Factory.DestinationSystem.GetDestinationByID(id.Trim());
		...
		private void FillData()
		{
			if (currentData != null && currentData.Tables.Count != 0 && currentData.Tables[0].Rows.Count != 0)
			{
				...
				textBoxCode.Text = dataRow["DestinationID"].ToString();
				textBoxName.Text = dataRow["DestinationName"].ToString();
				textBoxNote.Text = dataRow["Note"].ToString();
				checkBoxInactive.Checked = bool.Parse(dataRow["Inactive"].ToString());
				textBoxTicketAmount.Text = dataRow["TicketFixedAmount"].ToString();
		...
		private bool SaveData()
		{
			...
			try
			{
				...
				if (isNewRecord)
				{
					flag = Factory.DestinationSystem.CreateDestination(currentData);
					if (flag)
					{
						ComboDataHelper.SetRefreshStatus(DataComboType.Destination, needRefresh: true);
					}
				}
				else
				{
					flag = Factory.DestinationSystem.UpdateDestination(currentData);
				}
				if (!flag)
				{
		...
		private bool ValidateData()
		{
			...
			if (isNewRecord && Factory.DatabaseSystem.ExistFieldValue("Destination", "DestinationID", textBoxCode.Text.Trim()))
			{
		...
		{
			textBoxCode.Text = PublicFunctions.GetNextCardNumber("Destination", "DestinationID");
			textBoxName.Clear();
			textBoxNote.Clear();
		...
		private void DestinationGroupDetailsForm_Validating(object sender, CancelEventArgs e)
		{
		}

		private void DestinationGroupDetailsForm_Validated(object sender, EventArgs e)
		{
		}
		...
		private bool Delete()
		{
			try
			{
				...
				return Factory.DestinationSystem.DeleteDestination(textBoxCode.Text);
			}
			catch (Exception e)
			{
				ErrorHelper.ProcessError(e);
		...
		{
			LoadData(DatabaseHelper.GetNextID("Destination", "DestinationID", textBoxCode.Text));
		}

		private void toolStripButtonPrevious_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetPreviousID("Destination", "DestinationID", textBoxCode.Text));
		}

		private void toolStripButtonLast_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetLastID("Destination", "DestinationID"));
		}

		private void toolStripButtonFirst_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetFirstID("Destination", "DestinationID"));
		}
		...
		private void toolStripButtonFind_Click(object sender, EventArgs e)
		{
			try
			{
				...
				else if (Factory.DatabaseSystem.ExistFieldValue("Destination", "DestinationID", toolStripTextBoxFind.Text.Trim()))
				{
		...
		private void DestinationDetailsForm_Load(object sender, EventArgs e)
		{
			try
			{
				SetSecurity();
		...
		{
			new FormHelper().ShowList(DataComboType.Destination);
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Employees.DestinationDetailsForm));
			...
			panelButtons.Location = new System.Drawing.Point(0, 156);
			...
			labelCode.Text = "Destination Code:";
			...
			mmLabel1.TabIndex = 3;
			mmLabel1.Text = "Destination Name:";
			...
			textBoxName.Size = new System.Drawing.Size(306, 20);
			...
			mmLabel4.Location = new System.Drawing.Point(13, 128);
			...
			textBoxNote.Location = new System.Drawing.Point(126, 124);
			textBoxNote.MaxLength = 255;
			textBoxNote.Name = "textBoxNote";
			textBoxNote.Size = new System.Drawing.Size(306, 20);
			...
			textBoxTicketAmount.Location = new System.Drawing.Point(126, 80);
			...
			textBoxTicketAmount.TabIndex = 4;
			...
			comboBoxAccount.Location = new System.Drawing.Point(126, 102);
			...
			ultraFormattedLinkLabel6.Location = new System.Drawing.Point(12, 106);
			...
			ultraFormattedLinkLabel6.VisitedLinkAppearance = appearance13;
			ultraFormattedLinkLabel6.LinkClicked += new Infragistics.Win.FormattedLinkLabel.LinkClickedEventHandler(ultraFormattedLinkLabel6_LinkClicked);
			base.AutoScaleDimensions = new System.Drawing.SizeF(6f, 13f);
			base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			BackColor = System.Drawing.Color.WhiteSmoke;
			base.ClientSize = new System.Drawing.Size(470, 196);
			base.Controls.Add(comboBoxAccount);
			base.Controls.Add(ultraFormattedLinkLabel6);
			base.Controls.Add(textBoxTicketAmount);
			...
			base.Name = "DestinationDetailsForm";
			Text = "Destination";
