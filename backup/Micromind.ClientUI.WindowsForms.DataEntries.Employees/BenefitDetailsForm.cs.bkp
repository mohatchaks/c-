...
{
	public class BenefitDetailsForm : Form, IForm
	{
		private BenefitData currentData;

		private const string TABLENAME_CONST = "Benefit";

		private const string IDFIELD_CONST = "BenefitID";
		...
		private CheckBox checkBoxIsNonFinancial;

		public ScreenAreas ScreenArea => ScreenAreas.HR;

		public int ScreenID => 5001;
		...
		{
			base.Load += BenefitDetailsForm_Load;
		...
		private bool GetData()
		{
			try
			{
				...
				{
					currentData = new BenefitData();
				}
				DataRow dataRow = (!isNewRecord) ? currentData.BenefitTable.Rows[0] : currentData.BenefitTable.NewRow();
				dataRow.BeginEdit();
				dataRow["BenefitID"] = textBoxCode.Text.Trim();
				dataRow["BenefitName"] = textBoxName.Text.Trim();
				dataRow["AccountID"] = comboBoxAccount.SelectedID;
				dataRow["Note"] = textBoxNote.Text;
				dataRow["Inactive"] = checkBoxInactive.Checked;
				dataRow["IsNonFinancial"] = checkBoxIsNonFinancial.Checked;
				dataRow.EndEdit();
				if (isNewRecord)
				{
					currentData.BenefitTable.Rows.Add(dataRow);
				}
				return true;
			}
			catch (Exception e)
		...
		public void LoadData(string id)
		{
			try
			{
				...
				{
					currentData = Factory.BenefitSystem.GetBenefitByID(id.Trim());
		...
		private void FillData()
		{
			if (currentData != null && currentData.Tables.Count != 0 && currentData.Tables[0].Rows.Count != 0)
			{
				...
				textBoxCode.Text = dataRow["BenefitID"].ToString();
				textBoxName.Text = dataRow["BenefitName"].ToString();
				...
				if (dataRow["IsNonFinancial"] != DBNull.Value)
				{
					checkBoxIsNonFinancial.Checked = bool.Parse(dataRow["IsNonFinancial"].ToString());
				}
				else
				{
					checkBoxIsNonFinancial.Checked = false;
				}
			}
		}
		...
		private bool SaveData()
		{
			...
			try
			{
				...
				if (isNewRecord)
				{
					flag = Factory.BenefitSystem.CreateBenefit(currentData);
					if (flag)
					{
						ComboDataHelper.SetRefreshStatus(DataComboType.Benefit, needRefresh: true);
					}
				}
				else
				{
					flag = Factory.BenefitSystem.UpdateBenefit(currentData);
				}
				if (!flag)
				{
		...
		private bool ValidateData()
		{
			...
			if (!checkBoxIsNonFinancial.Checked && comboBoxAccount.SelectedID == "")
			{
				ErrorHelper.InformationMessage("Please enter required fields.");
				comboBoxAccount.Focus();
				return false;
			}
			if (isNewRecord && Factory.DatabaseSystem.ExistFieldValue("Benefit", "BenefitID", textBoxCode.Text.Trim()))
			{
		...
		{
			textBoxCode.Text = PublicFunctions.GetNextCardNumber("Benefit", "BenefitID");
			textBoxName.Clear();
			textBoxNote.Clear();
		...
		private void BenefitGroupDetailsForm_Validating(object sender, CancelEventArgs e)
		{
		}

		private void BenefitGroupDetailsForm_Validated(object sender, EventArgs e)
		{
		}
		...
		private bool Delete()
		{
			try
			{
				...
				return Factory.BenefitSystem.DeleteBenefit(textBoxCode.Text);
			}
			catch (Exception e)
			{
				ErrorHelper.ProcessError(e);
		...
		{
			LoadData(DatabaseHelper.GetNextID("Benefit", "BenefitID", textBoxCode.Text));
		}

		private void toolStripButtonPrevious_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetPreviousID("Benefit", "BenefitID", textBoxCode.Text));
		}

		private void toolStripButtonLast_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetLastID("Benefit", "BenefitID"));
		}

		private void toolStripButtonFirst_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetFirstID("Benefit", "BenefitID"));
		}
		...
		private void toolStripButtonFind_Click(object sender, EventArgs e)
		{
			try
			{
				...
				else if (Factory.DatabaseSystem.ExistFieldValue("Benefit", "BenefitID", toolStripTextBoxFind.Text.Trim()))
				{
		...
		private void BenefitDetailsForm_Load(object sender, EventArgs e)
		{
			try
			{
				SetSecurity();
		...
		{
			new FormHelper().ShowList(DataComboType.Benefit);
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Employees.BenefitDetailsForm));
			...
			checkBoxIsNonFinancial = new System.Windows.Forms.CheckBox();
			...
			labelCode.Location = new System.Drawing.Point(8, 37);
			labelCode.Name = "labelCode";
			labelCode.PenWidth = 1f;
			labelCode.ShowBorder = false;
			labelCode.Size = new System.Drawing.Size(84, 13);
			labelCode.TabIndex = 0;
			labelCode.Text = "Benefit Code:";
			...
			mmLabel4.Location = new System.Drawing.Point(11, 106);
			...
			textBoxNote.Location = new System.Drawing.Point(108, 105);
			...
			comboBoxAccount.Size = new System.Drawing.Size(126, 20);
			...
			textBoxAccountName.Location = new System.Drawing.Point(237, 81);
			textBoxAccountName.MaxLength = 255;
			textBoxAccountName.Name = "textBoxAccountName";
			textBoxAccountName.ReadOnly = true;
			textBoxAccountName.Size = new System.Drawing.Size(195, 20);
			...
			ultraLinkVoucherNumber.Location = new System.Drawing.Point(12, 82);
			...
			checkBoxIsNonFinancial.AutoSize = true;
			checkBoxIsNonFinancial.Location = new System.Drawing.Point(108, 131);
			checkBoxIsNonFinancial.Name = "checkBoxIsNonFinancial";
			checkBoxIsNonFinancial.Size = new System.Drawing.Size(99, 17);
			checkBoxIsNonFinancial.TabIndex = 163;
			checkBoxIsNonFinancial.Text = "Is NonFinancial";
			checkBoxIsNonFinancial.UseVisualStyleBackColor = true;
			base.AutoScaleDimensions = new System.Drawing.SizeF(6f, 13f);
			base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			BackColor = System.Drawing.Color.WhiteSmoke;
			base.ClientSize = new System.Drawing.Size(470, 193);
			base.Controls.Add(checkBoxIsNonFinancial);
