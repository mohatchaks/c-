...
{
	public class EmployeeListForm : Form, IDataForm, IDataList, IExternalReport
	{
		...
		private MenuItem menuItemGotoEmployee;
		...
		{
			InitializeComponent();
			base.Activated += EmployeeListForm_Activated;
			...
			base.FormClosing += EmployeeListForm_FormClosing;
		...
		private void dataGridList_DoubleClickCell(object sender, DoubleClickCellEventArgs e)
		{
			...
			checked
			{
				...
				{
					Image employeeThumbnailImage = PublicFunctions.GetEmployeeThumbnailImage(e.Cell.Row.Cells["Employee Code"].Value.ToString());
					thumbnailViewer1.Image = employeeThumbnailImage;
		...
		{
			if (disposing && employeeData != null)
			{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Employees.EmployeeListForm));
			...
			menuItemGotoEmployee = new System.Windows.Forms.MenuItem();
			...
			panelButtons.Size = new System.Drawing.Size(954, 40);
			...
			linePanelDown.Size = new System.Drawing.Size(954, 1);
			...
			buttonDone.Location = new System.Drawing.Point(846, 8);
			...
			menuItemGotoEmployee.Index = 0;
			menuItemGotoEmployee.Text = "&Goto Employee";
			menuItem2.Index = 1;
			menuItem2.Text = "-";
			menuItemNew.Index = 2;
			menuItemNew.Text = "&New Employee";
			menuItemDelete.Index = 3;
			menuItemDelete.Text = "&Delete Employee";
			menuItem1.Index = 4;
			menuItem1.Text = "-";
			...
			dataGridList.Size = new System.Drawing.Size(930, 402);
			...
			base.Name = "EmployeeListForm";
			Text = "Employee List";
			base.Load += new System.EventHandler(EmployeeListForm_Load);
		...
		private void LoadData()
		{
			if (Factory.IsDBConnected)
			{
				try
				{
					...
					employeeData = Factory.EmployeeSystem.GetEmployeeList(toolStripButtonShowInactive.Checked);
					dataGridList.DataSource = employeeData;
					dataGridList.ApplyFormat();
					dataGridList.AddColumnRowCount(dataGridList.DisplayLayout.Bands[0].Columns["Employee Code"]);
					if (!isSalary)
					{
						dataGridList.DisplayLayout.Bands[0].Columns["Salary"].Hidden = true;
					}
				}
		...
		private void HideShowColumns()
		{
			try
			{
				...
				{
					UltraGridColumn ultraGridColumn = dataGridList.DisplayLayout.Bands[0].Columns["Age"];
					UltraGridColumn ultraGridColumn2 = dataGridList.DisplayLayout.Bands[0].Columns["Birth Date"];
					UltraGridColumn ultraGridColumn3 = dataGridList.DisplayLayout.Bands[0].Columns["Class"];
					UltraGridColumn ultraGridColumn4 = dataGridList.DisplayLayout.Bands[0].Columns["Department"];
					UltraGridColumn ultraGridColumn5 = dataGridList.DisplayLayout.Bands[0].Columns["Division"];
					UltraGridColumn ultraGridColumn6 = dataGridList.DisplayLayout.Bands[0].Columns["Gender"];
					UltraGridColumn ultraGridColumn7 = dataGridList.DisplayLayout.Bands[0].Columns["Grade"];
					UltraGridColumn ultraGridColumn8 = dataGridList.DisplayLayout.Bands[0].Columns["Joining Date"];
					UltraGridColumn ultraGridColumn9 = dataGridList.DisplayLayout.Bands[0].Columns["Location"];
					UltraGridColumn ultraGridColumn10 = dataGridList.DisplayLayout.Bands[0].Columns["Nationality"];
					UltraGridColumn ultraGridColumn11 = dataGridList.DisplayLayout.Bands[0].Columns["Nick Name"];
					UltraGridColumn ultraGridColumn12 = dataGridList.DisplayLayout.Bands[0].Columns["Phone2"];
					UltraGridColumn ultraGridColumn13 = dataGridList.DisplayLayout.Bands[0].Columns["Report To"];
					UltraGridColumn ultraGridColumn14 = dataGridList.DisplayLayout.Bands[0].Columns["Type"];
					UltraGridColumn ultraGridColumn15 = dataGridList.DisplayLayout.Bands[0].Columns["Vacation"];
					bool flag2 = dataGridList.DisplayLayout.Bands[0].Columns["Sponsor"].Hidden = true;
					bool flag4 = ultraGridColumn15.Hidden = flag2;
					bool flag6 = ultraGridColumn14.Hidden = flag4;
					bool flag8 = ultraGridColumn13.Hidden = flag6;
					bool flag10 = ultraGridColumn12.Hidden = flag8;
					bool flag12 = ultraGridColumn11.Hidden = flag10;
					bool flag14 = ultraGridColumn10.Hidden = flag12;
					bool flag16 = ultraGridColumn9.Hidden = flag14;
					bool flag18 = ultraGridColumn8.Hidden = flag16;
					bool flag20 = ultraGridColumn7.Hidden = flag18;
					bool flag22 = ultraGridColumn6.Hidden = flag20;
					bool flag24 = ultraGridColumn5.Hidden = flag22;
					bool flag26 = ultraGridColumn4.Hidden = flag24;
					bool flag28 = ultraGridColumn3.Hidden = flag26;
					bool hidden = ultraGridColumn2.Hidden = flag28;
		...
		private void OpenForEdit()
		{
			...
			if (!(selectedID == ""))
			{
				new FormHelper().EditEmployee(selectedID);
			}
		}
		...
		private void SetupGrid()
		{
			try
			{
				...
				dataGridList.DisplayLayout.Bands[0].Columns["P"].Header.FixedHeaderIndicator = FixedHeaderIndicator.None;
				ValueList valueList = new ValueList();
				valueList.ValueListItems.Add(1, "Active");
				valueList.ValueListItems.Add(2, "Terminated");
				valueList.ValueListItems.Add(3, "Resigned");
				valueList.ValueListItems.Add(4, "Absconded");
				dataGridList.DisplayLayout.Bands[0].Columns["Status"].ValueList = valueList;
				dataGridList.ApplyNumericColumnFormat(dataGridList.DisplayLayout.Bands[0].Columns["Salary"], addSummary: true);
		...
		private string GetSelectedID()
		{
			...
			return dataGridList.ActiveRow.Cells["Employee Code"].Text.ToString();
		}
			...
			if (!isReadOnly)
			{
				...
				if (selectedID != "")
				{
					try
					{
						...
						{
							PublicFunctions.StartWaiting(this);
							if (Factory.EmployeeSystem.DeleteEmployee(selectedID))
							{
								try
								{
		...
		{
			if (!Security.IsAllowedSecurityRole(GeneralSecurityRoles.AccessSalary))
			{
				isSalary = false;
			}
		}
