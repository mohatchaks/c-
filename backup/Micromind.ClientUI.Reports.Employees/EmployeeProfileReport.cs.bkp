...
{
	public class EmployeeProfileReport : Form, IForm
	{
		...
		{
			DataSet data = Factory.EmployeeSystem.GetEmployeeProfileReport(employeeSelector.FromEmployee, employeeSelector.ToEmployee, employeeSelector.FromDepartment, employeeSelector.ToDepartment, employeeSelector.FromLocation, employeeSelector.ToLocation, employeeSelector.FromType, employeeSelector.ToType, employeeSelector.FromDivision, employeeSelector.ToDivision, employeeSelector.FromSponsor, employeeSelector.ToSponsor, employeeSelector.FromGroup, employeeSelector.ToGroup, employeeSelector.FromGrade, employeeSelector.ToGrade, employeeSelector.FromPosition, employeeSelector.ToPosition, employeeSelector.FromBank, employeeSelector.ToBank, employeeSelector.FromAccount, employeeSelector.ToAccount, checkBoxShowInactive.Checked, employeeSelector.MultipleEmployees);
			ReportHelper reportHelper = new ReportHelper();
			string reportFilter = "";
			reportHelper.AddGeneralReportData(ref data, reportFilter);
			reportHelper.AddFilterData(ref data, GetAllFormControls(this));
			XtraReport report = reportHelper.GetReport("Employee Profile");
			if (report == null)
			{
				ErrorHelper.ErrorMessage("Cannot find the report file", "Please make sure you have access to reports path and the files are not corrupted.", "'Employee Profile.repx'");
				return;
			}
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.Employees.EmployeeProfileReport));
			...
			buttonOK.Location = new System.Drawing.Point(286, 406);
			...
			checkBoxShowInactive.Location = new System.Drawing.Point(25, 350);
			...
			buttonClose.Location = new System.Drawing.Point(390, 406);
			...
			ultraGroupBox1.Location = new System.Drawing.Point(12, 11);
			...
			employeeSelector.Size = new System.Drawing.Size(402, 309);
			...
			base.ClientSize = new System.Drawing.Size(497, 438);
			...
			base.Name = "EmployeeProfileReport";
