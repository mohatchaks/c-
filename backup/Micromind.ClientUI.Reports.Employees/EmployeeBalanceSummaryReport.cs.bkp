...
{
	public class EmployeeBalanceSummaryReport : Form, IForm
	{
		...
		public EmployeeBalanceSummaryReport()
		{
			InitializeComponent();
			base.Load += Form_Load;
		...
		private void buttonOK_Click(object sender, EventArgs e)
		{
			...
			DataSet data = Factory.EmployeeSystem.GetEmployeeBalanceSummary(employeeSelector.FromEmployee, employeeSelector.ToEmployee, employeeSelector.FromDepartment, employeeSelector.ToDepartment, employeeSelector.FromLocation, employeeSelector.ToLocation, employeeSelector.FromType, employeeSelector.ToType, employeeSelector.FromDivision, employeeSelector.ToDivision, employeeSelector.FromSponsor, employeeSelector.ToSponsor, employeeSelector.FromGroup, employeeSelector.ToGroup, employeeSelector.FromGrade, employeeSelector.ToGrade, employeeSelector.FromPosition, employeeSelector.ToPosition, employeeSelector.FromBank, employeeSelector.ToBank, employeeSelector.FromAccount, employeeSelector.ToAccount, checkBoxShowZero.Checked, value, employeeSelector.MultipleEmployees);
			ReportHelper reportHelper = new ReportHelper();
			string reportFilter = "";
			reportHelper.AddGeneralReportData(ref data, reportFilter);
			reportHelper.AddFilterData(ref data, GetAllFormControls(this));
			XtraReport report = reportHelper.GetReport("Employee Balance Summary");
			if (report == null)
			{
				ErrorHelper.ErrorMessage("Cannot find the report file", "'Employee Balance Summar.repx'", "Please make sure you have access to reports path and the files are not corrupted.");
				return;
			}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.Employees.EmployeeBalanceSummaryReport));
			...
			SuspendLayout();
			buttonOK.Location = new System.Drawing.Point(287, 414);
			...
			checkBoxShowZero.Location = new System.Drawing.Point(19, 400);
			...
			buttonClose.Location = new System.Drawing.Point(391, 414);
			...
			label1.Location = new System.Drawing.Point(38, 29);
			label1.Name = "label1";
			label1.Size = new System.Drawing.Size(37, 13);
			label1.TabIndex = 12;
			label1.Text = "As on:";
			dateTimePickerDate.Format = System.Windows.Forms.DateTimePickerFormat.Short;
			dateTimePickerDate.Location = new System.Drawing.Point(89, 27);
			...
			ultraGroupBox1.Location = new System.Drawing.Point(18, 53);
			...
			base.ClientSize = new System.Drawing.Size(497, 468);
			...
			base.Name = "EmployeeBalanceSummaryReport";
			Text = "Employee Balance Summary";
