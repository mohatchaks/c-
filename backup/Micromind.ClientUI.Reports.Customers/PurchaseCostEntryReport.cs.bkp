...
{
	public class PurchaseCostEntryReport : Form, IForm
	{
		...
		public PurchaseCostEntryReport()
		{
			InitializeComponent();
			base.Load += Form_Load;
		}
		...
		private void buttonOK_Click(object sender, EventArgs e)
		{
			...
			{
				data = Factory.VendorSystem.GetPurchaseCostEntryByVendorDetailReport(dateControl1.FromDate, dateControl1.ToDate, vendorSelector.FromVendor, vendorSelector.ToVendor, vendorSelector.FromClass, vendorSelector.ToClass, vendorSelector.FromGroup, vendorSelector.ToGroup, vendorSelector.MultipleVendors);
				xtraReport = reportHelper.GetReport("Purchase Cost Entry By Vendor Detail");
			}
			else
			{
				data = Factory.VendorSystem.GetPurchaseCostEntryByVendorSummaryReport(dateControl1.FromDate, dateControl1.ToDate, vendorSelector.FromVendor, vendorSelector.ToVendor, vendorSelector.FromClass, vendorSelector.ToClass, vendorSelector.FromGroup, vendorSelector.ToGroup, vendorSelector.MultipleVendors);
				xtraReport = reportHelper.GetReport("Purchase Cost Entry By Vendor Summary");
			}
			...
			if (xtraReport == null)
			{
				ErrorHelper.ErrorMessage("Cannot find the report file", "Please make sure you have access to reports path and the files are not corrupted.", "'Purchase Cost Entry.repx'");
				return;
			}
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.Customers.PurchaseCostEntryReport));
			...
			ultraGroupBox1.Size = new System.Drawing.Size(476, 151);
			...
			dateControl1.Location = new System.Drawing.Point(12, 169);
			dateControl1.Name = "dateControl1";
			dateControl1.SelectedPeriod = Micromind.DataControls.DatePeriods.ThisMonthToDate;
			dateControl1.Size = new System.Drawing.Size(476, 55);
			dateControl1.TabIndex = 1;
			dateControl1.ToDate = new System.DateTime(2017, 10, 31, 23, 59, 59, 59);
			...
			base.Name = "PurchaseCostEntryReport";
			Text = "Purchase Cost Entry Report";
