...
{
	public class VendorListReport : Form, IForm
	{
		...
		public int ScreenID => 7044;

		public ScreenTypes ScreenType => ScreenTypes.Report;

		public VendorListReport()
		{
			InitializeComponent();
			base.Load += Form_Load;
		}
		...
		{
			DataSet data = Factory.VendorSystem.GetVendorListReport(vendorSelector.FromVendor, vendorSelector.ToVendor, vendorSelector.FromClass, vendorSelector.ToClass, vendorSelector.FromGroup, vendorSelector.ToGroup, checkBoxShowInactive.Checked, vendorSelector.MultipleVendors);
			ReportHelper reportHelper = new ReportHelper();
			string reportFilter = "";
			reportHelper.AddGeneralReportData(ref data, reportFilter);
			reportHelper.AddFilterData(ref data, GetAllFormControls(this));
			XtraReport report = reportHelper.GetReport("Vendor List");
			if (report == null)
			{
				ErrorHelper.ErrorMessage("Cannot find the report file", "'Vendor List.repx'", "Please make sure you have access to reports path and the files are not corrupted.");
				return;
			}
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.Customers.VendorListReport));
			...
			vendorSelector.Size = new System.Drawing.Size(464, 121);
			...
			checkBoxShowInactive.Location = new System.Drawing.Point(25, 158);
			...
			base.Name = "VendorListReport";
			Text = "Vendor List Report";
