...
{
	public class ProjectSubContractPOReportForm : Form, IForm
	{
		...
		public ProjectSubContractPOReportForm()
		{
			InitializeComponent();
			base.Load += Form_Load;
		}
		...
		private void buttonOK_Click(object sender, EventArgs e)
		{
			try
			{
				...
				DataSet data = Factory.ProductSystem.GetProjectSubContractOrderReport(dateControl1.FromDate, dateControl1.ToDate, productSelector.FromItem, productSelector.ToItem, productSelector.FromClass, productSelector.ToClass, productSelector.FromCategory, productSelector.ToCategory, vendorSelector.FromVendor, vendorSelector.ToVendor, vendorSelector.FromClass, vendorSelector.ToClass, vendorSelector.FromGroup, vendorSelector.ToGroup, BuyerSelector.FromBuyer, BuyerSelector.ToBuyer, jobSelector.FromJob, jobSelector.ToJob);
				xtraReport = reportHelper.GetReport("SubContract Order By Item Vendor Buyer");
				string reportFilter = "From:" + dateControl1.FromDate.ToShortDateString() + "  To:" + dateControl1.ToDate.ToShortDateString();
				reportHelper.AddGeneralReportData(ref data, reportFilter);
				reportHelper.AddFilterData(ref data, GetAllFormControls(this));
				if (xtraReport == null)
				{
					ErrorHelper.ErrorMessage("Cannot find the report file", "Please make sure you have access to reports path and the files are not corrupted.", "'SubContract Order By Item Vendor Buyer.repx'");
				}
				else
				{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.Customers.ProjectSubContractPOReportForm));
			...
			buttonOK.Location = new System.Drawing.Point(283, 513);
			...
			buttonClose.Location = new System.Drawing.Point(387, 513);
			...
			ultraGroupBox2.Size = new System.Drawing.Size(476, 148);
			...
			vendorSelector.Size = new System.Drawing.Size(432, 123);
			...
			dateControl1.Location = new System.Drawing.Point(12, 454);
			...
			groupBoxJob.Location = new System.Drawing.Point(12, 370);
			...
			base.ClientSize = new System.Drawing.Size(502, 549);
			...
			base.Name = "ProjectSubContractPOReportForm";
			Text = "ProjectSubContract Order Report";
