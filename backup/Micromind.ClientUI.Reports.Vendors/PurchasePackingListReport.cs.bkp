...
{
	public class PurchasePackingListReport : Form, IForm
	{
		...
		public PurchasePackingListReport()
		{
			InitializeComponent();
			base.Load += Form_Load;
		}
		...
		private void buttonOK_Click(object sender, EventArgs e)
		{
			try
			{
				...
				{
					data = Factory.VendorSystem.GetPurchasePLDetailReport(dateControl1.FromDate, dateControl1.ToDate, productSelector.FromItem, productSelector.ToItem, productSelector.FromClass, productSelector.ToClass, productSelector.FromCategory, productSelector.ToCategory, vendorSelector.FromVendor, vendorSelector.ToVendor, vendorSelector.FromClass, vendorSelector.ToClass, vendorSelector.FromGroup, vendorSelector.ToGroup, BuyerSelector.FromBuyer, BuyerSelector.ToBuyer, vendorSelector.MultipleVendors, productSelector.FromManufacturer, productSelector.ToManufacturer, productSelector.FromStyle, productSelector.ToStyle, productSelector.FromOrigin, productSelector.ToOrigin);
					xtraReport = reportHelper.GetReport("Purchase PL Detail");
				}
				else
				{
					data = Factory.VendorSystem.GetPurchasePLSummaryReport(dateControl1.FromDate, dateControl1.ToDate, vendorSelector.FromVendor, vendorSelector.ToVendor, vendorSelector.FromClass, vendorSelector.ToClass, vendorSelector.FromGroup, vendorSelector.ToGroup, BuyerSelector.FromBuyer, BuyerSelector.ToBuyer, vendorSelector.MultipleVendors);
					xtraReport = reportHelper.GetReport("Purchase PL Summary");
				}
				...
				if (xtraReport == null)
				{
					ErrorHelper.ErrorMessage("Cannot find the report file. Please make sure you have access to reports path and the files are not corrupted.", "'Purchase PL.repx'");
				}
				else
				{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.Vendors.PurchasePackingListReport));
			...
			radioButtonDetail.Location = new System.Drawing.Point(110, 525);
			...
			radioButtonSummary.Location = new System.Drawing.Point(21, 525);
			...
			ultraGroupBox2.Location = new System.Drawing.Point(13, 162);
			ultraGroupBox2.Name = "ultraGroupBox2";
			ultraGroupBox2.Size = new System.Drawing.Size(476, 210);
			...
			buttonClose.Location = new System.Drawing.Point(366, 563);
			...
			buttonOK.Location = new System.Drawing.Point(262, 563);
			...
			ultraGroupBox1.Size = new System.Drawing.Size(476, 144);
			...
			vendorSelector.Size = new System.Drawing.Size(432, 119);
			vendorSelector.TabIndex = 0;
			ultraGroupBox3.Controls.Add(BuyerSelector);
			ultraGroupBox3.Location = new System.Drawing.Point(13, 378);
			...
			dateControl1.Location = new System.Drawing.Point(13, 462);
			dateControl1.Name = "dateControl1";
			dateControl1.SelectedPeriod = Micromind.DataControls.DatePeriods.ThisMonthToDate;
			dateControl1.Size = new System.Drawing.Size(470, 57);
			dateControl1.TabIndex = 1;
			dateControl1.ToDate = new System.DateTime(2017, 10, 17, 23, 59, 59, 59);
			base.AutoScaleDimensions = new System.Drawing.SizeF(6f, 13f);
			base.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			BackColor = System.Drawing.Color.WhiteSmoke;
			base.ClientSize = new System.Drawing.Size(502, 599);
			...
			base.Name = "PurchasePackingListReport";
			Text = "Purchase Packing List Report";
