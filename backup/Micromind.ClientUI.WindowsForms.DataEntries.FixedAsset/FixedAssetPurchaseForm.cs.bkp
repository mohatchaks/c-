...
{
	public class FixedAssetPurchaseForm : Form, IForm
	{
		private FixedAssetPurchaseData currentData;

		private const string TABLENAME_CONST = "FixedAsset_Purchase";
		...
		private bool GetData()
		{
			try
			{
				...
				{
					currentData = new FixedAssetPurchaseData();
				}
				DataRow dataRow = (!isNewRecord) ? currentData.FixedAssetPurchaseTable.Rows[0] : currentData.FixedAssetPurchaseTable.NewRow();
				...
				if (IsNewRecord)
				{
					currentData.FixedAssetPurchaseTable.Rows.Add(dataRow);
				}
				currentData.FixedAssetPurchaseDetailTable.Rows.Clear();
				foreach (UltraGridRow row in dataGridItems.Rows)
				{
					DataRow dataRow2 = currentData.FixedAssetPurchaseDetailTable.NewRow();
					dataRow2.BeginEdit();
					...
					dataRow2.EndEdit();
					currentData.FixedAssetPurchaseDetailTable.Rows.Add(dataRow2);
				}
		...
		public void LoadData(string voucherID)
		{
			try
			{
				...
				{
					currentData = Factory.FixedAssetPurchaseSystem.GetFixedAssetPurchaseByID(SystemDocID, voucherID);
					if (currentData != null)
					{
						FillData();
						IsNewRecord = false;
		...
		{
			if (currentData == null || currentData.Tables.Count == 0 || currentData.Tables["FixedAsset_Purchase"].Rows.Count == 0)
			{
				return;
			}
			DataRow dataRow = currentData.Tables["FixedAsset_Purchase"].Rows[0];
			...
			if (currentData.Tables.Contains("FixedAsset_Purchase_Detail") && currentData.FixedAssetPurchaseDetailTable.Rows.Count != 0)
			{
				foreach (DataRow row in currentData.Tables["FixedAsset_Purchase_Detail"].Rows)
				{
					DataRow dataRow3 = dataTable.NewRow();
					dataRow3["Asset"] = row["AssetID"];
					dataRow3["Asset Name"] = row["AssetName1"];
		...
		private bool SaveData(bool clearAfter)
		{
			...
			try
			{
				bool flag = (!isNewRecord) ? Factory.FixedAssetPurchaseSystem.CreateFixedAssetPurchase(currentData, isUpdate: true) : Factory.FixedAssetPurchaseSystem.CreateFixedAssetPurchase(currentData, isUpdate: false);
				if (!flag)
				{
		...
		private bool ValidateData()
		{
			...
			if (formManager.IsFieldDirty(textBoxVoucherNumber) && Factory.SystemDocumentSystem.ExistDocumentNumber("FixedAsset_Purchase", "VoucherID", SystemDocID, textBoxVoucherNumber.Text))
			{
				ErrorHelper.WarningMessage(UIMessages.DocumentNumberInUse);
		...
		private bool Delete()
		{
			try
			{
				...
				return Factory.FixedAssetPurchaseSystem.DeleteFixedAssetPurchase(SystemDocID, textBoxVoucherNumber.Text);
			}
			catch (Exception e)
			{
				ErrorHelper.ProcessError(e);
		...
		{
			string nextID = DatabaseHelper.GetNextID("FixedAsset_Purchase", "VoucherID", textBoxVoucherNumber.Text, "SysDocID", SystemDocID);
			if (!(nextID == ""))
			{
				LoadData(nextID);
			}
		...
		{
			string previousID = DatabaseHelper.GetPreviousID("FixedAsset_Purchase", "VoucherID", textBoxVoucherNumber.Text, "SysDocID", SystemDocID);
			if (!(previousID == ""))
			{
				LoadData(previousID);
			}
		...
		{
			string lastID = DatabaseHelper.GetLastID("FixedAsset_Purchase", "VoucherID", "SysDocID", SystemDocID);
			if (!(lastID == ""))
			{
				LoadData(lastID);
			}
		...
		{
			string firstID = DatabaseHelper.GetFirstID("FixedAsset_Purchase", "VoucherID", "SysDocID", SystemDocID);
			if (!(firstID == ""))
			{
				LoadData(firstID);
			}
		...
		private void toolStripButtonFind_Click(object sender, EventArgs e)
		{
			try
			{
				...
				{
					string text = Factory.DatabaseSystem.FindDocumentByNumber("FixedAsset_Purchase", "VoucherID", SystemDocID, toolStripTextBoxFind.Text);
					if (text != "")
					{
						LoadData(text);
					}
		...
		private void JournalLeavesForm_Load(object sender, EventArgs e)
		{
			try
			{
				...
				{
					ClearForm();
					comboBoxSysDoc.FilterByType(SysDocTypes.FixedAssetPurchase);
				}
			}
			catch (Exception e2)
			{
		...
		private bool Void(bool isVoid)
		{
			try
			{
				...
				return Factory.FixedAssetPurchaseSystem.VoidFixedAssetPurchase(SystemDocID, textBoxVoucherNumber.Text, isVoid);
			}
			catch (Exception e)
			{
				ErrorHelper.ProcessError(e);
		...
		{
			new FormHelper().EditSysDoc(comboBoxSysDoc.SelectedID, SysDocTypes.FixedAssetPurchase);
		}
		...
		private void Print(bool isPrint, bool showPrintDialog, bool saveChanges)
		{
			try
			{
				if (!IsDirty || (ErrorHelper.QuestionMessage(MessageBoxButtons.YesNo, "You must save the document before printing.", "Do you want to save?") == DialogResult.Yes && SaveData(clearAfter: false)))
				{
					...
					string text = textBoxVoucherNumber.Text;
					DataSet fixedAssetPurchaseToPrint = Factory.FixedAssetPurchaseSystem.GetFixedAssetPurchaseToPrint(systemDocID, text);
					...
					{
						PrintHelper.PrintDocument(fixedAssetPurchaseToPrint, systemDocID, "Fixed Asset Purchase", SysDocTypes.FixedAssetPurchase, isPrint, showPrintDialog);
					}
				}
			}
			catch (Exception e)
		...
		{
			FormActivator.BringFormToFront(FormActivator.FixedAssetPurchaseListFormObj);
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.FixedAsset.FixedAssetPurchaseForm));
			...
			mmLabel1.Location = new System.Drawing.Point(11, 28);
			...
			panelDetails.Size = new System.Drawing.Size(645, 141);
			...
			textBoxTaxAmount.Location = new System.Drawing.Point(221, 114);
			...
			comboBoxTaxGroup.Location = new System.Drawing.Point(89, 114);
			...
			labelTaxGroup.Location = new System.Drawing.Point(11, 116);
			labelTaxGroup.Name = "labelTaxGroup";
			labelTaxGroup.Size = new System.Drawing.Size(60, 13);
			labelTaxGroup.TabIndex = 140;
			...
			mmLabel2.Location = new System.Drawing.Point(11, 71);
			...
			payeeSelector1.Size = new System.Drawing.Size(216, 20);
			...
			comboBoxGridFixedAsset.DisplayLayout.Appearance = appearance36;
			...
			comboBoxGridFixedAsset.DisplayLayout.GroupByBox.Appearance = appearance37;
			appearance38.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxGridFixedAsset.DisplayLayout.GroupByBox.BandLabelAppearance = appearance38;
			...
			comboBoxGridFixedAsset.DisplayLayout.GroupByBox.PromptAppearance = appearance39;
			...
			comboBoxGridFixedAsset.DisplayLayout.Override.ActiveCellAppearance = appearance40;
			...
			comboBoxGridFixedAsset.DisplayLayout.Override.ActiveRowAppearance = appearance41;
			...
			comboBoxGridFixedAsset.DisplayLayout.Override.CardAreaAppearance = appearance42;
			...
			comboBoxGridFixedAsset.DisplayLayout.Override.CellAppearance = appearance43;
			...
			comboBoxGridFixedAsset.DisplayLayout.Override.GroupByRowAppearance = appearance44;
			appearance45.TextHAlignAsString = "Left";
			comboBoxGridFixedAsset.DisplayLayout.Override.HeaderAppearance = appearance45;
			...
			comboBoxGridFixedAsset.DisplayLayout.Override.RowAppearance = appearance46;
			...
			comboBoxGridFixedAsset.DisplayLayout.Override.TemplateAddRowAppearance = appearance47;
			...
			dataGridItems.Location = new System.Drawing.Point(12, 178);
			...
			dataGridItems.Size = new System.Drawing.Size(634, 177);
			...
			base.Name = "FixedAssetPurchaseForm";
