...
{
	public class SelectSODialog : Form
	{
		...
		private void LoadData()
		{
			try
			{
				DataSet salesOrderItemsOnJobID = Factory.JobSystem.GetSalesOrderItemsOnJobID(projectID);
				dataGridItems.DataSource = null;
				if (salesOrderItemsOnJobID.Tables[0].Rows.Count > 0)
				{
					dataGridItems.DataSource = salesOrderItemsOnJobID.Tables[0];
					UltraGridColumn ultraGridColumn = dataGridItems.DisplayLayout.Bands[0].Columns["RowIndex"];
					UltraGridColumn ultraGridColumn2 = dataGridItems.DisplayLayout.Bands[0].Columns["TaxGroupID"];
					bool flag2 = dataGridItems.DisplayLayout.Bands[0].Columns["LocationID"].Hidden = true;
		...
		private void InitializeComponent()
		{
			...
			base.Name = "SelectSODialog";
			base.ShowIcon = false;
			base.ShowInTaskbar = false;
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			Text = "Select SO Items";
