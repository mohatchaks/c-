...
{
	public class VendorItemListForm : Form, IForm
	{
		...
		{
			DataSet itemVendorList = Factory.ProductSystem.GetItemVendorList(productSelector.FromItem, productSelector.ToItem, productSelector.FromClass, productSelector.ToClass, productSelector.FromCategory, productSelector.ToCategory, productSelector.FromBrand, productSelector.ToBrand, productSelector.FromManufacturer, productSelector.ToManufacturer, productSelector.FromOrigin, productSelector.ToOrigin, productSelector.FromStyle, productSelector.ToStyle, vendorSelector.FromVendor, vendorSelector.ToVendor, vendorSelector.FromClass, vendorSelector.ToClass, vendorSelector.FromGroup, vendorSelector.ToGroup, vendorSelector.MultipleVendors);
			if (itemVendorList != null && itemVendorList.Tables.Count != 0 && itemVendorList.Tables[0].Rows.Count != 0)
			{
				foreach (DataRow row in itemVendorList.Tables[0].Rows)
				{
				...
				new SalesForecastingForm();
				ItemCode = itemCode;
				ItemList = itemVendorList;
			}
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Others.VendorItemListForm));
			...
			panelButtons.Location = new System.Drawing.Point(0, 394);
			...
			buttonOK.Location = new System.Drawing.Point(273, 8);
			...
			buttonCancel.Location = new System.Drawing.Point(375, 8);
			...
			ultraGroupBox1.Location = new System.Drawing.Point(13, 180);
			ultraGroupBox1.Name = "ultraGroupBox1";
			ultraGroupBox1.Size = new System.Drawing.Size(451, 206);
			...
			ultraGroupBox2.Location = new System.Drawing.Point(19, 12);
			ultraGroupBox2.Name = "ultraGroupBox2";
			ultraGroupBox2.Size = new System.Drawing.Size(445, 156);
			...
			base.ClientSize = new System.Drawing.Size(483, 439);
