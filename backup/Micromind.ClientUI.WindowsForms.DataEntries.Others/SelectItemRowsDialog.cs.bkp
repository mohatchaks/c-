...
{
	public class SelectItemRowsDialog : Form
	{
		...
		public DataSet DataSource
		{
			...
			set
			{
				...
				dataGridItems.DisplayLayout.Bands[0].Columns["ProductID"].Hidden = false;
				dataGridItems.DisplayLayout.Bands[0].Columns["Description"].Hidden = false;
				dataGridItems.DisplayLayout.Bands[0].Columns["UnitID"].Hidden = false;
				dataGridItems.DisplayLayout.Bands[0].Columns["Quantity"].Hidden = false;
				dataGridItems.DisplayLayout.Bands[0].Columns["UnitPrice"].Hidden = false;
				dataGridItems.DisplayLayout.Bands[0].Columns["UnitPrice"].Header.VisiblePosition = 6;
				dataGridItems.DisplayLayout.Bands[0].Columns["Quantity"].Header.VisiblePosition = 5;
				dataGridItems.DisplayLayout.Bands[0].Columns["UnitPrice"].Header.Caption = "Price";
				dataGridItems.DisplayLayout.Bands[0].Columns["UnitID"].Header.Caption = "UOM";
		...
		public SelectItemRowsDialog()
		{
			InitializeComponent();
			base.Load += SelectItemRowsDialog_Load;
			textBoxSearch.KeyDown += textBoxSearch_KeyDown;
			base.Activated += SelectItemRowsDialog_Activated;
			base.FormClosing += SelectItemRowsDialog_FormClosing;
		...
		private void SelectItemRowsDialog_FormClosing(object sender, FormClosingEventArgs e)
		{
			try
			{
		...
		private void SelectItemRowsDialog_Activated(object sender, EventArgs e)
		{
			textBoxSearch.Focus();
		}
		...
		private void SelectItemRowsDialog_Load(object sender, EventArgs e)
		{
			try
			{
		...
		private void dataGridItems_AfterCellListCloseUp(object sender, CellEventArgs e)
		{
		}
		...
		private void InitializeComponent()
		{
			...
			buttonOK.Location = new System.Drawing.Point(291, 8);
			...
			buttonCancel.Location = new System.Drawing.Point(393, 8);
			...
			dataGridItems.AfterCellListCloseUp += new Infragistics.Win.UltraWinGrid.CellEventHandler(dataGridItems_AfterCellListCloseUp);
			...
			base.ClientSize = new System.Drawing.Size(503, 345);
			...
			base.Name = "SelectItemRowsDialog";
			base.ShowIcon = false;
