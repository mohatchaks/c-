...
{
	public class VendorListForm : Form, IDataForm, IDataList, IExternalReport
	{
		...
		private MenuItem menuItemGotoVendor;
		...
		{
			InitializeComponent();
			base.Activated += VendorListForm_Activated;
		...
		private void VendorListForm_Activated(object sender, EventArgs e)
		{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Vendors.VendorListForm));
			...
			menuItemGotoVendor = new System.Windows.Forms.MenuItem();
			...
			menuItemGotoVendor.Index = 0;
			menuItemGotoVendor.Text = "&Goto Vendor";
			menuItem2.Index = 1;
			menuItem2.Text = "-";
			menuItemNew.Index = 2;
			menuItemNew.Text = "&New Vendor";
			menuItemDelete.Index = 3;
			menuItemDelete.Text = "&Delete Vendor";
			menuItem1.Index = 4;
			menuItem1.Text = "-";
			...
			base.Name = "VendorListForm";
			Text = "Vendor List";
			base.Load += new System.EventHandler(VendorListForm_Load);
		...
		private void LoadData()
		{
			if (Factory.IsDBConnected)
			{
				try
				{
					...
					vendorData = Factory.VendorSystem.GetVendorList(toolStripButtonShowInactive.Checked);
					dataGridList.DataSource = vendorData;
					...
					dataGridList.AddColumnRowCount(dataGridList.DisplayLayout.Bands[0].Columns["Vendor Code"]);
				}
		...
		private string GetSelectedID()
		{
			...
			return dataGridList.ActiveRow.Cells["Vendor Code"].Text.ToString();
		}
		...
		{
			if (!Security.GetScreenAccessRight(base.Name).View)
			{
