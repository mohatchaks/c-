...
{
	public class ProformaInvoiceForm : Form, IForm
	{
		...
		private ToolStripMenuItem printMatrixTableToolStripMenuItem;

		private ToolStripSeparator toolStripSeparator8;

		private ToolStripMenuItem toolStripMenuItemMergePrint;

		private ToolStripSplitButton toolStripButtonPreview;

		private ToolStripMenuItem previewMatrixTableToolStripMenuItem;
		...
		private void SalesOrderForm_KeyDown(object sender, KeyEventArgs e)
		{
			...
			{
				Print(isPrint: true, showPrintDialog: true, saveChanges: true, printMatrixTable: false);
			}
		...
		private void SetupGrid()
		{
			try
			{
				...
				color4 = (dataGridItems.DisplayLayout.Bands[0].Columns["Tax"].CellAppearance.BackColor = (dataGridItems.DisplayLayout.Bands[0].Columns["TaxGroupID"].CellAppearance.BackColor = Color.WhiteSmoke));
		...
		private bool ValidateData()
		{
			...
			if (!IsNewRecord)
			{
				DataSet entityApprovalStatus = Factory.EntityDocSystem.GetEntityApprovalStatus(currentData, SysDocTypes.ProformaInvoice, Global.CurrentUser, includeApproveUser: false);
		...
		private void Form_Load(object sender, EventArgs e)
		{
			checked
			{
				try
				{
					...
					comboBoxSysDoc.FilterByType(SysDocTypes.ProformaInvoice);
		...
		{
			new FormHelper().EditSysDoc(comboBoxSysDoc.SelectedID, SysDocTypes.ProformaInvoice);
		}
		...
		private void CalculateTotal()
		{
			...
			{
				result = Math.Round(d * result2 / 100m, Global.CurDecimalPoints);
		...
		private void Print()
		{
			Print(isPrint: true, showPrintDialog: false, saveChanges: true, printMatrixTable: false);
		}

		private void Print(bool isPrint, bool showPrintDialog, bool saveChanges, bool printMatrixTable)
		{
			try
			{
				if (!IsDirty || (ErrorHelper.QuestionMessage(MessageBoxButtons.YesNo, "You must save the document before printing.", "Do you want to save?") == DialogResult.Yes && SaveData(clearAfter: false)))
				{
					string selectedID = comboBoxSysDoc.SelectedID;
					string text = textBoxVoucherNumber.Text;
					DataSet dataSet = (!printMatrixTable) ? Factory.PurchaseQuoteSystem.GetPurchaseQuoteToPrint(selectedID, text, toolStripMenuItemMergePrint.Checked) : Factory.PurchaseQuoteSystem.GetPurchaseQuoteToPrint(selectedID, text, mergeMatrixItems: false);
					if (dataSet == null || dataSet.Tables.Count == 0)
					{
						ErrorHelper.ErrorMessage("Cannot print the document.", "Document not found.");
					}
					else if (printMatrixTable)
					{
						PrintHelper.PrintDocument(dataSet, "", "Proforma Invoice Matrix", SysDocTypes.ProformaInvoice, isPrint, showPrintDialog);
					}
					else
					{
						PrintHelper.PrintDocument(dataSet, selectedID, "Proforma Invoice", SysDocTypes.ProformaInvoice, isPrint, showPrintDialog);
					}
				}
			}
			catch (Exception e)
		...
		{
			Print(isPrint: false, showPrintDialog: false, saveChanges: true, printMatrixTable: false);
		}
		...
		{
			FormActivator.BringFormToFront(FormActivator.ProformaInvoiceListFormObj);
		}
		...
		private bool SaveDraft()
		{
			try
			{
				if (GetData())
				{
					...
					{
						return Global.CompanySettings.SaveTransactionDraft(currentData, enterNameDialog.EnteredName, SysDocTypes.ProformaInvoice);
					}
				}
				return false;
			}
		...
		private bool LoadDraft()
		{
			try
			{
				DataSet settingsList = Factory.SettingSystem.GetSettingsList("", 63.ToString());
				...
				if (selectDocumentDialog.ShowDialog(this) == DialogResult.OK)
				{
					...
					DataSet dataSet = Global.CompanySettings.LoadTransactionDraft(key, SysDocTypes.ProformaInvoice);
		...
		{
			DBSettings.SaveCurrentUserSetting("PROPrintMatrixMerge", toolStripMenuItemMergePrint.Checked.ToString());
		}

		private void printMatrixTableToolStripMenuItem_Click(object sender, EventArgs e)
		{
			Print(isPrint: true, showPrintDialog: true, saveChanges: true, printMatrixTable: true);
		}

		private void previewMatrixTableToolStripMenuItem_Click(object sender, EventArgs e)
		{
			Print(isPrint: false, showPrintDialog: false, saveChanges: true, printMatrixTable: true);
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Vendors.ProformaInvoiceForm));
			...
			printMatrixTableToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			toolStripSeparator8 = new System.Windows.Forms.ToolStripSeparator();
			toolStripMenuItemMergePrint = new System.Windows.Forms.ToolStripMenuItem();
			toolStripButtonPreview = new System.Windows.Forms.ToolStripSplitButton();
			previewMatrixTableToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			...
			toolStrip1.Size = new System.Drawing.Size(823, 31);
			...
			toolStripButtonPrint.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[4]
			{
				toolStripSeparator7,
				printMatrixTableToolStripMenuItem,
				toolStripSeparator8,
			...
			printMatrixTableToolStripMenuItem.Name = "printMatrixTableToolStripMenuItem";
			printMatrixTableToolStripMenuItem.Size = new System.Drawing.Size(235, 22);
			printMatrixTableToolStripMenuItem.Text = "Print Matrix Table";
			printMatrixTableToolStripMenuItem.Click += new System.EventHandler(printMatrixTableToolStripMenuItem_Click);
			toolStripSeparator8.Name = "toolStripSeparator8";
			toolStripSeparator8.Size = new System.Drawing.Size(232, 6);
			...
			toolStripButtonPreview.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[1]
			{
				previewMatrixTableToolStripMenuItem
			});
			toolStripButtonPreview.Image = Micromind.ClientUI.Properties.Resources.preview;
			toolStripButtonPreview.ImageTransparentColor = System.Drawing.Color.Magenta;
			toolStripButtonPreview.Name = "toolStripButtonPreview";
			toolStripButtonPreview.Size = new System.Drawing.Size(40, 28);
			toolStripButtonPreview.Text = "Preview";
			toolStripButtonPreview.ToolTipText = "Preview";
			toolStripButtonPreview.ButtonClick += new System.EventHandler(toolStripButtonPreview_Click);
			previewMatrixTableToolStripMenuItem.Name = "previewMatrixTableToolStripMenuItem";
			previewMatrixTableToolStripMenuItem.Size = new System.Drawing.Size(182, 22);
			previewMatrixTableToolStripMenuItem.Text = "Preview Matrix Table";
			previewMatrixTableToolStripMenuItem.Click += new System.EventHandler(previewMatrixTableToolStripMenuItem_Click);
			...
			duplicateToolStripMenuItem.Size = new System.Drawing.Size(214, 22);
			...
			saveAsDraftToolStripMenuItem.Size = new System.Drawing.Size(214, 22);
			...
			loadDraftToolStripMenuItem.Size = new System.Drawing.Size(214, 22);
			...
			transferToPurchaseOrderToolStripMenuItem.Size = new System.Drawing.Size(214, 22);
			...
			panelButtons.Size = new System.Drawing.Size(823, 40);
			...
			linePanelDown.Size = new System.Drawing.Size(823, 1);
			...
			xpButton1.Location = new System.Drawing.Point(713, 8);
			...
			dateTimePickerDate.Location = new System.Drawing.Point(544, 1);
			...
			comboBoxPayeeTaxGroup.Location = new System.Drawing.Point(326, 68);
			...
			ultraFormattedLinkLabel3.Appearance = appearance17;
			ultraFormattedLinkLabel3.AutoSize = true;
			ultraFormattedLinkLabel3.Location = new System.Drawing.Point(10, 67);
			...
			ultraFormattedLinkLabel3.VisitedLinkAppearance = appearance18;
			ultraFormattedLinkLabel3.LinkClicked += new Infragistics.Win.FormattedLinkLabel.LinkClickedEventHandler(ultraFormattedLinkLabel3_LinkClicked);
			appearance19.FontData.BoldAsString = "False";
			appearance19.FontData.Name = "Tahoma";
			ultraFormattedLinkLabel1.Appearance = appearance19;
			ultraFormattedLinkLabel1.AutoSize = true;
			ultraFormattedLinkLabel1.Location = new System.Drawing.Point(234, 49);
			ultraFormattedLinkLabel1.Name = "ultraFormattedLinkLabel1";
			ultraFormattedLinkLabel1.Size = new System.Drawing.Size(90, 15);
			ultraFormattedLinkLabel1.TabIndex = 170;
			...
			ultraFormattedLinkLabel1.VisitedLinkAppearance = appearance20;
			...
			labelCurrency.Location = new System.Drawing.Point(472, 47);
			labelCurrency.Name = "labelCurrency";
			labelCurrency.Size = new System.Drawing.Size(52, 15);
			labelCurrency.TabIndex = 169;
			...
			mmLabel2.Location = new System.Drawing.Point(473, 68);
			...
			dateTimePickerDueDate.Location = new System.Drawing.Point(575, 66);
			...
			comboBoxCurrency.Location = new System.Drawing.Point(544, 45);
			...
			comboBoxShippingMethod.DisplayLayout.Appearance = appearance23;
			...
			comboBoxShippingMethod.DisplayLayout.GroupByBox.Appearance = appearance24;
			appearance25.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxShippingMethod.DisplayLayout.GroupByBox.BandLabelAppearance = appearance25;
			...
			comboBoxShippingMethod.DisplayLayout.GroupByBox.PromptAppearance = appearance26;
			...
			comboBoxShippingMethod.DisplayLayout.Override.ActiveCellAppearance = appearance27;
			...
			comboBoxShippingMethod.DisplayLayout.Override.ActiveRowAppearance = appearance28;
			...
			comboBoxShippingMethod.DisplayLayout.Override.CardAreaAppearance = appearance29;
			appearance30.BorderColor = System.Drawing.Color.Silver;
			appearance30.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxShippingMethod.DisplayLayout.Override.CellAppearance = appearance30;
			...
			comboBoxShippingMethod.DisplayLayout.Override.GroupByRowAppearance = appearance31;
			appearance32.TextHAlignAsString = "Left";
			comboBoxShippingMethod.DisplayLayout.Override.HeaderAppearance = appearance32;
			...
			comboBoxShippingMethod.DisplayLayout.Override.RowAppearance = appearance33;
			...
			comboBoxShippingMethod.DisplayLayout.Override.TemplateAddRowAppearance = appearance34;
			...
			comboBoxTerm.DisplayLayout.Appearance = appearance35;
			...
			comboBoxTerm.DisplayLayout.GroupByBox.Appearance = appearance36;
			appearance37.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxTerm.DisplayLayout.GroupByBox.BandLabelAppearance = appearance37;
			...
			comboBoxTerm.DisplayLayout.GroupByBox.PromptAppearance = appearance38;
			...
			comboBoxTerm.DisplayLayout.Override.ActiveCellAppearance = appearance39;
			...
			comboBoxTerm.DisplayLayout.Override.ActiveRowAppearance = appearance40;
			...
			comboBoxTerm.DisplayLayout.Override.CardAreaAppearance = appearance41;
			appearance42.BorderColor = System.Drawing.Color.Silver;
			appearance42.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxTerm.DisplayLayout.Override.CellAppearance = appearance42;
			...
			comboBoxTerm.DisplayLayout.Override.GroupByRowAppearance = appearance43;
			appearance44.TextHAlignAsString = "Left";
			comboBoxTerm.DisplayLayout.Override.HeaderAppearance = appearance44;
			...
			comboBoxTerm.DisplayLayout.Override.RowAppearance = appearance45;
			...
			comboBoxTerm.DisplayLayout.Override.TemplateAddRowAppearance = appearance46;
			...
			comboBoxBuyer.DisplayLayout.Appearance = appearance47;
			...
			comboBoxBuyer.DisplayLayout.GroupByBox.Appearance = appearance48;
			appearance49.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxBuyer.DisplayLayout.GroupByBox.BandLabelAppearance = appearance49;
			...
			comboBoxBuyer.DisplayLayout.GroupByBox.PromptAppearance = appearance50;
			...
			comboBoxBuyer.DisplayLayout.Override.ActiveCellAppearance = appearance51;
			...
			comboBoxBuyer.DisplayLayout.Override.ActiveRowAppearance = appearance52;
			...
			comboBoxBuyer.DisplayLayout.Override.CardAreaAppearance = appearance53;
			...
			comboBoxBuyer.DisplayLayout.Override.CellAppearance = appearance54;
			...
			comboBoxBuyer.DisplayLayout.Override.GroupByRowAppearance = appearance55;
			appearance56.TextHAlignAsString = "Left";
			comboBoxBuyer.DisplayLayout.Override.HeaderAppearance = appearance56;
			...
			comboBoxBuyer.DisplayLayout.Override.RowAppearance = appearance57;
			...
			comboBoxBuyer.DisplayLayout.Override.TemplateAddRowAppearance = appearance58;
			...
			ultraFormattedLinkLabel6.Appearance = appearance59;
			...
			ultraFormattedLinkLabel6.VisitedLinkAppearance = appearance60;
			...
			labelVoided.Size = new System.Drawing.Size(795, 49);
			...
			panel1.Location = new System.Drawing.Point(591, 416);
			panel1.Name = "panel1";
			panel1.Size = new System.Drawing.Size(221, 87);
			panel1.TabIndex = 3;
			label6.AutoSize = true;
			label6.Location = new System.Drawing.Point(114, 23);
			label6.Name = "label6";
			label6.Size = new System.Drawing.Size(15, 13);
			label6.TabIndex = 142;
			label6.Text = "%";
			label7.AutoSize = true;
			label7.Location = new System.Drawing.Point(3, 24);
			label7.Name = "label7";
			...
			textBoxDiscountPercent.Location = new System.Drawing.Point(79, 20);
			...
			textBoxDiscountAmount.Location = new System.Drawing.Point(130, 20);
			...
			linkLabelTax.Appearance = appearance89;
			...
			linkLabelTax.VisitedLinkAppearance = appearance90;
			...
			textBoxTaxAmount.Location = new System.Drawing.Point(80, 2);
			...
			textBoxTaxAmount.Size = new System.Drawing.Size(136, 20);
			...
			dataGridItems.DisplayLayout.Appearance = appearance91;
			...
			dataGridItems.DisplayLayout.GroupByBox.Appearance = appearance92;
			appearance93.ForeColor = System.Drawing.SystemColors.GrayText;
			dataGridItems.DisplayLayout.GroupByBox.BandLabelAppearance = appearance93;
			...
			dataGridItems.DisplayLayout.GroupByBox.PromptAppearance = appearance94;
			dataGridItems.DisplayLayout.MaxColScrollRegions = 1;
			dataGridItems.DisplayLayout.MaxRowScrollRegions = 1;
			appearance95.BackColor = System.Drawing.SystemColors.Window;
			appearance95.ForeColor = System.Drawing.SystemColors.ControlText;
			dataGridItems.DisplayLayout.Override.ActiveCellAppearance = appearance95;
			...
			dataGridItems.DisplayLayout.Override.ActiveRowAppearance = appearance96;
			dataGridItems.DisplayLayout.Override.AllowAddNew = Infragistics.Win.UltraWinGrid.AllowAddNew.No;
			dataGridItems.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.Dotted;
			dataGridItems.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.Dotted;
			appearance97.BackColor = System.Drawing.SystemColors.Window;
			dataGridItems.DisplayLayout.Override.CardAreaAppearance = appearance97;
			...
			dataGridItems.DisplayLayout.Override.CellAppearance = appearance98;
			...
			dataGridItems.DisplayLayout.Override.GroupByRowAppearance = appearance99;
			appearance100.TextHAlignAsString = "Left";
			dataGridItems.DisplayLayout.Override.HeaderAppearance = appearance100;
			dataGridItems.DisplayLayout.Override.HeaderClickAction = Infragistics.Win.UltraWinGrid.HeaderClickAction.SortMulti;
			dataGridItems.DisplayLayout.Override.HeaderStyle = Infragistics.Win.HeaderStyle.WindowsXPCommand;
			appearance101.BackColor = System.Drawing.SystemColors.Window;
			appearance101.BorderColor = System.Drawing.Color.Silver;
			dataGridItems.DisplayLayout.Override.RowAppearance = appearance101;
			dataGridItems.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance102.BackColor = System.Drawing.SystemColors.ControlLight;
			dataGridItems.DisplayLayout.Override.TemplateAddRowAppearance = appearance102;
			...
			dataGridItems.Size = new System.Drawing.Size(797, 270);
			...
			checkBoxPriceIncludeTax.Location = new System.Drawing.Point(458, 422);
			...
			base.ClientSize = new System.Drawing.Size(823, 555);
