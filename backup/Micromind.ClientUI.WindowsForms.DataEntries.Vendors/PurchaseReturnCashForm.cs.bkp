...
{
	public class PurchaseReturnCashForm : Form, IForm
	{
		...
		private ToolStripMenuItem createFromCashPurchaseToolStripMenuItem;
		...
		private void dataGridItems_HeaderClicked(object sender, EventArgs e)
		{
			...
			if (ultraGridColumn.Key == "Tax" && dataGridItems.ActiveRow != null)
			{
			...
			checked
			{
				try
				{
					...
					if (e.Cell.Column.Key == "Amount")
					{
						...
						UIGlobal.CalculateRowTax(e.Cell.Row, "Tax", result3, subtotal, default(decimal), checkBoxPriceIncludeTax.Checked);
						CalculateTotal();
					}
				}
				catch (Exception e2)
				...
				try
				{
					if (dataGridItems.ActiveRow != null)
					{
						...
						if (key == "Amount")
						{
							...
							UIGlobal.CalculateRowTax(e.Cell.Row, "Tax", result7, subtotal2, tradeDiscount, checkBoxPriceIncludeTax.Checked);
							CalculateTotal();
						}
					}
				}
		...
		private bool GetData()
		{
			try
			{
				...
				dataRow["PaymentMethodType"] = PaymentMethodTypes.Cash;
		...
		private bool ValidateData()
		{
			...
			checked
			{
				...
				if (textBoxVoucherNumber.Text.Trim() == "" || comboBoxSysDoc.SelectedID == "" || comboBoxRegister.SelectedID == "" || comboBoxVendor.SelectedID == "")
				{
		...
		private void Form_Load(object sender, EventArgs e)
		{
			checked
			{
				try
				{
					...
					comboBoxSysDoc.FilterByType(SysDocTypes.CashPurchaseReturn);
					SetSecurity();
		...
		{
			new FormHelper().EditSysDoc(comboBoxSysDoc.SelectedID, SysDocTypes.CashPurchaseReturn);
		}
		...
		private void Print(bool isPrint, bool showPrintDialog, bool saveChanges)
		{
			try
			{
				if (!(IsDirty && saveChanges) || (ErrorHelper.QuestionMessage(MessageBoxButtons.YesNo, "You must save the document before printing.", "Do you want to save?") == DialogResult.Yes && SaveData(clearAfter: false)))
				{
					...
					{
						PrintHelper.PrintDocument(purchaseReturnToPrint, selectedID, "Cash Purchase Return", SysDocTypes.CashPurchaseReturn, isPrint, showPrintDialog);
					}
				}
			}
			catch (Exception e)
		...
		private void transferToPurchaseReturnToolStripMenuItem_Click(object sender, EventArgs e)
		{
		}

		private void buttonSelectDocument_Click(object sender, EventArgs e)
		{
			createFromCashPurchaseToolStripMenuItem_Click(sender, e);
		}
		...
		private void createFromCashPurchaseToolStripMenuItem_Click(object sender, EventArgs e)
		{
			if (!IsNewRecord)
			{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Vendors.PurchaseReturnCashForm));
			...
			createFromCashPurchaseToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			...
			toolStrip1.Size = new System.Drawing.Size(788, 31);
			...
			toolStripDropDownButton1.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[2]
			{
				...
				createFromCashPurchaseToolStripMenuItem
			});
			...
			duplicateToolStripMenuItem.Size = new System.Drawing.Size(226, 22);
			...
			createFromCashPurchaseToolStripMenuItem.Name = "createFromCashPurchaseToolStripMenuItem";
			createFromCashPurchaseToolStripMenuItem.Size = new System.Drawing.Size(226, 22);
			createFromCashPurchaseToolStripMenuItem.Text = "Create from Cash Purchase...";
			createFromCashPurchaseToolStripMenuItem.Click += new System.EventHandler(createFromCashPurchaseToolStripMenuItem_Click);
			...
			panelButtons.Size = new System.Drawing.Size(788, 40);
			...
			linePanelDown.Size = new System.Drawing.Size(788, 1);
			...
			xpButton1.Location = new System.Drawing.Point(678, 8);
			...
			dateTimePickerDate.Location = new System.Drawing.Point(600, 31);
			dateTimePickerDate.Name = "dateTimePickerDate";
			dateTimePickerDate.Size = new System.Drawing.Size(109, 20);
			dateTimePickerDate.TabIndex = 6;
			textBoxVoucherNumber.Location = new System.Drawing.Point(296, 9);
			textBoxVoucherNumber.MaxLength = 15;
			textBoxVoucherNumber.Name = "textBoxVoucherNumber";
			textBoxVoucherNumber.Size = new System.Drawing.Size(167, 20);
			textBoxVoucherNumber.TabIndex = 1;
			label1.AutoSize = true;
			label1.Location = new System.Drawing.Point(510, 56);
			label1.Name = "label1";
			...
			mmLabel1.Location = new System.Drawing.Point(510, 33);
			...
			mmLabel1.TabIndex = 2;
			mmLabel1.Text = "Date:";
			textBoxRef1.Location = new System.Drawing.Point(600, 53);
			...
			textBoxNote.Location = new System.Drawing.Point(49, 464);
			textBoxNote.MaxLength = 4000;
			textBoxNote.Multiline = true;
			textBoxNote.Name = "textBoxNote";
			textBoxNote.ScrollBars = System.Windows.Forms.ScrollBars.Vertical;
			textBoxNote.Size = new System.Drawing.Size(342, 79);
			textBoxNote.TabIndex = 2;
			label3.Anchor = (System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left);
			label3.AutoSize = true;
			label3.Location = new System.Drawing.Point(9, 464);
			label3.Name = "label3";
			...
			ultraFormattedLinkLabel2.Location = new System.Drawing.Point(213, 12);
			...
			ultraFormattedLinkLabel7.Location = new System.Drawing.Point(469, 11);
			ultraFormattedLinkLabel7.Name = "ultraFormattedLinkLabel7";
			ultraFormattedLinkLabel7.Size = new System.Drawing.Size(53, 14);
			ultraFormattedLinkLabel7.TabIndex = 183;
			...
			comboBoxRegister.DisplayLayout.Appearance = appearance5;
			...
			comboBoxRegister.DisplayLayout.GroupByBox.Appearance = appearance6;
			appearance7.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxRegister.DisplayLayout.GroupByBox.BandLabelAppearance = appearance7;
			...
			comboBoxRegister.DisplayLayout.GroupByBox.PromptAppearance = appearance8;
			...
			comboBoxRegister.DisplayLayout.Override.ActiveCellAppearance = appearance9;
			appearance10.BackColor = System.Drawing.SystemColors.Highlight;
			appearance10.ForeColor = System.Drawing.SystemColors.HighlightText;
			comboBoxRegister.DisplayLayout.Override.ActiveRowAppearance = appearance10;
			...
			comboBoxRegister.DisplayLayout.Override.CardAreaAppearance = appearance11;
			appearance12.BorderColor = System.Drawing.Color.Silver;
			appearance12.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxRegister.DisplayLayout.Override.CellAppearance = appearance12;
			...
			comboBoxRegister.DisplayLayout.Override.GroupByRowAppearance = appearance13;
			appearance14.TextHAlignAsString = "Left";
			comboBoxRegister.DisplayLayout.Override.HeaderAppearance = appearance14;
			...
			comboBoxRegister.DisplayLayout.Override.RowAppearance = appearance15;
			comboBoxRegister.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance16.BackColor = System.Drawing.SystemColors.ControlLight;
			comboBoxRegister.DisplayLayout.Override.TemplateAddRowAppearance = appearance16;
			...
			comboBoxRegister.Location = new System.Drawing.Point(526, 8);
			...
			labelTaxGroup.VisitedLinkAppearance = appearance18;
			...
			comboBoxPayeeTaxGroup.DisplayLayout.Appearance = appearance19;
			...
			comboBoxPayeeTaxGroup.DisplayLayout.GroupByBox.Appearance = appearance20;
			appearance21.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxPayeeTaxGroup.DisplayLayout.GroupByBox.BandLabelAppearance = appearance21;
			...
			comboBoxPayeeTaxGroup.DisplayLayout.GroupByBox.PromptAppearance = appearance22;
			...
			comboBoxPayeeTaxGroup.DisplayLayout.Override.ActiveCellAppearance = appearance23;
			...
			comboBoxPayeeTaxGroup.DisplayLayout.Override.ActiveRowAppearance = appearance24;
			...
			comboBoxPayeeTaxGroup.DisplayLayout.Override.CardAreaAppearance = appearance25;
			appearance26.BorderColor = System.Drawing.Color.Silver;
			appearance26.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxPayeeTaxGroup.DisplayLayout.Override.CellAppearance = appearance26;
			...
			comboBoxPayeeTaxGroup.DisplayLayout.Override.GroupByRowAppearance = appearance27;
			appearance28.TextHAlignAsString = "Left";
			comboBoxPayeeTaxGroup.DisplayLayout.Override.HeaderAppearance = appearance28;
			...
			comboBoxPayeeTaxGroup.DisplayLayout.Override.RowAppearance = appearance29;
			comboBoxPayeeTaxGroup.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance30.BackColor = System.Drawing.SystemColors.ControlLight;
			comboBoxPayeeTaxGroup.DisplayLayout.Override.TemplateAddRowAppearance = appearance30;
			...
			comboBoxPayeeTaxGroup.Location = new System.Drawing.Point(99, 76);
			...
			comboBoxPayeeTaxGroup.Size = new System.Drawing.Size(109, 21);
			...
			labelCurrency.Appearance = appearance31;
			labelCurrency.AutoSize = true;
			labelCurrency.Location = new System.Drawing.Point(214, 55);
			labelCurrency.Name = "labelCurrency";
			labelCurrency.Size = new System.Drawing.Size(50, 14);
			labelCurrency.TabIndex = 177;
			...
			labelCurrency.VisitedLinkAppearance = appearance32;
			...
			buttonSelectDocument.Location = new System.Drawing.Point(437, 30);
			...
			label4.Location = new System.Drawing.Point(510, 77);
			label4.Name = "label4";
			label4.Size = new System.Drawing.Size(70, 13);
			label4.TabIndex = 145;
			label4.Text = "Reference 2:";
			textBoxRef2.Location = new System.Drawing.Point(600, 74);
			...
			ultraFormattedLinkLabel6.Location = new System.Drawing.Point(12, 54);
			...
			ultraFormattedLinkLabel4.Appearance = appearance35;
			ultraFormattedLinkLabel4.AutoSize = true;
			ultraFormattedLinkLabel4.Location = new System.Drawing.Point(12, 32);
			...
			ultraFormattedLinkLabel4.VisitedLinkAppearance = appearance36;
			...
			comboBoxVendor.DisplayLayout.Appearance = appearance37;
			...
			comboBoxVendor.DisplayLayout.GroupByBox.Appearance = appearance38;
			appearance39.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxVendor.DisplayLayout.GroupByBox.BandLabelAppearance = appearance39;
			...
			comboBoxVendor.DisplayLayout.GroupByBox.PromptAppearance = appearance40;
			...
			comboBoxVendor.DisplayLayout.Override.ActiveCellAppearance = appearance41;
			appearance42.BackColor = System.Drawing.SystemColors.Highlight;
			appearance42.ForeColor = System.Drawing.SystemColors.HighlightText;
			comboBoxVendor.DisplayLayout.Override.ActiveRowAppearance = appearance42;
			...
			comboBoxVendor.DisplayLayout.Override.CardAreaAppearance = appearance43;
			appearance44.BorderColor = System.Drawing.Color.Silver;
			appearance44.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxVendor.DisplayLayout.Override.CellAppearance = appearance44;
			...
			comboBoxVendor.DisplayLayout.Override.GroupByRowAppearance = appearance45;
			appearance46.TextHAlignAsString = "Left";
			comboBoxVendor.DisplayLayout.Override.HeaderAppearance = appearance46;
			...
			comboBoxVendor.DisplayLayout.Override.RowAppearance = appearance47;
			comboBoxVendor.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance48.BackColor = System.Drawing.SystemColors.ControlLight;
			comboBoxVendor.DisplayLayout.Override.TemplateAddRowAppearance = appearance48;
			...
			comboBoxVendor.Location = new System.Drawing.Point(99, 31);
			...
			comboBoxVendor.Size = new System.Drawing.Size(109, 21);
			...
			ultraFormattedLinkLabel5.Appearance = appearance49;
			ultraFormattedLinkLabel5.AutoSize = true;
			ultraFormattedLinkLabel5.Location = new System.Drawing.Point(12, 11);
			...
			ultraFormattedLinkLabel5.VisitedLinkAppearance = appearance50;
			...
			comboBoxSysDoc.DisplayLayout.Appearance = appearance51;
			...
			comboBoxSysDoc.DisplayLayout.GroupByBox.Appearance = appearance52;
			appearance53.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxSysDoc.DisplayLayout.GroupByBox.BandLabelAppearance = appearance53;
			...
			comboBoxSysDoc.DisplayLayout.GroupByBox.PromptAppearance = appearance54;
			comboBoxSysDoc.DisplayLayout.MaxColScrollRegions = 1;
			comboBoxSysDoc.DisplayLayout.MaxRowScrollRegions = 1;
			appearance55.BackColor = System.Drawing.SystemColors.Window;
			appearance55.ForeColor = System.Drawing.SystemColors.ControlText;
			comboBoxSysDoc.DisplayLayout.Override.ActiveCellAppearance = appearance55;
			...
			comboBoxSysDoc.DisplayLayout.Override.ActiveRowAppearance = appearance56;
			comboBoxSysDoc.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.Dotted;
			comboBoxSysDoc.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.Dotted;
			appearance57.BackColor = System.Drawing.SystemColors.Window;
			comboBoxSysDoc.DisplayLayout.Override.CardAreaAppearance = appearance57;
			...
			comboBoxSysDoc.DisplayLayout.Override.CellAppearance = appearance58;
			...
			comboBoxSysDoc.DisplayLayout.Override.GroupByRowAppearance = appearance59;
			appearance60.TextHAlignAsString = "Left";
			comboBoxSysDoc.DisplayLayout.Override.HeaderAppearance = appearance60;
			comboBoxSysDoc.DisplayLayout.Override.HeaderClickAction = Infragistics.Win.UltraWinGrid.HeaderClickAction.SortMulti;
			comboBoxSysDoc.DisplayLayout.Override.HeaderStyle = Infragistics.Win.HeaderStyle.WindowsXPCommand;
			appearance61.BackColor = System.Drawing.SystemColors.Window;
			appearance61.BorderColor = System.Drawing.Color.Silver;
			comboBoxSysDoc.DisplayLayout.Override.RowAppearance = appearance61;
			comboBoxSysDoc.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance62.BackColor = System.Drawing.SystemColors.ControlLight;
			comboBoxSysDoc.DisplayLayout.Override.TemplateAddRowAppearance = appearance62;
			...
			comboBoxSysDoc.Location = new System.Drawing.Point(99, 9);
			comboBoxSysDoc.MaxDropDownItems = 12;
			comboBoxSysDoc.Name = "comboBoxSysDoc";
			comboBoxSysDoc.ShowAll = false;
			comboBoxSysDoc.ShowInactiveItems = false;
			comboBoxSysDoc.ShowQuickAdd = true;
			comboBoxSysDoc.Size = new System.Drawing.Size(109, 21);
			comboBoxSysDoc.TabIndex = 0;
			comboBoxSysDoc.UseFlatMode = Infragistics.Win.DefaultableBoolean.True;
			textBoxVendorName.BackColor = System.Drawing.Color.WhiteSmoke;
			textBoxVendorName.Location = new System.Drawing.Point(210, 31);
			...
			comboBoxCurrency.Location = new System.Drawing.Point(269, 53);
			...
			comboBoxCurrency.Size = new System.Drawing.Size(166, 20);
			...
			comboBoxBuyer.Location = new System.Drawing.Point(99, 53);
			...
			comboBoxBuyer.Size = new System.Drawing.Size(109, 21);
			...
			labelVoided.Location = new System.Drawing.Point(13, 398);
			labelVoided.Name = "labelVoided";
			labelVoided.Size = new System.Drawing.Size(760, 59);
			...
			panel1.Location = new System.Drawing.Point(556, 458);
			panel1.Name = "panel1";
			panel1.Size = new System.Drawing.Size(220, 90);
			panel1.TabIndex = 4;
			...
			textBoxDiscountAmount.Validated += new System.EventHandler(textBoxDiscountAmount_TextChanged);
			...
			linkLabelTax.Appearance = appearance75;
			...
			linkLabelTax.VisitedLinkAppearance = appearance76;
			...
			comboBoxSpecification.Location = new System.Drawing.Point(441, 299);
			...
			comboBoxStyle.Location = new System.Drawing.Point(247, 272);
			...
			comboBoxGridLocation.DisplayLayout.Appearance = appearance101;
			...
			comboBoxGridLocation.DisplayLayout.GroupByBox.Appearance = appearance102;
			appearance103.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxGridLocation.DisplayLayout.GroupByBox.BandLabelAppearance = appearance103;
			...
			comboBoxGridLocation.DisplayLayout.GroupByBox.PromptAppearance = appearance104;
			...
			comboBoxGridLocation.DisplayLayout.Override.ActiveCellAppearance = appearance105;
			...
			comboBoxGridLocation.DisplayLayout.Override.ActiveRowAppearance = appearance106;
			...
			comboBoxGridLocation.DisplayLayout.Override.CardAreaAppearance = appearance107;
			...
			comboBoxGridLocation.DisplayLayout.Override.CellAppearance = appearance108;
			...
			comboBoxGridLocation.DisplayLayout.Override.GroupByRowAppearance = appearance109;
			appearance110.TextHAlignAsString = "Left";
			comboBoxGridLocation.DisplayLayout.Override.HeaderAppearance = appearance110;
			...
			comboBoxGridLocation.DisplayLayout.Override.RowAppearance = appearance111;
			...
			comboBoxGridLocation.DisplayLayout.Override.TemplateAddRowAppearance = appearance112;
			...
			dataGridItems.DisplayLayout.Appearance = appearance113;
			...
			dataGridItems.DisplayLayout.GroupByBox.Appearance = appearance114;
			appearance115.ForeColor = System.Drawing.SystemColors.GrayText;
			dataGridItems.DisplayLayout.GroupByBox.BandLabelAppearance = appearance115;
			...
			dataGridItems.DisplayLayout.GroupByBox.PromptAppearance = appearance116;
			...
			dataGridItems.DisplayLayout.Override.ActiveCellAppearance = appearance117;
			...
			dataGridItems.DisplayLayout.Override.ActiveRowAppearance = appearance118;
			dataGridItems.DisplayLayout.Override.AllowAddNew = Infragistics.Win.UltraWinGrid.AllowAddNew.No;
			dataGridItems.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.Dotted;
			dataGridItems.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.Dotted;
			appearance119.BackColor = System.Drawing.SystemColors.Window;
			dataGridItems.DisplayLayout.Override.CardAreaAppearance = appearance119;
			...
			dataGridItems.DisplayLayout.Override.CellAppearance = appearance120;
			...
			dataGridItems.DisplayLayout.Override.GroupByRowAppearance = appearance121;
			appearance122.TextHAlignAsString = "Left";
			dataGridItems.DisplayLayout.Override.HeaderAppearance = appearance122;
			...
			dataGridItems.DisplayLayout.Override.RowAppearance = appearance123;
			dataGridItems.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance124.BackColor = System.Drawing.SystemColors.ControlLight;
			dataGridItems.DisplayLayout.Override.TemplateAddRowAppearance = appearance124;
			...
			dataGridItems.Location = new System.Drawing.Point(12, 159);
			...
			dataGridItems.Size = new System.Drawing.Size(762, 299);
			...
			comboBoxGridItem.DisplayLayout.Appearance = appearance125;
			...
			comboBoxGridItem.DisplayLayout.GroupByBox.Appearance = appearance126;
			appearance127.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxGridItem.DisplayLayout.GroupByBox.BandLabelAppearance = appearance127;
			...
			comboBoxGridItem.DisplayLayout.GroupByBox.PromptAppearance = appearance128;
			...
			comboBoxGridItem.DisplayLayout.Override.ActiveCellAppearance = appearance129;
			...
			comboBoxGridItem.DisplayLayout.Override.ActiveRowAppearance = appearance130;
			...
			comboBoxGridItem.DisplayLayout.Override.CardAreaAppearance = appearance131;
			...
			comboBoxGridItem.DisplayLayout.Override.CellAppearance = appearance132;
			...
			comboBoxGridItem.DisplayLayout.Override.GroupByRowAppearance = appearance133;
			appearance134.TextHAlignAsString = "Left";
			comboBoxGridItem.DisplayLayout.Override.HeaderAppearance = appearance134;
			...
			comboBoxGridItem.DisplayLayout.Override.RowAppearance = appearance135;
			...
			comboBoxGridItem.DisplayLayout.Override.TemplateAddRowAppearance = appearance136;
			...
			checkBoxPriceIncludeTax.Location = new System.Drawing.Point(417, 463);
			...
			base.ClientSize = new System.Drawing.Size(788, 590);
			...
			base.Name = "PurchaseReturnCashForm";
			Text = "Purchase Return - Cash";
