...
{
	public class VendorAddressDetailsForm : Form, IForm
	{
		private VendorAddressData currentData;

		private const string TABLENAME_CONST = "Vendor_Address";

		private const string IDFIELD_CONST = "AddressID";

		private const string IDFIELD2_CONST = "VendorID";

		private bool isNewRecord = true;

		private bool isLoadingNewVendor;
		...
		private MMTextBox textBoxVendorName;
		...
		public event EventHandler VendorAddressChanged;

		public VendorAddressDetailsForm()
		{
			InitializeComponent();
			AddEvents();
		}
		...
		{
			base.Load += VendorAddressDetailsForm_Load;
		...
		{
			if (comboBoxVendors.SelectedRow != null && comboBoxVendors.SelectedID != "")
			{
				textBoxVendorName.Text = comboBoxVendors.SelectedRow.Cells["Name"].Text.ToString();
				if (comboBoxVendors.Text == "")
				{
					isLoadingNewVendor = false;
					return;
				}
				if (isLoadingNewVendor)
				{
					return;
				}
				isLoadingNewVendor = true;
				LoadData(comboBoxVendors.Text, "PRIMARY");
			}
			else
			{
		...
		private bool GetData()
		{
			try
			{
				...
				{
					currentData = new VendorAddressData();
				}
				DataRow dataRow = (!isNewRecord) ? currentData.VendorAddressTable.Rows[0] : currentData.VendorAddressTable.NewRow();
				dataRow.BeginEdit();
				string text = (string)(dataRow["VendorID"] = ((!isLoadingNewVendor) ? comboBoxVendors.SelectedID : comboBoxVendors.OldValue));
		...
		{
			LoadData(comboBoxVendors.SelectedID, addressID);
		}

		public void LoadData(string vendorID, string addressID)
		{
			try
			{
				if (!(vendorID.Trim() == "") && !(addressID == "") && CanClose())
				{
					currentData = Factory.VendorAddressSystem.GetVendorAddressByID(vendorID, addressID);
					if (comboBoxVendors.Text != vendorID)
					{
						comboBoxVendors.SelectedID = vendorID;
					}
					if (currentData != null)
					{
						FillData();
		...
		private bool SaveData()
		{
			...
			try
			{
				...
				if (isNewRecord)
				{
					flag = Factory.VendorAddressSystem.CreateVendorAddress(currentData);
				}
				else
				{
					flag = Factory.VendorAddressSystem.UpdateVendorAddress(currentData);
					if (this.VendorAddressChanged != null)
					{
						this.VendorAddressChanged(currentData, null);
					}
				}
				if (!flag)
				{
		...
		private bool ValidateData()
		{
			...
			if (!IsNewRecord && !Global.IsUserAdmin && !AllowEditCard && Global.CurrentUser != Factory.SystemDocumentSystem.GetCardUserID("Vendor_Address", "AddressID", textBoxCode.Text))
			{
			...
			if (comboBoxVendors.SelectedID == "")
			{
				ErrorHelper.InformationMessage("Please enter required fields.");
				return false;
			}
			if (isNewRecord && Factory.DatabaseSystem.ExistFieldValue("Vendor_Address", "AddressID", textBoxCode.Text.Trim(), "VendorID", comboBoxVendors.SelectedID))
			{
		...
		private void VendorAddressGroupDetailsForm_Validating(object sender, CancelEventArgs e)
		{
		}

		private void VendorAddressGroupDetailsForm_Validated(object sender, EventArgs e)
		{
		}
		...
		private bool Delete()
		{
			try
			{
				...
				if (Factory.VendorAddressSystem.IsPrimaryAddress(textBoxCode.Text, comboBoxVendors.SelectedID))
				{
					ErrorHelper.InformationMessage("You cannot delete this address because it is assigned as the primary address.");
					return false;
				}
				return Factory.VendorAddressSystem.DeleteVendorAddress(textBoxCode.Text, comboBoxVendors.SelectedID);
			}
			catch (Exception e)
			{
				ErrorHelper.ProcessError(e);
		...
		{
			LoadData(DatabaseHelper.GetNextID("Vendor_Address", "AddressID", textBoxCode.Text, "VendorID", comboBoxVendors.SelectedID));
		}

		private void toolStripButtonPrevious_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetPreviousID("Vendor_Address", "AddressID", textBoxCode.Text, "VendorID", comboBoxVendors.SelectedID));
		}

		private void toolStripButtonLast_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetLastID("Vendor_Address", "AddressID", "VendorID", comboBoxVendors.SelectedID));
		}

		private void toolStripButtonFirst_Click(object sender, EventArgs e)
		{
			LoadData(DatabaseHelper.GetFirstID("Vendor_Address", "AddressID", "VendorID", comboBoxVendors.SelectedID));
		}
		...
		private void toolStripButtonFind_Click(object sender, EventArgs e)
		{
			try
			{
				...
				else if (Factory.DatabaseSystem.ExistFieldValue("Vendor_Address", "AddressID", toolStripTextBoxFind.Text.Trim()))
				{
		...
		private void VendorAddressDetailsForm_Load(object sender, EventArgs e)
		{
			try
			{
				SetSecurity();
		...
		{
			new FormHelper().EditVendor(comboBoxVendors.SelectedID);
		}

		private void textBoxAddress3_TextChanged(object sender, EventArgs e)
		{
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Vendors.VendorAddressDetailsForm));
			...
			textBoxVendorName = new Micromind.UISupport.MMTextBox();
			...
			textBoxAddress3.TextChanged += new System.EventHandler(textBoxAddress3_TextChanged);
			...
			nonDirtyPanel1.Controls.Add(textBoxVendorName);
			nonDirtyPanel1.Controls.Add(mmLabel2);
			nonDirtyPanel1.Controls.Add(comboBoxVendors);
			...
			ultraFormattedLinkLabel2.Location = new System.Drawing.Point(12, 9);
			ultraFormattedLinkLabel2.Name = "ultraFormattedLinkLabel2";
			ultraFormattedLinkLabel2.Size = new System.Drawing.Size(79, 15);
			ultraFormattedLinkLabel2.TabIndex = 4;
			ultraFormattedLinkLabel2.TabStop = true;
			ultraFormattedLinkLabel2.TreatValueAs = Infragistics.Win.FormattedLinkLabel.TreatValueAs.URL;
			ultraFormattedLinkLabel2.UnderlineLinks = Infragistics.Win.FormattedLinkLabel.UnderlineLink.WhenHovered;
			ultraFormattedLinkLabel2.Value = "Vendor Code:";
			...
			textBoxVendorName.CharacterCasing = System.Windows.Forms.CharacterCasing.Upper;
			textBoxVendorName.CustomReportFieldName = "";
			textBoxVendorName.CustomReportKey = "";
			textBoxVendorName.CustomReportValueType = 1;
			textBoxVendorName.Enabled = false;
			textBoxVendorName.IsComboTextBox = false;
			textBoxVendorName.IsModified = false;
			textBoxVendorName.Location = new System.Drawing.Point(135, 33);
			textBoxVendorName.MaxLength = 255;
			textBoxVendorName.Name = "textBoxVendorName";
			textBoxVendorName.ReadOnly = true;
			textBoxVendorName.Size = new System.Drawing.Size(229, 20);
			...
			comboBoxVendors.DescriptionTextBox = null;
			appearance3.BackColor = System.Drawing.SystemColors.Window;
			appearance3.BorderColor = System.Drawing.SystemColors.InactiveCaption;
			comboBoxVendors.DisplayLayout.Appearance = appearance3;
			...
			comboBoxVendors.DisplayLayout.GroupByBox.Appearance = appearance4;
			appearance5.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxVendors.DisplayLayout.GroupByBox.BandLabelAppearance = appearance5;
			...
			comboBoxVendors.DisplayLayout.GroupByBox.PromptAppearance = appearance6;
			...
			comboBoxVendors.DisplayLayout.Override.ActiveCellAppearance = appearance7;
			appearance8.BackColor = System.Drawing.SystemColors.Highlight;
			appearance8.ForeColor = System.Drawing.SystemColors.HighlightText;
			comboBoxVendors.DisplayLayout.Override.ActiveRowAppearance = appearance8;
			...
			comboBoxVendors.DisplayLayout.Override.CardAreaAppearance = appearance9;
			appearance10.BorderColor = System.Drawing.Color.Silver;
			appearance10.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxVendors.DisplayLayout.Override.CellAppearance = appearance10;
			...
			comboBoxVendors.DisplayLayout.Override.GroupByRowAppearance = appearance11;
			appearance12.TextHAlignAsString = "Left";
			comboBoxVendors.DisplayLayout.Override.HeaderAppearance = appearance12;
			...
			comboBoxVendors.DisplayLayout.Override.RowAppearance = appearance13;
			comboBoxVendors.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance14.BackColor = System.Drawing.SystemColors.ControlLight;
			comboBoxVendors.DisplayLayout.Override.TemplateAddRowAppearance = appearance14;
			...
			comboBoxVendors.Location = new System.Drawing.Point(135, 8);
			...
			comboBoxVendors.Size = new System.Drawing.Size(229, 20);
			comboBoxVendors.TabIndex = 1;
			...
			base.Name = "VendorAddressDetailsForm";
			Text = "Vendor Address Detail";
