...
{
	public class DebitNoteEntryForm : Form, IForm
	{
		...
		private void SetupGrid()
		{
			try
			{
				...
				UltraGridColumn ultraGridColumn2 = dataGridItems.DisplayLayout.Bands[0].Columns["Job"];
			...
			try
			{
				...
				else
				{
					if (showAllocationForm)
					{
						...
						else if (payeeSelector1.SelectedType == "C")
						{
							CustomerPaymentAllocationForm customerPaymentAllocationForm2 = new CustomerPaymentAllocationForm();
							customerPaymentAllocationForm2.SetData(comboBoxSysDoc.SelectedID, textBoxVoucherNumber.Text, payeeSelector1.SelectedID, -1, isPDC: false);
		...
		private void JournalLeavesForm_Load(object sender, EventArgs e)
		{
			try
			{
				...
				if (!base.IsDisposed)
				{
					IsNewRecord = true;
					ClearForm();
					comboBoxSysDoc.FilterByType(SysDocTypes.DebitNote);
				}
			}
			catch (Exception e2)
			{
		...
		{
			new FormHelper().EditSysDoc(comboBoxSysDoc.SelectedID, SysDocTypes.DebitNote);
		}
		...
		private void Print(bool isPrint, bool showPrintDialog, bool saveChanges)
		{
			try
			{
				if (!(IsDirty && saveChanges) || (ErrorHelper.QuestionMessage(MessageBoxButtons.YesNo, "You must save the document before printing.", "Do you want to save?") == DialogResult.Yes && SaveData(clearAfter: false)))
				{
					...
					{
						PrintHelper.PrintDocument(transactionToPrint, systemDocID, "Debit Note", SysDocTypes.DebitNote, isPrint, showPrintDialog);
					}
				}
			}
			catch (Exception e)
		...
		private void toolStripButtonOpenList_Click(object sender, EventArgs e)
		{
			...
			FormActivator.BringFormToFront(FormActivator.DebitNoteListFormObj);
		}

		private void toolStripButtonDS_Click(object sender, EventArgs e)
		{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Accounts.DebitNoteEntryForm));
			...
			toolStrip1.Size = new System.Drawing.Size(657, 31);
			...
			toolStripButtonDistribution.Click += new System.EventHandler(toolStripButtonDS_Click);
			...
			panelButtons.Size = new System.Drawing.Size(657, 40);
			...
			linePanelDown.Size = new System.Drawing.Size(657, 1);
			...
			xpButton1.Location = new System.Drawing.Point(547, 8);
			...
			textBoxVoucherNumber.Size = new System.Drawing.Size(162, 20);
			...
			textBoxRef1.Location = new System.Drawing.Point(308, 25);
			textBoxRef1.MaxLength = 20;
			textBoxRef1.Name = "textBoxRef1";
			textBoxRef1.Size = new System.Drawing.Size(162, 20);
			textBoxRef1.TabIndex = 3;
			textBoxNote.Location = new System.Drawing.Point(89, 115);
			...
			ultraLabel1.Size = new System.Drawing.Size(488, 16);
			...
			ultraGroupBox1.Location = new System.Drawing.Point(13, 385);
			ultraGroupBox1.Name = "ultraGroupBox1";
			ultraGroupBox1.Size = new System.Drawing.Size(633, 21);
			...
			labelBalance.Location = new System.Drawing.Point(490, 3);
			...
			panelDetails.Size = new System.Drawing.Size(659, 140);
			...
			textBoxTaxAmount.Location = new System.Drawing.Point(223, 92);
			...
			comboBoxTaxGroup.Location = new System.Drawing.Point(89, 92);
			...
			ultraFormattedLinkLabel3.Location = new System.Drawing.Point(10, 49);
			...
			ultraFormattedLinkLabel3.Value = "Debit To:";
			...
			textBoxPayeeName.Location = new System.Drawing.Point(308, 47);
			...
			currencySelector.Location = new System.Drawing.Point(308, 69);
			...
			labelVoided.Location = new System.Drawing.Point(16, 347);
			labelVoided.Name = "labelVoided";
			labelVoided.Size = new System.Drawing.Size(627, 39);
			...
			comboBoxPropertyUnit.DisplayLayout.Appearance = appearance36;
			...
			comboBoxPropertyUnit.DisplayLayout.GroupByBox.Appearance = appearance37;
			appearance38.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxPropertyUnit.DisplayLayout.GroupByBox.BandLabelAppearance = appearance38;
			...
			comboBoxPropertyUnit.DisplayLayout.GroupByBox.PromptAppearance = appearance39;
			...
			comboBoxPropertyUnit.DisplayLayout.Override.ActiveCellAppearance = appearance40;
			...
			comboBoxPropertyUnit.DisplayLayout.Override.ActiveRowAppearance = appearance41;
			...
			comboBoxPropertyUnit.DisplayLayout.Override.CardAreaAppearance = appearance42;
			...
			comboBoxPropertyUnit.DisplayLayout.Override.CellAppearance = appearance43;
			...
			comboBoxPropertyUnit.DisplayLayout.Override.GroupByRowAppearance = appearance44;
			appearance45.TextHAlignAsString = "Left";
			comboBoxPropertyUnit.DisplayLayout.Override.HeaderAppearance = appearance45;
			...
			comboBoxPropertyUnit.DisplayLayout.Override.RowAppearance = appearance46;
			...
			comboBoxPropertyUnit.DisplayLayout.Override.TemplateAddRowAppearance = appearance47;
			...
			comboBoxPropertyUnit.Location = new System.Drawing.Point(418, 324);
			...
			comboBoxPropertyUnit.TabIndex = 126;
			...
			comboBoxProperty.DisplayLayout.Appearance = appearance48;
			...
			comboBoxProperty.DisplayLayout.GroupByBox.Appearance = appearance49;
			appearance50.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxProperty.DisplayLayout.GroupByBox.BandLabelAppearance = appearance50;
			...
			comboBoxProperty.DisplayLayout.GroupByBox.PromptAppearance = appearance51;
			...
			comboBoxProperty.DisplayLayout.Override.ActiveCellAppearance = appearance52;
			...
			comboBoxProperty.DisplayLayout.Override.ActiveRowAppearance = appearance53;
			...
			comboBoxProperty.DisplayLayout.Override.CardAreaAppearance = appearance54;
			appearance55.BorderColor = System.Drawing.Color.Silver;
			appearance55.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxProperty.DisplayLayout.Override.CellAppearance = appearance55;
			...
			comboBoxProperty.DisplayLayout.Override.GroupByRowAppearance = appearance56;
			appearance57.TextHAlignAsString = "Left";
			comboBoxProperty.DisplayLayout.Override.HeaderAppearance = appearance57;
			...
			comboBoxProperty.DisplayLayout.Override.RowAppearance = appearance58;
			...
			comboBoxProperty.DisplayLayout.Override.TemplateAddRowAppearance = appearance59;
			...
			comboBoxProperty.Location = new System.Drawing.Point(373, 283);
			...
			comboBoxGridCostCenter.DisplayLayout.Appearance = appearance60;
			...
			comboBoxGridCostCenter.DisplayLayout.GroupByBox.Appearance = appearance61;
			appearance62.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxGridCostCenter.DisplayLayout.GroupByBox.BandLabelAppearance = appearance62;
			...
			comboBoxGridCostCenter.DisplayLayout.GroupByBox.PromptAppearance = appearance63;
			...
			comboBoxGridCostCenter.DisplayLayout.Override.ActiveCellAppearance = appearance64;
			...
			comboBoxGridCostCenter.DisplayLayout.Override.ActiveRowAppearance = appearance65;
			...
			comboBoxGridCostCenter.DisplayLayout.Override.CardAreaAppearance = appearance66;
			...
			comboBoxGridCostCenter.DisplayLayout.Override.CellAppearance = appearance67;
			...
			comboBoxGridCostCenter.DisplayLayout.Override.GroupByRowAppearance = appearance68;
			appearance69.TextHAlignAsString = "Left";
			comboBoxGridCostCenter.DisplayLayout.Override.HeaderAppearance = appearance69;
			...
			comboBoxGridCostCenter.DisplayLayout.Override.RowAppearance = appearance70;
			...
			comboBoxGridCostCenter.DisplayLayout.Override.TemplateAddRowAppearance = appearance71;
			...
			comboBoxCostCategory.TabIndex = 124;
			...
			dataGridItems.DisplayLayout.Appearance = appearance108;
			...
			dataGridItems.DisplayLayout.GroupByBox.Appearance = appearance109;
			appearance110.ForeColor = System.Drawing.SystemColors.GrayText;
			dataGridItems.DisplayLayout.GroupByBox.BandLabelAppearance = appearance110;
			...
			dataGridItems.DisplayLayout.GroupByBox.PromptAppearance = appearance111;
			...
			dataGridItems.DisplayLayout.Override.ActiveCellAppearance = appearance112;
			...
			dataGridItems.DisplayLayout.Override.ActiveRowAppearance = appearance113;
			dataGridItems.DisplayLayout.Override.AllowAddNew = Infragistics.Win.UltraWinGrid.AllowAddNew.No;
			dataGridItems.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.Dotted;
			dataGridItems.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.Dotted;
			appearance114.BackColor = System.Drawing.SystemColors.Window;
			dataGridItems.DisplayLayout.Override.CardAreaAppearance = appearance114;
			...
			dataGridItems.DisplayLayout.Override.CellAppearance = appearance115;
			...
			dataGridItems.DisplayLayout.Override.GroupByRowAppearance = appearance116;
			appearance117.TextHAlignAsString = "Left";
			dataGridItems.DisplayLayout.Override.HeaderAppearance = appearance117;
			...
			dataGridItems.DisplayLayout.Override.RowAppearance = appearance118;
			dataGridItems.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance119.BackColor = System.Drawing.SystemColors.ControlLight;
			dataGridItems.DisplayLayout.Override.TemplateAddRowAppearance = appearance119;
			...
			dataGridItems.Location = new System.Drawing.Point(12, 177);
			...
			dataGridItems.Size = new System.Drawing.Size(633, 231);
			...
			base.ClientSize = new System.Drawing.Size(657, 454);
