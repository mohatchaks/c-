...
{
	public class IssuedChequeCancellationForm : Form, IForm
	{
		...
		public IssuedChequeCancellationForm()
		{
			InitializeComponent();
			AddEvents();
			comboBoxSysDoc.FilterByType(SysDocTypes.IssuedChequeCancellation);
		}
		...
		private bool SaveData()
		{
			...
			try
			{
				bool flag = (!isNewRecord) ? Factory.TransactionSystem.CancellIssuedCheque(currentData, isUpdate: true) : Factory.TransactionSystem.CancellIssuedCheque(currentData, isUpdate: false);
				if (!flag)
				{
		...
		private bool ValidateData()
		{
			...
			if (issuedChequeStatus == IssuedChequeStatus.Cancelled && IsNewRecord)
			{
				ErrorHelper.WarningMessage(UIMessages.ChequeAlreadyCancelled);
				textBoxChequeNumber.Focus();
				return false;
			}
			if (IsNewRecord && issuedChequeStatus != IssuedChequeStatus.Issued && issuedChequeStatus != IssuedChequeStatus.Bounced)
			{
		...
		private void buttonSelectCheque_Click(object sender, EventArgs e)
		{
			try
			{
				...
				selectChequeDialog.DataSource = Factory.IssuedChequeSystem.GetIssuedChequeToCancelList();
				...
				if (selectChequeDialog.ShowDialog() == DialogResult.OK)
				{
					...
					if (!(text == ""))
					{
						...
						AnalysisID = Factory.IssuedChequeSystem.GetAnalysisID(text2, text3);
					}
				}
			}
			catch (Exception e2)
		...
		{
			new FormHelper().EditSysDoc(comboBoxSysDoc.SelectedID, SysDocTypes.IssuedChequeCancellation);
		}
		...
		private void toolStripButtonLast_Click_1(object sender, EventArgs e)
		{
			string lastID = DatabaseHelper.GetLastID("GL_Transaction", "VoucherID", "SysDocID", SystemDocID);
			if (!(lastID == ""))
			{
		...
		private void Print(bool isPrint, bool showPrintDialog, bool saveChanges)
		{
			try
			{
				if (!(IsDirty && saveChanges) || (ErrorHelper.QuestionMessage(MessageBoxButtons.YesNo, "You must save the document before printing.", "Do you want to save?") == DialogResult.Yes && SaveData()))
				{
					...
					{
						PrintHelper.PrintDocument(transactionToPrint, systemDocID, "Issued Cheque Cancellation", SysDocTypes.ReceivedChequeCancellation, isPrint, showPrintDialog);
					}
				}
			}
			catch (Exception e)
		...
		{
			FormActivator.BringFormToFront(FormActivator.IssuedChequeCancellationListFormObj);
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Accounts.IssuedChequeCancellationForm));
			...
			panelButtons.Size = new System.Drawing.Size(584, 40);
			...
			linePanelDown.Size = new System.Drawing.Size(584, 1);
			...
			xpButton1.Location = new System.Drawing.Point(474, 8);
			...
			panelDetails.Location = new System.Drawing.Point(9, 26);
			panelDetails.Name = "panelDetails";
			panelDetails.Size = new System.Drawing.Size(573, 236);
			panelDetails.TabIndex = 0;
			appearance.FontData.BoldAsString = "False";
			appearance.FontData.Name = "Tahoma";
			ultraFormattedLinkLabel3.Appearance = appearance;
			ultraFormattedLinkLabel3.AutoSize = true;
			ultraFormattedLinkLabel3.Location = new System.Drawing.Point(7, 52);
			ultraFormattedLinkLabel3.Name = "ultraFormattedLinkLabel3";
			ultraFormattedLinkLabel3.Size = new System.Drawing.Size(47, 15);
			ultraFormattedLinkLabel3.TabIndex = 147;
			...
			ultraFormattedLinkLabel5.Location = new System.Drawing.Point(7, 8);
			ultraFormattedLinkLabel5.Name = "ultraFormattedLinkLabel5";
			ultraFormattedLinkLabel5.Size = new System.Drawing.Size(45, 15);
			ultraFormattedLinkLabel5.TabIndex = 146;
			...
			comboBoxSysDoc.Location = new System.Drawing.Point(87, 6);
			...
			ultraGroupBox1.Location = new System.Drawing.Point(3, 105);
			...
			comboBoxReason.Location = new System.Drawing.Point(87, 49);
			...
			dateTimePickerDate.Location = new System.Drawing.Point(87, 27);
			dateTimePickerDate.Name = "dateTimePickerDate";
			dateTimePickerDate.Size = new System.Drawing.Size(151, 20);
			dateTimePickerDate.TabIndex = 2;
			dateTimePickerDate.Value = new System.DateTime(2008, 5, 15, 12, 0, 51, 879);
			textBoxReasonName.BackColor = System.Drawing.Color.WhiteSmoke;
			textBoxReasonName.Location = new System.Drawing.Point(240, 49);
			...
			textBoxVoucherNumber.Location = new System.Drawing.Point(321, 5);
			textBoxVoucherNumber.MaxLength = 15;
			textBoxVoucherNumber.Name = "textBoxVoucherNumber";
			textBoxVoucherNumber.Size = new System.Drawing.Size(130, 20);
			textBoxVoucherNumber.TabIndex = 1;
			textBoxRef1.Location = new System.Drawing.Point(321, 26);
			...
			ultraFormattedLinkLabel2.Location = new System.Drawing.Point(240, 8);
			...
			label1.Location = new System.Drawing.Point(242, 30);
			label1.Name = "label1";
			label1.Size = new System.Drawing.Size(60, 13);
			label1.TabIndex = 20;
			label1.Text = "Reference:";
			textBoxNote.Location = new System.Drawing.Point(87, 71);
			textBoxNote.MaxLength = 255;
			textBoxNote.Name = "textBoxNote";
			textBoxNote.Size = new System.Drawing.Size(475, 20);
			textBoxNote.TabIndex = 6;
			label3.AutoSize = true;
			label3.Location = new System.Drawing.Point(7, 74);
			label3.Name = "label3";
			...
			mmLabel1.Location = new System.Drawing.Point(7, 29);
			...
			toolStrip2.Size = new System.Drawing.Size(564, 31);
			...
			toolStripButtonLast.Click += new System.EventHandler(toolStripButtonLast_Click_1);
			...
			base.ClientSize = new System.Drawing.Size(584, 304);
			...
			base.Name = "IssuedChequeCancellationForm";
			Text = "Issued Cheque Cancellation";
