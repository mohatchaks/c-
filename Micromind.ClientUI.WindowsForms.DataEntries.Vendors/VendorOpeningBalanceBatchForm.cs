...
{
	public class VendorOpeningBalanceBatchForm : Form, IForm
	{
		...
		public VendorOpeningBalanceBatchForm()
		{
			InitializeComponent();
			AddEvents();
			checked
		...
		private void comboBoxVendor_VisibleChanged(object sender, EventArgs e)
		{
		}
		...
		private void dataGridItems_AfterCellUpdate(object sender, CellEventArgs e)
		{
			...
			activeRow.Cells["VendorName"].Value = comboBoxVendor.SelectedName;
			checked
			{
				if (index > 0)
				{
		...
		private void dataGrid_BeforeRowDeactivate(object sender, CancelEventArgs e)
		{
			...
			{
				if (activeRow.Cells["VendorID"].Value.ToString() == "")
				{
					ErrorHelper.InformationMessage("Please select an item.");
					e.Cancel = true;
					activeRow.Cells["VendorID"].Activate();
				}
		...
		{
			if (dataGridItems.ActiveCell.Column.Key.ToString() == "VendorID")
			{
				e.RaiseErrorEvent = false;
				comboBoxVendor.Text = dataGridItems.ActiveCell.Text;
				comboBoxVendor.QuickAddItem();
			}
		...
		private bool GetData()
		{
			try
			{
				...
				foreach (UltraGridRow row in dataGridItems.Rows)
				{
					...
					dataRow2["SysDocID"] = "SYS_011";
					dataRow2["AccountID"] = row.Cells["VendorID"].Value.ToString();
					...
					{
						dataRow2["DueDate"] = row.Cells["TransactionDate"].Value.ToString();
					}
		...
		private void SetupGrid()
		{
			try
			{
				...
				dataGridItems.DisplayLayout.Bands[0].Columns["VendorID"].CharacterCasing = CharacterCasing.Upper;
				dataGridItems.DisplayLayout.Bands[0].Columns["VendorID"].MaxLength = 64;
				dataGridItems.DisplayLayout.Bands[0].Columns["VendorID"].InvalidValueBehavior = InvalidValueBehavior.RetainValueAndFocus;
				dataGridItems.DisplayLayout.Bands[0].Columns["VendorID"].Style = Infragistics.Win.UltraWinGrid.ColumnStyle.DropDownValidate;
				dataGridItems.DisplayLayout.Bands[0].Columns["VendorID"].ValueList = comboBoxVendor;
				dataGridItems.DisplayLayout.Bands[0].Columns["VendorID"].Header.Caption = "Vendor Code";
				...
				dataGridItems.DisplayLayout.Bands[0].Columns["VendorName"].CellActivation = Activation.Disabled;
				dataGridItems.DisplayLayout.Bands[0].Columns["VendorName"].CellAppearance.BackColorDisabled = Color.WhiteSmoke;
				dataGridItems.DisplayLayout.Bands[0].Columns["VendorName"].CellAppearance.ForeColorDisabled = Color.Black;
				dataGridItems.DisplayLayout.Bands[0].Columns["VendorName"].Header.Caption = "Vendor Name";
				dataGridItems.DisplayLayout.Bands[0].Columns["Description"].Width = checked(40 * dataGridItems.Width) / 100;
				dataGridItems.DisplayLayout.Bands[0].Columns["VendorID"].Width = checked(18 * dataGridItems.Width) / 100;
		...
		public void LoadData(string voucherID)
		{
			try
			{
				...
				{
					currentData = Factory.OpeningBalanceBatchSystem.GetOpeningBalanceBatchByID("SYS_011", voucherID);
					if (currentData != null)
					{
						FillData();
						IsNewRecord = false;
				...
				if (currentData != null && currentData.Tables.Count != 0 && currentData.Tables[0].Rows.Count != 0)
				{
					...
					if (currentData.Tables.Contains("Opening_Balance_Batch_Detail") && currentData.OpeningBalanceBatchDetailsTable.Rows.Count != 0)
					{
						...
						foreach (DataRow row in currentData.Tables["Opening_Balance_Batch_Detail"].Rows)
						{
							...
							dataRow3["VendorName"] = row["VendorName"];
		...
		private bool ValidateData()
		{
			...
			for (int i = 0; i < dataGridItems.Rows.Count; i = checked(i + 1))
			{
				...
				else if (dataGridItems.Rows[i].Cells["VendorID"].Value.ToString() == "")
				{
					ErrorHelper.InformationMessage("Please select an item.");
		...
		private bool Delete()
		{
			try
			{
				return Factory.OpeningBalanceBatchSystem.DeleteOpeningBalanceBatch("SYS_011", textBoxVoucherNumber.Text);
			}
			catch (Exception e)
			{
				ErrorHelper.ProcessError(e);
		...
		{
			string nextID = DatabaseHelper.GetNextID("Opening_Balance_Batch", "BatchID", textBoxVoucherNumber.Text, "SysDocID", "SYS_011");
			if (!(nextID == ""))
			{
				LoadData(nextID);
			}
		...
		{
			string previousID = DatabaseHelper.GetPreviousID("Opening_Balance_Batch", "BatchID", textBoxVoucherNumber.Text, "SysDocID", "SYS_011");
			if (!(previousID == ""))
			{
				LoadData(previousID);
			}
		...
		{
			string lastID = DatabaseHelper.GetLastID("Opening_Balance_Batch", "BatchID", "SysDocID", "SYS_011");
			if (!(lastID == ""))
			{
				LoadData(lastID);
			}
		...
		{
			string firstID = DatabaseHelper.GetFirstID("Opening_Balance_Batch", "BatchID", "SysDocID", "SYS_011");
			if (!(firstID == ""))
			{
				LoadData(firstID);
			}
		...
		{
			if (dataGridItems.ActiveRow != null && dataGridItems.ActiveCell != null && !dataGridItems.ActiveRow.IsGroupByRow && dataGridItems.ActiveCell.Column.Key == "VendorID" && dataGridItems.ActiveCell.Row.Index > 0 && (dataGridItems.ActiveCell.Value == null || dataGridItems.ActiveCell.Value.ToString() == ""))
			{
				string text2 = (string)(dataGridItems.ActiveCell.Value = (comboBoxVendor.SelectedID = dataGridItems.Rows[checked(dataGridItems.ActiveCell.Row.Index - 1)].Cells["VendorID"].Value.ToString()));
			}
		}
		...
		private string GetNextVoucherNumber()
		{
			try
			{
				return Factory.OpeningBalanceBatchSystem.GetNextBatchNumber("SYS_011");
			}
			catch (Exception e)
			{
				ErrorHelper.ProcessError(e);
		...
		private void Print(bool isPrint, bool showPrintDialog, bool saveChanges)
		{
			try
			{
				if (!(IsDirty && saveChanges) || (ErrorHelper.QuestionMessage(MessageBoxButtons.YesNo, "You must save the document before printing.", "Do you want to save?") == DialogResult.Yes && SaveData(clearAfter: false)))
				{
					...
					{
						PrintHelper.PrintDocument(openingBalanceBatchToPrint, "", "Opening Balance Batch", SysDocTypes.None, isPrint, showPrintDialog);
					}
				}
			}
			catch (Exception e)
		...
		private void toolStripButton2_Click(object sender, EventArgs e)
		{
			...
			{
				dataGridItems.DisplayLayout.Bands[0].SortedColumns.Add("VendorID", descending: true, groupBy: true);
			}
			else
			{
				dataGridItems.DisplayLayout.Bands[0].SortedColumns.Remove("VendorID");
			}
		}

		private void linkLabelTransactionID_LinkClicked(object sender, Infragistics.Win.FormattedLinkLabel.LinkClickedEventArgs e)
		{
		}
		...
		{
			FormActivator.BringFormToFront(FormActivator.VendorOpeningBalanceBatchListFormObj);
		}
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Vendors.VendorOpeningBalanceBatchForm));
			...
			toolStripButtonGroup.Size = new System.Drawing.Size(124, 28);
			toolStripButtonGroup.Text = "Group By Vendor";
			...
			textBoxNote.Location = new System.Drawing.Point(123, 73);
			textBoxNote.MaxLength = 255;
			textBoxNote.Name = "textBoxNote";
			textBoxNote.Size = new System.Drawing.Size(526, 21);
			textBoxNote.TabIndex = 7;
			label3.AutoSize = true;
			label3.Location = new System.Drawing.Point(15, 75);
			label3.Name = "label3";
			...
			ultraFormattedLinkLabel1.Location = new System.Drawing.Point(15, 26);
			...
			labelCurrency.Appearance = appearance8;
			labelCurrency.AutoSize = true;
			labelCurrency.Location = new System.Drawing.Point(437, 29);
			...
			labelCurrency.VisitedLinkAppearance = appearance9;
			...
			currencySelector1.Location = new System.Drawing.Point(494, 26);
			...
			textBoxAccountName.Location = new System.Drawing.Point(314, 50);
			...
			comboBoxAccount.Location = new System.Drawing.Point(123, 50);
			...
			ultraFormattedLinkLabel3.Appearance = appearance10;
			ultraFormattedLinkLabel3.AutoSize = true;
			ultraFormattedLinkLabel3.Location = new System.Drawing.Point(15, 51);
			...
			ultraFormattedLinkLabel3.VisitedLinkAppearance = appearance11;
			...
			comboBoxLocation.DisplayLayout.Appearance = appearance12;
			...
			comboBoxLocation.DisplayLayout.GroupByBox.Appearance = appearance13;
			appearance14.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxLocation.DisplayLayout.GroupByBox.BandLabelAppearance = appearance14;
			...
			comboBoxLocation.DisplayLayout.GroupByBox.PromptAppearance = appearance15;
			...
			comboBoxLocation.DisplayLayout.Override.ActiveCellAppearance = appearance16;
			appearance17.BackColor = System.Drawing.SystemColors.Highlight;
			appearance17.ForeColor = System.Drawing.SystemColors.HighlightText;
			comboBoxLocation.DisplayLayout.Override.ActiveRowAppearance = appearance17;
			...
			comboBoxLocation.DisplayLayout.Override.CardAreaAppearance = appearance18;
			appearance19.BorderColor = System.Drawing.Color.Silver;
			appearance19.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxLocation.DisplayLayout.Override.CellAppearance = appearance19;
			...
			comboBoxLocation.DisplayLayout.Override.GroupByRowAppearance = appearance20;
			appearance21.TextHAlignAsString = "Left";
			comboBoxLocation.DisplayLayout.Override.HeaderAppearance = appearance21;
			...
			comboBoxLocation.DisplayLayout.Override.RowAppearance = appearance22;
			comboBoxLocation.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance23.BackColor = System.Drawing.SystemColors.ControlLight;
			comboBoxLocation.DisplayLayout.Override.TemplateAddRowAppearance = appearance23;
			...
			dataGridItems.DisplayLayout.Appearance = appearance24;
			...
			dataGridItems.DisplayLayout.GroupByBox.Appearance = appearance25;
			appearance26.ForeColor = System.Drawing.SystemColors.GrayText;
			dataGridItems.DisplayLayout.GroupByBox.BandLabelAppearance = appearance26;
			...
			dataGridItems.DisplayLayout.GroupByBox.PromptAppearance = appearance27;
			dataGridItems.DisplayLayout.MaxColScrollRegions = 1;
			dataGridItems.DisplayLayout.MaxRowScrollRegions = 1;
			appearance28.BackColor = System.Drawing.SystemColors.Window;
			appearance28.ForeColor = System.Drawing.SystemColors.ControlText;
			dataGridItems.DisplayLayout.Override.ActiveCellAppearance = appearance28;
			...
			dataGridItems.DisplayLayout.Override.ActiveRowAppearance = appearance29;
			dataGridItems.DisplayLayout.Override.AllowAddNew = Infragistics.Win.UltraWinGrid.AllowAddNew.No;
			dataGridItems.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.Dotted;
			dataGridItems.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.Dotted;
			appearance30.BackColor = System.Drawing.SystemColors.Window;
			dataGridItems.DisplayLayout.Override.CardAreaAppearance = appearance30;
			appearance31.BorderColor = System.Drawing.Color.Silver;
			appearance31.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			dataGridItems.DisplayLayout.Override.CellAppearance = appearance31;
			...
			dataGridItems.DisplayLayout.Override.GroupByRowAppearance = appearance32;
			appearance33.TextHAlignAsString = "Left";
			dataGridItems.DisplayLayout.Override.HeaderAppearance = appearance33;
			dataGridItems.DisplayLayout.Override.HeaderClickAction = Infragistics.Win.UltraWinGrid.HeaderClickAction.SortMulti;
			dataGridItems.DisplayLayout.Override.HeaderStyle = Infragistics.Win.HeaderStyle.WindowsXPCommand;
			appearance34.BackColor = System.Drawing.SystemColors.Window;
			appearance34.BorderColor = System.Drawing.Color.Silver;
			dataGridItems.DisplayLayout.Override.RowAppearance = appearance34;
			dataGridItems.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance35.BackColor = System.Drawing.SystemColors.ControlLight;
			dataGridItems.DisplayLayout.Override.TemplateAddRowAppearance = appearance35;
			...
			comboBoxCurrency.DisplayLayout.Appearance = appearance36;
			...
			comboBoxCurrency.DisplayLayout.GroupByBox.Appearance = appearance37;
			appearance38.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxCurrency.DisplayLayout.GroupByBox.BandLabelAppearance = appearance38;
			...
			comboBoxCurrency.DisplayLayout.GroupByBox.PromptAppearance = appearance39;
			...
			comboBoxCurrency.DisplayLayout.Override.ActiveCellAppearance = appearance40;
			...
			comboBoxCurrency.DisplayLayout.Override.ActiveRowAppearance = appearance41;
			...
			comboBoxCurrency.DisplayLayout.Override.CardAreaAppearance = appearance42;
			...
			comboBoxCurrency.DisplayLayout.Override.CellAppearance = appearance43;
			...
			comboBoxCurrency.DisplayLayout.Override.GroupByRowAppearance = appearance44;
			appearance45.TextHAlignAsString = "Left";
			comboBoxCurrency.DisplayLayout.Override.HeaderAppearance = appearance45;
			...
			comboBoxCurrency.DisplayLayout.Override.RowAppearance = appearance46;
			...
			comboBoxCurrency.DisplayLayout.Override.TemplateAddRowAppearance = appearance47;
			...
			comboBoxVendor.DisplayLayout.Appearance = appearance48;
			...
			comboBoxVendor.DisplayLayout.GroupByBox.Appearance = appearance49;
			appearance50.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxVendor.DisplayLayout.GroupByBox.BandLabelAppearance = appearance50;
			...
			comboBoxVendor.DisplayLayout.GroupByBox.PromptAppearance = appearance51;
			...
			comboBoxVendor.DisplayLayout.Override.ActiveCellAppearance = appearance52;
			...
			comboBoxVendor.DisplayLayout.Override.ActiveRowAppearance = appearance53;
			...
			comboBoxVendor.DisplayLayout.Override.CardAreaAppearance = appearance54;
			appearance55.BorderColor = System.Drawing.Color.Silver;
			appearance55.TextTrimming = Infragistics.Win.TextTrimming.EllipsisCharacter;
			comboBoxVendor.DisplayLayout.Override.CellAppearance = appearance55;
			...
			comboBoxVendor.DisplayLayout.Override.GroupByRowAppearance = appearance56;
			appearance57.TextHAlignAsString = "Left";
			comboBoxVendor.DisplayLayout.Override.HeaderAppearance = appearance57;
			...
			comboBoxVendor.DisplayLayout.Override.RowAppearance = appearance58;
			...
			comboBoxVendor.DisplayLayout.Override.TemplateAddRowAppearance = appearance59;
			...
			comboBoxVendor.Location = new System.Drawing.Point(669, 217);
			...
			comboBoxVendor.Size = new System.Drawing.Size(71, 21);
			comboBoxVendor.TabIndex = 123;
			...
			ultraFormattedLinkLabel4.Appearance = appearance60;
			ultraFormattedLinkLabel4.AutoSize = true;
			ultraFormattedLinkLabel4.Location = new System.Drawing.Point(266, 27);
			ultraFormattedLinkLabel4.Name = "ultraFormattedLinkLabel4";
			ultraFormattedLinkLabel4.Size = new System.Drawing.Size(51, 15);
			ultraFormattedLinkLabel4.TabIndex = 152;
			...
			ultraFormattedLinkLabel4.VisitedLinkAppearance = appearance61;
			...
			comboBoxDivision.Location = new System.Drawing.Point(323, 26);
			...
			comboBoxDivision.Size = new System.Drawing.Size(115, 21);
			comboBoxDivision.TabIndex = 153;
			...
			base.Name = "VendorOpeningBalanceBatchForm";
			Text = "Vendor Opening Balance Entry";
