...
{
	public class SalesByProductCategoryReport : Form, IForm
	{
		...
		public SalesByProductCategoryReport()
		{
			InitializeComponent();
			base.Load += Form_Load;
		}
		...
		private void buttonOK_Click(object sender, EventArgs e)
		{
			...
			DataSet data = Factory.ProductSystem.GetSalesByItemCategorySummaryReport(dateControl1.FromDate, dateControl1.ToDate, productCategorySelector.FromProductCategory, productCategorySelector.ToProductCategory);
			...
			xtraReport = reportHelper.GetReport("Sales By Item Category");
			string reportFilter = "From:" + dateControl1.FromDate.ToShortDateString() + "  To:" + dateControl1.ToDate.ToShortDateString();
			reportHelper.AddGeneralReportData(ref data, reportFilter);
			reportHelper.AddFilterData(ref data, GetAllFormControls(this));
			if (xtraReport == null)
			{
				ErrorHelper.ErrorMessage("Cannot find the report file", "Please make sure you have access to reports path and the files are not corrupted.", "'Sales By Item Category.repx'");
				return;
			}
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.Sales.SalesByProductCategoryReport));
			...
			base.Name = "SalesByProductCategoryReport";
			Text = "Sales by Item Category Report";
