...
{
	public class SalesByLocationReport : Form, IForm
	{
		...
		private void buttonOK_Click(object sender, EventArgs e)
		{
			...
			{
				data = Factory.LocationSystem.GetSalesByLocationDetailReport(dateControl1.FromDate, dateControl1.ToDate, locationSelector.FromLocation, locationSelector.ToLocation);
			...
			{
				data = Factory.LocationSystem.GetSalesByLocationSummaryReport(dateControl1.FromDate, dateControl1.ToDate, locationSelector.FromLocation, locationSelector.ToLocation);
			...
			string text = "";
			text = ((templateMapCombo.SelectedID != "") ? templateMapCombo.SelectedID : ((!radioButtonSummary.Checked) ? "Sales By Location Detail" : "Sales By Location Summary"));
			...
			if (xtraReport == null)
			{
				ErrorHelper.ErrorMessage("Cannot find the report file", "Please make sure you have access to reports path and the files are not corrupted.", "'Sales By Location Summary.repx'");
				return;
			}
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.Sales.SalesByLocationReport));
			...
			buttonOK.Location = new System.Drawing.Point(286, 231);
			...
			buttonClose.Location = new System.Drawing.Point(390, 231);
			...
			radioButtonSummary.Location = new System.Drawing.Point(27, 156);
			...
			radioButtonDetail.Location = new System.Drawing.Point(116, 156);
			...
			templateMapCombo.FilterFormID = "SalesByLocationReport";
			...
			templateMapCombo.Location = new System.Drawing.Point(146, 184);
			...
			base.ClientSize = new System.Drawing.Size(497, 262);
			...
			base.Name = "SalesByLocationReport";
			Text = "Sales by Location Report";
