...
{
	public class ExportSalesOrderForm : Form, IForm, IWorkFlowForm
	{
		...
		private ToolStripMenuItem createFromExportSalesProformaInvoiceToolStripMenuItem;
		...
		private bool IsNewRecord
		{
			...
			set
			{
				...
				if (value)
				{
					...
					flag3 = (comboBoxCustomer.Enabled = true);
					enabled = (textBox.Enabled = flag3);
				...
				toolStripButtonExcelImport.Enabled = value;
		...
		private void comboBoxSysDoc_SelectedIndexChanged(object sender, EventArgs e)
		{
			if (!isDataLoading)
			{
				...
				createJobwithSOSysDoc = CompanyOptions.GetCompanyOption(CompanyOptionsEnum.AllowtoCreateProjectwithSOSysDoc, 52, comboBoxSysDoc.SelectedID, defaultValue: false);
				...
				activateSOEditing = CompanyOptions.GetCompanyOption(CompanyOptionsEnum.ActivateSOEditing, 52, comboBoxSysDoc.SelectedID, defaultValue: false);
					...
					if (itemTypes == ItemTypes.Matrix)
					{
						...
						if (matrixSelectionForm.ShowDialog(this) == DialogResult.OK)
						{
							foreach (DataRow row in matrixSelectionForm.SelectedItems.Tables[0].Rows)
							{
								...
								if (a == "")
								{
									a = Security.DefaultInventoryLocationID;
								}
		...
		private bool GetData()
		{
			try
			{
				...
				if (createJobwithSO)
				{
					...
					if (isNewRecord)
					{
						DataRow dataRow3 = jobData.JobTable.NewRow();
						dataRow3["JobID"] = comboBoxSysDoc.SelectedID.Trim() + "-" + textBoxVoucherNumber.Text.Trim();
						dataRow3["JobName"] = comboBoxCustomer.SelectedID + "-" + comboBoxSysDoc.SelectedID + "-" + textBoxVoucherNumber.Text;
						dataRow3["CustomerID"] = comboBoxCustomer.SelectedID;
						dataRow3["Status"] = 0;
						dataRow3.EndEdit();
						jobData.JobTable.Rows.Add(dataRow3);
		...
		private void SetupGrid()
		{
			try
			{
				...
				UltraGridColumn ultraGridColumn = dataGridItems.DisplayLayout.Bands[0].Columns["Processed Quantity"];
				UltraGridColumn ultraGridColumn2 = dataGridItems.DisplayLayout.Bands[0].Columns["Attribute1"];
				UltraGridColumn ultraGridColumn3 = dataGridItems.DisplayLayout.Bands[0].Columns["Attribute2"];
				UltraGridColumn ultraGridColumn4 = dataGridItems.DisplayLayout.Bands[0].Columns["Attribute3"];
				...
				UltraGridColumn ultraGridColumn6 = dataGridItems.DisplayLayout.Bands[0].Columns["RefSlNo"];
				UltraGridColumn ultraGridColumn7 = dataGridItems.DisplayLayout.Bands[0].Columns["RefText1"];
				UltraGridColumn ultraGridColumn8 = dataGridItems.DisplayLayout.Bands[0].Columns["RefText2"];
				UltraGridColumn ultraGridColumn9 = dataGridItems.DisplayLayout.Bands[0].Columns["RefNum1"];
				UltraGridColumn ultraGridColumn10 = dataGridItems.DisplayLayout.Bands[0].Columns["RefNum2"];
				UltraGridColumn ultraGridColumn11 = dataGridItems.DisplayLayout.Bands[0].Columns["RefDate1"];
				bool flag10 = dataGridItems.DisplayLayout.Bands[0].Columns["RefDate2"].Hidden = true;
				bool flag12 = ultraGridColumn11.Hidden = flag10;
				flag2 = (ultraGridColumn10.Hidden = flag12);
				flag4 = (ultraGridColumn9.Hidden = flag2);
				flag6 = (ultraGridColumn8.Hidden = flag4);
				hidden = (ultraGridColumn7.Hidden = flag6);
			...
			try
			{
				...
				if (currentData != null && currentData.Tables.Count != 0 && currentData.Tables[0].Rows.Count != 0)
				{
					...
					if (currentData.Tables.Contains("Sales_Order_Detail") && currentData.SalesOrderDetailTable.Rows.Count != 0)
					{
						...
						if (currentData.Tables.Contains("Export_PickList_Detail") && currentData.Tables["Export_PickList_Detail"].Rows.Count > 0)
						{
							sourceDocType = ItemSourceTypes.PickList;
							labelProcessedDocs.Visible = true;
							checkedListBoxProcessedDocs.Visible = true;
							foreach (DataRow row4 in currentData.Tables["Export_PickList_Detail"].Rows)
							{
						...
						CalculateTotal();
						if (activateSOEditing && currentData.Tables.Contains("Delivery_Note_Detail") && currentData.Tables["Delivery_Note_Detail"].Rows.Count > 0)
						{
		...
		private void checkedListBoxProcessedDocs_DoubleClick(object sender, EventArgs e)
		{
			if (checkedListBoxProcessedDocs.SelectedItem.ToString() != "")
			{
				...
				{
					formHelper.EditTransaction(TransactionListType.ExportDeliveryNote, nameValue.ID, nameValue.Name);
				}
				else if (sourceDocType == ItemSourceTypes.PickList)
				{
					formHelper.EditTransaction(TransactionListType.ExportPickList, nameValue.ID, nameValue.Name);
				}
			}
		}
		...
		private void Form_Load(object sender, EventArgs e)
		{
			checked
			{
				try
				{
					...
					comboBoxSysDoc.FilterByType(SysDocTypes.ExportSalesOrder);
					SetSecurity();
					if (!base.IsDisposed)
					{
						IsNewRecord = true;
		...
		{
			new FormHelper().EditSysDoc(comboBoxSysDoc.SelectedID, SysDocTypes.ExportSalesOrder);
		}
		...
		private void Print(bool isPrint, bool showPrintDialog, bool saveChanges)
		{
			try
			{
				if (!(IsDirty && saveChanges) || (ErrorHelper.QuestionMessage(MessageBoxButtons.YesNo, "You must save the document before printing.", "Do you want to save?") == DialogResult.Yes && SaveData(clearAfter: false)))
				{
					...
					{
						PrintHelper.PrintDocument(salesOrderToPrint, selectedID, "Export Sales Order", SysDocTypes.ExportSalesOrder, isPrint, showPrintDialog);
					}
				}
			}
			catch (Exception e)
		...
		private void toolStripButtonOpenList_Click(object sender, EventArgs e)
		{
			...
			FormActivator.BringFormToFront(FormActivator.ExportSalesOrderListFormObj);
		}
		...
		private void ExportSalesOrderForm_Load(object sender, EventArgs e)
		{
		}
		...
		private void toolStripButtonMultiPreview_Click(object sender, EventArgs e)
		{
			...
			attachementDetailsForm.SysDocType = SysDocTypes.ExportSalesOrder;
		...
		private void changeStatusToolStripMenuItem_Click(object sender, EventArgs e)
		{
			...
			updatePOStatusDialog.SetDocument(SysDocTypes.ExportSalesOrder, comboBoxSysDoc.SelectedID, textBoxVoucherNumber.Text);
		...
		private void EnableControlMode(bool isEnable)
		{
			if (isEnable)
			{
				...
				foreach (UltraGridRow row in dataGridItems.Rows)
				{
					Activation activation3 = row.Cells["Item Code"].Activation = (row.Cells["Unit"].Activation = Activation.Disabled);
				}
			}
			else
			{
				...
				foreach (UltraGridRow row2 in dataGridItems.Rows)
				{
					Activation activation3 = row2.Cells["Item Code"].Activation = (row2.Cells["Unit"].Activation = Activation.AllowEdit);
				}
			}
		}
		...
		private void createFromExportSalesProformaInvoiceToolStripMenuItem_Click(object sender, EventArgs e)
		{
			if (!IsNewRecord)
			{
				ErrorHelper.InformationMessage("Please start a new transaction first.");
			...
			DataSet openOrdersSummary = Factory.SalesProformaSystem.GetOpenOrdersSummary(comboBoxCustomer.SelectedID, isExport: true);
			SelectDocumentDialog selectDocumentDialog = new SelectDocumentDialog();
			...
			if (selectDocumentDialog.ShowDialog(this) == DialogResult.OK)
			{
				...
				DataSet dataSet = new DataSet();
				dataSet.Merge(salesOrderByID.SalesProformaDetailTable, preserveChanges: true, MissingSchemaAction.Add);
				textBoxPONumber.Text = dataRow["PONumber"].ToString();
				textBoxDiscountAmount.Text = dataRow["Discount"].ToString();
				DataTable dataTable = dataGridItems.DataSource as DataTable;
				dataTable.Rows.Clear();
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Customers.ExportSalesOrderForm));
			...
			createFromExportSalesProformaInvoiceToolStripMenuItem = new System.Windows.Forms.ToolStripMenuItem();
			...
			toolStrip1.Size = new System.Drawing.Size(906, 31);
			...
			toolStripDropDownButton1.DropDownItems.AddRange(new System.Windows.Forms.ToolStripItem[6]
			{
				...
				createFromExportSalesProformaInvoiceToolStripMenuItem,
			...
			duplicateToolStripMenuItem.Size = new System.Drawing.Size(298, 22);
			...
			createFromSalesQuoteToolStripMenuItem.Size = new System.Drawing.Size(298, 22);
			...
			createFromExportSalesProformaInvoiceToolStripMenuItem.Name = "createFromExportSalesProformaInvoiceToolStripMenuItem";
			createFromExportSalesProformaInvoiceToolStripMenuItem.Size = new System.Drawing.Size(298, 22);
			createFromExportSalesProformaInvoiceToolStripMenuItem.Text = "Create From Export Sales Proforma Invoice";
			createFromExportSalesProformaInvoiceToolStripMenuItem.Click += new System.EventHandler(createFromExportSalesProformaInvoiceToolStripMenuItem_Click);
			changeStatusToolStripMenuItem.Name = "changeStatusToolStripMenuItem";
			changeStatusToolStripMenuItem.Size = new System.Drawing.Size(298, 22);
			...
			panelButtons.Size = new System.Drawing.Size(906, 40);
			...
			linePanelDown.Size = new System.Drawing.Size(906, 1);
			...
			xpButton1.Location = new System.Drawing.Point(796, 8);
			...
			dateTimePickerDate.Location = new System.Drawing.Point(733, 3);
			...
			label1.Location = new System.Drawing.Point(653, 30);
			label1.Name = "label1";
			label1.Size = new System.Drawing.Size(60, 13);
			label1.TabIndex = 20;
			label1.Text = "Reference:";
			textBoxRef1.Location = new System.Drawing.Point(733, 26);
			...
			textBoxNote.Size = new System.Drawing.Size(309, 76);
			textBoxNote.TabIndex = 2;
			label3.Anchor = (System.Windows.Forms.AnchorStyles.Bottom | System.Windows.Forms.AnchorStyles.Left);
			label3.AutoSize = true;
			label3.Location = new System.Drawing.Point(10, 454);
			label3.Name = "label3";
			...
			panelDetails.Size = new System.Drawing.Size(891, 166);
			panelDetails.TabIndex = 0;
			label4.AutoSize = true;
			label4.Location = new System.Drawing.Point(653, 53);
			label4.Name = "label4";
			label4.Size = new System.Drawing.Size(66, 13);
			label4.TabIndex = 165;
			label4.Text = "Reference2:";
			textBoxRef2.Location = new System.Drawing.Point(733, 49);
			...
			labelTaxGroup.Location = new System.Drawing.Point(448, 94);
			...
			comboBoxPayeeTaxGroup.Location = new System.Drawing.Point(531, 92);
			...
			comboBoxPayeeTaxGroup.TabIndex = 162;
			...
			labelJob.Location = new System.Drawing.Point(233, 145);
			labelJob.Name = "labelJob";
			labelJob.Size = new System.Drawing.Size(42, 15);
			labelJob.TabIndex = 160;
			...
			labelCurrency.Location = new System.Drawing.Point(653, 121);
			labelCurrency.Name = "labelCurrency";
			labelCurrency.Size = new System.Drawing.Size(52, 15);
			labelCurrency.TabIndex = 158;
			...
			ultraFormattedLinkPayment.Appearance = appearance25;
			ultraFormattedLinkPayment.AutoSize = true;
			ultraFormattedLinkPayment.Location = new System.Drawing.Point(448, 49);
			...
			ultraFormattedLinkPayment.VisitedLinkAppearance = appearance26;
			...
			textBoxShipto.Location = new System.Drawing.Point(230, 67);
			...
			comboBoxBillingAddress.TabIndex = 17;
			...
			comboBoxShippingAddressID.TabIndex = 18;
			...
			textBoxBilltoAddress.Location = new System.Drawing.Point(12, 66);
			...
			textBoxBilltoAddress.TabIndex = 19;
			...
			comboBoxCostCategory.Location = new System.Drawing.Point(483, 143);
			...
			comboBoxCostCategory.TabIndex = 25;
			...
			mmLabel2.Location = new System.Drawing.Point(448, 73);
			...
			comboBoxJob.Location = new System.Drawing.Point(280, 143);
			...
			dateTimePickerDueDate.Location = new System.Drawing.Point(530, 70);
			...
			comboBoxCurrency.Location = new System.Drawing.Point(733, 118);
			...
			comboBoxShippingMethod.Location = new System.Drawing.Point(106, 143);
			...
			comboBoxShippingMethod.Size = new System.Drawing.Size(121, 20);
			comboBoxShippingMethod.TabIndex = 22;
			...
			comboBoxTerm.Location = new System.Drawing.Point(531, 47);
			...
			comboBoxSalesperson.Location = new System.Drawing.Point(733, 95);
			...
			comboBoxSalesperson.Size = new System.Drawing.Size(139, 20);
			...
			ultraFormattedLinkLabel6.Location = new System.Drawing.Point(653, 98);
			...
			ultraFormattedLinkLabel3.Location = new System.Drawing.Point(230, 47);
			...
			label2.Location = new System.Drawing.Point(653, 76);
			label2.Name = "label2";
			label2.Size = new System.Drawing.Size(79, 13);
			label2.TabIndex = 132;
			label2.Text = "Customer PO#:";
			textBoxPONumber.Location = new System.Drawing.Point(733, 72);
			textBoxPONumber.MaxLength = 30;
			textBoxPONumber.Name = "textBoxPONumber";
			textBoxPONumber.Size = new System.Drawing.Size(139, 20);
			...
			mmLabel1.Location = new System.Drawing.Point(653, 6);
			...
			textBoxCustomerName.Size = new System.Drawing.Size(427, 20);
			...
			labelVoided.Location = new System.Drawing.Point(13, 388);
			labelVoided.Name = "labelVoided";
			labelVoided.Size = new System.Drawing.Size(878, 58);
			...
			panel1.Location = new System.Drawing.Point(674, 449);
			panel1.Name = "panel1";
			...
			panelNonTax.Location = new System.Drawing.Point(0, 42);
			...
			checkBoxPriceIncludeTax.Location = new System.Drawing.Point(526, 453);
			...
			checkedListBoxProcessedDocs.Location = new System.Drawing.Point(364, 475);
			...
			checkedListBoxProcessedDocs.TabIndex = 171;
			checkedListBoxProcessedDocs.Visible = false;
			...
			dataGridItems.Location = new System.Drawing.Point(12, 203);
			...
			dataGridItems.Size = new System.Drawing.Size(880, 246);
			...
			comboBoxStyle.Location = new System.Drawing.Point(306, 267);
			...
			comboBoxSpecification.Location = new System.Drawing.Point(500, 294);
			...
			toolStripSeparator8.Size = new System.Drawing.Size(295, 6);
			toolStripMenuRelationshipMap.Name = "toolStripMenuRelationshipMap";
			toolStripMenuRelationshipMap.Size = new System.Drawing.Size(298, 22);
			...
			base.ClientSize = new System.Drawing.Size(906, 581);
			...
			base.Name = "ExportSalesOrderForm";
			Text = "Export Sales Order";
			base.Load += new System.EventHandler(ExportSalesOrderForm_Load);
