...
{
	public class VendorCategoryDetailsForm : Form, IForm
	{
		...
		private EntityTypesEnum entityType = EntityTypesEnum.Vendors;
		...
		public VendorCategoryDetailsForm()
		{
			InitializeComponent();
			AddEvents();
		}
		...
		{
			new FormHelper().ShowList(DataComboType.VendorCategory);
		}
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Customers.VendorCategoryDetailsForm));
			...
			base.Name = "VendorCategoryDetailsForm";
