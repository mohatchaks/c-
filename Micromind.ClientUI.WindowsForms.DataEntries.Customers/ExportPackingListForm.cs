...
{
	public class ExportPackingListForm : Form, IForm
	{
		...
		private void JournalLeavesForm_Load(object sender, EventArgs e)
		{
			try
			{
				...
				SetupGrid();
				comboBoxSysDoc.FilterByType(SysDocTypes.ExportPackingList);
				SetSecurity();
				if (!base.IsDisposed)
				{
					IsNewRecord = true;
		...
		{
			new FormHelper().EditSysDoc(comboBoxSysDoc.SelectedID, SysDocTypes.ExportPackingList);
		}
		...
		private void Print(bool isPrint, bool showPrintDialog, bool saveChanges)
		{
			try
			{
				if (!(IsDirty && saveChanges) || (ErrorHelper.QuestionMessage(MessageBoxButtons.YesNo, "You must save the document before printing.", "Do you want to save?") == DialogResult.Yes && SaveData(clearAfter: false)))
				{
					...
					{
						PrintHelper.PrintDocument(exportPackingListToPrint, selectedID, "Packing List", SysDocTypes.ExportPackingList, isPrint, showPrintDialog);
					}
				}
			}
			catch (Exception e)
		...
		private bool SaveDraft()
		{
			try
			{
				if (GetData())
				{
					...
					{
						return Global.CompanySettings.SaveTransactionDraft(currentData, enterNameDialog.EnteredName, SysDocTypes.ExportPackingList);
					}
				}
				return false;
			}
		...
		private bool LoadDraft()
		{
			try
			{
				DataSet settingsList = Factory.SettingSystem.GetSettingsList("", 91.ToString());
				...
				if (selectDocumentDialog.ShowDialog(this) == DialogResult.OK)
				{
					...
					DataSet dataSet = Global.CompanySettings.LoadTransactionDraft(key, SysDocTypes.ExportPackingList);
		...
		private void toolStripMenuItemSelectDNote_Click(object sender, EventArgs e)
		{
			try
			{
				if (isNewRecord)
				{
					DataSet dOsForPackingList = Factory.DeliveryNoteSystem.GetDOsForPackingList(comboBoxCustomer.SelectedID, isExport: true);
					SelectDocumentDialog selectDocumentDialog = new SelectDocumentDialog();
					selectDocumentDialog.ValidateSelection += form_ValidateSelection;
					selectDocumentDialog.IsMultiSelect = true;
					selectDocumentDialog.DataSource = dOsForPackingList;
		...
		{
			FormActivator.BringFormToFront(FormActivator.ExportPackingListListFormObj);
		}
		...
		private void toolStripButtonMultiPreview_Click(object sender, EventArgs e)
		{
			...
			attachementDetailsForm.SysDocType = SysDocTypes.ExportPackingList;
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Customers.ExportPackingListForm));
			...
			dateTimePickerETA = new Micromind.UISupport.MMSDateTimePicker();
			...
			ultraTabbedMdiManager1 = new Infragistics.Win.UltraWinTabbedMdi.UltraTabbedMdiManager();
			...
			ultraTabPageControl1.Size = new System.Drawing.Size(721, 252);
			...
			dataGridItems.Size = new System.Drawing.Size(715, 249);
			...
			ultraTabPageControl2.Location = new System.Drawing.Point(23, 1);
			ultraTabPageControl2.Name = "ultraTabPageControl2";
			ultraTabPageControl2.Size = new System.Drawing.Size(721, 252);
			...
			labelVoided.Location = new System.Drawing.Point(2, 211);
			...
			label1.Location = new System.Drawing.Point(438, 26);
			label1.Name = "label1";
			...
			mmLabel1.Location = new System.Drawing.Point(438, 3);
			...
			mmLabel1.TabIndex = 2;
			mmLabel1.Text = "Date:";
			textBoxRef1.Location = new System.Drawing.Point(532, 23);
			...
			panelDetails.Size = new System.Drawing.Size(711, 156);
			panelDetails.TabIndex = 0;
			packingListTagTextBox.Location = new System.Drawing.Point(532, 133);
			packingListTagTextBox.MaxLength = 64;
			packingListTagTextBox.Name = "packingListTagTextBox";
			packingListTagTextBox.Size = new System.Drawing.Size(138, 20);
			packingListTagTextBox.TabIndex = 18;
			label28.AutoSize = true;
			label28.Location = new System.Drawing.Point(437, 138);
			...
			comboBoxCostCategory.Location = new System.Drawing.Point(532, 111);
			...
			labelcostcategory.Location = new System.Drawing.Point(438, 116);
			...
			labelJob.Location = new System.Drawing.Point(213, 116);
			...
			textBoxValue.Location = new System.Drawing.Point(532, 89);
			...
			label16.Location = new System.Drawing.Point(438, 48);
			...
			label14.Location = new System.Drawing.Point(438, 71);
			label14.Name = "label14";
			label14.Size = new System.Drawing.Size(79, 13);
			label14.TabIndex = 148;
			label14.Text = "Clearing Agent:";
			textBoxClearingAgent.Location = new System.Drawing.Point(532, 67);
			...
			label5.Location = new System.Drawing.Point(438, 93);
			label5.Name = "label5";
			...
			comboBoxPort.DisplayLayout.Appearance = appearance51;
			...
			comboBoxPort.DisplayLayout.GroupByBox.Appearance = appearance52;
			appearance53.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxPort.DisplayLayout.GroupByBox.BandLabelAppearance = appearance53;
			...
			comboBoxPort.DisplayLayout.GroupByBox.PromptAppearance = appearance54;
			...
			comboBoxPort.DisplayLayout.Override.ActiveCellAppearance = appearance55;
			...
			comboBoxPort.DisplayLayout.Override.ActiveRowAppearance = appearance56;
			...
			comboBoxPort.DisplayLayout.Override.CardAreaAppearance = appearance57;
			...
			comboBoxPort.DisplayLayout.Override.CellAppearance = appearance58;
			...
			comboBoxPort.DisplayLayout.Override.GroupByRowAppearance = appearance59;
			appearance60.TextHAlignAsString = "Left";
			comboBoxPort.DisplayLayout.Override.HeaderAppearance = appearance60;
			...
			comboBoxPort.DisplayLayout.Override.RowAppearance = appearance61;
			...
			comboBoxPort.DisplayLayout.Override.TemplateAddRowAppearance = appearance62;
			...
			label4.Location = new System.Drawing.Point(212, 69);
			label4.Name = "label4";
			label4.Size = new System.Drawing.Size(29, 13);
			label4.TabIndex = 142;
			label4.Text = "Port:";
			label15.AutoSize = true;
			label15.Location = new System.Drawing.Point(10, 91);
			...
			label10.Location = new System.Drawing.Point(212, 47);
			label10.Name = "label10";
			label10.Size = new System.Drawing.Size(93, 13);
			label10.TabIndex = 140;
			label10.Text = "Shipment Method:";
			...
			textBoxShipper.Location = new System.Drawing.Point(532, 45);
			...
			ultraTabControl1.Location = new System.Drawing.Point(3, 193);
			ultraTabControl1.Name = "ultraTabControl1";
			ultraTabControl1.SharedControlsPage = ultraTabSharedControlsPage1;
			ultraTabControl1.Size = new System.Drawing.Size(747, 256);
			...
			ultraTabSharedControlsPage1.Size = new System.Drawing.Size(721, 252);
			...
			base.Name = "ExportPackingListForm";
