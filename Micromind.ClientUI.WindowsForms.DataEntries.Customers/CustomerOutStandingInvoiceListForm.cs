...
{
	public class CustomerOutStandingInvoiceListForm : Form, IDataForm, IDataList, IExternalReport
	{
		...
		public CustomerOutStandingInvoiceListForm()
		{
			InitializeComponent();
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Customers.CustomerOutStandingInvoiceListForm));
			...
			base.Name = "CustomerOutStandingInvoiceListForm";
			Text = "Customer Outstanding Invoice List";
		...
		private void LoadData()
		{
			if (Factory.IsDBConnected)
			{
				try
				{
					...
					customerData = Factory.CustomerSystem.GetCustomerOutstandingInvoicesList(fromCustomer, checkBoxShowZero.Checked, checkBoxFC.Checked);
					dataGridList.DataSource = customerData.Tables[0];
