...
{
	public class CustomerCategoryAssignDialog : Form, IForm
	{
		...
		public CustomerCategoryAssignDialog()
		{
			InitializeComponent();
		...
		{
			DataSet customerAssignedCategorysList = Factory.CustomerCategorySystem.GetCustomerAssignedCategorysList(textBoxCode.Text);
			dataGridItems.DataSource = customerAssignedCategorysList.Tables[0];
		}
		...
		private bool SaveData()
		{
			try
			{
				...
				foreach (UltraGridRow row in dataGridItems.Rows)
				{
					...
					{
						customerCategoryData.Tables["Customer_Category_Detail"].Rows.Add(textBoxCode.Text, row.Cells["Code"].Value.ToString(), EntityType);
					}
				}
				return Factory.CustomerCategorySystem.InsertCustomerCategoryAssignment(customerCategoryData, textBoxCode.Text);
			}
			catch (Exception e)
			{
		...
		private void CustomerGroupAssignDialog_Load(object sender, EventArgs e)
		{
			try
			{
				LoadData();
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Customers.CustomerCategoryAssignDialog));
			...
			base.Name = "CustomerCategoryAssignDialog";
			base.ShowInTaskbar = false;
			base.StartPosition = System.Windows.Forms.FormStartPosition.CenterParent;
			Text = "Select Categories";
			base.Load += new System.EventHandler(CustomerGroupAssignDialog_Load);
