...
{
	public class ExportPickListForm : Form, IForm
	{
		...
		private ExportPickListData currentData;

		private const string TABLENAME_CONST = "Export_PickList";
		...
		private bool showcreatefrompicklist = CompanyPreferences.ShowCreatefromPickList;
		...
		private void docStatusLabel_LinkClicked(object sender, EventArgs e)
		{
			...
			if (control != null)
			{
				formHelper.EditTransaction(TransactionListType.ExportSalesInvoice, control.Tag.ToString(), control.Text);
			}
		}
		...
		private void dataGridItems_BeforeRowUpdate(object sender, CancelableRowEventArgs e)
		{
			...
			if (activeRow == null || activeRow.Cells["Item Code"].Value == null || activeRow.Cells["Item Code"].Value.ToString() == "" || CompanyPreferences.LocalSalesFlow != SalesFlows.SOThenDNThenInvoice || activeRow == null || !activeRow.DataChanged || CompanyPreferences.NegativeQuantityAction == 1)
			{
				return;
			}
			string sysDocID = "";
			...
			if (Factory.ProductSystem.IsSufficientQuantityOnhand(activeRow.Cells["Item Code"].Value.ToString(), activeRow.Cells["Unit"].Value.ToString(), activeRow.Cells["Location"].Value.ToString(), "Export_PickList_Detail", sysDocID, voucherID, decimal.Parse(activeRow.Cells["Quantity"].Value.ToString())) || supressInventoryMessage)
			{
				return;
			}
		...
		private void dataGridItems_AfterCellUpdate(object sender, CellEventArgs e)
		{
			try
			{
				...
				if (e.Cell.Column.Key == "Quantity")
				{
					...
					decimal.TryParse(e.Cell.Row.Cells["Ordered"].Value.ToString(), out result4);
					decimal.TryParse(e.Cell.Row.Cells["Shipped"].Value.ToString(), out decimal result6);
					if (result4 < result5 + result6)
					{
						ErrorHelper.WarningMessage("Quantity should less than ordered quantity");
						e.Cell.Row.Cells["Quantity"].Value = result4 - result6;
					}
				}
				end_IL_0000:;
			}
		...
		private void dataGrid_BeforeCellUpdate(object sender, BeforeCellUpdateEventArgs e)
		{
			if (CompanyPreferences.LocalSalesFlow == SalesFlows.SOThenDNThenInvoice)
			{
				...
				if (activeRow != null && activeRow.DataChanged && activeRow.IsAddRow && e.Cell.Column.Key == "Quantity" && CompanyPreferences.NegativeQuantityAction != 1)
				{
					...
					if (!Factory.ProductSystem.IsSufficientQuantityOnhand(activeRow.Cells["Item Code"].Value.ToString(), activeRow.Cells["Unit"].Value.ToString(), activeRow.Cells["Location"].Value.ToString(), "Export_PickList_Detail", sysDocID, voucherID, decimal.Parse(e.NewValue.ToString())) && !supressInventoryMessage)
					{
						if (CompanyPreferences.NegativeQuantityAction == 2)
						{
							if (ErrorHelper.QuestionMessage(MessageBoxButtons.YesNo, "You do not have sufficient quantity in this location. Do you want to continue?") != DialogResult.Yes)
			...
			if (dataGridItems.ActiveCell != null && e.Cell.Column.Key == "Quantity" && dataGridItems.ActiveCell.Column.Key == "Quantity" && !AllocateQuantityToLot(e.Cell))
			{
				e.Cancel = true;
			}
		}
		...
		private bool GetData()
		{
			try
			{
				...
				{
					currentData = new ExportPickListData();
				}
				DataRow dataRow = (!isNewRecord) ? currentData.ExportPickListTable.Rows[0] : currentData.ExportPickListTable.NewRow();
				...
				if (IsNewRecord)
				{
					currentData.ExportPickListTable.Rows.Add(dataRow);
				}
				currentData.ExportPickListDetailTable.Rows.Clear();
				currentData.Tables["Product_Lot_Issue_Detail"].Rows.Clear();
				foreach (UltraGridRow row in dataGridItems.Rows)
				{
					DataRow dataRow2 = currentData.ExportPickListDetailTable.NewRow();
					dataRow2.BeginEdit();
					...
					dataRow2.EndEdit();
					currentData.ExportPickListDetailTable.Rows.Add(dataRow2);
		...
		public void LoadData(string voucherID)
		{
			try
			{
				...
				{
					currentData = Factory.ExportPickListSystem.GetExportPickListByID(SystemDocID, voucherID);
					if (currentData != null)
					{
						FillData();
						IsNewRecord = false;
		...
		private void FillData()
		{
			try
			{
				...
				{
					DataRow dataRow = currentData.Tables["Export_PickList"].Rows[0];
					...
					if (currentData.Tables.Contains("Export_PickList_Detail") && currentData.ExportPickListDetailTable.Rows.Count != 0)
					{
						foreach (DataRow row in currentData.Tables["Export_PickList_Detail"].Rows)
						{
							...
							else
							{
								...
								num = decimal.Parse(row["Shipped"].ToString());
								num2 = decimal.Parse(row["Quantity"].ToString());
								dataRow3["Ordered"] = row["Ordered"].ToString();
								dataRow3["Shipped"] = num - num2;
							}
		...
		private bool SaveData(bool clearAfter)
		{
			...
			try
			{
				bool flag2 = Factory.ExportPickListSystem.CreateExportPickList(currentData, !isNewRecord);
				if (flag2)
				{
					flag = true;
				}
		...
		private bool ValidateData()
		{
			...
			if (!IsNewRecord && !Global.IsUserAdmin && !AllowEditTransaction && Global.CurrentUser != Factory.SystemDocumentSystem.GetTransUserID("Export_PickList", "VoucherID", SystemDocID, textBoxVoucherNumber.Text))
			{
			...
			checked
			{
				...
				if (formManager.IsFieldDirty(textBoxVoucherNumber) && Factory.SystemDocumentSystem.ExistDocumentNumber("Export_PickList", "VoucherID", SystemDocID, textBoxVoucherNumber.Text))
				{
					ErrorHelper.WarningMessage(UIMessages.DocumentNumberInUse);
					textBoxVoucherNumber.Focus();
					return false;
				}
				if (!IsNewRecord && !Factory.ExportPickListSystem.AllowDelete(comboBoxSysDoc.SelectedID, textBoxVoucherNumber.Text))
				{
		...
		private bool Delete()
		{
			try
			{
				...
				if (!Factory.ExportPickListSystem.AllowDelete(comboBoxSysDoc.SelectedID, textBoxVoucherNumber.Text))
				{
					ErrorHelper.WarningMessage("Some items in this transaction has been already allocated. You are not able to delete.");
					return false;
				}
				return Factory.ExportPickListSystem.DeleteExportPickList(SystemDocID, textBoxVoucherNumber.Text);
			}
			catch (Exception e)
			{
				ErrorHelper.ProcessError(e);
		...
		{
			string nextID = DatabaseHelper.GetNextID("Export_PickList", "VoucherID", textBoxVoucherNumber.Text, "SysDocID", SystemDocID);
			if (!(nextID == ""))
			{
				LoadData(nextID);
			}
		...
		{
			string previousID = DatabaseHelper.GetPreviousID("Export_PickList", "VoucherID", textBoxVoucherNumber.Text, "SysDocID", SystemDocID);
			if (!(previousID == ""))
			{
				LoadData(previousID);
			}
		...
		{
			string lastID = DatabaseHelper.GetLastID("Export_PickList", "VoucherID", "SysDocID", SystemDocID);
			if (!(lastID == ""))
			{
				LoadData(lastID);
			}
		...
		{
			string firstID = DatabaseHelper.GetFirstID("Export_PickList", "VoucherID", "SysDocID", SystemDocID);
			if (!(firstID == ""))
			{
				LoadData(firstID);
			}
		...
		private void toolStripButtonFind_Click(object sender, EventArgs e)
		{
			try
			{
				...
				{
					string text = Factory.DatabaseSystem.FindDocumentByNumber("Export_PickList", "VoucherID", SystemDocID, toolStripTextBoxFind.Text);
					if (text != "")
					{
						LoadData(text);
					}
		...
		private void JournalLeavesForm_Load(object sender, EventArgs e)
		{
			...
			{
				SetupGrid();
				comboBoxSysDoc.FilterByType(SysDocTypes.ExportPickList);
				SetSecurity();
				if (!base.IsDisposed)
				{
					IsNewRecord = true;
		...
		private bool Void(bool isVoid)
		{
			try
			{
				...
				if (!Factory.ExportPickListSystem.AllowDelete(comboBoxSysDoc.SelectedID, textBoxVoucherNumber.Text))
				{
					ErrorHelper.WarningMessage("Some items in this transaction has been already allocated. You are not able to void.");
					return false;
				}
				return Factory.ExportPickListSystem.VoidExportPickList(SystemDocID, textBoxVoucherNumber.Text, isVoid);
			}
			catch (Exception e)
			{
				ErrorHelper.ProcessError(e);
		...
		{
			new FormHelper().EditSysDoc(comboBoxSysDoc.SelectedID, SysDocTypes.ExportPickList);
		}
		...
		private void Print(bool isPrint, bool showPrintDialog, bool saveChanges)
		{
			try
			{
				if (!(IsDirty && saveChanges) || (ErrorHelper.QuestionMessage(MessageBoxButtons.YesNo, "You must save the document before printing.", "Do you want to save?") == DialogResult.Yes && SaveData(clearAfter: false)))
				{
					...
					string text = textBoxVoucherNumber.Text;
					DataSet exportPickListToPrint = Factory.ExportPickListSystem.GetExportPickListToPrint(selectedID, text, showLotDetail);
					if (exportPickListToPrint == null || exportPickListToPrint.Tables.Count == 0)
					{
						ErrorHelper.ErrorMessage("Cannot print the document.", "Document not found.");
					}
					else
					{
						PrintHelper.PrintDocument(exportPickListToPrint, selectedID, "Export Pick List", SysDocTypes.ExportPickList, isPrint, showPrintDialog);
					}
				}
			}
			catch (Exception e)
		...
		{
			FormActivator.BringFormToFront(FormActivator.ExportPickListListFormObj);
		}
		...
		private void toolStripButtonMultiPreview_Click(object sender, EventArgs e)
		{
			...
			attachementDetailsForm.SysDocType = SysDocTypes.ExportPickList;
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.WindowsForms.DataEntries.Customers.ExportPickListForm));
			...
			toolStrip1.Size = new System.Drawing.Size(776, 31);
			...
			duplicateToolStripMenuItem.Size = new System.Drawing.Size(216, 22);
			...
			selectInvoiceToolStripMenuItem.Size = new System.Drawing.Size(216, 22);
			...
			createFromSalesOrderToolStripMenuItem.Size = new System.Drawing.Size(216, 22);
			...
			panelButtons.Size = new System.Drawing.Size(776, 40);
			...
			xpButton1.Location = new System.Drawing.Point(666, 8);
			...
			panelDetails.Size = new System.Drawing.Size(749, 188);
			panelDetails.TabIndex = 0;
			appearance3.FontData.BoldAsString = "False";
			appearance3.FontData.Name = "Tahoma";
			labelTaxGroup.Appearance = appearance3;
			labelTaxGroup.AutoSize = true;
			labelTaxGroup.Location = new System.Drawing.Point(408, 143);
			...
			comboBoxPayeeTaxGroup.Location = new System.Drawing.Point(473, 142);
			...
			ultraFormattedLinkShipping.VisitedLinkAppearance = appearance18;
			...
			labelJob.Location = new System.Drawing.Point(360, 168);
			labelJob.Name = "labelJob";
			labelJob.Size = new System.Drawing.Size(25, 15);
			labelJob.TabIndex = 176;
			...
			labelcostcategory.Appearance = appearance21;
			labelcostcategory.AutoSize = true;
			labelcostcategory.Location = new System.Drawing.Point(520, 166);
			labelcostcategory.Name = "labelcostcategory";
			labelcostcategory.Size = new System.Drawing.Size(76, 15);
			labelcostcategory.TabIndex = 175;
			...
			labelcostcategory.VisitedLinkAppearance = appearance22;
			...
			comboBoxCostCategory.Location = new System.Drawing.Point(597, 163);
			...
			comboBoxCostCategory.TabIndex = 24;
			...
			comboBoxContainerSize.Location = new System.Drawing.Point(293, 142);
			...
			comboBoxContainerSize.TabIndex = 18;
			...
			comboBoxJob.TabIndex = 23;
			comboBoxJob.UseFlatMode = Infragistics.Win.DefaultableBoolean.True;
			label7.AutoSize = true;
			label7.Location = new System.Drawing.Point(213, 145);
			label7.Name = "label7";
			...
			textBoxContainerNo.TabIndex = 17;
			...
			comboBoxVehicle.Location = new System.Drawing.Point(618, 141);
			...
			comboBoxVehicle.Size = new System.Drawing.Size(86, 20);
			...
			linkLabelVehicle.Location = new System.Drawing.Point(569, 145);
			...
			comboBoxDriver.Location = new System.Drawing.Point(551, 112);
			...
			linkLabelDriver.Location = new System.Drawing.Point(472, 115);
			...
			comboBoxSalesperson.Location = new System.Drawing.Point(551, 89);
			...
			ultraFormattedLinkLabel6.Location = new System.Drawing.Point(472, 91);
			...
			label2.Location = new System.Drawing.Point(469, 70);
			label2.Name = "label2";
			label2.Size = new System.Drawing.Size(79, 13);
			label2.TabIndex = 143;
			label2.Text = "Customer PO#:";
			textBoxPONumber.Location = new System.Drawing.Point(551, 67);
			...
			comboBoxShippingMethod.TabIndex = 21;
			...
			labelVoided.Location = new System.Drawing.Point(12, 388);
			labelVoided.Name = "labelVoided";
			labelVoided.Size = new System.Drawing.Size(735, 49);
			...
			docStatusLabel.Location = new System.Drawing.Point(585, 486);
			...
			comboBoxGridLocation.Location = new System.Drawing.Point(635, 251);
			...
			dataGridItems.DisplayLayout.Appearance = appearance169;
			...
			dataGridItems.DisplayLayout.GroupByBox.Appearance = appearance170;
			appearance171.ForeColor = System.Drawing.SystemColors.GrayText;
			dataGridItems.DisplayLayout.GroupByBox.BandLabelAppearance = appearance171;
			...
			dataGridItems.DisplayLayout.GroupByBox.PromptAppearance = appearance172;
			...
			dataGridItems.DisplayLayout.Override.ActiveCellAppearance = appearance173;
			...
			dataGridItems.DisplayLayout.Override.ActiveRowAppearance = appearance174;
			dataGridItems.DisplayLayout.Override.AllowAddNew = Infragistics.Win.UltraWinGrid.AllowAddNew.No;
			dataGridItems.DisplayLayout.Override.BorderStyleCell = Infragistics.Win.UIElementBorderStyle.Dotted;
			dataGridItems.DisplayLayout.Override.BorderStyleRow = Infragistics.Win.UIElementBorderStyle.Dotted;
			appearance175.BackColor = System.Drawing.SystemColors.Window;
			dataGridItems.DisplayLayout.Override.CardAreaAppearance = appearance175;
			...
			dataGridItems.DisplayLayout.Override.CellAppearance = appearance176;
			...
			dataGridItems.DisplayLayout.Override.GroupByRowAppearance = appearance177;
			appearance178.TextHAlignAsString = "Left";
			dataGridItems.DisplayLayout.Override.HeaderAppearance = appearance178;
			...
			dataGridItems.DisplayLayout.Override.RowAppearance = appearance179;
			dataGridItems.DisplayLayout.Override.RowSelectors = Infragistics.Win.DefaultableBoolean.False;
			appearance180.BackColor = System.Drawing.SystemColors.ControlLight;
			dataGridItems.DisplayLayout.Override.TemplateAddRowAppearance = appearance180;
			...
			dataGridItems.Location = new System.Drawing.Point(3, 221);
			...
			dataGridItems.Size = new System.Drawing.Size(750, 250);
			...
			comboBoxGridItem.DisplayLayout.Appearance = appearance181;
			...
			comboBoxGridItem.DisplayLayout.GroupByBox.Appearance = appearance182;
			appearance183.ForeColor = System.Drawing.SystemColors.GrayText;
			comboBoxGridItem.DisplayLayout.GroupByBox.BandLabelAppearance = appearance183;
			...
			comboBoxGridItem.DisplayLayout.GroupByBox.PromptAppearance = appearance184;
			...
			comboBoxGridItem.DisplayLayout.Override.ActiveCellAppearance = appearance185;
			...
			comboBoxGridItem.DisplayLayout.Override.ActiveRowAppearance = appearance186;
			...
			comboBoxGridItem.DisplayLayout.Override.CardAreaAppearance = appearance187;
			...
			comboBoxGridItem.DisplayLayout.Override.CellAppearance = appearance188;
			...
			comboBoxGridItem.DisplayLayout.Override.GroupByRowAppearance = appearance189;
			appearance190.TextHAlignAsString = "Left";
			comboBoxGridItem.DisplayLayout.Override.HeaderAppearance = appearance190;
			...
			comboBoxGridItem.DisplayLayout.Override.RowAppearance = appearance191;
			...
			comboBoxGridItem.DisplayLayout.Override.TemplateAddRowAppearance = appearance192;
			...
			base.ClientSize = new System.Drawing.Size(776, 608);
			...
			base.Name = "ExportPickListForm";
			Text = "Export Pick List";
