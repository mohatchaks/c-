...
namespace Micromind.ClientUI.Reports.CustomReports
{
	public class AddParameterDialog : Form
	{
		...
		private void buttonOK_Click(object sender, EventArgs e)
		{
			...
			reportParameter.ParameterName = textBoxParameterName.Text;
			reportParameter.ParameterType = checked(comboBoxDataType.SelectedIndex + 1);
		...
		public void EditParameter(ReportParameter parameter)
		{
			if (parameter != null)
			{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.CustomReports.AddParameterDialog));
