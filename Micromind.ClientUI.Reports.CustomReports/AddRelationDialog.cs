...
namespace Micromind.ClientUI.Reports.CustomReports
{
	...
	{
		private CustomReport reportData;

		private ReportRelation relation;
		...
		public ReportRelation Relationship
		{
			get
			{
				return relation;
		...
		public CustomReport ReportData
		{
			get
			{
				return reportData;
			...
			set
			{
				...
				foreach (CustomReportTable table in reportData.Tables)
				{
		...
		private void comboBoxChildTable_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			{
				CustomReportTable customReportTable = comboBoxChildTable.SelectedItem as CustomReportTable;
				DataSet tableSchema = Factory.CustomReportSystem.GetTableSchema(customReportTable.query);
		...
		private void comboBoxParentTable_SelectedIndexChanged(object sender, EventArgs e)
		{
			...
			{
				CustomReportTable customReportTable = comboBoxParentTable.SelectedItem as CustomReportTable;
				DataSet tableSchema = Factory.CustomReportSystem.GetTableSchema(customReportTable.query);
		...
		public void LoadReportData(CustomReport reportData)
		{
			comboBoxChildTable.Items.Clear();
			comboBoxParentTable.Items.Clear();
			foreach (CustomReportTable table in reportData.Tables)
		...
		public void EditRelation(ReportRelation relation)
		{
