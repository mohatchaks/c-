...
{
	public class PurchaseQuoteReport : Form, IForm
	{
		...
		private void buttonOK_Click(object sender, EventArgs e)
		{
			try
			{
				...
				{
					data = Factory.VendorSystem.GetPurchaseQuoteDetailReport(dateControl1.FromDate, dateControl1.ToDate, productSelector.FromItem, productSelector.ToItem, productSelector.FromClass, productSelector.ToClass, productSelector.FromCategory, productSelector.ToCategory, productSelector.FromBrand, productSelector.ToBrand, vendorSelector.FromVendor, vendorSelector.ToVendor, vendorSelector.FromClass, vendorSelector.ToClass, vendorSelector.FromGroup, vendorSelector.ToGroup, BuyerSelector.FromBuyer, BuyerSelector.ToBuyer, locationSelector.FromLocation, locationSelector.ToLocation, productSelector.FromManufacturer, productSelector.ToManufacturer, productSelector.FromStyle, productSelector.ToStyle, productSelector.FromOrigin, productSelector.ToOrigin);
					xtraReport = reportHelper.GetReport("Purchase Quote Detail");
				}
				else
				{
					data = Factory.VendorSystem.GetPurchaseQuoteSummaryReport(dateControl1.FromDate, dateControl1.ToDate, vendorSelector.FromVendor, vendorSelector.ToVendor, vendorSelector.FromClass, vendorSelector.ToClass, vendorSelector.FromGroup, vendorSelector.ToGroup, BuyerSelector.FromBuyer, BuyerSelector.ToBuyer);
					xtraReport = reportHelper.GetReport("Purchase Quote Summary");
				}
				...
				if (xtraReport == null)
				{
					ErrorHelper.ErrorMessage("Cannot find the report file. Please make sure you have access to reports path and the files are not corrupted.", "'Purchase Quote.repx'");
				}
				else
				{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.Vendors.PurchaseQuoteReport));
			...
			radioButtonDetail.Location = new System.Drawing.Point(112, 584);
			...
			radioButtonSummary.Location = new System.Drawing.Point(23, 584);
			...
			ultraGroupBox4.Location = new System.Drawing.Point(13, 441);
			...
			ultraGroupBox2.Location = new System.Drawing.Point(13, 157);
			...
			buttonClose.Location = new System.Drawing.Point(370, 620);
			...
			buttonOK.Location = new System.Drawing.Point(266, 620);
			...
			ultraGroupBox3.Location = new System.Drawing.Point(13, 367);
			...
			dateControl1.Location = new System.Drawing.Point(13, 521);
			...
			base.Name = "PurchaseQuoteReport";
			Text = "Purchase Quote Report";
