...
{
	public class CashPurchaseReport : Form, IForm
	{
		...
		private void buttonOK_Click(object sender, EventArgs e)
		{
			try
			{
				...
				{
					data = Factory.VendorSystem.GetcashPurchaseDetailReport(dateControl1.FromDate, dateControl1.ToDate, productSelector.FromItem, productSelector.ToItem, productSelector.FromClass, productSelector.ToClass, productSelector.FromCategory, productSelector.ToCategory, productSelector.FromBrand, productSelector.ToBrand, vendorSelector.FromVendor, vendorSelector.ToVendor, vendorSelector.FromClass, vendorSelector.ToClass, vendorSelector.FromGroup, vendorSelector.ToGroup, BuyerSelector.FromBuyer, BuyerSelector.ToBuyer, vendorSelector.MultipleVendors);
					xtraReport = reportHelper.GetReport("Cash Purchase Detail");
				}
				else
				{
					data = Factory.VendorSystem.GetCashPurchaseSummaryReport(dateControl1.FromDate, dateControl1.ToDate, vendorSelector.FromVendor, vendorSelector.ToVendor, vendorSelector.FromClass, vendorSelector.ToClass, vendorSelector.FromGroup, vendorSelector.ToGroup, BuyerSelector.FromBuyer, BuyerSelector.ToBuyer, vendorSelector.MultipleVendors);
					xtraReport = reportHelper.GetReport("Cash Purchase Summary");
				}
				string reportFilter = "From:" + dateControl1.FromDate.ToShortDateString() + "  To:" + dateControl1.ToDate.ToShortDateString();
				reportHelper.AddGeneralReportData(ref data, reportFilter);
				if (xtraReport == null)
				{
					ErrorHelper.ErrorMessage("Cannot find the report file. Please make sure you have access to reports path and the files are not corrupted.", "'Cash Purchase.repx'");
				}
				else
				{
		...
		{
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Micromind.ClientUI.Reports.Vendors.CashPurchaseReport));
			...
			radioButtonDetail.Location = new System.Drawing.Point(112, 514);
			...
			radioButtonSummary.Location = new System.Drawing.Point(23, 514);
			...
			buttonClose.Location = new System.Drawing.Point(370, 561);
			...
			buttonOK.Location = new System.Drawing.Point(266, 561);
			...
			vendorSelector.Size = new System.Drawing.Size(432, 132);
			...
			dateControl1.Location = new System.Drawing.Point(13, 452);
			...
			base.ClientSize = new System.Drawing.Size(502, 598);
